...
import static com.liferay.portal.configuration.easyconf.ClassLoaderComponentConfiguration.decode;
...
public class ClassLoaderComponentConfigurationTest {
	...
	public void testDecode() {
		...
		Assert.assertEquals("abcDEF", decode("abcDEF"));

		// Incompleted encoded content

		Assert.assertEquals("abc_DEF", decode("abc_DEF"));
		...
		Assert.assertEquals(
			"abc:D,^E[F]", decode("abc_58_D_44__94_E_91_F_93_"));
		...
		try (CaptureHandler captureHandler =
			...
			Assert.assertEquals(s, decode(s));
