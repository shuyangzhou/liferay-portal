...
public class ClusterSchedulerEngineTest {
	...
	public void testSetClusterableThreadLocal1() throws Exception {
		...
		Map<String, Serializable> context = _collectThreadLoaclContext();
		...
		context = _collectThreadLoaclContext();
	...
	private Map<String, Serializable> _collectThreadLoaclContext()
		throws Exception {
