...
public class PortalImplCanonicalURLTest {
	...
	protected String generateURL(
		String portalDomain, String port, String groupFriendlyURL,
		String layoutFriendlyURL, boolean secure) {
	...
	protected void testCanonicalURL(
		...
		String expectedCanonicalURL = generateURL(
			expectedPortalDomain, port, expectedGroupFriendlyURL,
			expectedLayoutFriendlyURL, secure);
