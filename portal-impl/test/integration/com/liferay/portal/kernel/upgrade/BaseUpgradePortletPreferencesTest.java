...
public class BaseUpgradePortletPreferencesTest
	...
	public void tearDown() throws Exception {
		...
		runSQL(
			"DELETE from PortletPreferences where portletId = '" + _portletId +
				"'");
	}
	...
	private static final String _portletId = "test";

	private long _groupId;
	private long _organizationId;
	private long _plid;
	private long _portletItemId;
	private final List<PortletPreferences> _portletPreferences =
		new ArrayList<>();
