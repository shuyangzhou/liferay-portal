...
public class UserGroupRoleServiceTest {
	...
	public void testGroupAdminRemovingOrganizationAdminRoleByRoles()
		...
		User objectUser = UserTestUtil.addOrganizationAdminUser(_organization);
	...
	public void testGroupAdminRemovingOrganizationOwnerRoleByRoles()
		...
		User subjectUser = UserTestUtil.addGroupAdminUser(group);
		User objectUser = UserTestUtil.addOrganizationOwnerUser(_organization);
	...
	public void testOrganizationAdminRemovingOrganizationAdminRoleByRoles()
		...
		User subjectUser = UserTestUtil.addOrganizationAdminUser(_organization);
		User objectUser = UserTestUtil.addOrganizationAdminUser(_organization);

		try {
			deleteUserGroupRolesByRole(
				_organization.getGroupId(), role.getRoleId(), subjectUser,
				objectUser);
			...
			Assert.assertTrue(
				UserGroupRoleLocalServiceUtil.hasUserGroupRole(
					objectUser.getUserId(), _organization.getGroupId(),
					role.getRoleId()));
		}
	}
	...
	public void testOrganizationOwnerRemovingOrganizationAdminRoleByRoles()
		...
		User subjectUser = UserTestUtil.addOrganizationOwnerUser(_organization);
		User objectUser = UserTestUtil.addOrganizationAdminUser(_organization);
