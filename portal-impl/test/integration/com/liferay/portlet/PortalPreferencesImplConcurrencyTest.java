...
public class PortalPreferencesImplConcurrencyTest {
	...
	public static void setUpClass() {
		...
		_transactionInterceptor.setTransactionExecutor(
			new SynchronizedTransactionExecutor(
				_originalTransactionExecutor, new CyclicBarrier(2)));
	...
	protected void doSynchronousUpdate(
		...
		SynchronousInvocationHandler._synchronize = true;
		...
		SynchronousInvocationHandler._synchronize = false;
	...
	protected static class SynchronizedTransactionExecutor
		...
		private static boolean _synchronize;
	...
	protected static class SynchronousInvocationHandler
		...
		public Object invoke(Object proxy, Method method, Object[] args)
			...
			if (method.getName().equals("updatePreferences") &&
				Arrays.equals(parameterTypes, expectedTypes)) {

				SynchronizedTransactionExecutor._synchronize = _synchronize;
