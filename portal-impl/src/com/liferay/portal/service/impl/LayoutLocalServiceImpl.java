...
public class LayoutLocalServiceImpl extends LayoutLocalServiceBaseImpl {
	...
	public Map<Long, List<Layout>> getLayoutChildLayouts(
		...
		for (Layout childLayout : childLayouts) {
			List<Layout> layoutChildLayoutsList = layoutChildLayouts.get(
				childLayout.getParentLayoutId());

			if (layoutChildLayoutsList == null) {
				layoutChildLayoutsList = new ArrayList<>();

				layoutChildLayouts.put(
					childLayout.getParentLayoutId(), layoutChildLayoutsList);
			}
