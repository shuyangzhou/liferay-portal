...
import com.liferay.portal.backgroundtask.BackgroundTaskStatusJSONMethodKeyFactory;
...
public class BackgroundTaskLocalServiceImpl
	...
	public void cleanUpBackgroundTasks() throws SystemException {
		...
		for (BackgroundTask backgroundTask : backgroundTasks) {
			...
			backgroundTaskLocalService.cleanUpBackgroundTask(
	...
	@ClusterMaster(
		methodKeyFactory = BackgroundTaskStatusJSONMethodKeyFactory.class)
	@Override
