...
public class LayoutRevisionPersistenceImpl extends BasePersistenceImpl<LayoutRevision>
	...
	public LayoutRevision updateImpl(LayoutRevision layoutRevision) {
		...
		LayoutRevision updatedLayoutRevision = null;
		...
		try {
			...
			if (layoutRevision.isNew()) {
				...
				updatedLayoutRevision = (LayoutRevision)session.merge(layoutRevision);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedLayoutRevision == null) {
			...
			cacheUniqueFindersCache(updatedLayoutRevision, isNew);
		}
