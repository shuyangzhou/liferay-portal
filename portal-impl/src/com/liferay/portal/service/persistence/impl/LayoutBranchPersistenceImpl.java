...
public class LayoutBranchPersistenceImpl extends BasePersistenceImpl<LayoutBranch>
	...
	public LayoutBranch updateImpl(LayoutBranch layoutBranch) {
		...
		LayoutBranch updatedLayoutBranch = null;
		...
		try {
			...
			if (layoutBranch.isNew()) {
				...
				updatedLayoutBranch = (LayoutBranch)session.merge(layoutBranch);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedLayoutBranch == null) {
			...
			cacheUniqueFindersCache(updatedLayoutBranch, isNew);
		}
