...
public class RepositoryPersistenceImpl
	...
	public List<Repository> findByUuid(
		...
		List<Repository> list = (List<Repository>)FinderCacheUtil.getResult(
	 ...
	 *
	 * @deprecated As of Mueller (7.2.x), replaced by {@link #fetchByG_N_P(long,String,String)}
	 * @param groupId the group ID
	 * @param name the name
	 * @param portletId the portlet ID
	 * @param useFinderCache whether to use the finder cache
	...
	public Repository fetchByG_N_P(
		...
		return fetchByG_N_P(groupId, name, portletId);
	}
