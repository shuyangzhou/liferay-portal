...
public class LayoutPersistenceImpl
	...
	static {
		...
		strictCTModeAttributeNames.add("uuid_");
		strictCTModeAttributeNames.add("groupId");
		strictCTModeAttributeNames.add("companyId");
		strictCTModeAttributeNames.add("userId");
		strictCTModeAttributeNames.add("userName");
		strictCTModeAttributeNames.add("createDate");
		ignoreCTModeAttributeNames.add("modifiedDate");
		strictCTModeAttributeNames.add("parentPlid");
		strictCTModeAttributeNames.add("privateLayout");
		strictCTModeAttributeNames.add("layoutId");
		strictCTModeAttributeNames.add("parentLayoutId");
		strictCTModeAttributeNames.add("classNameId");
		strictCTModeAttributeNames.add("classPK");
		mergeCTModeAttributeNames.add("name");
		mergeCTModeAttributeNames.add("title");
		mergeCTModeAttributeNames.add("description");
		strictCTModeAttributeNames.add("keywords");
		strictCTModeAttributeNames.add("robots");
		strictCTModeAttributeNames.add("type_");
		strictCTModeAttributeNames.add("typeSettings");
		strictCTModeAttributeNames.add("hidden_");
		strictCTModeAttributeNames.add("system_");
		strictCTModeAttributeNames.add("friendlyURL");
		strictCTModeAttributeNames.add("iconImageId");
		strictCTModeAttributeNames.add("themeId");
		strictCTModeAttributeNames.add("colorSchemeId");
		strictCTModeAttributeNames.add("css");
		strictCTModeAttributeNames.add("priority");
		strictCTModeAttributeNames.add("masterLayoutPlid");
		strictCTModeAttributeNames.add("layoutPrototypeUuid");
		strictCTModeAttributeNames.add("layoutPrototypeLinkEnabled");
		strictCTModeAttributeNames.add("sourcePrototypeLayoutUuid");
		strictCTModeAttributeNames.add("publishDate");
		strictCTModeAttributeNames.add("lastPublishDate");
		...
		_ctModeAttributeNames.put(CTMode.PK, Collections.singleton("plid"));
