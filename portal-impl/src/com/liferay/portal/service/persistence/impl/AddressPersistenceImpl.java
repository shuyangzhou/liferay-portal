...
public class AddressPersistenceImpl extends BasePersistenceImpl<Address>
	 ...
	 */
	@Override
	public List<Address> findByUuid(String uuid, boolean retrieveFromCache) {
		return findByUuid(uuid, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null,
			retrieveFromCache);
	}
	 ...
	 */
	@Override
	public List<Address> findByUserId(long userId, boolean retrieveFromCache) {
		return findByUserId(userId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null,
			retrieveFromCache);
	}
	...
	@Override
	public List<Address> findByC_C_C_M(long companyId, long classNameId,
		long classPK, boolean mailing, boolean retrieveFromCache) {
		return findByC_C_C_M(companyId, classNameId, classPK, mailing,
