...
public class LayoutSetPersistenceImpl
	...
	public List<LayoutSet> findByGroupId(
		...
		List<LayoutSet> list = (List<LayoutSet>)FinderCacheUtil.getResult(
	 ...
	 *
	 * @deprecated As of Mueller (7.2.x), replaced by {@link #fetchByG_P(long,boolean)}
	 * @param groupId the group ID
	 * @param privateLayout the private layout
	 * @param useFinderCache whether to use the finder cache
	...
	public LayoutSet fetchByG_P(
		...
		return fetchByG_P(groupId, privateLayout);
	}
	 ...
	 *
	 * @deprecated As of Mueller (7.2.x), replaced by {@link #fetchByP_L(boolean,long)}
	 * @param privateLayout the private layout
	 * @param logoId the logo ID
	 * @param useFinderCache whether to use the finder cache
	 * @return the matching layout set, or <code>null</code> if a matching layout set could not be found
	...
	public LayoutSet fetchByP_L(
		...
		return fetchByP_L(privateLayout, logoId);
	}
