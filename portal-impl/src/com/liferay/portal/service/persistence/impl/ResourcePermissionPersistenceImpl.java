...
public class ResourcePermissionPersistenceImpl
	...
	static {
		...
		strictCTModeAttributeNames.add("scope");
		strictCTModeAttributeNames.add("primKey");
		strictCTModeAttributeNames.add("primKeyId");
		strictCTModeAttributeNames.add("roleId");
		strictCTModeAttributeNames.add("ownerId");
		strictCTModeAttributeNames.add("actionIds");
		strictCTModeAttributeNames.add("viewActionId");
		...
		_ctModeAttributeNames.put(
			CTMode.PK, Collections.singleton("resourcePermissionId"));
