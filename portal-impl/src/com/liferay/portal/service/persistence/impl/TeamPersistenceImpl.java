...
public class TeamPersistenceImpl extends BasePersistenceImpl<Team>
	...
	public long[] getUserPrimaryKeys(long pk) {
		Team team = findByPrimaryKey(pk);

		long[] pks = teamToUserTableMapper.getRightPrimaryKeys(team.getCompanyId(),
				pk);
	...
	public List<com.liferay.portal.model.User> getUsers(long pk, int start,
		...
		return teamToUserTableMapper.getRightBaseModels(team.getCompanyId(),
	...
	public boolean containsUser(long pk, long userPK) {
		...
		return teamToUserTableMapper.containsTableMapping(team.getCompanyId(),
			pk, userPK);
	}
	...
	public void addUser(long pk, long userPK) {
		...
		teamToUserTableMapper.addTableMapping(team.getCompanyId(), pk, userPK);
	}
	...
	public void removeUser(long pk, long userPK) {
		...
		teamToUserTableMapper.deleteTableMapping(team.getCompanyId(), pk, userPK);
	}
	...
	public void removeUsers(long pk, long[] userPKs) {
		...
		for (long userPK : userPKs) {
			teamToUserTableMapper.deleteTableMapping(team.getCompanyId(), pk,
				userPK);
		}
	}
	...
	public long[] getUserGroupPrimaryKeys(long pk) {
		...
		long[] pks = teamToUserGroupTableMapper.getRightPrimaryKeys(team.getCompanyId(),
				pk);
	...
	public List<com.liferay.portal.model.UserGroup> getUserGroups(long pk,
		...
		return teamToUserGroupTableMapper.getRightBaseModels(team.getCompanyId(),
			pk, start, end, orderByComparator);
	}
	...
	public boolean containsUserGroup(long pk, long userGroupPK) {
		...
		return teamToUserGroupTableMapper.containsTableMapping(team.getCompanyId(),
			pk, userGroupPK);
	}
	...
	public void removeUserGroup(long pk, long userGroupPK) {
		...
		teamToUserGroupTableMapper.deleteTableMapping(team.getCompanyId(), pk,
			userGroupPK);
	}
	...
	public void removeUserGroups(long pk, long[] userGroupPKs) {
		...
		for (long userGroupPK : userGroupPKs) {
			teamToUserGroupTableMapper.deleteTableMapping(team.getCompanyId(),
				pk, userGroupPK);
		}
	}
