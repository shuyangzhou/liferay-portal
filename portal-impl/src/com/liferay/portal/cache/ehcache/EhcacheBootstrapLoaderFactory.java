 ...
 * @author Tina Tian
 */
public class EhcacheBootstrapLoaderFactory
	implements ListenerFactory<BootstrapLoader> {

	@Override
	public BootstrapLoader createListener(Properties properties) {
		if (properties == null) {
		...
		try {
			BootstrapCacheLoaderFactory<?> bootstrapCacheLoaderFactory =
				_bootstrapCacheLoaderFactories.get(factoryName);
			...
			if (bootstrapCacheLoaderFactory == null) {
				...
				_bootstrapCacheLoaderFactories.put(
					factoryName, bootstrapCacheLoaderFactory);
			}
	...
	private static Log _log = LogFactoryUtil.getLog(
		EhcacheBootstrapLoaderFactory.class);

	private static Map<String, BootstrapCacheLoaderFactory<?>>
