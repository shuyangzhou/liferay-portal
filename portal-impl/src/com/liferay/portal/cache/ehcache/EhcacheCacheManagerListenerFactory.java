 ...
 * @author Tina Tian
 */
public class EhcacheCacheManagerListenerFactory
	implements ListenerFactory<CacheManagerListener> {

	@Override
	public CacheManagerListener createListener(Properties properties) {
		if (properties == null) {
		...
		try {
			CacheManagerEventListenerFactory cacheManagerEventListenerFactory =
				_cacheManagerEventListenerFactories.get(factoryName);
			...
			if (cacheManagerEventListenerFactory == null) {
				...
				_cacheManagerEventListenerFactories.put(
					factoryName, cacheManagerEventListenerFactory);
			}
	...
	private static Log _log = LogFactoryUtil.getLog(
		EhcacheCacheManagerListenerFactory.class);

	private static Map<String, CacheManagerEventListenerFactory>
