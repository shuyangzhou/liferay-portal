...
public class DataFactory {
	...
	public List<Long> getAssetCategoryIds(long groupId) {
		...
		List<Long> assetCategoryIds = new ArrayList<Long>(
			_maxAssetEntryCategoryCount);

		for (int i = 0; i < _maxAssetEntryCategoryCount; i++) {
	...
	public List<Long> getAssetTagIds(long groupId) {
		...
		List<Long> assetTagIds = new ArrayList<Long>(_maxAssetEntryTagCount);

		for (int i = 0; i < _maxAssetEntryTagCount; i++) {
