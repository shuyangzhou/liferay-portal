...
public class DataFactory {
	...
	public DataFactory(
			...
			int maxAssetCategoryPerEntryCount, int maxAssetTagCount,
			int maxAssetTagPerEntryCount, int maxAssetVocabularyCount,
		...
		_maxAssetCategoryPerEntryCount = maxAssetCategoryPerEntryCount;
		_maxAssetTagCount = maxAssetTagCount;
		_maxAssetTagPerEntryCount = maxAssetTagPerEntryCount;
	...
	public List<Long> getAssetCategoryIds(long groupId) {
		...
		List<Long> assetCategoryIds = new ArrayList<Long>(
			_maxAssetCategoryPerEntryCount);

		for (int i = 0; i < _maxAssetCategoryPerEntryCount; i++) {
	...
	public List<Long> getAssetTagIds(long groupId) {
		...
		List<Long> assetTagIds = new ArrayList<Long>(_maxAssetTagPerEntryCount);

		for (int i = 0; i < _maxAssetTagPerEntryCount; i++) {
	...
	private int _maxAssetCategoryPerEntryCount;
	private int _maxAssetTagCount;
	private int _maxAssetTagPerEntryCount;
