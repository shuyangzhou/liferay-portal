...
public class SampleSQLBuilder {
	...
	public SampleSQLBuilder(Map<String, String> arguments) throws Exception {
		...
		_maxAssetCategoryCount = GetterUtil.getInteger(
			arguments.get(
				"sample.sql.max.asset.category.per.vocabulary.count"));
		_maxAssetCategoryPerEntry = GetterUtil.getInteger(
			arguments.get("sample.sql.max.asset.category.per.entry.count"));
		_maxAssetTagCount = GetterUtil.getInteger(
			arguments.get("sample.sql.max.asset.tag.count"));
		_maxAssetTagPerEntryCount = GetterUtil.getInteger(
			arguments.get("sample.sql.max.asset.tag.per.entry.count"));
		...
		_dataFactory = new DataFactory(
			baseDir, _maxAssetCategoryCount, _maxAssetCategoryPerEntry,
			_maxAssetTagCount, _maxAssetTagPerEntryCount,
	...
	private int _maxAssetCategoryPerEntry;
