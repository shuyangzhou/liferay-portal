...
public class SampleSQLBuilder {
	...
	public SampleSQLBuilder(Map<String, String> arguments) throws Exception {
		...
		_maxAssetPublisherToFilterRuleCount = GetterUtil.getInteger(
			arguments.get(
				"sample.sql.max.asset.publisher.to.filter.rule.count"));
		...
		_dataFactory = new DataFactory(
			...
			_maxAssetPublisherToFilterRuleCount, _maxAssetTagCount,
