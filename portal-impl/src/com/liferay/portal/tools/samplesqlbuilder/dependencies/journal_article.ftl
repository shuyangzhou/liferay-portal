<#if (dataFactory.maxJournalArticlePageCount > 0)>
	<#list 1..dataFactory.maxJournalArticlePageCount as journalArticlePageCount>
		...
		<#if (dataFactory.maxJournalArticleCount > 0) && (dataFactory.maxJournalArticleVersionCount > 0)>
			<#list 1..dataFactory.maxJournalArticleCount as journalArticleCount>
				...
				<#list 1..dataFactory.maxJournalArticleVersionCount as versionCount>
