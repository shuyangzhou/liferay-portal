<#if (dataFactory.maxMBCategoryCount > 0)>
	<#list 1..dataFactory.maxMBCategoryCount as mbCategoryCount>
		...
		<#if (dataFactory.maxMBThreadCount > 0) && (dataFactory.maxMBMessageCount > 0)>
			<#list 1..dataFactory.maxMBThreadCount as mbThreadCount>
				...
				<#list 1..dataFactory.maxMBMessageCount as mbMessageCount>
