...
insert into DLFileVersion values (${dlFileVersion.fileVersionId}, ${dlFileVersion.groupId}, ${dlFileVersion.companyId}, ${dlFileVersion.userId}, '', CURRENT_TIMESTAMP, ${dlFileVersion.repositoryId}, ${dlFileVersion.fileEntryId}, '${dlFileVersion.extension}', '${dlFileVersion.mimeType}', '${dlFileVersion.title}','${dlFileEntry.description}', '', '', 0, '1.0', '${dlFileSize}', ${dlFileVersion.smallImageId}, ${dlFileVersion.largeImageId}, ${dlFileVersion.custom1ImageId}, ${dlFileVersion.custom2ImageId}, 0, ${dlFileVersion.userId}, '', CURRENT_TIMESTAMP);
...
<#assign ddmStructureLink = dataFactory.addDDMStructureLink(dataFactory.dlFileEntryMetadataClassName.classNameId, dlFileEntryMetadata.fileEntryMetadataId, ddmStructure.structureId)>
