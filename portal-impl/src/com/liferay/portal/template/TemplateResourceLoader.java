 ...
 * @author Tina Tian
 */
public abstract class TemplateResourceLoader {
	...
	public abstract TemplateResource findTemplateReource(String templateId)
		throws IOException;

	public abstract Reader getReader(Object resource) throws IOException;
