...
public class PropsValues {
	...
	public static final int RETRY_JDBC_DELAY_SECONDS = GetterUtil.getInteger(PropsUtil.get(PropsKeys.RETRY_JDBC_DELAY_SECONDS));

	public static final int RETRY_JDBC_MAX_RETRIES = GetterUtil.getInteger(PropsUtil.get(PropsKeys.RETRY_JDBC_MAX_RETRIES));
