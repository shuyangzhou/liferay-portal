...
public class RepositoryEntryModelImpl
	...
	public void setRepositoryEntryId(long repositoryEntryId) {
		_setOriginalValue(REPOSITORYENTRYID_COLUMN_INDEX, _repositoryEntryId);
	...
	public void setMappedId(String mappedId) {
		_setOriginalValue(MAPPEDID_COLUMN_INDEX, _mappedId);
	...
	public String getOriginalMappedId() {
		return GetterUtil.getString(
			_getOriginalValue(MAPPEDID_COLUMN_INDEX, _mappedId));
	}
