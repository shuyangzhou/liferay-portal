...
public class LayoutTypeControllerImpl implements LayoutTypeController {
	...
	public String getViewPath(String portletId) {
		...
		if (Validator.isNotNull(portletId)) {
			if (LayoutConstants.TYPE_PANEL.equals(_type)) {
				return
					StrutsUtil.TEXT_HTML_DIR + "/portal/layout/view/panel.jsp";
			}
			else {
				return StrutsUtil.TEXT_HTML_DIR +
	...
	public boolean includeLayoutContent(
		...
		if (Validator.isNotNull(portletId) &&
			...
			_processTemplate(request, response);

			path = StrutsUtil.TEXT_HTML_DIR + "/portal/layout/view/portlet.jsp";
		}
		else {
			path = getViewPath(portletId);
		}
