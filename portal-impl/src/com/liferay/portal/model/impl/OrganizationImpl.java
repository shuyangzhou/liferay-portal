...
public class OrganizationImpl extends OrganizationBaseImpl {
	...
	public List<Organization> getDescendants() {
		Set<Organization> descendantsSet = new LinkedHashSet<Organization>();

		for (Organization suborganization : getSuborganizations()) {
			descendantsSet.add(suborganization);
			descendantsSet.addAll(suborganization.getDescendants());
		}

		ArrayList<Organization> descendants = new ArrayList<Organization>(
			descendantsSet);
		return descendants;
	}
