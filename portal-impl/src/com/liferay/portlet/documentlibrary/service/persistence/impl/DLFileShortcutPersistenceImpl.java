...
public class DLFileShortcutPersistenceImpl extends BasePersistenceImpl<DLFileShortcut>
	...
	public DLFileShortcut updateImpl(DLFileShortcut dlFileShortcut) {
		...
		DLFileShortcut updatedDLFileShortcut = null;
		...
		try {
			...
			if (dlFileShortcut.isNew()) {
				...
				updatedDLFileShortcut = (DLFileShortcut)session.merge(dlFileShortcut);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedDLFileShortcut == null) {
			...
			cacheUniqueFindersCache(updatedDLFileShortcut, isNew);
		}
