...
public class DLFileVersionPersistenceImpl extends BasePersistenceImpl<DLFileVersion>
	...
	public DLFileVersion updateImpl(DLFileVersion dlFileVersion) {
		...
		DLFileVersion updatedDLFileVersion = null;
		...
		try {
			...
			if (dlFileVersion.isNew()) {
				...
				updatedDLFileVersion = (DLFileVersion)session.merge(dlFileVersion);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedDLFileVersion == null) {
			...
			cacheUniqueFindersCache(updatedDLFileVersion, isNew);
		}
