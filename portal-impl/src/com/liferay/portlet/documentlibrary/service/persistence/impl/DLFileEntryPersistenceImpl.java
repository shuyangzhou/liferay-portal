...
public class DLFileEntryPersistenceImpl extends BasePersistenceImpl<DLFileEntry>
	...
	public DLFileEntry updateImpl(DLFileEntry dlFileEntry) {
		...
		DLFileEntry updatedDLFileEntry = null;
		...
		try {
			...
			if (dlFileEntry.isNew()) {
				...
				updatedDLFileEntry = (DLFileEntry)session.merge(dlFileEntry);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedDLFileEntry == null) {
			...
			cacheUniqueFindersCache(updatedDLFileEntry, isNew);
		}
