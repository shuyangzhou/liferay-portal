...
public class AssetTagModelImpl
	...
	public static final String MAPPING_TABLE_ASSETENTRIES_ASSETTAGS_SQL_CREATE =
		"create table AssetEntries_AssetTags (companyId LONG not null,entryId LONG not null,tagId LONG not null,ctCollectionId LONG default 0 not null,changeType BOOLEAN,primary key (entryId, tagId, ctCollectionId))";
