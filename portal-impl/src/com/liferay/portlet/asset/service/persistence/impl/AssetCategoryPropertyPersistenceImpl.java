...
public class AssetCategoryPropertyPersistenceImpl
	...
	static {
		...
		strictCTModeAttributeNames.add("categoryId");
		strictCTModeAttributeNames.add("key_");
		strictCTModeAttributeNames.add("value");
		...
		_ctModeAttributeNames.put(
			CTMode.PK, Collections.singleton("categoryPropertyId"));
