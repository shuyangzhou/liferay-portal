...
public class AssetTagStatsPersistenceImpl extends BasePersistenceImpl<AssetTagStats>
	...
	public AssetTagStats updateImpl(AssetTagStats assetTagStats) {
		...
		AssetTagStats updatedAssetTagStats = null;
		...
		try {
			...
			if (assetTagStats.isNew()) {
				...
				updatedAssetTagStats = (AssetTagStats)session.merge(assetTagStats);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedAssetTagStats == null) {
			...
			cacheUniqueFindersCache(updatedAssetTagStats, isNew);
		}
