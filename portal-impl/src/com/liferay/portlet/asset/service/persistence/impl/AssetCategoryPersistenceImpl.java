...
public class AssetCategoryPersistenceImpl extends BasePersistenceImpl<AssetCategory>
	...
	public AssetCategory updateImpl(AssetCategory assetCategory) {
		...
		AssetCategory updatedAssetCategory = null;
		...
		try {
			...
			if (assetCategory.isNew()) {
				...
				updatedAssetCategory = (AssetCategory)session.merge(assetCategory);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedAssetCategory == null) {
			...
			cacheUniqueFindersCache(updatedAssetCategory, isNew);
		}
