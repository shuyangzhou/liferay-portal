...
public class AssetCategoryPersistenceImpl
	...
	static {
		...
		strictCTModeAttributeNames.add("externalReferenceCode");
		...
		strictCTModeAttributeNames.add("parentCategoryId");
		strictCTModeAttributeNames.add("treePath");
		strictCTModeAttributeNames.add("name");
		strictCTModeAttributeNames.add("title");
		strictCTModeAttributeNames.add("description");
		strictCTModeAttributeNames.add("vocabularyId");
		strictCTModeAttributeNames.add("lastPublishDate");
		strictCTModeAttributeNames.add("entries");
		...
		_ctModeAttributeNames.put(
			CTMode.PK, Collections.singleton("categoryId"));
