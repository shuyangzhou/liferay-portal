...
public class AssetLinkPersistenceImpl
	...
	static {
		...
		strictCTModeAttributeNames.add("entryId1");
		strictCTModeAttributeNames.add("entryId2");
		strictCTModeAttributeNames.add("type_");
		strictCTModeAttributeNames.add("weight");
		...
		_ctModeAttributeNames.put(CTMode.PK, Collections.singleton("linkId"));
