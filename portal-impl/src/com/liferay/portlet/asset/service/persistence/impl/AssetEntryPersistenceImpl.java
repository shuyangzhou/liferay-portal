...
public class AssetEntryPersistenceImpl
	...
	static {
		...
		strictCTModeAttributeNames.add("classUuid");
		strictCTModeAttributeNames.add("classTypeId");
		strictCTModeAttributeNames.add("listable");
		strictCTModeAttributeNames.add("visible");
		strictCTModeAttributeNames.add("startDate");
		strictCTModeAttributeNames.add("endDate");
		strictCTModeAttributeNames.add("publishDate");
		strictCTModeAttributeNames.add("expirationDate");
		strictCTModeAttributeNames.add("mimeType");
		strictCTModeAttributeNames.add("title");
		strictCTModeAttributeNames.add("description");
		strictCTModeAttributeNames.add("summary");
		strictCTModeAttributeNames.add("url");
		strictCTModeAttributeNames.add("layoutUuid");
		strictCTModeAttributeNames.add("height");
		strictCTModeAttributeNames.add("width");
		strictCTModeAttributeNames.add("priority");
		strictCTModeAttributeNames.add("categories");
		strictCTModeAttributeNames.add("tags");
		...
		_ctModeAttributeNames.put(CTMode.PK, Collections.singleton("entryId"));
