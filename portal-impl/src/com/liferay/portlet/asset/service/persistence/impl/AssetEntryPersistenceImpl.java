...
public class AssetEntryPersistenceImpl extends BasePersistenceImpl<AssetEntry>
	...
	public AssetEntry updateImpl(AssetEntry assetEntry) {
		...
		AssetEntry updatedAssetEntry = null;
		...
		try {
			...
			if (assetEntry.isNew()) {
				...
				updatedAssetEntry = (AssetEntry)session.merge(assetEntry);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedAssetEntry == null) {
			...
			cacheUniqueFindersCache(updatedAssetEntry, isNew);
		}
