...
public class MBStatsUserPersistenceImpl extends BasePersistenceImpl<MBStatsUser>
	 ...
	 */
	@Override
	public List<MBStatsUser> findByUserId(long userId, boolean retrieveFromCache) {
		return findByUserId(userId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null,
			retrieveFromCache);
	}
	...
	@Override
	public List<MBStatsUser> findByG_NotU_NotM(long groupId, long userId,
		int messageCount, boolean retrieveFromCache) {
		return findByG_NotU_NotM(groupId, userId, messageCount,
	...
	@Override
	public List<MBStatsUser> findByG_NotU_NotM(long groupId, long userId,
		int messageCount, int start, int end, boolean retrieveFromCache) {
