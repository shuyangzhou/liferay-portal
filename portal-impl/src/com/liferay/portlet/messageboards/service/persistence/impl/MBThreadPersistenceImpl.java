...
public class MBThreadPersistenceImpl extends BasePersistenceImpl<MBThread>
	 ...
	 */
	@Override
	public List<MBThread> findByUuid(String uuid, boolean retrieveFromCache) {
		return findByUuid(uuid, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null,
			retrieveFromCache);
	}
	 ...
	 */
	@Override
	public List<MBThread> findByGroupId(long groupId, boolean retrieveFromCache) {
	...
	@Override
	public List<MBThread> findByG_C_L(long groupId, long categoryId,
		Date lastPostDate, boolean retrieveFromCache) {
		return findByG_C_L(groupId, categoryId, lastPostDate,
	...
	@Override
	public List<MBThread> findByG_C_L(long groupId, long categoryId,
		Date lastPostDate, int start, int end, boolean retrieveFromCache) {
		return findByG_C_L(groupId, categoryId, lastPostDate, start, end, null,
			retrieveFromCache);
	}
