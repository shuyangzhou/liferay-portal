...
public class SocialRelationPersistenceImpl extends BasePersistenceImpl<SocialRelation>
	...
	public List<SocialRelation> findByUserId1(long userId1,
		boolean retrieveFromCache) {
		return findByUserId1(userId1, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null, retrieveFromCache);
	}
	...
	public List<SocialRelation> findByUserId1(long userId1, int start, int end,
		boolean retrieveFromCache) {
		return findByUserId1(userId1, start, end, null, retrieveFromCache);
	}
	...
	public List<SocialRelation> findByUserId2(long userId2,
		boolean retrieveFromCache) {
		return findByUserId2(userId2, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null, retrieveFromCache);
	}
	...
	public List<SocialRelation> findByUserId2(long userId2, int start, int end,
		boolean retrieveFromCache) {
		return findByUserId2(userId2, start, end, null, retrieveFromCache);
	}
	 ...
	 */
	@Override
	public List<SocialRelation> findByType(int type, boolean retrieveFromCache) {
		return findByType(type, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null,
			retrieveFromCache);
	}
	...
	public List<SocialRelation> findByType(int type, int start, int end,
		boolean retrieveFromCache) {
		return findByType(type, start, end, null, retrieveFromCache);
	}
	...
	public List<SocialRelation> findByC_T(long companyId, int type, int start,
		int end, boolean retrieveFromCache) {
		return findByC_T(companyId, type, start, end, null, retrieveFromCache);
	}
	...
	public List<SocialRelation> findByU1_U2(long userId1, long userId2,
		int start, int end, boolean retrieveFromCache) {
		return findByU1_U2(userId1, userId2, start, end, null, retrieveFromCache);
	}
	...
	public List<SocialRelation> findByU1_T(long userId1, int type, int start,
		int end, boolean retrieveFromCache) {
		return findByU1_T(userId1, type, start, end, null, retrieveFromCache);
	}
	...
	public List<SocialRelation> findByU2_T(long userId2, int type, int start,
		int end, boolean retrieveFromCache) {
		return findByU2_T(userId2, type, start, end, null, retrieveFromCache);
	}
