...
public class SocialRequestPersistenceImpl extends BasePersistenceImpl<SocialRequest>
	...
	public SocialRequest updateImpl(SocialRequest socialRequest) {
		...
		SocialRequest updatedSocialRequest = null;
		...
		try {
			...
			if (socialRequest.isNew()) {
				...
				updatedSocialRequest = (SocialRequest)session.merge(socialRequest);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedSocialRequest == null) {
			...
			cacheUniqueFindersCache(updatedSocialRequest, isNew);
		}
