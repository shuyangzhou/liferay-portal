...
public class SocialActivitySettingModelImpl
	...
	public void setActivitySettingId(long activitySettingId) {
		if ((_columnBitmask & ACTIVITYSETTINGID_COLUMN_BITMASK) == 0) {
			...
			_originalValues[ACTIVITYSETTINGID_COLUMN_INDEX] =
				_activitySettingId;
		}
	...
	public void setActivityType(int activityType) {
		if ((_columnBitmask & ACTIVITYTYPE_COLUMN_BITMASK) == 0) {
	...
	public int getOriginalActivityType() {
		if (_originalValues != null) {
			Object originalActivityType =
				_originalValues[ACTIVITYTYPE_COLUMN_INDEX];

			if (originalActivityType != null) {
				return (int)originalActivityType;
			}
		}
