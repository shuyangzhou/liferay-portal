...
public class ExpandoRowPersistenceImpl extends BasePersistenceImpl<ExpandoRow>
	...
	public ExpandoRow updateImpl(ExpandoRow expandoRow) {
		...
		ExpandoRow updatedExpandoRow = null;
		...
		try {
			...
			if (expandoRow.isNew()) {
				...
				updatedExpandoRow = (ExpandoRow)session.merge(expandoRow);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedExpandoRow == null) {
			...
			cacheUniqueFindersCache(updatedExpandoRow, isNew);
		}
