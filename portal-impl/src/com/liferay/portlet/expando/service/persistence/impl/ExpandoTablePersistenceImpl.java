...
public class ExpandoTablePersistenceImpl extends BasePersistenceImpl<ExpandoTable>
	...
	public ExpandoTable updateImpl(ExpandoTable expandoTable) {
		...
		ExpandoTable updatedExpandoTable = null;
		...
		try {
			...
			if (expandoTable.isNew()) {
				...
				updatedExpandoTable = (ExpandoTable)session.merge(expandoTable);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedExpandoTable == null) {
			...
			cacheUniqueFindersCache(updatedExpandoTable, isNew);
		}
