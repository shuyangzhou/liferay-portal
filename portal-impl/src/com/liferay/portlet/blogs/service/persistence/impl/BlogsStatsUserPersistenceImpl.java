...
public class BlogsStatsUserPersistenceImpl extends BasePersistenceImpl<BlogsStatsUser>
	...
	public BlogsStatsUser updateImpl(BlogsStatsUser blogsStatsUser) {
		...
		BlogsStatsUser updatedBlogsStatsUser = null;
		...
		try {
			...
			if (blogsStatsUser.isNew()) {
				...
				updatedBlogsStatsUser = (BlogsStatsUser)session.merge(blogsStatsUser);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedBlogsStatsUser == null) {
			...
			cacheUniqueFindersCache(updatedBlogsStatsUser, isNew);
		}
