...
public class SCProductEntryPersistenceImpl extends BasePersistenceImpl<SCProductEntry>
	...
	public SCProductEntry updateImpl(SCProductEntry scProductEntry) {
		...
		SCProductEntry updatedSCProductEntry = null;
		...
		try {
			...
			if (scProductEntry.isNew()) {
				...
				updatedSCProductEntry = (SCProductEntry)session.merge(scProductEntry);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedSCProductEntry == null) {
			...
			cacheUniqueFindersCache(updatedSCProductEntry, isNew);
		}
