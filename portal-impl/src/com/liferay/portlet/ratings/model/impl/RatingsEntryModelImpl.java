...
public class RatingsEntryModelImpl
	...
	public static final long SCORE_COLUMN_BITMASK = 512L;

	public static final int UUID_COLUMN_INDEX = 0;

	public static final int ENTRYID_COLUMN_INDEX = 1;
	...
	public static final int SCORE_COLUMN_INDEX = 9;
	...
	public void setScore(double score) {
		if ((_columnBitmask & SCORE_COLUMN_BITMASK) == 0) {
	...
	public double getOriginalScore() {
		if (_originalValues != null) {
			Object originalScore = _originalValues[SCORE_COLUMN_INDEX];

			if (originalScore != null) {
				return (double)originalScore;
			}
		}
