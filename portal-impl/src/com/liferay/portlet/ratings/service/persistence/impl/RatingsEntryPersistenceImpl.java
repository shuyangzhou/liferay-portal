...
public class RatingsEntryPersistenceImpl extends BasePersistenceImpl<RatingsEntry>
	...
	public RatingsEntry updateImpl(RatingsEntry ratingsEntry) {
		...
		RatingsEntry updatedRatingsEntry = null;
		...
		try {
			...
			if (ratingsEntry.isNew()) {
				...
				updatedRatingsEntry = (RatingsEntry)session.merge(ratingsEntry);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedRatingsEntry == null) {
			...
			cacheUniqueFindersCache(updatedRatingsEntry, isNew);
		}
