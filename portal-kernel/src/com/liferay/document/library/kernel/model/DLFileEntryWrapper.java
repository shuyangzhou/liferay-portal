...
public class DLFileEntryWrapper implements DLFileEntry,
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<DLFileEntry, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<DLFileEntry, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<DLFileEntry, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<DLFileEntry, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<DLFileEntry, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<DLFileEntry, Object> attributeBiConsumer = entry.getValue();
	...
	public Map<String, Function<DLFileEntry, Object>> getAttributeGetters() {
		return _dlFileEntry.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<DLFileEntry, Object>> getAttributeSetters() {
		return _dlFileEntry.getAttributeSetters();
	}
