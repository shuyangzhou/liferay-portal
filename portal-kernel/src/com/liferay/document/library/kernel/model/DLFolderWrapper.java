...
public class DLFolderWrapper implements DLFolder, ModelWrapper<DLFolder> {
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<DLFolder, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<DLFolder, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<DLFolder, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<DLFolder, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<DLFolder, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<DLFolder, Object> attributeBiConsumer = entry.getValue();
	...
	public Map<String, Function<DLFolder, Object>> getAttributeGetters() {
		return _dlFolder.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<DLFolder, Object>> getAttributeSetters() {
		return _dlFolder.getAttributeSetters();
	}
