...
public class DLFileEntryTypeWrapper implements DLFileEntryType,
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<DLFileEntryType, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<DLFileEntryType, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<DLFileEntryType, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<DLFileEntryType, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<DLFileEntryType, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<DLFileEntryType, Object> attributeBiConsumer = entry.getValue();
	...
	@Override
	public Map<String, Function<DLFileEntryType, Object>> getAttributeGetters() {
		return _dlFileEntryType.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<DLFileEntryType, Object>> getAttributeSetters() {
		return _dlFileEntryType.getAttributeSetters();
	}
