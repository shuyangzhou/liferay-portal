...
public class DLAppServiceUtil {
	...
	public static DLAppService getService() {
		return _serviceDCLSingleton.getSingleton(DLAppServiceUtil::_getService);
	}

	private static DLAppService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(DLAppServiceUtil.class);
		...
		ServiceReference<DLAppService> serviceReference =
			bundleContext.getServiceReference(DLAppService.class);
	...
	private static final DCLSingleton<DLAppService> _serviceDCLSingleton =
		new DCLSingleton<>();
