...
public class DLFolderServiceUtil {
	...
	public static DLFolderService getService() {
		return _serviceDCLSingleton.getSingleton(
			DLFolderServiceUtil::_getService);
	}

	private static DLFolderService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(DLFolderServiceUtil.class);
		...
		ServiceReference<DLFolderService> serviceReference =
			bundleContext.getServiceReference(DLFolderService.class);
	...
	private static final DCLSingleton<DLFolderService> _serviceDCLSingleton =
		new DCLSingleton<>();
