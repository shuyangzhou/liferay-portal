...
public class DLFileEntryTypeLocalServiceUtil {
	...
	public static DLFileEntryTypeLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DLFileEntryTypeLocalServiceUtil::_getService);
	}

	private static DLFileEntryTypeLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			DLFileEntryTypeLocalServiceUtil.class);
		...
		ServiceReference<DLFileEntryTypeLocalService> serviceReference =
	...
	private static final DCLSingleton<DLFileEntryTypeLocalService>
