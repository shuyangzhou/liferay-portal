...
public class DLFileEntryLocalServiceUtil {
	...
	public static DLFileEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DLFileEntryLocalServiceUtil::_getService);
	}

	private static DLFileEntryLocalService _getService() {
		...
		ServiceReference<DLFileEntryLocalService> serviceReference =
			bundleContext.getServiceReference(DLFileEntryLocalService.class);
	...
	private static final DCLSingleton<DLFileEntryLocalService>
