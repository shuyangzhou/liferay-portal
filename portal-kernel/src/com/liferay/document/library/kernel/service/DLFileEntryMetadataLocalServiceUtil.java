...
public class DLFileEntryMetadataLocalServiceUtil {
	...
	public static DLFileEntryMetadataLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DLFileEntryMetadataLocalServiceUtil::_getService);
	}

	private static DLFileEntryMetadataLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			DLFileEntryMetadataLocalServiceUtil.class);
		...
		ServiceReference<DLFileEntryMetadataLocalService> serviceReference =
	...
	private static final DCLSingleton<DLFileEntryMetadataLocalService>
