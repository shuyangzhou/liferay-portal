...
public class DLAppLocalServiceUtil {
	...
	public static DLAppLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DLAppLocalServiceUtil::_getService);
	}

	private static DLAppLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(DLAppLocalServiceUtil.class);
	...
	private static final DCLSingleton<DLAppLocalService> _serviceDCLSingleton =
		new DCLSingleton<>();
