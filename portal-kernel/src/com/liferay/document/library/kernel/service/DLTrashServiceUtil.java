...
public class DLTrashServiceUtil {
	...
	public static DLTrashService getService() {
		return _serviceDCLSingleton.getSingleton(
			DLTrashServiceUtil::_getService);
	}

	private static DLTrashService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(DLTrashServiceUtil.class);
		...
		ServiceReference<DLTrashService> serviceReference =
			bundleContext.getServiceReference(DLTrashService.class);
	...
	private static final DCLSingleton<DLTrashService> _serviceDCLSingleton =
		new DCLSingleton<>();
