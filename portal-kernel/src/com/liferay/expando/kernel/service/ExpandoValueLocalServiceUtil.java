...
public class ExpandoValueLocalServiceUtil {
	...
	public static ExpandoValueLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ExpandoValueLocalServiceUtil::_getService);
	}

	private static ExpandoValueLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			ExpandoValueLocalServiceUtil.class);
		...
		ServiceReference<ExpandoValueLocalService> serviceReference =
			bundleContext.getServiceReference(ExpandoValueLocalService.class);
	...
	private static final DCLSingleton<ExpandoValueLocalService>
