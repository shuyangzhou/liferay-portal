...
public class ExpandoTableLocalServiceUtil {
	...
	public static ExpandoTableLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ExpandoTableLocalServiceUtil::_getService);
	}

	private static ExpandoTableLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			ExpandoTableLocalServiceUtil.class);
		...
		ServiceReference<ExpandoTableLocalService> serviceReference =
			bundleContext.getServiceReference(ExpandoTableLocalService.class);
	...
	private static final DCLSingleton<ExpandoTableLocalService>
