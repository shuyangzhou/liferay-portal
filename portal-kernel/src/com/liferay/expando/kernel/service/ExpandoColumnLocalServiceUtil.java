...
public class ExpandoColumnLocalServiceUtil {
	...
	public static java.util.List<com.liferay.expando.kernel.model.ExpandoColumn>
		getColumns(long tableId, java.util.Collection<java.lang.String> names) {
	...
	public static java.util.List<com.liferay.expando.kernel.model.ExpandoColumn>
		getDefaultTableColumns(long companyId, java.lang.String className) {
	...
	private static volatile ExpandoColumnLocalService
