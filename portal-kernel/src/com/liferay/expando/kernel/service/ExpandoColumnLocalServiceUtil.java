...
public class ExpandoColumnLocalServiceUtil {
	...
	public static ExpandoColumnLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ExpandoColumnLocalServiceUtil::_getService);
	}

	private static ExpandoColumnLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			ExpandoColumnLocalServiceUtil.class);
		...
		ServiceReference<ExpandoColumnLocalService> serviceReference =
			bundleContext.getServiceReference(ExpandoColumnLocalService.class);
	...
	private static final DCLSingleton<ExpandoColumnLocalService>
