...
public class StagingLocalServiceUtil {
	...
	public static StagingLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			StagingLocalServiceUtil::_getService);
	}

	private static StagingLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(StagingLocalServiceUtil.class);
		...
		ServiceReference<StagingLocalService> serviceReference =
			bundleContext.getServiceReference(StagingLocalService.class);
	...
	private static final DCLSingleton<StagingLocalService>
