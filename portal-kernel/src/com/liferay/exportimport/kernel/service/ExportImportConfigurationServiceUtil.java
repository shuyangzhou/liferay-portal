...
public class ExportImportConfigurationServiceUtil {
	...
	public static ExportImportConfigurationService getService() {
		return _serviceDCLSingleton.getSingleton(
			ExportImportConfigurationServiceUtil::_getService);
	}

	private static ExportImportConfigurationService _getService() {
		...
		ServiceReference<ExportImportConfigurationService> serviceReference =
	...
	private static final DCLSingleton<ExportImportConfigurationService>
