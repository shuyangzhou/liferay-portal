...
public class WebDAVPropsWrapper implements WebDAVProps,
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<WebDAVProps, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<WebDAVProps, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<WebDAVProps, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<WebDAVProps, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<WebDAVProps, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<WebDAVProps, Object> attributeBiConsumer = entry.getValue();
	...
	public Map<String, Function<WebDAVProps, Object>> getAttributeGetters() {
		return _webDAVProps.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<WebDAVProps, Object>> getAttributeSetters() {
		return _webDAVProps.getAttributeSetters();
	}
