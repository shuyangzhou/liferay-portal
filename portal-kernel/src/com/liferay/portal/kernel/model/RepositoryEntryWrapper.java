...
public class RepositoryEntryWrapper implements RepositoryEntry,
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<RepositoryEntry, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<RepositoryEntry, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<RepositoryEntry, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<RepositoryEntry, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<RepositoryEntry, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<RepositoryEntry, Object> attributeBiConsumer = entry.getValue();
	...
	public Map<String, Function<RepositoryEntry, Object>> getAttributeGetters() {
		return _repositoryEntry.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<RepositoryEntry, Object>> getAttributeSetters() {
		return _repositoryEntry.getAttributeSetters();
	}
