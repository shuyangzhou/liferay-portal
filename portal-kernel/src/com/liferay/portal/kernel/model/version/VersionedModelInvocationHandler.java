...
public class VersionedModelInvocationHandler implements InvocationHandler {
	...
	public VersionedModelInvocationHandler(
		VersionModel<?> versionModel, Map<Method, Method> methodMappings) {
	...
	public Object invoke(Object proxy, Method method, Object[] arguments)
		...
		Method mappedMethod = _methodMappings.get(method);
	...
	private final Map<Method, Method> _methodMappings;
