...
public abstract class BaseModelImpl<T> implements BaseModel<T> {
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		for (Map.Entry<String, BiConsumer<T, Object>> entry :
				attributeSetters.entrySet()) {

			String attributeName = entry.getKey();
			BiConsumer<T, Object> attributeBiConsumer = entry.getValue();

			BiConsumer<T, Object> attributeSetter = attributeSetters.get(
				attributeName);

			if (attributeSetter != null) {
				attributeBiConsumer.accept(
					(T)this, attributeSetters.get(attributeName));
			}
		}
	}
