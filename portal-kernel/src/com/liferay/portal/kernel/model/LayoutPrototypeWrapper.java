...
public class LayoutPrototypeWrapper implements LayoutPrototype,
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<LayoutPrototype, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<LayoutPrototype, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<LayoutPrototype, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<LayoutPrototype, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<LayoutPrototype, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<LayoutPrototype, Object> attributeBiConsumer = entry.getValue();
	...
	public Map<String, Function<LayoutPrototype, Object>> getAttributeGetters() {
		return _layoutPrototype.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<LayoutPrototype, Object>> getAttributeSetters() {
		return _layoutPrototype.getAttributeSetters();
	}
