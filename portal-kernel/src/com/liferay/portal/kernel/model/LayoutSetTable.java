...
public class LayoutSetTable extends Table<LayoutSetTable> {
	...
	public final Column<LayoutSetTable, String> css = createColumn(
		"css", String.class, Types.CLOB);
	public final Column<LayoutSetTable, String> settings = createColumn(
		"settings_", String.class, Types.CLOB);
