...
public class UserGroupLocalServiceUtil {
	...
	public static UserGroupLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			UserGroupLocalServiceUtil::_getService);
	}

	private static UserGroupLocalService _getService() {
		...
		ServiceReference<UserGroupLocalService> serviceReference =
			bundleContext.getServiceReference(UserGroupLocalService.class);
	...
	private static final DCLSingleton<UserGroupLocalService>
