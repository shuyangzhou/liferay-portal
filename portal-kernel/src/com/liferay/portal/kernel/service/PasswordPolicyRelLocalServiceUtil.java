...
public class PasswordPolicyRelLocalServiceUtil {
	...
	public static PasswordPolicyRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			PasswordPolicyRelLocalServiceUtil::_getService);
	}

	private static PasswordPolicyRelLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			PasswordPolicyRelLocalServiceUtil.class);
		...
		ServiceReference<PasswordPolicyRelLocalService> serviceReference =
			bundleContext.getServiceReference(
				PasswordPolicyRelLocalService.class);
	...
	private static final DCLSingleton<PasswordPolicyRelLocalService>
