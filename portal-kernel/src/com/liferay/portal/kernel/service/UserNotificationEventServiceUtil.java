...
public class UserNotificationEventServiceUtil {
	...
	public static UserNotificationEventService getService() {
		return _serviceDCLSingleton.getSingleton(
			UserNotificationEventServiceUtil::_getService);
	}

	private static UserNotificationEventService _getService() {
		...
		ServiceReference<UserNotificationEventService> serviceReference =
	...
	private static final DCLSingleton<UserNotificationEventService>
