...
public class RecentLayoutSetBranchLocalServiceUtil {
	...
	public static RecentLayoutSetBranchLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			RecentLayoutSetBranchLocalServiceUtil::_getService);
	}

	private static RecentLayoutSetBranchLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			RecentLayoutSetBranchLocalServiceUtil.class);
		...
		ServiceReference<RecentLayoutSetBranchLocalService> serviceReference =
			bundleContext.getServiceReference(
				RecentLayoutSetBranchLocalService.class);
	...
	private static final DCLSingleton<RecentLayoutSetBranchLocalService>
