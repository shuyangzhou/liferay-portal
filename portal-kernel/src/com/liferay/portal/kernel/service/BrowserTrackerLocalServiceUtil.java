...
public class BrowserTrackerLocalServiceUtil {
	...
	public static BrowserTrackerLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			BrowserTrackerLocalServiceUtil::_getService);
	}

	private static BrowserTrackerLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			BrowserTrackerLocalServiceUtil.class);
		...
		ServiceReference<BrowserTrackerLocalService> serviceReference =
			bundleContext.getServiceReference(BrowserTrackerLocalService.class);
	...
	private static final DCLSingleton<BrowserTrackerLocalService>
