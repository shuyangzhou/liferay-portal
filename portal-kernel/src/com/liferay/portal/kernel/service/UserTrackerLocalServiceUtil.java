...
public class UserTrackerLocalServiceUtil {
	...
	public static UserTrackerLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			UserTrackerLocalServiceUtil::_getService);
	}

	private static UserTrackerLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			UserTrackerLocalServiceUtil.class);
		...
		ServiceReference<UserTrackerLocalService> serviceReference =
			bundleContext.getServiceReference(UserTrackerLocalService.class);
	...
	private static final DCLSingleton<UserTrackerLocalService>
