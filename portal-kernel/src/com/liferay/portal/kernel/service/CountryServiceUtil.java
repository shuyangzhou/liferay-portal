...
public class CountryServiceUtil {
	...
	public static CountryService getService() {
		return _serviceDCLSingleton.getSingleton(
			CountryServiceUtil::_getService);
	}

	private static CountryService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(CountryServiceUtil.class);
		...
		ServiceReference<CountryService> serviceReference =
			bundleContext.getServiceReference(CountryService.class);
	...
	private static final DCLSingleton<CountryService> _serviceDCLSingleton =
		new DCLSingleton<>();
