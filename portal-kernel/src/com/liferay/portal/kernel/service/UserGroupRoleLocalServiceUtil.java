...
public class UserGroupRoleLocalServiceUtil {
	...
	public static UserGroupRoleLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			UserGroupRoleLocalServiceUtil::_getService);
	}

	private static UserGroupRoleLocalService _getService() {
		...
		ServiceReference<UserGroupRoleLocalService> serviceReference =
			bundleContext.getServiceReference(UserGroupRoleLocalService.class);
	...
	private static final DCLSingleton<UserGroupRoleLocalService>
