...
public class RegionLocalServiceUtil {
	...
	public static RegionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			RegionLocalServiceUtil::_getService);
	}

	private static RegionLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(RegionLocalServiceUtil.class);
		...
		ServiceReference<RegionLocalService> serviceReference =
			bundleContext.getServiceReference(RegionLocalService.class);
	...
	private static final DCLSingleton<RegionLocalService> _serviceDCLSingleton =
		new DCLSingleton<>();
