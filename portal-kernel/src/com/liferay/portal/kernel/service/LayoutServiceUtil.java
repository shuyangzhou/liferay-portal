...
public class LayoutServiceUtil {
	...
	public static LayoutService getService() {
		return _serviceDCLSingleton.getSingleton(
			LayoutServiceUtil::_getService);
	}

	private static LayoutService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(LayoutServiceUtil.class);
		...
		ServiceReference<LayoutService> serviceReference =
			bundleContext.getServiceReference(LayoutService.class);
	...
	private static final DCLSingleton<LayoutService> _serviceDCLSingleton =
		new DCLSingleton<>();
