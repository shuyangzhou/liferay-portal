...
public class PasswordTrackerLocalServiceUtil {
	...
	public static PasswordTrackerLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			PasswordTrackerLocalServiceUtil::_getService);
	}

	private static PasswordTrackerLocalService _getService() {
		...
		ServiceReference<PasswordTrackerLocalService> serviceReference =
	...
	private static final DCLSingleton<PasswordTrackerLocalService>
