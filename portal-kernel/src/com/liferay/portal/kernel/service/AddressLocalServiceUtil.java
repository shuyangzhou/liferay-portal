...
public class AddressLocalServiceUtil {
	...
	public static AddressLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			AddressLocalServiceUtil::_getService);
	}

	private static AddressLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(AddressLocalServiceUtil.class);
		...
		ServiceReference<AddressLocalService> serviceReference =
			bundleContext.getServiceReference(AddressLocalService.class);
	...
	private static final DCLSingleton<AddressLocalService>
