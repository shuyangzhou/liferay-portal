...
public class LayoutBranchLocalServiceUtil {
	...
	public static LayoutBranchLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			LayoutBranchLocalServiceUtil::_getService);
	}

	private static LayoutBranchLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			LayoutBranchLocalServiceUtil.class);
		...
		ServiceReference<LayoutBranchLocalService> serviceReference =
			bundleContext.getServiceReference(LayoutBranchLocalService.class);
	...
	private static final DCLSingleton<LayoutBranchLocalService>
