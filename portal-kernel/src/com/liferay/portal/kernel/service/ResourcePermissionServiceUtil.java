...
public class ResourcePermissionServiceUtil {
	...
	public static ResourcePermissionService getService() {
		return _serviceDCLSingleton.getSingleton(
			ResourcePermissionServiceUtil::_getService);
	}

	private static ResourcePermissionService _getService() {
		...
		ServiceReference<ResourcePermissionService> serviceReference =
			bundleContext.getServiceReference(ResourcePermissionService.class);
	...
	private static final DCLSingleton<ResourcePermissionService>
