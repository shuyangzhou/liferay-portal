...
public class PasswordPolicyServiceUtil {
	...
	public static PasswordPolicyService getService() {
		return _serviceDCLSingleton.getSingleton(
			PasswordPolicyServiceUtil::_getService);
	}

	private static PasswordPolicyService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			PasswordPolicyServiceUtil.class);
		...
		ServiceReference<PasswordPolicyService> serviceReference =
			bundleContext.getServiceReference(PasswordPolicyService.class);
	...
	private static final DCLSingleton<PasswordPolicyService>
