...
public class WebDAVPropsLocalServiceUtil {
	...
	public static WebDAVPropsLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			WebDAVPropsLocalServiceUtil::_getService);
	}

	private static WebDAVPropsLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			WebDAVPropsLocalServiceUtil.class);
		...
		ServiceReference<WebDAVPropsLocalService> serviceReference =
			bundleContext.getServiceReference(WebDAVPropsLocalService.class);
	...
	private static final DCLSingleton<WebDAVPropsLocalService>
