...
public class ResourcePermissionLocalServiceUtil {
	...
	public static ResourcePermissionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ResourcePermissionLocalServiceUtil::_getService);
	}

	private static ResourcePermissionLocalService _getService() {
		...
		ServiceReference<ResourcePermissionLocalService> serviceReference =
	...
	private static final DCLSingleton<ResourcePermissionLocalService>
