...
public class RoleServiceUtil {
	...
	public static RoleService getService() {
		return _serviceDCLSingleton.getSingleton(RoleServiceUtil::_getService);
	}

	private static RoleService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(RoleServiceUtil.class);
		...
		ServiceReference<RoleService> serviceReference =
			bundleContext.getServiceReference(RoleService.class);
	...
	private static final DCLSingleton<RoleService> _serviceDCLSingleton =
		new DCLSingleton<>();
