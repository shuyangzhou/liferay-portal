...
public class RecentLayoutRevisionLocalServiceUtil {
	...
	public static RecentLayoutRevisionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			RecentLayoutRevisionLocalServiceUtil::_getService);
	}

	private static RecentLayoutRevisionLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			RecentLayoutRevisionLocalServiceUtil.class);
		...
		ServiceReference<RecentLayoutRevisionLocalService> serviceReference =
			bundleContext.getServiceReference(
				RecentLayoutRevisionLocalService.class);
	...
	private static final DCLSingleton<RecentLayoutRevisionLocalService>
