...
public class UserNotificationDeliveryLocalServiceUtil {
	...
	public static UserNotificationDeliveryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			UserNotificationDeliveryLocalServiceUtil::_getService);
	}

	private static UserNotificationDeliveryLocalService _getService() {
		...
		ServiceReference<UserNotificationDeliveryLocalService>
	...
	private static final DCLSingleton<UserNotificationDeliveryLocalService>
