...
public class GroupLocalServiceUtil {
	...
	public static GroupLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			GroupLocalServiceUtil::_getService);
	}

	private static GroupLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(GroupLocalServiceUtil.class);
		...
		ServiceReference<GroupLocalService> serviceReference =
			bundleContext.getServiceReference(GroupLocalService.class);
	...
	private static final DCLSingleton<GroupLocalService> _serviceDCLSingleton =
		new DCLSingleton<>();
