...
/**
 * Provides the local service interface for ABCTestEntity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ABCTestEntityLocalServiceUtil
...
public interface ABCTestEntityLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ABCTestEntityLocalServiceUtil} to access the abc test entity local service. Add custom service methods to {@link com.liferay.portal.service.impl.ABCTestEntityLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public ABCTestEntity addABCTestEntity(ABCTestEntity abcTestEntity);
	...
	*/
	public ABCTestEntity createABCTestEntity(java.lang.String abcTestEntityId);
	...
	*/
	...
	public ABCTestEntity deleteABCTestEntity(ABCTestEntity abcTestEntity);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ABCTestEntity deleteABCTestEntity(java.lang.String abcTestEntityId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ABCTestEntity fetchABCTestEntity(java.lang.String abcTestEntityId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ABCTestEntity getABCTestEntity(java.lang.String abcTestEntityId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public ABCTestEntity updateABCTestEntity(ABCTestEntity abcTestEntity);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ABCTestEntityLocalization fetchABCTestEntityLocalization(
		java.lang.String abcTestEntityId, java.lang.String languageId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ABCTestEntityLocalization getABCTestEntityLocalization(
		java.lang.String abcTestEntityId, java.lang.String languageId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ABCTestEntity> getABCTestEntities(int start, int end);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ABCTestEntityLocalization> getABCTestEntityLocalizations(
