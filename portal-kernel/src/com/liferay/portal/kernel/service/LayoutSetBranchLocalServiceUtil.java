...
public class LayoutSetBranchLocalServiceUtil {
	...
	public static LayoutSetBranchLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			LayoutSetBranchLocalServiceUtil::_getService);
	}

	private static LayoutSetBranchLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			LayoutSetBranchLocalServiceUtil.class);
		...
		ServiceReference<LayoutSetBranchLocalService> serviceReference =
			bundleContext.getServiceReference(
				LayoutSetBranchLocalService.class);
	...
	private static final DCLSingleton<LayoutSetBranchLocalService>
