...
public class OrgLaborLocalServiceUtil {
	...
	public static OrgLaborLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			OrgLaborLocalServiceUtil::_getService);
	}

	private static OrgLaborLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(OrgLaborLocalServiceUtil.class);
		...
		ServiceReference<OrgLaborLocalService> serviceReference =
			bundleContext.getServiceReference(OrgLaborLocalService.class);
	...
	private static final DCLSingleton<OrgLaborLocalService>
