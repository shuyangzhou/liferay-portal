...
public class UserLocalServiceUtil {
	...
	public static UserLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			UserLocalServiceUtil::_getService);
	}

	private static UserLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(UserLocalServiceUtil.class);
		...
		ServiceReference<UserLocalService> serviceReference =
	...
	private static final DCLSingleton<UserLocalService> _serviceDCLSingleton =
		new DCLSingleton<>();
