...
public class ImageServiceUtil {
	...
	public static ImageService getService() {
		return _serviceDCLSingleton.getSingleton(ImageServiceUtil::_getService);
	}

	private static ImageService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(ImageServiceUtil.class);
		...
		ServiceReference<ImageService> serviceReference =
			bundleContext.getServiceReference(ImageService.class);
	...
	private static final DCLSingleton<ImageService> _serviceDCLSingleton =
		new DCLSingleton<>();
