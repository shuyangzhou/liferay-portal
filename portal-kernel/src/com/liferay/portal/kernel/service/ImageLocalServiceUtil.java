...
public class ImageLocalServiceUtil {
	...
	public static ImageLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ImageLocalServiceUtil::_getService);
	}

	private static ImageLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(ImageLocalServiceUtil.class);
		...
		ServiceReference<ImageLocalService> serviceReference =
			bundleContext.getServiceReference(ImageLocalService.class);
	...
	private static final DCLSingleton<ImageLocalService> _serviceDCLSingleton =
		new DCLSingleton<>();
