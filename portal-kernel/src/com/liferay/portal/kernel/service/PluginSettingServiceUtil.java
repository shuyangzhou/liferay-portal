...
public class PluginSettingServiceUtil {
	...
	public static PluginSettingService getService() {
		return _serviceDCLSingleton.getSingleton(
			PluginSettingServiceUtil::_getService);
	}

	private static PluginSettingService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(PluginSettingServiceUtil.class);
		...
		ServiceReference<PluginSettingService> serviceReference =
			bundleContext.getServiceReference(PluginSettingService.class);
	...
	private static final DCLSingleton<PluginSettingService>
