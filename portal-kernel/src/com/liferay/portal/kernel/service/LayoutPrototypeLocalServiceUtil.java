...
public class LayoutPrototypeLocalServiceUtil {
	...
	public static LayoutPrototypeLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			LayoutPrototypeLocalServiceUtil::_getService);
	}

	private static LayoutPrototypeLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			LayoutPrototypeLocalServiceUtil.class);
		...
		ServiceReference<LayoutPrototypeLocalService> serviceReference =
			bundleContext.getServiceReference(
				LayoutPrototypeLocalService.class);
	...
	private static final DCLSingleton<LayoutPrototypeLocalService>
