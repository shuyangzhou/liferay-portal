...
public class VirtualHostLocalServiceUtil {
	...
	public static VirtualHostLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			VirtualHostLocalServiceUtil::_getService);
	}

	private static VirtualHostLocalService _getService() {
		...
		ServiceReference<VirtualHostLocalService> serviceReference =
			bundleContext.getServiceReference(VirtualHostLocalService.class);
	...
	private static final DCLSingleton<VirtualHostLocalService>
