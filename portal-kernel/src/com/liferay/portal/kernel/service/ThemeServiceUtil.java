...
public class ThemeServiceUtil {
	...
	public static ThemeService getService() {
		return _serviceDCLSingleton.getSingleton(ThemeServiceUtil::_getService);
	}

	private static ThemeService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(ThemeServiceUtil.class);
		...
		ServiceReference<ThemeService> serviceReference =
			bundleContext.getServiceReference(ThemeService.class);
	...
	private static final DCLSingleton<ThemeService> _serviceDCLSingleton =
		new DCLSingleton<>();
