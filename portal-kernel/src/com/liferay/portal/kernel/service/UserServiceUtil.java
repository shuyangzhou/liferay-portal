...
public class UserServiceUtil {
	...
	public static UserService getService() {
		return _serviceDCLSingleton.getSingleton(UserServiceUtil::_getService);
	}

	private static UserService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(UserServiceUtil.class);
		...
		ServiceReference<UserService> serviceReference =
			bundleContext.getServiceReference(UserService.class);
	...
	private static final DCLSingleton<UserService> _serviceDCLSingleton =
		new DCLSingleton<>();
