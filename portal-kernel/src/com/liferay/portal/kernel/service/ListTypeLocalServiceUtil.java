...
public class ListTypeLocalServiceUtil {
	...
	public static ListTypeLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ListTypeLocalServiceUtil::_getService);
	}

	private static ListTypeLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(ListTypeLocalServiceUtil.class);
		...
		ServiceReference<ListTypeLocalService> serviceReference =
			bundleContext.getServiceReference(ListTypeLocalService.class);
	...
	private static final DCLSingleton<ListTypeLocalService>
