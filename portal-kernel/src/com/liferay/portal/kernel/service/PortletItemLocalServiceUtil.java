...
public class PortletItemLocalServiceUtil {
	...
	public static PortletItemLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			PortletItemLocalServiceUtil::_getService);
	}

	private static PortletItemLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			PortletItemLocalServiceUtil.class);
		...
		ServiceReference<PortletItemLocalService> serviceReference =
			bundleContext.getServiceReference(PortletItemLocalService.class);
	...
	private static final DCLSingleton<PortletItemLocalService>
