...
public class CompanyLocalServiceUtil {
	...
	public static CompanyLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CompanyLocalServiceUtil::_getService);
	}

	private static CompanyLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(CompanyLocalServiceUtil.class);
		...
		ServiceReference<CompanyLocalService> serviceReference =
	...
	private static final DCLSingleton<CompanyLocalService>
