...
public class UserGroupServiceUtil {
	...
	public static UserGroupService getService() {
		return _serviceDCLSingleton.getSingleton(
			UserGroupServiceUtil::_getService);
	}

	private static UserGroupService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(UserGroupServiceUtil.class);
		...
		ServiceReference<UserGroupService> serviceReference =
			bundleContext.getServiceReference(UserGroupService.class);
	...
	private static final DCLSingleton<UserGroupService> _serviceDCLSingleton =
		new DCLSingleton<>();
