...
public class WorkflowDefinitionLinkLocalServiceUtil {
	...
	public static WorkflowDefinitionLinkLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			WorkflowDefinitionLinkLocalServiceUtil::_getService);
	}

	private static WorkflowDefinitionLinkLocalService _getService() {
		...
		ServiceReference<WorkflowDefinitionLinkLocalService> serviceReference =
	...
	private static final DCLSingleton<WorkflowDefinitionLinkLocalService>
