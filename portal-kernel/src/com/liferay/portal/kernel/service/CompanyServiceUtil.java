...
public class CompanyServiceUtil {
	...
	public static CompanyService getService() {
		return _serviceDCLSingleton.getSingleton(
			CompanyServiceUtil::_getService);
	}

	private static CompanyService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(CompanyServiceUtil.class);
		...
		ServiceReference<CompanyService> serviceReference =
			bundleContext.getServiceReference(CompanyService.class);
	...
	private static final DCLSingleton<CompanyService> _serviceDCLSingleton =
		new DCLSingleton<>();
