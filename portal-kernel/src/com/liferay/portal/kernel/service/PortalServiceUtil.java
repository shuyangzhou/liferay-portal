...
public class PortalServiceUtil {
	...
	public static PortalService getService() {
		return _serviceDCLSingleton.getSingleton(
			PortalServiceUtil::_getService);
	}

	private static PortalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(PortalServiceUtil.class);
		...
		ServiceReference<PortalService> serviceReference =
			bundleContext.getServiceReference(PortalService.class);
	...
	private static final DCLSingleton<PortalService> _serviceDCLSingleton =
		new DCLSingleton<>();
