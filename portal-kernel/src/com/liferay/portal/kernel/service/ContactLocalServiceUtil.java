...
public class ContactLocalServiceUtil {
	...
	public static ContactLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ContactLocalServiceUtil::_getService);
	}

	private static ContactLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(ContactLocalServiceUtil.class);
		...
		ServiceReference<ContactLocalService> serviceReference =
			bundleContext.getServiceReference(ContactLocalService.class);
	...
	private static final DCLSingleton<ContactLocalService>
