...
public class WorkflowInstanceLinkLocalServiceUtil {
	...
	public static WorkflowInstanceLinkLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			WorkflowInstanceLinkLocalServiceUtil::_getService);
	}

	private static WorkflowInstanceLinkLocalService _getService() {
		...
		ServiceReference<WorkflowInstanceLinkLocalService> serviceReference =
	...
	private static final DCLSingleton<WorkflowInstanceLinkLocalService>
