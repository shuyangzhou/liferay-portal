...
public class LayoutSetPrototypeLocalServiceUtil {
	...
	public static LayoutSetPrototypeLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			LayoutSetPrototypeLocalServiceUtil::_getService);
	}

	private static LayoutSetPrototypeLocalService _getService() {
		...
		ServiceReference<LayoutSetPrototypeLocalService> serviceReference =
			bundleContext.getServiceReference(
				LayoutSetPrototypeLocalService.class);
	...
	private static final DCLSingleton<LayoutSetPrototypeLocalService>
