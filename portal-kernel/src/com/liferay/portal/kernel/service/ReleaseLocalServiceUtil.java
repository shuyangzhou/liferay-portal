...
public class ReleaseLocalServiceUtil {
	...
	public static ReleaseLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ReleaseLocalServiceUtil::_getService);
	}

	private static ReleaseLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(ReleaseLocalServiceUtil.class);
		...
		ServiceReference<ReleaseLocalService> serviceReference =
			bundleContext.getServiceReference(ReleaseLocalService.class);
	...
	private static final DCLSingleton<ReleaseLocalService>
