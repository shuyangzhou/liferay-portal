...
public class LayoutRevisionLocalServiceUtil {
	...
	public static LayoutRevisionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			LayoutRevisionLocalServiceUtil::_getService);
	}

	private static LayoutRevisionLocalService _getService() {
		...
		ServiceReference<LayoutRevisionLocalService> serviceReference =
			bundleContext.getServiceReference(LayoutRevisionLocalService.class);
	...
	private static final DCLSingleton<LayoutRevisionLocalService>
