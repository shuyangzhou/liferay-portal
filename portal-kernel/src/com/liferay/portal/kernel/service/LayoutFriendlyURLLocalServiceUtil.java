...
public class LayoutFriendlyURLLocalServiceUtil {
	...
	public static LayoutFriendlyURLLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			LayoutFriendlyURLLocalServiceUtil::_getService);
	}

	private static LayoutFriendlyURLLocalService _getService() {
		...
		ServiceReference<LayoutFriendlyURLLocalService> serviceReference =
	...
	private static final DCLSingleton<LayoutFriendlyURLLocalService>
