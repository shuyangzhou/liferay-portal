...
public class LayoutLocalServiceUtil {
	...
	public static LayoutLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			LayoutLocalServiceUtil::_getService);
	}

	private static LayoutLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(LayoutLocalServiceUtil.class);
		...
		ServiceReference<LayoutLocalService> serviceReference =
	...
	private static final DCLSingleton<LayoutLocalService> _serviceDCLSingleton =
		new DCLSingleton<>();
