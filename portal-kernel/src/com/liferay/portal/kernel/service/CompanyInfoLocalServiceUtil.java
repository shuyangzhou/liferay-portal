...
public class CompanyInfoLocalServiceUtil {
	...
	public static CompanyInfoLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CompanyInfoLocalServiceUtil::_getService);
	}

	private static CompanyInfoLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			CompanyInfoLocalServiceUtil.class);
		...
		ServiceReference<CompanyInfoLocalService> serviceReference =
			bundleContext.getServiceReference(CompanyInfoLocalService.class);
	...
	private static final DCLSingleton<CompanyInfoLocalService>
