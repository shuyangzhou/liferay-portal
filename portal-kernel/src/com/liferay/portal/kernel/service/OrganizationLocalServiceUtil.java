...
public class OrganizationLocalServiceUtil {
	...
	public static OrganizationLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			OrganizationLocalServiceUtil::_getService);
	}

	private static OrganizationLocalService _getService() {
		...
		ServiceReference<OrganizationLocalService> serviceReference =
			bundleContext.getServiceReference(OrganizationLocalService.class);
	...
	private static final DCLSingleton<OrganizationLocalService>
