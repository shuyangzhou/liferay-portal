...
public class PortletPreferencesLocalServiceUtil {
	...
	public static PortletPreferencesLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			PortletPreferencesLocalServiceUtil::_getService);
	}

	private static PortletPreferencesLocalService _getService() {
		...
		ServiceReference<PortletPreferencesLocalService> serviceReference =
	...
	private static final DCLSingleton<PortletPreferencesLocalService>
