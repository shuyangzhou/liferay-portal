...
public class PortalPreferencesLocalServiceUtil {
	...
	public static PortalPreferencesLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			PortalPreferencesLocalServiceUtil::_getService);
	}

	private static PortalPreferencesLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			PortalPreferencesLocalServiceUtil.class);
		...
		ServiceReference<PortalPreferencesLocalService> serviceReference =
			bundleContext.getServiceReference(
				PortalPreferencesLocalService.class);
	...
	private static final DCLSingleton<PortalPreferencesLocalService>
