...
public class PortletLocalServiceUtil {
	...
	public static PortletLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			PortletLocalServiceUtil::_getService);
	}

	private static PortletLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(PortletLocalServiceUtil.class);
		...
		ServiceReference<PortletLocalService> serviceReference =
			bundleContext.getServiceReference(PortletLocalService.class);
	...
	private static final DCLSingleton<PortletLocalService>
