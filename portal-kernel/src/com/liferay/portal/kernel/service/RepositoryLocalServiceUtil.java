...
public class RepositoryLocalServiceUtil {
	...
	public static RepositoryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			RepositoryLocalServiceUtil::_getService);
	}

	private static RepositoryLocalService _getService() {
		...
		ServiceReference<RepositoryLocalService> serviceReference =
			bundleContext.getServiceReference(RepositoryLocalService.class);
	...
	private static final DCLSingleton<RepositoryLocalService>
