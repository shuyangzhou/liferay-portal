...
public class UserGroupGroupRoleLocalServiceUtil {
	...
	public static UserGroupGroupRoleLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			UserGroupGroupRoleLocalServiceUtil::_getService);
	}

	private static UserGroupGroupRoleLocalService _getService() {
		...
		ServiceReference<UserGroupGroupRoleLocalService> serviceReference =
	...
	private static final DCLSingleton<UserGroupGroupRoleLocalService>
