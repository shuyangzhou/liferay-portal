...
public class ResourceActionLocalServiceUtil {
	...
	public static ResourceActionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ResourceActionLocalServiceUtil::_getService);
	}

	private static ResourceActionLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			ResourceActionLocalServiceUtil.class);
		...
		ServiceReference<ResourceActionLocalService> serviceReference =
			bundleContext.getServiceReference(ResourceActionLocalService.class);
	...
	private static final DCLSingleton<ResourceActionLocalService>
