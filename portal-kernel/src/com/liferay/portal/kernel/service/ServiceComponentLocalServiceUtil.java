...
public class ServiceComponentLocalServiceUtil {
	...
	public static ServiceComponentLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ServiceComponentLocalServiceUtil::_getService);
	}

	private static ServiceComponentLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			ServiceComponentLocalServiceUtil.class);
		...
		ServiceReference<ServiceComponentLocalService> serviceReference =
	...
	private static final DCLSingleton<ServiceComponentLocalService>
