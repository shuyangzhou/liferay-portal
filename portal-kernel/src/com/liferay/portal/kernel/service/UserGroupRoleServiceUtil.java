...
public class UserGroupRoleServiceUtil {
	...
	public static UserGroupRoleService getService() {
		return _serviceDCLSingleton.getSingleton(
			UserGroupRoleServiceUtil::_getService);
	}

	private static UserGroupRoleService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(UserGroupRoleServiceUtil.class);
		...
		ServiceReference<UserGroupRoleService> serviceReference =
			bundleContext.getServiceReference(UserGroupRoleService.class);
	...
	private static final DCLSingleton<UserGroupRoleService>
