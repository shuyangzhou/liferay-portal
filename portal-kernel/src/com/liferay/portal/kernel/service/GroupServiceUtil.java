...
public class GroupServiceUtil {
	...
	public static GroupService getService() {
		return _serviceDCLSingleton.getSingleton(GroupServiceUtil::_getService);
	}

	private static GroupService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(GroupServiceUtil.class);
		...
		ServiceReference<GroupService> serviceReference =
			bundleContext.getServiceReference(GroupService.class);
	...
	private static final DCLSingleton<GroupService> _serviceDCLSingleton =
		new DCLSingleton<>();
