...
public class WebsiteLocalServiceUtil {
	...
	public static WebsiteLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			WebsiteLocalServiceUtil::_getService);
	}

	private static WebsiteLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(WebsiteLocalServiceUtil.class);
		...
		ServiceReference<WebsiteLocalService> serviceReference =
			bundleContext.getServiceReference(WebsiteLocalService.class);
	...
	private static final DCLSingleton<WebsiteLocalService>
