...
public class MembershipRequestLocalServiceUtil {
	...
	public static MembershipRequestLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			MembershipRequestLocalServiceUtil::_getService);
	}

	private static MembershipRequestLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			MembershipRequestLocalServiceUtil.class);
		...
		ServiceReference<MembershipRequestLocalService> serviceReference =
			bundleContext.getServiceReference(
				MembershipRequestLocalService.class);
	...
	private static final DCLSingleton<MembershipRequestLocalService>
