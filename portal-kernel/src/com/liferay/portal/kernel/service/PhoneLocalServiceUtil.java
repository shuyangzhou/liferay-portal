...
public class PhoneLocalServiceUtil {
	...
	public static PhoneLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			PhoneLocalServiceUtil::_getService);
	}

	private static PhoneLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(PhoneLocalServiceUtil.class);
		...
		ServiceReference<PhoneLocalService> serviceReference =
			bundleContext.getServiceReference(PhoneLocalService.class);
	...
	private static final DCLSingleton<PhoneLocalService> _serviceDCLSingleton =
		new DCLSingleton<>();
