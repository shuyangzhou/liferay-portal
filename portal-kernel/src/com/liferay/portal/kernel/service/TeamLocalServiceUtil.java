...
public class TeamLocalServiceUtil {
	...
	public static TeamLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			TeamLocalServiceUtil::_getService);
	}

	private static TeamLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(TeamLocalServiceUtil.class);
		...
		ServiceReference<TeamLocalService> serviceReference =
			bundleContext.getServiceReference(TeamLocalService.class);
	...
	private static final DCLSingleton<TeamLocalService> _serviceDCLSingleton =
		new DCLSingleton<>();
