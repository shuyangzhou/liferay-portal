...
public class UserGroupGroupRoleServiceUtil {
	...
	public static UserGroupGroupRoleService getService() {
		return _serviceDCLSingleton.getSingleton(
			UserGroupGroupRoleServiceUtil::_getService);
	}

	private static UserGroupGroupRoleService _getService() {
		...
		ServiceReference<UserGroupGroupRoleService> serviceReference =
			bundleContext.getServiceReference(UserGroupGroupRoleService.class);
	...
	private static final DCLSingleton<UserGroupGroupRoleService>
