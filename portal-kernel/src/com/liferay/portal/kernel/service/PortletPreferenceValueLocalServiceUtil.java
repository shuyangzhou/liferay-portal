...
public class PortletPreferenceValueLocalServiceUtil {
	...
	public static PortletPreferenceValueLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			PortletPreferenceValueLocalServiceUtil::_getService);
	}

	private static PortletPreferenceValueLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			PortletPreferenceValueLocalServiceUtil.class);
		...
		ServiceReference<PortletPreferenceValueLocalService> serviceReference =
			bundleContext.getServiceReference(
				PortletPreferenceValueLocalService.class);
	...
	private static final DCLSingleton<PortletPreferenceValueLocalService>
