...
public class OrganizationServiceUtil {
	...
	public static OrganizationService getService() {
		return _serviceDCLSingleton.getSingleton(
			OrganizationServiceUtil::_getService);
	}

	private static OrganizationService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(OrganizationServiceUtil.class);
		...
		ServiceReference<OrganizationService> serviceReference =
			bundleContext.getServiceReference(OrganizationService.class);
	...
	private static final DCLSingleton<OrganizationService>
