...
public class ModelResourcePermissionChecker<T extends GroupedModel>
	...
	public static <M extends GroupedModel> ModelResourcePermissionChecker<M>
		create(
			...
			BiConsumer<ModelResourcePermission<M>, List<ModelResourcePermissionCheck<M>>>
				modelResourcePermissionCheckerConfigurator) {
	...
	public static <M extends GroupedModel> ModelResourcePermissionChecker<M>
		...
		modelResourcePermissionCheckerConfigurator.accept(
			modelResourcePermissionChecker, modelResourcePermissionChecks);
