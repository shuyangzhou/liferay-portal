 ...
 */
public abstract class ParentModelPermissionChecker<T extends GroupedModel>
	extends BaseModelPermissionChecker<T> implements ParentModelPermission<T> {

	@SafeVarargs
	public ParentModelPermissionChecker(
