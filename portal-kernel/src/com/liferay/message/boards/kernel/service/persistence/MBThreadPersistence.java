...
public interface MBThreadPersistence extends BasePersistence<MBThread> {
	...
	* @return the matching message boards threads that the user has permission to view
	*/
	public java.util.List<MBThread> filterFindByG_L(long groupId,
		Date lastPostDate);
	...
	* @return the matching message boards threads
	*/
	public java.util.List<MBThread> findByG_C_L(long groupId,
		long[] categoryIds, Date lastPostDate);
	...
	* @return the matching message boards threads
	*/
	public java.util.List<MBThread> findByG_L_S(long groupId,
	...
	* @return the matching message boards threads that the user has permission to view
	*/
	public java.util.List<MBThread> filterFindByG_L_S(long groupId,
		Date lastPostDate, int status);
	...
	* @return the matching message boards threads
	*/
	public java.util.List<MBThread> findByG_C_L_S(long groupId,
	...
	* @return the matching message boards threads that the user has permission to view
	*/
	public java.util.List<MBThread> filterFindByG_C_L_S(long groupId,
		long categoryId, Date lastPostDate, int status);
