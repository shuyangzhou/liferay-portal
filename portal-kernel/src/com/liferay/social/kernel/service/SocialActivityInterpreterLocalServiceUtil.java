...
public class SocialActivityInterpreterLocalServiceUtil {
	...
	public static SocialActivityInterpreterLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SocialActivityInterpreterLocalServiceUtil::_getService);
	}

	private static SocialActivityInterpreterLocalService _getService() {
		...
		ServiceReference<SocialActivityInterpreterLocalService>
	...
	private static final DCLSingleton<SocialActivityInterpreterLocalService>
