...
public class SocialActivitySettingServiceUtil {
	...
	public static SocialActivitySettingService getService() {
		return _serviceDCLSingleton.getSingleton(
			SocialActivitySettingServiceUtil::_getService);
	}

	private static SocialActivitySettingService _getService() {
		...
		ServiceReference<SocialActivitySettingService> serviceReference =
			bundleContext.getServiceReference(
				SocialActivitySettingService.class);
	...
	private static final DCLSingleton<SocialActivitySettingService>
