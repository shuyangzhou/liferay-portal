...
public class SocialRelationLocalServiceUtil {
	...
	public static SocialRelationLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SocialRelationLocalServiceUtil::_getService);
	}

	private static SocialRelationLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			SocialRelationLocalServiceUtil.class);
		...
		ServiceReference<SocialRelationLocalService> serviceReference =
			bundleContext.getServiceReference(SocialRelationLocalService.class);
	...
	private static final DCLSingleton<SocialRelationLocalService>
