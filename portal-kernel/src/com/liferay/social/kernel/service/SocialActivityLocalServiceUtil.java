...
public class SocialActivityLocalServiceUtil {
	...
	public static SocialActivityLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SocialActivityLocalServiceUtil::_getService);
	}

	private static SocialActivityLocalService _getService() {
		...
		ServiceReference<SocialActivityLocalService> serviceReference =
			bundleContext.getServiceReference(SocialActivityLocalService.class);
	...
	private static final DCLSingleton<SocialActivityLocalService>
