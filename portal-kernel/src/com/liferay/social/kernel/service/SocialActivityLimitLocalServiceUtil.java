...
public class SocialActivityLimitLocalServiceUtil {
	...
	public static SocialActivityLimitLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SocialActivityLimitLocalServiceUtil::_getService);
	}

	private static SocialActivityLimitLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			SocialActivityLimitLocalServiceUtil.class);
		...
		ServiceReference<SocialActivityLimitLocalService> serviceReference =
			bundleContext.getServiceReference(
				SocialActivityLimitLocalService.class);
	...
	private static final DCLSingleton<SocialActivityLimitLocalService>
