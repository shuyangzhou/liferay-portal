...
public class SocialActivitySettingLocalServiceUtil {
	...
	public static SocialActivitySettingLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SocialActivitySettingLocalServiceUtil::_getService);
	}

	private static SocialActivitySettingLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			SocialActivitySettingLocalServiceUtil.class);
		...
		ServiceReference<SocialActivitySettingLocalService> serviceReference =
			bundleContext.getServiceReference(
				SocialActivitySettingLocalService.class);
	...
	private static final DCLSingleton<SocialActivitySettingLocalService>
