...
public class AssetTagWrapper implements AssetTag, ModelWrapper<AssetTag> {
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<AssetTag, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<AssetTag, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<AssetTag, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<AssetTag, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<AssetTag, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<AssetTag, Object> attributeBiConsumer = entry.getValue();
	...
	public Map<String, Function<AssetTag, Object>> getAttributeGetters() {
		return _assetTag.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<AssetTag, Object>> getAttributeSetters() {
		return _assetTag.getAttributeSetters();
	}
