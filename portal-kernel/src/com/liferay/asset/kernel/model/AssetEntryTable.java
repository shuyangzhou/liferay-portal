 ...
 * @generated
 */
public class AssetEntryTable extends Table<AssetEntryTable> {
	...
	public final Column<AssetEntryTable, String> description = createColumn(
		"description", String.class, Types.CLOB);
	public final Column<AssetEntryTable, String> summary = createColumn(
		"summary", String.class, Types.CLOB);
