...
public class AssetCategoryServiceUtil {
	...
	public static AssetCategoryService getService() {
		return _serviceDCLSingleton.getSingleton(
			AssetCategoryServiceUtil::_getService);
	}

	private static AssetCategoryService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(AssetCategoryServiceUtil.class);
		...
		ServiceReference<AssetCategoryService> serviceReference =
			bundleContext.getServiceReference(AssetCategoryService.class);
	...
	private static final DCLSingleton<AssetCategoryService>
