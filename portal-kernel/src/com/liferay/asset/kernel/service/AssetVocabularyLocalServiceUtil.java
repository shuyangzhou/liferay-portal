...
public class AssetVocabularyLocalServiceUtil {
	...
	public static AssetVocabularyLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			AssetVocabularyLocalServiceUtil::_getService);
	}

	private static AssetVocabularyLocalService _getService() {
		...
		ServiceReference<AssetVocabularyLocalService> serviceReference =
	...
	private static final DCLSingleton<AssetVocabularyLocalService>
