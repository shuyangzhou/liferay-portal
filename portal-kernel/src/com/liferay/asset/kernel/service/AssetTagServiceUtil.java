...
public class AssetTagServiceUtil {
	...
	public static AssetTagService getService() {
		return _serviceDCLSingleton.getSingleton(
			AssetTagServiceUtil::_getService);
	}

	private static AssetTagService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(AssetTagServiceUtil.class);
		...
		ServiceReference<AssetTagService> serviceReference =
			bundleContext.getServiceReference(AssetTagService.class);
	...
	private static final DCLSingleton<AssetTagService> _serviceDCLSingleton =
		new DCLSingleton<>();
