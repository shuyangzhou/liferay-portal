...
public class AssetVocabularyServiceUtil {
	...
	public static AssetVocabularyService getService() {
		return _serviceDCLSingleton.getSingleton(
			AssetVocabularyServiceUtil::_getService);
	}

	private static AssetVocabularyService _getService() {
		...
		ServiceReference<AssetVocabularyService> serviceReference =
			bundleContext.getServiceReference(AssetVocabularyService.class);
	...
	private static final DCLSingleton<AssetVocabularyService>
