...
public class AssetEntryLocalServiceUtil {
	...
	public static AssetEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			AssetEntryLocalServiceUtil::_getService);
	}

	private static AssetEntryLocalService _getService() {
		...
		ServiceReference<AssetEntryLocalService> serviceReference =
			bundleContext.getServiceReference(AssetEntryLocalService.class);
	...
	private static final DCLSingleton<AssetEntryLocalService>
