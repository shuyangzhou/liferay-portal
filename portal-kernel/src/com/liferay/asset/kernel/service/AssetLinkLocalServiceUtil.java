...
public class AssetLinkLocalServiceUtil {
	...
	public static AssetLinkLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			AssetLinkLocalServiceUtil::_getService);
	}

	private static AssetLinkLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			AssetLinkLocalServiceUtil.class);
		...
		ServiceReference<AssetLinkLocalService> serviceReference =
			bundleContext.getServiceReference(AssetLinkLocalService.class);
	...
	private static final DCLSingleton<AssetLinkLocalService>
