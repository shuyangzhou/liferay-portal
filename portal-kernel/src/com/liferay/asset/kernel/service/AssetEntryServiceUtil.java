...
public class AssetEntryServiceUtil {
	...
	public static AssetEntryService getService() {
		return _serviceDCLSingleton.getSingleton(
			AssetEntryServiceUtil::_getService);
	}

	private static AssetEntryService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(AssetEntryServiceUtil.class);
		...
		ServiceReference<AssetEntryService> serviceReference =
			bundleContext.getServiceReference(AssetEntryService.class);
	...
	private static final DCLSingleton<AssetEntryService> _serviceDCLSingleton =
		new DCLSingleton<>();
