...
public class AssetTagLocalServiceUtil {
	...
	public static AssetTagLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			AssetTagLocalServiceUtil::_getService);
	}

	private static AssetTagLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(AssetTagLocalServiceUtil.class);
		...
		ServiceReference<AssetTagLocalService> serviceReference =
			bundleContext.getServiceReference(AssetTagLocalService.class);
	...
	private static final DCLSingleton<AssetTagLocalService>
