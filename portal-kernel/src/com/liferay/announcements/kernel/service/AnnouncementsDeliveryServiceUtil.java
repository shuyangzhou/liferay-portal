...
public class AnnouncementsDeliveryServiceUtil {
	...
	public static AnnouncementsDeliveryService getService() {
		return _serviceDCLSingleton.getSingleton(
			AnnouncementsDeliveryServiceUtil::_getService);
	}

	private static AnnouncementsDeliveryService _getService() {
		...
		ServiceReference<AnnouncementsDeliveryService> serviceReference =
	...
	private static final DCLSingleton<AnnouncementsDeliveryService>
