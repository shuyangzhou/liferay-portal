...
public class AnnouncementsEntryLocalServiceUtil {
	...
	public static AnnouncementsEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			AnnouncementsEntryLocalServiceUtil::_getService);
	}

	private static AnnouncementsEntryLocalService _getService() {
		...
		ServiceReference<AnnouncementsEntryLocalService> serviceReference =
			bundleContext.getServiceReference(
				AnnouncementsEntryLocalService.class);
	...
	private static final DCLSingleton<AnnouncementsEntryLocalService>
