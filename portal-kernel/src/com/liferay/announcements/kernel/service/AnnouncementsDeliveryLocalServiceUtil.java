...
public class AnnouncementsDeliveryLocalServiceUtil {
	...
	public static AnnouncementsDeliveryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			AnnouncementsDeliveryLocalServiceUtil::_getService);
	}

	private static AnnouncementsDeliveryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			AnnouncementsDeliveryLocalServiceUtil.class);
		...
		ServiceReference<AnnouncementsDeliveryLocalService> serviceReference =
			bundleContext.getServiceReference(
				AnnouncementsDeliveryLocalService.class);
	...
	private static final DCLSingleton<AnnouncementsDeliveryLocalService>
