...
public class LocalProcessExecutorTest {
	...
	public void testEnvironment() throws Exception {
		...
		Map<String, String> actualEnvironment = future.get();

		Assert.assertEquals("value1", actualEnvironment.get("key1"));
		Assert.assertEquals("value2", actualEnvironment.get("key2"));
	}
