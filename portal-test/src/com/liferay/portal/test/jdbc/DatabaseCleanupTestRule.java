...
public class DatabaseCleanupTestRule extends BaseTestRule<Object, Object> {
	...
	public static void processDeleteAfterInvoke(Connection connection,
			String sql) {
	...
	public static void processInsertAfterInvoke(Connection connection,
			String sql) {
	...
	protected void afterClass(Description description, Object c) {
		...
		for (String insertedObject : _insertedObjects.keySet()) {
			System.out.println(insertedObject);
		}
	}
