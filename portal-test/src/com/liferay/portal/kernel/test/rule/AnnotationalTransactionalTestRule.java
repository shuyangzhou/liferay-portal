 ...
 * @author Shuyang Zhou
 */
public class AnnotationalTransactionalTestRule implements TestRule {

	public static final AnnotationalTransactionalTestRule INSTANCE =
		new AnnotationalTransactionalTestRule();

	public AnnotationalTransactionalTestRule() {
	}
