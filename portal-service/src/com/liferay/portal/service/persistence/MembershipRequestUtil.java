...
public class MembershipRequestUtil {
	...
	*/
	public static List<MembershipRequest> findByG_S(long groupId,
		...
		return getPersistence().findByG_S(groupId, statusId, retrieveFromCache);
	}
	...
	*/
	public static List<MembershipRequest> findByG_S(long groupId,
		...
		return getPersistence()
				   .findByG_S(groupId, statusId, start, end, retrieveFromCache);
	}
	...
	*/
	public static List<MembershipRequest> findByG_U_S(long groupId,
		long userId, long statusId, boolean retrieveFromCache) {
		return getPersistence()
				   .findByG_U_S(groupId, userId, statusId, retrieveFromCache);
	}
