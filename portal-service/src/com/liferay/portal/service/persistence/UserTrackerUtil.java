...
public class UserTrackerUtil {
	...
	*/
	public static List<UserTracker> findBySessionId(
		java.lang.String sessionId, boolean retrieveFromCache) {
		return getPersistence().findBySessionId(sessionId, retrieveFromCache);
	}
	...
	*/
	public static List<UserTracker> findBySessionId(
		...
		boolean retrieveFromCache) {
		return getPersistence()
				   .findBySessionId(sessionId, start, end, retrieveFromCache);
	}
