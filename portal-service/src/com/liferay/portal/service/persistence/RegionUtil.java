...
public class RegionUtil {
	...
	*/
	public static List<Region> findByCountryId(long countryId,
		...
		return getPersistence().findByCountryId(countryId, retrieveFromCache);
	}
	...
	*/
	public static List<Region> findByCountryId(long countryId, int start,
		...
		return getPersistence()
				   .findByCountryId(countryId, start, end, retrieveFromCache);
	}
	...
	*/
	public static List<Region> findByC_A(long countryId, boolean active,
		boolean retrieveFromCache) {
		return getPersistence().findByC_A(countryId, active, retrieveFromCache);
	}
	...
	*/
	public static List<Region> findByC_A(long countryId, boolean active,
		...
		return getPersistence()
				   .findByC_A(countryId, active, start, end, retrieveFromCache);
	}
