...
public class ResourcePermissionUtil {
	...
	*/
	public static List<ResourcePermission> findByScope(int scope,
		...
		return getPersistence().findByScope(scope, retrieveFromCache);
	}
	...
	*/
	public static List<ResourcePermission> findByScope(int scope, int start,
		...
		return getPersistence().findByScope(scope, start, end, retrieveFromCache);
	}
	...
	*/
	public static List<ResourcePermission> findByScope(int[] scopes,
		boolean retrieveFromCache) {
		return getPersistence().findByScope(scopes, retrieveFromCache);
	}
	...
	*/
	public static List<ResourcePermission> findByScope(int[] scopes, int start,
		int end, boolean retrieveFromCache) {
		return getPersistence()
				   .findByScope(scopes, start, end, retrieveFromCache);
	}
	...
	*/
	public static List<ResourcePermission> findByC_LikeP(long companyId,
		...
		return getPersistence()
				   .findByC_LikeP(companyId, primKey, retrieveFromCache);
	}
	...
	*/
	public static List<ResourcePermission> findByC_LikeP(long companyId,
		java.lang.String primKey, int start, int end, boolean retrieveFromCache) {
		return getPersistence()
	...
	*/
	public static List<ResourcePermission> findByC_N_S(long companyId,
		...
		return getPersistence()
				   .findByC_N_S(companyId, name, scope, retrieveFromCache);
	}
	...
	*/
	public static List<ResourcePermission> findByC_N_S_P(long companyId,
		...
		boolean retrieveFromCache) {
		return getPersistence()
				   .findByC_N_S_P(companyId, name, scope, primKey,
			retrieveFromCache);
	}
	...
	*/
	public static List<ResourcePermission> findByC_N_S_P_R(long companyId,
		java.lang.String name, int scope, java.lang.String primKey,
		long[] roleIds, boolean retrieveFromCache) {
		return getPersistence()
				   .findByC_N_S_P_R(companyId, name, scope, primKey, roleIds,
			retrieveFromCache);
	}
	...
	*/
	public static List<ResourcePermission> findByC_N_S_P_R(long companyId,
		java.lang.String name, int scope, java.lang.String primKey,
		long[] roleIds, int start, int end, boolean retrieveFromCache) {
		return getPersistence()
				   .findByC_N_S_P_R(companyId, name, scope, primKey, roleIds,
	...
	*/
	public static List<ResourcePermission> findByC_N_S_P_R_V(long companyId,
		...
		return getPersistence()
				   .findByC_N_S_P_R_V(companyId, name, scope, primKeyId,
			roleId, viewActionId, retrieveFromCache);
	}
	...
	*/
	public static List<ResourcePermission> findByC_N_S_P_R_V(long companyId,
		...
		return getPersistence()
				   .findByC_N_S_P_R_V(companyId, name, scope, primKeyId,
			roleId, viewActionId, start, end, retrieveFromCache);
	}
	...
	*/
	public static List<ResourcePermission> findByC_N_S_P_R_V(long companyId,
		...
		return getPersistence()
				   .findByC_N_S_P_R_V(companyId, name, scope, primKeyId,
			roleIds, viewActionId, retrieveFromCache);
	}
	...
	*/
	public static List<ResourcePermission> findByC_N_S_P_R_V(long companyId,
		...
		return getPersistence()
				   .findByC_N_S_P_R_V(companyId, name, scope, primKeyId,
			roleIds, viewActionId, start, end, retrieveFromCache);
	}
