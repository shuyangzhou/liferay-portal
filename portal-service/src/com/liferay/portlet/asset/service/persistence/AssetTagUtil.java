...
public class AssetTagUtil {
	...
	*/
	public static List<AssetTag> findByG_LikeN(long groupId,
		...
		return getPersistence().findByG_LikeN(groupId, name, retrieveFromCache);
	}
	...
	*/
	public static List<AssetTag> findByG_LikeN(long groupId,
		...
		return getPersistence()
				   .findByG_LikeN(groupId, name, start, end, retrieveFromCache);
	}
	...
	*/
	public static List<AssetTag> findByG_LikeN(long[] groupIds,
		java.lang.String name, boolean retrieveFromCache) {
		return getPersistence().findByG_LikeN(groupIds, name, retrieveFromCache);
	}
	...
	*/
	public static List<AssetTag> findByG_LikeN(long[] groupIds,
		java.lang.String name, int start, int end, boolean retrieveFromCache) {
		return getPersistence()
				   .findByG_LikeN(groupIds, name, start, end, retrieveFromCache);
	}
