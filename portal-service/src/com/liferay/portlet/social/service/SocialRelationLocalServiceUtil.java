...
public class SocialRelationLocalServiceUtil {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.liferay.portal.model.User> getSocialUsersByType(
		long userId, int type, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator obc)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getSocialUsersByType(userId, type, start, end, obc);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getSocialUsersCountByType(long userId, int type)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getSocialUsersCountByType(userId, type);
	}
