...
public class SearchPermissionCheckerTest {
	...
	public void setUp() throws Exception {
		...
		IndexerRegistryUtil.register(_testIndexer);
	...
	public void tearDown() throws Exception {
		IndexerRegistryUtil.unregister(_testIndexer);
	...
	@Test
	public void testUpdatePermissionFieldsPermissionAware() {
		_testIndexer.setPermissionAware(true);

		_searchPermissionChecker.updatePermissionFields(
			TestIndexer.class.getName(), StringPool.BLANK);

		_testIndexer.assertPermissionAwareReindex();
	}

	@Test
	public void testUpdatePermissionFieldsPermissionUnaware() {
		_testIndexer.setPermissionAware(false);
	...
	private final TestIndexer _testIndexer = new TestIndexer();
	...
	private static class TestIndexer extends DummyIndexer {

		public void assertPermissionAwareReindex() {
			Assert.assertEquals(_permissionAware, _reindexCalled);
		}
		...
		private boolean _reindexCalled;
