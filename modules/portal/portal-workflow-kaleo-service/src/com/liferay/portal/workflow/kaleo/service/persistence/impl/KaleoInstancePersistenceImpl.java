...
public class KaleoInstancePersistenceImpl extends BasePersistenceImpl<KaleoInstance>
	...
	public KaleoInstance updateImpl(KaleoInstance kaleoInstance) {
		...
		KaleoInstance updatedKaleoInstance = null;
		...
		try {
			...
			if (kaleoInstance.isNew()) {
				...
				updatedKaleoInstance = (KaleoInstance)session.merge(kaleoInstance);
			}
		}
		catch (Exception e) {
			throw processException(e);
