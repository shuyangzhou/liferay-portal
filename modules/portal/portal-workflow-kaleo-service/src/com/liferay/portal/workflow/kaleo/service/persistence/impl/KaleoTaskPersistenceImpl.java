...
public class KaleoTaskPersistenceImpl extends BasePersistenceImpl<KaleoTask>
	...
	public KaleoTask updateImpl(KaleoTask kaleoTask) {
		...
		KaleoTask updatedKaleoTask = null;
		...
		try {
			...
			if (kaleoTask.isNew()) {
				...
				updatedKaleoTask = (KaleoTask)session.merge(kaleoTask);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedKaleoTask == null) {
			...
			cacheUniqueFindersCache(updatedKaleoTask, isNew);
		}
