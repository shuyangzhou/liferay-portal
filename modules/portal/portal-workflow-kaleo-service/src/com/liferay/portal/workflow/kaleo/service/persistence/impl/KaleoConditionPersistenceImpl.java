...
public class KaleoConditionPersistenceImpl extends BasePersistenceImpl<KaleoCondition>
	...
	public KaleoCondition updateImpl(KaleoCondition kaleoCondition) {
		...
		KaleoCondition updatedKaleoCondition = null;
		...
		try {
			...
			if (kaleoCondition.isNew()) {
				...
				updatedKaleoCondition = (KaleoCondition)session.merge(kaleoCondition);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedKaleoCondition == null) {
			...
			cacheUniqueFindersCache(updatedKaleoCondition, isNew);
		}
