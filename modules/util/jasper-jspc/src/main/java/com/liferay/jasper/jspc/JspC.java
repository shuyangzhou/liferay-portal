...
public class JspC extends org.apache.jasper.JspC {
	...
	public static void main(String[] args) {
		...
		try {
			...
			try {
				Field noDieLevelField = ReflectionUtil.getDeclaredField(
					org.apache.jasper.JspC.class, "NO_DIE_LEVEL");
	...
	public JspC() {
		...
		try {
			Field pagesField = ReflectionUtil.getDeclaredField(
				org.apache.jasper.JspC.class, "pages");
