...
<#list blogsEntryModels as blogsEntryModel>
	insert into BlogsEntry values ('${blogsEntryModel.uuid}', ${blogsEntryModel.entryId}, ${blogsEntryModel.groupId}, ${blogsEntryModel.userId}, '${blogsEntryModel.userName}', '${dataFactory.getDateString(blogsEntryModel.createDate)}', '${dataFactory.getDateString(blogsEntryModel.modifiedDate)}', '${blogsEntryModel.title}', '${blogsEntryModel.subtitle}', '${blogsEntryModel.urlTitle}', '${blogsEntryModel.description}', '${blogsEntryModel.content}', '${dataFactory.getDateString(blogsEntryModel.displayDate)}', ${blogsEntryModel.allowPingbacks?string}, ${blogsEntryModel.allowTrackbacks?string}, '${blogsEntryModel.trackbacks}', '${blogsEntryModel.coverImageCaption}', ${blogsEntryModel.coverImageFileEntryId}, '${blogsEntryModel.coverImageURL}', ${blogsEntryModel.smallImage?string}, ${blogsEntryModel.smallImageFileEntryId}, ${blogsEntryModel.smallImageId}, '${blogsEntryModel.smallImageURL}', '${dataFactory.getDateString(blogsEntryModel.lastPublishDate)}', ${blogsEntryModel.status}, ${blogsEntryModel.statusByUserId}, '${blogsEntryModel.statusByUserName}', '${dataFactory.getDateString(blogsEntryModel.statusDate)}', ${blogsEntryModel.companyId});
