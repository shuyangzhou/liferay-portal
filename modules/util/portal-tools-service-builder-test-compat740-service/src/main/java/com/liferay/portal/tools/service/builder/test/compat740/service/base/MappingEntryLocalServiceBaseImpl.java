...
import com.liferay.portal.tools.service.builder.test.compat740.service.MappingEntryLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.portal.tools.service.builder.test.compat740.service.impl.MappingEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.portal.tools.service.builder.test.compat740.service.impl.MappingEntryLocalServiceImpl
 * @generated
 */
public abstract class MappingEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, MappingEntryLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MappingEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.portal.tools.service.builder.test.compat740.service.MappingEntryLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return mappingEntryPersistence.dslQuery(dslQuery);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return mappingEntryPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement MappingEntryLocalServiceImpl#deleteMappingEntry(MappingEntry) to avoid orphaned data");
		}
	...
	public boolean addBasicEntryMappingEntry(
		...
		return basicEntryPersistence.addMappingEntry(
	...
	public boolean addBasicEntryMappingEntries(
		...
		return basicEntryPersistence.addMappingEntries(
	...
	public List<MappingEntry> getBasicEntryMappingEntries(long basicEntryId) {
		return mappingEntryPersistence.getBasicEntryMappingEntries(
			basicEntryId);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MappingEntryLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		mappingEntryLocalService = (MappingEntryLocalService)aopProxy;
	}
