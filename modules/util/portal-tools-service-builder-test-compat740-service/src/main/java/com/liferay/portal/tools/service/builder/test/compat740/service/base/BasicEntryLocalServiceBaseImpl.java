...
import com.liferay.portal.tools.service.builder.test.compat740.service.BasicEntryLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.portal.tools.service.builder.test.compat740.service.impl.BasicEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.portal.tools.service.builder.test.compat740.service.impl.BasicEntryLocalServiceImpl
 * @generated
 */
public abstract class BasicEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, BasicEntryLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BasicEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.portal.tools.service.builder.test.compat740.service.BasicEntryLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return basicEntryPersistence.dslQuery(dslQuery);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return basicEntryPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement BasicEntryLocalServiceImpl#deleteBasicEntry(BasicEntry) to avoid orphaned data");
		}
	...
	public boolean addMappingEntryBasicEntry(
		...
		return mappingEntryPersistence.addBasicEntry(
	...
	public boolean addMappingEntryBasicEntries(
		...
		return mappingEntryPersistence.addBasicEntries(
	...
	public List<BasicEntry> getMappingEntryBasicEntries(long mappingEntryId) {
		return basicEntryPersistence.getMappingEntryBasicEntries(
			mappingEntryId);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BasicEntryLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		basicEntryLocalService = (BasicEntryLocalService)aopProxy;
	}
