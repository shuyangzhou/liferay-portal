...
import com.liferay.service.builder.test.service.persistence.VersionedEntryUtil;
...
public class VersionedEntryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newVersionedEntry.setContent(RandomTestUtil.randomString());
		...
		Assert.assertEquals(existingVersionedEntry.getContent(),
			newVersionedEntry.getContent());
	...
	protected OrderByComparator<VersionedEntry> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("VersionedEntry",
			"mvccVersion", true, "versionedEntryId", true, "content", true,
			"headId", true);
	}
	...
	protected VersionedEntry addVersionedEntry() throws Exception {
		...
		versionedEntry.setContent(RandomTestUtil.randomString());
