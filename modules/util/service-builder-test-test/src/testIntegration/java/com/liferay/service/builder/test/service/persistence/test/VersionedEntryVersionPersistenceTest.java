...
import com.liferay.service.builder.test.service.persistence.VersionedEntryVersionUtil;
...
public class VersionedEntryVersionPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newVersionedEntryVersion.setContent(RandomTestUtil.randomString());
		...
		Assert.assertEquals(existingVersionedEntryVersion.getContent(),
			newVersionedEntryVersion.getContent());
	}
	...
	protected OrderByComparator<VersionedEntryVersion> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("VersionedEntryVersion",
			...
			"versionedEntryId", true, "content", true);
	}
	...
	protected VersionedEntryVersion addVersionedEntryVersion()
		...
		versionedEntryVersion.setContent(RandomTestUtil.randomString());
