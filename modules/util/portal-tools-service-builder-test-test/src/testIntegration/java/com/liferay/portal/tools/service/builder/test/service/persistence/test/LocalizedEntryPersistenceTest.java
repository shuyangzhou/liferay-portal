...
public class LocalizedEntryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		Assert.assertEquals(existingLocalizedEntry.getEntryId(),
			newLocalizedEntry.getEntryId());
	...
	protected OrderByComparator<LocalizedEntry> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("LocalizedEntry", "entryId",
	...
	public void testDynamicQueryByProjectionExisting()
		...
		Object newEntryId = newLocalizedEntry.getEntryId();
