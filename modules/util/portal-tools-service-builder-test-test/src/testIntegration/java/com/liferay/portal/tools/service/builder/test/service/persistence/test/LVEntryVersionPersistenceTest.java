...
public class LVEntryVersionPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newLVEntryVersion.setEntryId(RandomTestUtil.nextLong());
		...
		Assert.assertEquals(existingLVEntryVersion.getEntryId(),
			newLVEntryVersion.getEntryId());
	...
	protected OrderByComparator<LVEntryVersion> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("LVEntryVersion",
			"lvEntryVersionId", true, "version", true, "entryId", true,
	...
	public void testResetOriginalValues() throws Exception {
		...
		Assert.assertEquals(Long.valueOf(existingLVEntryVersion.getEntryId()),
	...
	protected LVEntryVersion addLVEntryVersion() throws Exception {
		...
		lvEntryVersion.setEntryId(RandomTestUtil.nextLong());
