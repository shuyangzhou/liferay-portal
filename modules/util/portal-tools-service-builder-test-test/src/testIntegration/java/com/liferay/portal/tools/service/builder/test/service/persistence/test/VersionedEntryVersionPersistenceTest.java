...
public class VersionedEntryVersionPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newVersionedEntryVersion.setEntryId(RandomTestUtil.nextLong());
		...
		Assert.assertEquals(existingVersionedEntryVersion.getEntryId(),
			newVersionedEntryVersion.getEntryId());
	...
	protected OrderByComparator<VersionedEntryVersion> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("VersionedEntryVersion",
			"versionedEntryVersionId", true, "version", true, "entryId", true,
			"groupId", true);
	}
	...
	public void testResetOriginalValues() throws Exception {
		...
		Assert.assertEquals(Long.valueOf(
				existingVersionedEntryVersion.getEntryId()),
	...
	protected VersionedEntryVersion addVersionedEntryVersion()
		...
		versionedEntryVersion.setEntryId(RandomTestUtil.nextLong());
