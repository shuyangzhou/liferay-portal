...
public class VersionedEntryVersionPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newVersionedEntryVersion.setDefaultLanguageId(RandomTestUtil.randomString());
		...
		Assert.assertEquals(existingVersionedEntryVersion.getDefaultLanguageId(),
			newVersionedEntryVersion.getDefaultLanguageId());
	}
	...
	protected OrderByComparator<VersionedEntryVersion> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("VersionedEntryVersion",
			...
			"versionedEntryId", true, "groupId", true, "defaultLanguageId", true);
	}
	...
	protected VersionedEntryVersion addVersionedEntryVersion()
		...
		versionedEntryVersion.setDefaultLanguageId(RandomTestUtil.randomString());
