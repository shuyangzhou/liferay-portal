...
public class VersionedEntryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newVersionedEntry.setDefaultLanguageId(RandomTestUtil.randomString());
		...
		Assert.assertEquals(existingVersionedEntry.getDefaultLanguageId(),
			newVersionedEntry.getDefaultLanguageId());
	}
	...
	protected OrderByComparator<VersionedEntry> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("VersionedEntry",
			...
			"headId", true, "defaultLanguageId", true);
	}
	...
	protected VersionedEntry addVersionedEntry() throws Exception {
		...
		versionedEntry.setDefaultLanguageId(RandomTestUtil.randomString());
