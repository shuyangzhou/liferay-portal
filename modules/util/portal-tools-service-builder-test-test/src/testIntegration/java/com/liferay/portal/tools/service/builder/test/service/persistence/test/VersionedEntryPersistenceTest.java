...
public class VersionedEntryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		Assert.assertEquals(existingVersionedEntry.getEntryId(),
			newVersionedEntry.getEntryId());
	...
	protected OrderByComparator<VersionedEntry> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("VersionedEntry",
			"mvccVersion", true, "entryId", true, "groupId", true, "headId",
			true);
	}
	...
	public void testDynamicQueryByProjectionExisting()
		...
		Object newEntryId = newVersionedEntry.getEntryId();
