...
public class SpringEntryLocalServiceUtil {
	...
	public static SpringEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SpringEntryLocalServiceUtil::_getService);
	}

	private static SpringEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			SpringEntryLocalServiceUtil.class);
		...
		ServiceReference<SpringEntryLocalService> serviceReference =
			bundleContext.getServiceReference(SpringEntryLocalService.class);
	...
	private static final DCLSingleton<SpringEntryLocalService>
