 ...
 * <code>com.liferay.portal.tools.service.builder.test.compat740.service.impl.BasicEntryLocalServiceImpl</code> and
...
public class BasicEntryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.portal.tools.service.builder.test.compat740.service.impl.BasicEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static boolean addMappingEntryBasicEntries(
		long mappingEntryId, List<BasicEntry> basicEntries) {

		return getService().addMappingEntryBasicEntries(
	...
	public static boolean addMappingEntryBasicEntry(
		long mappingEntryId, BasicEntry basicEntry) {

		return getService().addMappingEntryBasicEntry(
	...
	private static final Snapshot<BasicEntryLocalService> _serviceSnapshot =
		new Snapshot<>(
