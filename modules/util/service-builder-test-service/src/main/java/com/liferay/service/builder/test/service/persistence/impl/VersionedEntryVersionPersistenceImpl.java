...
package com.liferay.service.builder.test.service.persistence.impl;
...
import com.liferay.service.builder.test.exception.NoSuchVersionedEntryVersionException;
import com.liferay.service.builder.test.model.VersionedEntryVersion;
import com.liferay.service.builder.test.model.impl.VersionedEntryVersionImpl;
import com.liferay.service.builder.test.model.impl.VersionedEntryVersionModelImpl;
import com.liferay.service.builder.test.service.persistence.VersionedEntryVersionPersistence;
 ...
 * @see com.liferay.service.builder.test.service.persistence.VersionedEntryVersionUtil
 * @generated
 */
@ProviderType
public class VersionedEntryVersionPersistenceImpl extends BasePersistenceImpl<VersionedEntryVersion>
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((versionedEntryVersion.getVersionedEntryId() != versionedEntryId) ||
	...
	protected VersionedEntryVersion removeImpl(
		...
		versionedEntryVersion = toUnwrappedModel(versionedEntryVersion);
	...
	protected VersionedEntryVersion toUnwrappedModel(
		VersionedEntryVersion versionedEntryVersion) {
		if (versionedEntryVersion instanceof VersionedEntryVersionImpl) {
			return versionedEntryVersion;
		}

		VersionedEntryVersionImpl versionedEntryVersionImpl = new VersionedEntryVersionImpl();

		versionedEntryVersionImpl.setNew(versionedEntryVersion.isNew());
		versionedEntryVersionImpl.setPrimaryKey(versionedEntryVersion.getPrimaryKey());

		versionedEntryVersionImpl.setVersionedEntryVersionId(versionedEntryVersion.getVersionedEntryVersionId());
		versionedEntryVersionImpl.setVersion(versionedEntryVersion.getVersion());
		versionedEntryVersionImpl.setVersionedEntryId(versionedEntryVersion.getVersionedEntryId());
		versionedEntryVersionImpl.setContent(versionedEntryVersion.getContent());
