...
public abstract class VersionedEntryLocalServiceBaseImpl
	...
	public VersionedEntry deleteVersionedEntry(long entryId) {
		VersionedEntry versionedEntry = versionedEntryPersistence.fetchByPrimaryKey(entryId);
	...
	public VersionedEntry fetchVersionedEntry(long entryId) {
		return versionedEntryPersistence.fetchByPrimaryKey(entryId);
	}
	...
	public VersionedEntry getVersionedEntry(long entryId)
		...
		return versionedEntryPersistence.findByPrimaryKey(entryId);
	}
	...
	public VersionedEntryVersion deleteVersion(
		...
		VersionedEntryVersion latestVersionedEntryVersion = versionedEntryVersionPersistence.findByEntryId_First(versionedEntryVersion.getVersionedModelId(),
				null);
	...
	public VersionedEntryVersion fetchLatestVersion(
		...
		return versionedEntryVersionPersistence.fetchByEntryId_First(primaryKey,
			null);
	}
	...
	public VersionedEntryVersion getVersion(VersionedEntry versionedEntry,
		...
		return versionedEntryVersionPersistence.findByEntryId_Version(primaryKey,
			version);
	}
	...
	public List<VersionedEntryVersion> getVersions(
		...
		return versionedEntryVersionPersistence.findByEntryId(primaryKey);
	}
	...
	public VersionedEntry publishDraft(VersionedEntry draftVersionedEntry)
		...
		if (draftVersionedEntry.getHeadId() == draftVersionedEntry.getPrimaryKey()) {
			...
			VersionedEntryVersion latestVersionedEntryVersion = versionedEntryVersionPersistence.findByEntryId_First(draftVersionedEntry.getHeadId(),
					null);
