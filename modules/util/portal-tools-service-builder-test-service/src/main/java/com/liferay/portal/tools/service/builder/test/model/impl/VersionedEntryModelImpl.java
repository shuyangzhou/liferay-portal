...
public class VersionedEntryModelImpl extends BaseModelImpl<VersionedEntry>
	...
	public static final String TABLE_SQL_CREATE = "create table VersionedEntry (mvccVersion LONG default 0 not null,entryId LONG not null primary key,groupId LONG,headId LONG)";
	public static final String TABLE_SQL_DROP = "drop table VersionedEntry";
	public static final String ORDER_BY_JPQL = " ORDER BY versionedEntry.entryId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY VersionedEntry.entryId ASC";
	...
	public Object clone() {
		...
		versionedEntryImpl.setEntryId(getEntryId());
	...
	public CacheModel<VersionedEntry> toCacheModel() {
		...
		versionedEntryCacheModel.entryId = getEntryId();
