...
public class LVEntryModelImpl extends BaseModelImpl<LVEntry>
	...
	public static final String TABLE_SQL_CREATE = "create table LVEntry (mvccVersion LONG default 0 not null,entryId LONG not null primary key,groupId LONG,headId LONG,defaultLanguageId VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table LVEntry";
	public static final String ORDER_BY_JPQL = " ORDER BY lvEntry.entryId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY LVEntry.entryId ASC";
	...
	public Object clone() {
		...
		lvEntryImpl.setEntryId(getEntryId());
	...
	public CacheModel<LVEntry> toCacheModel() {
		...
		lvEntryCacheModel.entryId = getEntryId();
