...
public class LVEntryLocalizationModelImpl extends BaseModelImpl<LVEntryLocalization>
	...
	public static final String TABLE_SQL_CREATE = "create table LVEntryLocalization (mvccVersion LONG default 0 not null,lvEntryLocalizationId LONG not null primary key,entryId LONG,languageId VARCHAR(75) null,title VARCHAR(75) null,content VARCHAR(75) null,headId LONG)";
	...
	public void populateVersionModel(
		...
		lvEntryLocalizationVersion.setEntryId(getEntryId());
	...
	public Object clone() {
		...
		lvEntryLocalizationImpl.setEntryId(getEntryId());
	...
	public void resetOriginalValues() {
		...
		lvEntryLocalizationModelImpl._originalEntryId = lvEntryLocalizationModelImpl._entryId;

		lvEntryLocalizationModelImpl._setOriginalEntryId = false;
	...
	public CacheModel<LVEntryLocalization> toCacheModel() {
		...
		lvEntryLocalizationCacheModel.entryId = getEntryId();
