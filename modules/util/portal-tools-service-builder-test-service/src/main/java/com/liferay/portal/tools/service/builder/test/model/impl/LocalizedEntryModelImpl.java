...
public class LocalizedEntryModelImpl extends BaseModelImpl<LocalizedEntry>
	...
	public static final String TABLE_SQL_CREATE = "create table LocalizedEntry (entryId LONG not null primary key,defaultLanguageId VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table LocalizedEntry";
	public static final String ORDER_BY_JPQL = " ORDER BY localizedEntry.entryId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY LocalizedEntry.entryId ASC";
	...
	public Object clone() {
		...
		localizedEntryImpl.setEntryId(getEntryId());
	...
	public CacheModel<LocalizedEntry> toCacheModel() {
		...
		localizedEntryCacheModel.entryId = getEntryId();
