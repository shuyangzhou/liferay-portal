...
public class LVEntryPersistenceImpl extends BasePersistenceImpl<LVEntry>
	...
	public LVEntry[] findByGroupId_PrevAndNext(long entryId, long groupId,
		OrderByComparator<LVEntry> orderByComparator)
		throws NoSuchLVEntryException {
		LVEntry lvEntry = findByPrimaryKey(entryId);
	...
	private static final String _SQL_SELECT_LVENTRY_WHERE_PKS_IN = "SELECT lvEntry FROM LVEntry lvEntry WHERE entryId IN (";
