...
public class LocalizedEntryLocalizationPersistenceImpl
	...
	public static final FinderPath FINDER_PATH_COUNT_ALL = new FinderPath(LocalizedEntryLocalizationModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[0]);
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_ENTRYID = new FinderPath(LocalizedEntryLocalizationModelImpl.ENTITY_CACHE_ENABLED,
			LocalizedEntryLocalizationModelImpl.FINDER_CACHE_ENABLED,
			LocalizedEntryLocalizationImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ENTRYID =
		new FinderPath(LocalizedEntryLocalizationModelImpl.ENTITY_CACHE_ENABLED,
			...
			LocalizedEntryLocalizationModelImpl.ENTRYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_ENTRYID = new FinderPath(LocalizedEntryLocalizationModelImpl.ENTITY_CACHE_ENABLED,
			LocalizedEntryLocalizationModelImpl.FINDER_CACHE_ENABLED,
	 ...
	 */
	@Override
	public List<LocalizedEntryLocalization> findByEntryId(long entryId) {
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (LocalizedEntryLocalization localizedEntryLocalization : list) {
					if ((entryId != localizedEntryLocalization.getEntryId())) {
						list = null;
	 ...
	 */
	@Override
	public LocalizedEntryLocalization findByEntryId_First(long entryId,
		OrderByComparator<LocalizedEntryLocalization> orderByComparator)
		throws NoSuchLocalizedEntryLocalizationException {
		LocalizedEntryLocalization localizedEntryLocalization = fetchByEntryId_First(entryId,
				orderByComparator);
	 ...
	 */
	@Override
	public LocalizedEntryLocalization fetchByEntryId_First(long entryId,
		OrderByComparator<LocalizedEntryLocalization> orderByComparator) {
		List<LocalizedEntryLocalization> list = findByEntryId(entryId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public LocalizedEntryLocalization findByEntryId_Last(long entryId,
		OrderByComparator<LocalizedEntryLocalization> orderByComparator)
		throws NoSuchLocalizedEntryLocalizationException {
		LocalizedEntryLocalization localizedEntryLocalization = fetchByEntryId_Last(entryId,
				orderByComparator);
	 ...
	 */
	@Override
	public LocalizedEntryLocalization fetchByEntryId_Last(long entryId,
		OrderByComparator<LocalizedEntryLocalization> orderByComparator) {
		...
		List<LocalizedEntryLocalization> list = findByEntryId(entryId,
	 ...
	 */
	@Override
	public LocalizedEntryLocalization[] findByEntryId_PrevAndNext(
		...
		try {
			...
			array[0] = getByEntryId_PrevAndNext(session,
					localizedEntryLocalization, entryId, orderByComparator, true);

			array[1] = localizedEntryLocalization;

			array[2] = getByEntryId_PrevAndNext(session,
					localizedEntryLocalization, entryId, orderByComparator,
					false);
	...
	protected LocalizedEntryLocalization getByEntryId_PrevAndNext(
	...
	public void removeByEntryId(long entryId) {
		for (LocalizedEntryLocalization localizedEntryLocalization : findByEntryId(
	...
	private static final String _FINDER_COLUMN_ENTRYID_ENTRYID_2 = "localizedEntryLocalization.entryId = ?";
	public static final FinderPath FINDER_PATH_FETCH_BY_ENTRYID_LANGUAGEID = new FinderPath(LocalizedEntryLocalizationModelImpl.ENTITY_CACHE_ENABLED,
			LocalizedEntryLocalizationModelImpl.FINDER_CACHE_ENABLED,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_ENTRYID_LANGUAGEID = new FinderPath(LocalizedEntryLocalizationModelImpl.ENTITY_CACHE_ENABLED,
			LocalizedEntryLocalizationModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
	 ...
	 */
	@Override
	public LocalizedEntryLocalization findByEntryId_LanguageId(long entryId,
		String languageId) throws NoSuchLocalizedEntryLocalizationException {
		LocalizedEntryLocalization localizedEntryLocalization = fetchByEntryId_LanguageId(entryId,
				languageId);
	 ...
	 */
	@Override
	public LocalizedEntryLocalization fetchByEntryId_LanguageId(long entryId,
		String languageId) {
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((localizedEntryLocalization.getEntryId() != entryId) ||
							(localizedEntryLocalization.getLanguageId() == null) ||
							!localizedEntryLocalization.getLanguageId()
														   .equals(languageId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_ENTRYID_LANGUAGEID,
							finderArgs, localizedEntryLocalization);
					}
				}
			}
			catch (Exception e) {
	 ...
	 */
	@Override
	public LocalizedEntryLocalization removeByEntryId_LanguageId(long entryId,
		String languageId) throws NoSuchLocalizedEntryLocalizationException {
		LocalizedEntryLocalization localizedEntryLocalization = findByEntryId_LanguageId(entryId,
				languageId);
	...
	private static final String _FINDER_COLUMN_ENTRYID_LANGUAGEID_ENTRYID_2 = "localizedEntryLocalization.entryId = ? AND ";
	private static final String _FINDER_COLUMN_ENTRYID_LANGUAGEID_LANGUAGEID_1 = "localizedEntryLocalization.languageId IS NULL";
	private static final String _FINDER_COLUMN_ENTRYID_LANGUAGEID_LANGUAGEID_2 = "localizedEntryLocalization.languageId = ?";
	private static final String _FINDER_COLUMN_ENTRYID_LANGUAGEID_LANGUAGEID_3 = "(localizedEntryLocalization.languageId IS NULL OR localizedEntryLocalization.languageId = '')";
	...
	public void cacheResult(
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_ENTRYID_LANGUAGEID,
			new Object[] {
				localizedEntryLocalization.getEntryId(),
				localizedEntryLocalization.getLanguageId()
			}, localizedEntryLocalization);
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
				localizedEntryLocalizationModelImpl.getEntryId(),
	...
	protected void clearUniqueFindersCache(
		...
		if ((localizedEntryLocalizationModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
					localizedEntryLocalizationModelImpl.getOriginalEntryId(),
