...
public abstract class LVEntryLocalServiceBaseImpl extends BaseLocalServiceImpl
	...
	public LVEntry deleteLVEntry(long entryId) {
		LVEntry lvEntry = lvEntryPersistence.fetchByPrimaryKey(entryId);
	...
	public LVEntry fetchLVEntry(long entryId) {
		return lvEntryPersistence.fetchByPrimaryKey(entryId);
	}
	...
	public LVEntry getLVEntry(long entryId) throws PortalException {
		return lvEntryPersistence.findByPrimaryKey(entryId);
	}
	...
	public LVEntryLocalization fetchLVEntryLocalization(long entryId,
		String languageId) {
		return lvEntryLocalizationPersistence.fetchByEntryId_LanguageId(entryId,
			languageId);
	}
	...
	public LVEntryLocalization getLVEntryLocalization(long entryId,
		...
		return lvEntryLocalizationPersistence.findByEntryId_LanguageId(entryId,
			languageId);
	}

	@Override
	public List<LVEntryLocalization> getLVEntryLocalizations(long entryId) {
		return lvEntryLocalizationPersistence.findByEntryId(entryId);
	}
	...
	public LVEntryLocalization updateLVEntryLocalization(LVEntry draftLVEntry,
		...
		LVEntryLocalization lvEntryLocalization = lvEntryLocalizationPersistence.fetchByEntryId_LanguageId(draftLVEntry.getEntryId(),
				languageId);
	...
	public List<LVEntryLocalization> updateLVEntryLocalizations(
		...
		for (LVEntryLocalization lvEntryLocalization : lvEntryLocalizationPersistence.findByEntryId(
				draftLVEntry.getEntryId())) {
		...
		for (Map.Entry<String, String[]> entry : localizedValuesMap.entrySet()) {
			...
			lvEntryLocalization.setEntryId(draftLVEntry.getEntryId());
	...
	public LVEntryVersion deleteVersion(LVEntryVersion lvEntryVersion)
		throws PortalException {
		LVEntryVersion latestLVEntryVersion = lvEntryVersionPersistence.findByEntryId_First(lvEntryVersion.getVersionedModelId(),
				null);
	...
	public LVEntryVersion fetchLatestVersion(LVEntry lvEntry) {
		...
		return lvEntryVersionPersistence.fetchByEntryId_First(primaryKey, null);
	}
	...
	public LVEntryVersion getVersion(LVEntry lvEntry, int version)
		...
		return lvEntryVersionPersistence.findByEntryId_Version(primaryKey,
			version);
	}
	...
	public List<LVEntryVersion> getVersions(LVEntry lvEntry) {
		...
		return lvEntryVersionPersistence.findByEntryId(primaryKey);
	}
	...
	public LVEntry publishDraft(LVEntry draftLVEntry) throws PortalException {
		...
		if (draftLVEntry.getHeadId() == draftLVEntry.getPrimaryKey()) {
			...
			LVEntryVersion latestLVEntryVersion = lvEntryVersionPersistence.findByEntryId_First(draftLVEntry.getHeadId(),
					null);
	...
	private class LVEntryLocalizationVersionServiceListener
		...
		public void afterCheckout(LVEntry draftLVEntry, int version)
			...
			for (LVEntryLocalization publishedLVEntryLocalization : lvEntryLocalizationPersistence.findByEntryId(
			...
			List<LVEntryLocalizationVersion> lvEntryLocalizationVersions = lvEntryLocalizationVersionPersistence.findByEntryId_Version(draftLVEntry.getHeadId(),
					version);
			...
			for (LVEntryLocalizationVersion lvEntryLocalizationVersion : lvEntryLocalizationVersions) {
				...
				draftLVEntryLocalization.setEntryId(draftLVEntry.getPrimaryKey());
		...
		public void afterDelete(LVEntry publishedLVEntry)
			throws PortalException {
			lvEntryLocalizationPersistence.removeByEntryId(publishedLVEntry.getPrimaryKey());
			lvEntryLocalizationVersionPersistence.removeByEntryId(publishedLVEntry.getPrimaryKey());
		}

		@Override
		public void afterDeleteDraft(LVEntry draftLVEntry)
			throws PortalException {
			lvEntryLocalizationPersistence.removeByEntryId(draftLVEntry.getPrimaryKey());
		}

		@Override
		public void afterDeleteVersion(LVEntryVersion lvEntryVersion)
			throws PortalException {
			lvEntryLocalizationVersionPersistence.removeByEntryId_Version(lvEntryVersion.getVersionedModelId(),
				lvEntryVersion.getVersion());
		}
		...
		public void afterPublishDraft(LVEntry draftLVEntry, int version)
			...
			for (LVEntryLocalization draftLVEntryLocalization : lvEntryLocalizationPersistence.findByEntryId(
					draftLVEntry.getPrimaryKey())) {
			...
			for (LVEntryLocalization draftLVEntryLocalization : draftLVEntryLocalizationMap.values()) {
				...
				lvEntryLocalization.setHeadId(lvEntryLocalization.getPrimaryKey());
				lvEntryLocalization.setEntryId(draftLVEntry.getHeadId());
