...
public class VersionedEntryPersistenceImpl extends BasePersistenceImpl<VersionedEntry>
	...
	protected VersionedEntry removeImpl(VersionedEntry versionedEntry) {
		versionedEntry = toUnwrappedModel(versionedEntry);
	...
	protected VersionedEntry toUnwrappedModel(VersionedEntry versionedEntry) {
		if (versionedEntry instanceof VersionedEntryImpl) {
			return versionedEntry;
		}

		VersionedEntryImpl versionedEntryImpl = new VersionedEntryImpl();

		versionedEntryImpl.setNew(versionedEntry.isNew());
		versionedEntryImpl.setPrimaryKey(versionedEntry.getPrimaryKey());

		versionedEntryImpl.setMvccVersion(versionedEntry.getMvccVersion());
		versionedEntryImpl.setVersionedEntryId(versionedEntry.getVersionedEntryId());
		versionedEntryImpl.setGroupId(versionedEntry.getGroupId());
		versionedEntryImpl.setHeadId(versionedEntry.getHeadId());
		versionedEntryImpl.setDefaultLanguageId(versionedEntry.getDefaultLanguageId());
