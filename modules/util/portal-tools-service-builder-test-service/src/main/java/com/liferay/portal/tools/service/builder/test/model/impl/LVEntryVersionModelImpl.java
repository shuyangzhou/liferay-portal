...
public class LVEntryVersionModelImpl extends BaseModelImpl<LVEntryVersion>
	...
	public static final String TABLE_SQL_CREATE = "create table LVEntryVersion (lvEntryVersionId LONG not null primary key,version INTEGER,entryId LONG,groupId LONG,defaultLanguageId VARCHAR(75) null)";
	...
	public Object clone() {
		...
		lvEntryVersionImpl.setEntryId(getEntryId());
	...
	public void resetOriginalValues() {
		...
		lvEntryVersionModelImpl._originalEntryId = lvEntryVersionModelImpl._entryId;

		lvEntryVersionModelImpl._setOriginalEntryId = false;
	...
	public CacheModel<LVEntryVersion> toCacheModel() {
		...
		lvEntryVersionCacheModel.entryId = getEntryId();
	...
	static {
		try {
			...
			_versionedModelMethodsMap.put(LVEntry.class.getMethod("getEntryId"),
				LVEntryVersion.class.getMethod("getEntryId"));
