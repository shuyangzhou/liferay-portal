...
public class LocalizedEntryLocalizationModelImpl extends BaseModelImpl<LocalizedEntryLocalization>
	...
	public static final String TABLE_SQL_CREATE = "create table LocalizedEntryLocalization (mvccVersion LONG default 0 not null,localizedEntryLocalizationId LONG not null primary key,entryId LONG,languageId VARCHAR(75) null,title VARCHAR(75) null,content VARCHAR(75) null)";
	...
	public Object clone() {
		...
		localizedEntryLocalizationImpl.setEntryId(getEntryId());
	...
	public void resetOriginalValues() {
		...
		localizedEntryLocalizationModelImpl._originalEntryId = localizedEntryLocalizationModelImpl._entryId;

		localizedEntryLocalizationModelImpl._setOriginalEntryId = false;
	...
	public CacheModel<LocalizedEntryLocalization> toCacheModel() {
		...
		localizedEntryLocalizationCacheModel.entryId = getEntryId();
