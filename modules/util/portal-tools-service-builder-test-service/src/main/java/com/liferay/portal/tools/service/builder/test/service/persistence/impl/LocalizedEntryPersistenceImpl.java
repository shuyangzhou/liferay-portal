...
public class LocalizedEntryPersistenceImpl extends BasePersistenceImpl<LocalizedEntry>
	 ...
	 */
	@Override
	public LocalizedEntry remove(long entryId)
	 ...
	 */
	@Override
	public LocalizedEntry findByPrimaryKey(long entryId)
		throws NoSuchLocalizedEntryException {
	 ...
	 */
	@Override
	public LocalizedEntry fetchByPrimaryKey(long entryId) {
	...
	private static final String _SQL_SELECT_LOCALIZEDENTRY_WHERE_PKS_IN = "SELECT localizedEntry FROM LocalizedEntry localizedEntry WHERE entryId IN (";
