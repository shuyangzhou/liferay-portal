...
public class VersionedEntryVersionModelImpl extends BaseModelImpl<VersionedEntryVersion>
	...
	public static final String TABLE_SQL_CREATE = "create table VersionedEntryVersion (versionedEntryVersionId LONG not null primary key,version INTEGER,entryId LONG,groupId LONG)";
	...
	public Object clone() {
		...
		versionedEntryVersionImpl.setEntryId(getEntryId());
	...
	public void resetOriginalValues() {
		...
		versionedEntryVersionModelImpl._originalEntryId = versionedEntryVersionModelImpl._entryId;

		versionedEntryVersionModelImpl._setOriginalEntryId = false;
	...
	public CacheModel<VersionedEntryVersion> toCacheModel() {
		...
		versionedEntryVersionCacheModel.entryId = getEntryId();
	...
	static {
		try {
			...
			_versionedModelMethodsMap.put(VersionedEntry.class.getMethod(
					"getEntryId"),
				VersionedEntryVersion.class.getMethod("getEntryId"));
