...
public class VersionedEntryVersionModelImpl extends BaseModelImpl<VersionedEntryVersion>
	...
	public static final String TABLE_SQL_CREATE = "create table VersionedEntryVersion (versionedEntryVersionId LONG not null primary key,version INTEGER,versionedEntryId LONG,groupId LONG,defaultLanguageId VARCHAR(75) null)";
	...
	public void populateVersionedModel(VersionedEntry versionedEntry) {
		...
		versionedEntry.setDefaultLanguageId(getDefaultLanguageId());
	}
	...
	public Object clone() {
		...
		versionedEntryVersionImpl.setDefaultLanguageId(getDefaultLanguageId());
	...
	public CacheModel<VersionedEntryVersion> toCacheModel() {
		...
		versionedEntryVersionCacheModel.defaultLanguageId = getDefaultLanguageId();

		String defaultLanguageId = versionedEntryVersionCacheModel.defaultLanguageId;

		if ((defaultLanguageId != null) && (defaultLanguageId.length() == 0)) {
			versionedEntryVersionCacheModel.defaultLanguageId = null;
		}
	...
	static {
		try {
			...
			_versionedModelMethodsMap.put(VersionedEntry.class.getMethod(
				...
				VersionedEntryVersion.class.getMethod("getDefaultLanguageId"));
		}
