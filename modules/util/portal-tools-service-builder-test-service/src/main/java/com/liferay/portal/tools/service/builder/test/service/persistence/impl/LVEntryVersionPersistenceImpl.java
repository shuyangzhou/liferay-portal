...
public class LVEntryVersionPersistenceImpl extends BasePersistenceImpl<LVEntryVersion>
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_ALL = new FinderPath(LVEntryVersionModelImpl.ENTITY_CACHE_ENABLED,
			LVEntryVersionModelImpl.FINDER_CACHE_ENABLED,
			LVEntryVersionImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_ALL = new FinderPath(LVEntryVersionModelImpl.ENTITY_CACHE_ENABLED,
			LVEntryVersionModelImpl.FINDER_CACHE_ENABLED,
			LVEntryVersionImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_COUNT_ALL = new FinderPath(LVEntryVersionModelImpl.ENTITY_CACHE_ENABLED,
			LVEntryVersionModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_ENTRYID = new FinderPath(LVEntryVersionModelImpl.ENTITY_CACHE_ENABLED,
			LVEntryVersionModelImpl.FINDER_CACHE_ENABLED,
			LVEntryVersionImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByEntryId",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ENTRYID =
		new FinderPath(LVEntryVersionModelImpl.ENTITY_CACHE_ENABLED,
			LVEntryVersionModelImpl.FINDER_CACHE_ENABLED,
			LVEntryVersionImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByEntryId",
			new String[] { Long.class.getName() },
			LVEntryVersionModelImpl.ENTRYID_COLUMN_BITMASK |
			LVEntryVersionModelImpl.VERSION_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_ENTRYID = new FinderPath(LVEntryVersionModelImpl.ENTITY_CACHE_ENABLED,
			LVEntryVersionModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<LVEntryVersion> findByEntryId(long entryId) {
	 ...
	 */
	@Override
	public List<LVEntryVersion> findByEntryId(long entryId, int start, int end) {
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (LVEntryVersion lvEntryVersion : list) {
					if ((entryId != lvEntryVersion.getEntryId())) {
						list = null;
	 ...
	 */
	@Override
	public LVEntryVersion findByEntryId_First(long entryId,
		OrderByComparator<LVEntryVersion> orderByComparator)
		throws NoSuchLVEntryVersionException {
		LVEntryVersion lvEntryVersion = fetchByEntryId_First(entryId,
				orderByComparator);
	 ...
	 */
	@Override
	public LVEntryVersion fetchByEntryId_First(long entryId,
		OrderByComparator<LVEntryVersion> orderByComparator) {
		List<LVEntryVersion> list = findByEntryId(entryId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public LVEntryVersion findByEntryId_Last(long entryId,
		OrderByComparator<LVEntryVersion> orderByComparator)
		throws NoSuchLVEntryVersionException {
		LVEntryVersion lvEntryVersion = fetchByEntryId_Last(entryId,
				orderByComparator);
	 ...
	 */
	@Override
	public LVEntryVersion fetchByEntryId_Last(long entryId,
		OrderByComparator<LVEntryVersion> orderByComparator) {
		...
		List<LVEntryVersion> list = findByEntryId(entryId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public LVEntryVersion[] findByEntryId_PrevAndNext(long lvEntryVersionId,
		long entryId, OrderByComparator<LVEntryVersion> orderByComparator)
		throws NoSuchLVEntryVersionException {
		...
		try {
			...
			array[0] = getByEntryId_PrevAndNext(session, lvEntryVersion,
					entryId, orderByComparator, true);

			array[1] = lvEntryVersion;

			array[2] = getByEntryId_PrevAndNext(session, lvEntryVersion,
	...
	protected LVEntryVersion getByEntryId_PrevAndNext(Session session,
		LVEntryVersion lvEntryVersion, long entryId,
	...
	public void removeByEntryId(long entryId) {
		for (LVEntryVersion lvEntryVersion : findByEntryId(entryId,
	...
	private static final String _FINDER_COLUMN_ENTRYID_ENTRYID_2 = "lvEntryVersion.entryId = ?";
	public static final FinderPath FINDER_PATH_FETCH_BY_ENTRYID_VERSION = new FinderPath(LVEntryVersionModelImpl.ENTITY_CACHE_ENABLED,
			LVEntryVersionModelImpl.FINDER_CACHE_ENABLED,
			...
			LVEntryVersionModelImpl.ENTRYID_COLUMN_BITMASK |
			LVEntryVersionModelImpl.VERSION_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_ENTRYID_VERSION = new FinderPath(LVEntryVersionModelImpl.ENTITY_CACHE_ENABLED,
			LVEntryVersionModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public LVEntryVersion findByEntryId_Version(long entryId, int version)
		throws NoSuchLVEntryVersionException {
		LVEntryVersion lvEntryVersion = fetchByEntryId_Version(entryId, version);
	 ...
	 */
	@Override
	public LVEntryVersion fetchByEntryId_Version(long entryId, int version) {
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((lvEntryVersion.getEntryId() != entryId) ||
							(lvEntryVersion.getVersion() != version)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_ENTRYID_VERSION,
							finderArgs, lvEntryVersion);
					}
				}
			}
			catch (Exception e) {
	 ...
	 */
	@Override
	public LVEntryVersion removeByEntryId_Version(long entryId, int version)
		throws NoSuchLVEntryVersionException {
		LVEntryVersion lvEntryVersion = findByEntryId_Version(entryId, version);
	...
	private static final String _FINDER_COLUMN_ENTRYID_VERSION_ENTRYID_2 = "lvEntryVersion.entryId = ? AND ";
	private static final String _FINDER_COLUMN_ENTRYID_VERSION_VERSION_2 = "lvEntryVersion.version = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPID = new FinderPath(LVEntryVersionModelImpl.ENTITY_CACHE_ENABLED,
			LVEntryVersionModelImpl.FINDER_CACHE_ENABLED,
			LVEntryVersionImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByGroupId",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPID =
		new FinderPath(LVEntryVersionModelImpl.ENTITY_CACHE_ENABLED,
			...
			LVEntryVersionModelImpl.VERSION_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPID = new FinderPath(LVEntryVersionModelImpl.ENTITY_CACHE_ENABLED,
			LVEntryVersionModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPID_VERSION =
		new FinderPath(LVEntryVersionModelImpl.ENTITY_CACHE_ENABLED,
			...
			LVEntryVersionModelImpl.GROUPID_COLUMN_BITMASK |
			LVEntryVersionModelImpl.VERSION_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPID_VERSION = new FinderPath(LVEntryVersionModelImpl.ENTITY_CACHE_ENABLED,
			LVEntryVersionModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
	...
	public void cacheResult(LVEntryVersion lvEntryVersion) {
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_ENTRYID_VERSION,
			new Object[] {
				lvEntryVersion.getEntryId(), lvEntryVersion.getVersion()
			}, lvEntryVersion);
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
				lvEntryVersionModelImpl.getEntryId(),
	...
	protected void clearUniqueFindersCache(
		...
		if ((lvEntryVersionModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
					lvEntryVersionModelImpl.getOriginalEntryId(),
	...
	public LVEntryVersion updateImpl(LVEntryVersion lvEntryVersion) {
		...
		if (!LVEntryVersionModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			Object[] args = new Object[] { lvEntryVersionModelImpl.getEntryId() };
			...
			if ((lvEntryVersionModelImpl.getColumnBitmask() &
				...
				args = new Object[] { lvEntryVersionModelImpl.getEntryId() };
