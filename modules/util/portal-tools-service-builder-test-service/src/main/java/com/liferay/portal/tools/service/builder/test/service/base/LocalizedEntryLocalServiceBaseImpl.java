...
public abstract class LocalizedEntryLocalServiceBaseImpl
	...
	public LocalizedEntry createLocalizedEntry(long entryId) {
		return localizedEntryPersistence.create(entryId);
	}
	...
	public LocalizedEntry deleteLocalizedEntry(long entryId)
		...
		return localizedEntryPersistence.remove(entryId);
	}
	...
	public LocalizedEntry fetchLocalizedEntry(long entryId) {
		return localizedEntryPersistence.fetchByPrimaryKey(entryId);
	}
	...
	public LocalizedEntry getLocalizedEntry(long entryId)
		throws PortalException {
		return localizedEntryPersistence.findByPrimaryKey(entryId);
	}
	...
	public LocalizedEntryLocalization fetchLocalizedEntryLocalization(
		...
		return localizedEntryLocalizationPersistence.fetchByEntryId_LanguageId(entryId,
			languageId);
	}
	...
	public LocalizedEntryLocalization getLocalizedEntryLocalization(
		...
		return localizedEntryLocalizationPersistence.findByEntryId_LanguageId(entryId,
			languageId);
	}
	...
	public List<LocalizedEntryLocalization> getLocalizedEntryLocalizations(
		long entryId) {
		return localizedEntryLocalizationPersistence.findByEntryId(entryId);
	}
	...
	public LocalizedEntryLocalization updateLocalizedEntryLocalization(
		...
		LocalizedEntryLocalization localizedEntryLocalization = localizedEntryLocalizationPersistence.fetchByEntryId_LanguageId(localizedEntry.getEntryId(),
				languageId);
	...
	public List<LocalizedEntryLocalization> updateLocalizedEntryLocalizations(
		...
		for (LocalizedEntryLocalization localizedEntryLocalization : localizedEntryLocalizationPersistence.findByEntryId(
				localizedEntry.getEntryId())) {
		...
		for (Map.Entry<String, String[]> entry : localizedValuesMap.entrySet()) {
			...
			localizedEntryLocalization.setEntryId(localizedEntry.getEntryId());
