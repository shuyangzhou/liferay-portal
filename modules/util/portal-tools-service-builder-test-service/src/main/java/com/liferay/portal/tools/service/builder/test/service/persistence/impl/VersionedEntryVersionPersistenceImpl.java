...
public class VersionedEntryVersionPersistenceImpl extends BasePersistenceImpl<VersionedEntryVersion>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_ENTRYID = new FinderPath(VersionedEntryVersionModelImpl.ENTITY_CACHE_ENABLED,
			VersionedEntryVersionModelImpl.FINDER_CACHE_ENABLED,
			VersionedEntryVersionImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ENTRYID =
		new FinderPath(VersionedEntryVersionModelImpl.ENTITY_CACHE_ENABLED,
			...
			VersionedEntryVersionModelImpl.ENTRYID_COLUMN_BITMASK |
			VersionedEntryVersionModelImpl.VERSION_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_ENTRYID = new FinderPath(VersionedEntryVersionModelImpl.ENTITY_CACHE_ENABLED,
			VersionedEntryVersionModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByEntryId",
			new String[] { Long.class.getName() });

	/**
	 * Returns all the versioned entry versions where entryId = &#63;.
	 *
	 * @param entryId the entry ID
	 * @return the matching versioned entry versions
	 */
	@Override
	public List<VersionedEntryVersion> findByEntryId(long entryId) {
		return findByEntryId(entryId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the versioned entry versions where entryId = &#63;.
	 *
	 * <p>
	 ...
	 */
	@Override
	public List<VersionedEntryVersion> findByEntryId(long entryId, int start,
		int end) {
		return findByEntryId(entryId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the versioned entry versions where entryId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link VersionedEntryVersionModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (VersionedEntryVersion versionedEntryVersion : list) {
					if ((entryId != versionedEntryVersion.getEntryId())) {
						list = null;
	...
	/**
	 * Returns the first versioned entry version in the ordered set where entryId = &#63;.
	 *
	 * @param entryId the entry ID
	 ...
	 */
	@Override
	public VersionedEntryVersion findByEntryId_First(long entryId,
		OrderByComparator<VersionedEntryVersion> orderByComparator)
		throws NoSuchVersionedEntryVersionException {
		VersionedEntryVersion versionedEntryVersion = fetchByEntryId_First(entryId,
				orderByComparator);
	 ...
	 */
	@Override
	public VersionedEntryVersion fetchByEntryId_First(long entryId,
		OrderByComparator<VersionedEntryVersion> orderByComparator) {
		List<VersionedEntryVersion> list = findByEntryId(entryId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last versioned entry version in the ordered set where entryId = &#63;.
	 *
	 * @param entryId the entry ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public VersionedEntryVersion findByEntryId_Last(long entryId,
		OrderByComparator<VersionedEntryVersion> orderByComparator)
		throws NoSuchVersionedEntryVersionException {
		VersionedEntryVersion versionedEntryVersion = fetchByEntryId_Last(entryId,
				orderByComparator);
	 ...
	 */
	@Override
	public VersionedEntryVersion fetchByEntryId_Last(long entryId,
		OrderByComparator<VersionedEntryVersion> orderByComparator) {
		...
		List<VersionedEntryVersion> list = findByEntryId(entryId, count - 1,
	...
	/**
	 * Returns the versioned entry versions before and after the current versioned entry version in the ordered set where entryId = &#63;.
	 *
	 ...
	 */
	@Override
	public VersionedEntryVersion[] findByEntryId_PrevAndNext(
		long versionedEntryVersionId, long entryId,
		OrderByComparator<VersionedEntryVersion> orderByComparator)
		throws NoSuchVersionedEntryVersionException {
		...
		try {
			...
			array[0] = getByEntryId_PrevAndNext(session, versionedEntryVersion,
					entryId, orderByComparator, true);

			array[1] = versionedEntryVersion;

			array[2] = getByEntryId_PrevAndNext(session, versionedEntryVersion,
	...
	protected VersionedEntryVersion getByEntryId_PrevAndNext(Session session,
		VersionedEntryVersion versionedEntryVersion, long entryId,
		OrderByComparator<VersionedEntryVersion> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the versioned entry versions where entryId = &#63; from the database.
	 *
	 * @param entryId the entry ID
	 */
	@Override
	public void removeByEntryId(long entryId) {
		for (VersionedEntryVersion versionedEntryVersion : findByEntryId(
	...
	/**
	 * Returns the number of versioned entry versions where entryId = &#63;.
	 *
	 * @param entryId the entry ID
	...
	private static final String _FINDER_COLUMN_ENTRYID_ENTRYID_2 = "versionedEntryVersion.entryId = ?";
	public static final FinderPath FINDER_PATH_FETCH_BY_ENTRYID_VERSION = new FinderPath(VersionedEntryVersionModelImpl.ENTITY_CACHE_ENABLED,
			VersionedEntryVersionModelImpl.FINDER_CACHE_ENABLED,
			VersionedEntryVersionImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByEntryId_Version",
			new String[] { Long.class.getName(), Integer.class.getName() },
			VersionedEntryVersionModelImpl.ENTRYID_COLUMN_BITMASK |
			VersionedEntryVersionModelImpl.VERSION_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_ENTRYID_VERSION = new FinderPath(VersionedEntryVersionModelImpl.ENTITY_CACHE_ENABLED,
			VersionedEntryVersionModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	/**
	 * Returns the versioned entry version where entryId = &#63; and version = &#63; or throws a {@link NoSuchVersionedEntryVersionException} if it could not be found.
	 *
	 * @param entryId the entry ID
	 ...
	 */
	@Override
	public VersionedEntryVersion findByEntryId_Version(long entryId, int version)
		throws NoSuchVersionedEntryVersionException {
		VersionedEntryVersion versionedEntryVersion = fetchByEntryId_Version(entryId,
				version);
	...
	/**
	 * Returns the versioned entry version where entryId = &#63; and version = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param entryId the entry ID
	 * @param version the version
	 ...
	 */
	@Override
	public VersionedEntryVersion fetchByEntryId_Version(long entryId,
		int version) {
		return fetchByEntryId_Version(entryId, version, true);
	}

	/**
	 * Returns the versioned entry version where entryId = &#63; and version = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param entryId the entry ID
	 * @param version the version
	 * @param retrieveFromCache whether to retrieve from the finder cache
	...
	public VersionedEntryVersion fetchByEntryId_Version(long entryId,
		...
		if (retrieveFromCache) {
			result = finderCache.getResult(FINDER_PATH_FETCH_BY_ENTRYID_VERSION,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					finderCache.putResult(FINDER_PATH_FETCH_BY_ENTRYID_VERSION,
						finderArgs, list);
				}
				else {
					...
					if ((versionedEntryVersion.getEntryId() != entryId) ||
							(versionedEntryVersion.getVersion() != version)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_ENTRYID_VERSION,
							finderArgs, versionedEntryVersion);
					}
				}
			}
			catch (Exception e) {
				finderCache.removeResult(FINDER_PATH_FETCH_BY_ENTRYID_VERSION,
					finderArgs);
	...
	/**
	 * Removes the versioned entry version where entryId = &#63; and version = &#63; from the database.
	 *
	 * @param entryId the entry ID
	 * @param version the version
	 ...
	 */
	@Override
	public VersionedEntryVersion removeByEntryId_Version(long entryId,
		int version) throws NoSuchVersionedEntryVersionException {
		VersionedEntryVersion versionedEntryVersion = findByEntryId_Version(entryId,
				version);
	...
	/**
	 * Returns the number of versioned entry versions where entryId = &#63; and version = &#63;.
	 *
	 * @param entryId the entry ID
	 * @param version the version
	 * @return the number of matching versioned entry versions
	...
	private static final String _FINDER_COLUMN_ENTRYID_VERSION_ENTRYID_2 = "versionedEntryVersion.entryId = ? AND ";
	private static final String _FINDER_COLUMN_ENTRYID_VERSION_VERSION_2 = "versionedEntryVersion.version = ?";
	...
	public void cacheResult(VersionedEntryVersion versionedEntryVersion) {
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_ENTRYID_VERSION,
			new Object[] {
				versionedEntryVersion.getEntryId(),
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
				versionedEntryVersionModelImpl.getEntryId(),
				versionedEntryVersionModelImpl.getVersion()
			};

		finderCache.putResult(FINDER_PATH_COUNT_BY_ENTRYID_VERSION, args,
			Long.valueOf(1), false);
		finderCache.putResult(FINDER_PATH_FETCH_BY_ENTRYID_VERSION, args,
	...
	protected void clearUniqueFindersCache(
		...
		if (clearCurrent) {
			...
			finderCache.removeResult(FINDER_PATH_FETCH_BY_ENTRYID_VERSION, args);
		}

		if ((versionedEntryVersionModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_ENTRYID_VERSION.getColumnBitmask()) != 0) {
			Object[] args = new Object[] {
					versionedEntryVersionModelImpl.getOriginalEntryId(),
		...
		if (!VersionedEntryVersionModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			if ((versionedEntryVersionModelImpl.getColumnBitmask() &
				...
				args = new Object[] { versionedEntryVersionModelImpl.getEntryId() };
