...
public class LVEntryLocalizationVersionModelImpl extends BaseModelImpl<LVEntryLocalizationVersion>
	...
	public static final String TABLE_SQL_CREATE = "create table LVEntryLocalizationVersion (lvEntryLocalizationVersionId LONG not null primary key,version INTEGER,lvEntryLocalizationId LONG,entryId LONG,languageId VARCHAR(75) null,title VARCHAR(75) null,content VARCHAR(75) null)";
	...
	public void populateVersionedModel(LVEntryLocalization lvEntryLocalization) {
		lvEntryLocalization.setEntryId(getEntryId());
	...
	public Object clone() {
		...
		lvEntryLocalizationVersionImpl.setEntryId(getEntryId());
	...
	public void resetOriginalValues() {
		...
		lvEntryLocalizationVersionModelImpl._originalEntryId = lvEntryLocalizationVersionModelImpl._entryId;

		lvEntryLocalizationVersionModelImpl._setOriginalEntryId = false;
	...
	public CacheModel<LVEntryLocalizationVersion> toCacheModel() {
		...
		lvEntryLocalizationVersionCacheModel.entryId = getEntryId();
	...
	static {
		try {
			...
			_versionedModelMethodsMap.put(LVEntryLocalization.class.getMethod(
					"getEntryId"),
				LVEntryLocalizationVersion.class.getMethod("getEntryId"));
