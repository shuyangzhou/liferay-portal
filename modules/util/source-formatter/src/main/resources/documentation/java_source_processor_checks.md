...
JavaServiceGetFetchCheck | [Bug Prevention](bug_prevention_checks.md#bug-prevention-checks) | Finds `get*` methods in `*ServiceImpl` that simply return a nullable `fetch*` result, contradicting the non-null promise of the `get` name. |
