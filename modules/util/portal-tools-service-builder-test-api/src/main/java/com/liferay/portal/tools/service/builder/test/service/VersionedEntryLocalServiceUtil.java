...
public class VersionedEntryLocalServiceUtil {
	...
	public static VersionedEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			VersionedEntryLocalServiceUtil::_getService);
	}

	private static VersionedEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			VersionedEntryLocalServiceUtil.class);
		...
		ServiceReference<VersionedEntryLocalService> serviceReference =
			bundleContext.getServiceReference(VersionedEntryLocalService.class);
	...
	private static final DCLSingleton<VersionedEntryLocalService>
