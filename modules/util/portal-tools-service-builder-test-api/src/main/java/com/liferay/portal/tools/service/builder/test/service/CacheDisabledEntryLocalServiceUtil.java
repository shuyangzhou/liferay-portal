...
public class CacheDisabledEntryLocalServiceUtil {
	...
	public static CacheDisabledEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CacheDisabledEntryLocalServiceUtil::_getService);
	}

	private static CacheDisabledEntryLocalService _getService() {
		...
		ServiceReference<CacheDisabledEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<CacheDisabledEntryLocalService>
