...
/**
 * The persistence utility for the localized entry localization service. This utility wraps {@link com.liferay.portal.tools.service.builder.test.service.persistence.impl.LocalizedEntryLocalizationPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class LocalizedEntryLocalizationUtil {
	...
	public static LocalizedEntryLocalization update(
		...
		return getPersistence()
				   .update(localizedEntryLocalization, serviceContext);
	}

	/**
	* Returns all the localized entry localizations where entryId = &#63;.
	*
	* @param entryId the entry ID
	* @return the matching localized entry localizations
	*/
	public static List<LocalizedEntryLocalization> findByEntryId(long entryId) {
		return getPersistence().findByEntryId(entryId);
	}

	/**
	* Returns a range of all the localized entry localizations where entryId = &#63;.
	*
	* <p>
	...
	*/
	...
	/**
	* Returns an ordered range of all the localized entry localizations where entryId = &#63;.
	*
	* <p>
	* Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link LocalizedEntryLocalizationModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	* </p>
	...
	*/
	...
	/**
	* Returns the first localized entry localization in the ordered set where entryId = &#63;.
	*
	* @param entryId the entry ID
	...
	*/
	public static LocalizedEntryLocalization findByEntryId_First(long entryId,
		OrderByComparator<LocalizedEntryLocalization> orderByComparator)
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchLocalizedEntryLocalizationException {
	...
	*/
	public static LocalizedEntryLocalization fetchByEntryId_First(
		long entryId,
		OrderByComparator<LocalizedEntryLocalization> orderByComparator) {
	...
	/**
	* Returns the last localized entry localization in the ordered set where entryId = &#63;.
	*
	* @param entryId the entry ID
	* @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	* @throws NoSuchLocalizedEntryLocalizationException if a matching localized entry localization could not be found
	*/
	public static LocalizedEntryLocalization findByEntryId_Last(long entryId,
		OrderByComparator<LocalizedEntryLocalization> orderByComparator)
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchLocalizedEntryLocalizationException {
	...
	*/
	public static LocalizedEntryLocalization fetchByEntryId_Last(long entryId,
		OrderByComparator<LocalizedEntryLocalization> orderByComparator) {
		return getPersistence().fetchByEntryId_Last(entryId, orderByComparator);
	}

	/**
	* Returns the localized entry localizations before and after the current localized entry localization in the ordered set where entryId = &#63;.
	*
	...
	*/
	public static LocalizedEntryLocalization[] findByEntryId_PrevAndNext(
		long localizedEntryLocalizationId, long entryId,
		OrderByComparator<LocalizedEntryLocalization> orderByComparator)
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchLocalizedEntryLocalizationException {
		return getPersistence()
				   .findByEntryId_PrevAndNext(localizedEntryLocalizationId,
			entryId, orderByComparator);
	}

	/**
	* Removes all the localized entry localizations where entryId = &#63; from the database.
	*
	* @param entryId the entry ID
	*/
	...
	/**
	* Returns the number of localized entry localizations where entryId = &#63;.
	*
	* @param entryId the entry ID
	...
	*/
	...
	/**
	* Returns the localized entry localization where entryId = &#63; and languageId = &#63; or throws a {@link NoSuchLocalizedEntryLocalizationException} if it could not be found.
	*
	* @param entryId the entry ID
	...
	* @throws NoSuchLocalizedEntryLocalizationException if a matching localized entry localization could not be found
	*/
	public static LocalizedEntryLocalization findByEntryId_LanguageId(
	...
	/**
	* Returns the localized entry localization where entryId = &#63; and languageId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	*
	* @param entryId the entry ID
	* @param languageId the language ID
	...
	*/
	public static LocalizedEntryLocalization fetchByEntryId_LanguageId(
		long entryId, String languageId) {
		return getPersistence().fetchByEntryId_LanguageId(entryId, languageId);
	}

	/**
	* Returns the localized entry localization where entryId = &#63; and languageId = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	*
	* @param entryId the entry ID
	* @param languageId the language ID
	* @param retrieveFromCache whether to retrieve from the finder cache
	...
	*/
	public static LocalizedEntryLocalization fetchByEntryId_LanguageId(
		long entryId, String languageId, boolean retrieveFromCache) {
		return getPersistence()
	...
	/**
	* Removes the localized entry localization where entryId = &#63; and languageId = &#63; from the database.
	*
	* @param entryId the entry ID
	* @param languageId the language ID
	* @return the localized entry localization that was removed
	*/
	public static LocalizedEntryLocalization removeByEntryId_LanguageId(
		long entryId, String languageId)
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchLocalizedEntryLocalizationException {
	...
	/**
	* Returns the number of localized entry localizations where entryId = &#63; and languageId = &#63;.
	*
	* @param entryId the entry ID
	* @param languageId the language ID
	* @return the number of matching localized entry localizations
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, LocalizedEntryLocalization> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<LocalizedEntryLocalizationPersistence, LocalizedEntryLocalizationPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(LocalizedEntryLocalizationPersistence.class);

		ServiceTracker<LocalizedEntryLocalizationPersistence, LocalizedEntryLocalizationPersistence> serviceTracker =
			new ServiceTracker<LocalizedEntryLocalizationPersistence, LocalizedEntryLocalizationPersistence>(bundle.getBundleContext(),
