...
public class LocalizedEntryLocalizationWrapper
	...
	*/
	...
	/**
	* Returns the entry ID of this localized entry localization.
	*
	* @return the entry ID of this localized entry localization
	*/
	@Override
	public long getEntryId() {
		return _localizedEntryLocalization.getEntryId();
	}
	...
	*/
	...
	/**
	* Sets the entry ID of this localized entry localization.
	*
	* @param entryId the entry ID of this localized entry localization
	*/
	@Override
	public void setEntryId(long entryId) {
		_localizedEntryLocalization.setEntryId(entryId);
	}
