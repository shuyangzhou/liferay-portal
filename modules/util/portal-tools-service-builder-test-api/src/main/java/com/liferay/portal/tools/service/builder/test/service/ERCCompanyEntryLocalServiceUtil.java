...
public class ERCCompanyEntryLocalServiceUtil {
	...
	public static ERCCompanyEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ERCCompanyEntryLocalServiceUtil::_getService);
	}

	private static ERCCompanyEntryLocalService _getService() {
		...
		ServiceReference<ERCCompanyEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<ERCCompanyEntryLocalService>
