...
public class VersionedEntryVersionWrapper implements VersionedEntryVersion,
	...
	/**
	* Returns the entry ID of this versioned entry version.
	*
	* @return the entry ID of this versioned entry version
	*/
	@Override
	public long getEntryId() {
		return _versionedEntryVersion.getEntryId();
	}
	...
	*/
	...
	/**
	* Sets the entry ID of this versioned entry version.
	*
	* @param entryId the entry ID of this versioned entry version
	*/
	@Override
	public void setEntryId(long entryId) {
		_versionedEntryVersion.setEntryId(entryId);
	}
