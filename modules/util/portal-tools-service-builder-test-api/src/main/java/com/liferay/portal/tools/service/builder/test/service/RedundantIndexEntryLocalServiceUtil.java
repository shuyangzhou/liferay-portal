...
public class RedundantIndexEntryLocalServiceUtil {
	...
	public static RedundantIndexEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			RedundantIndexEntryLocalServiceUtil::_getService);
	}

	private static RedundantIndexEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			RedundantIndexEntryLocalServiceUtil.class);
		...
		ServiceReference<RedundantIndexEntryLocalService> serviceReference =
			bundleContext.getServiceReference(
				RedundantIndexEntryLocalService.class);
	...
	private static final DCLSingleton<RedundantIndexEntryLocalService>
