...
public class LVEntryLocalServiceUtil {
	...
	public static LVEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			LVEntryLocalServiceUtil::_getService);
	}

	private static LVEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(LVEntryLocalServiceUtil.class);
		...
		ServiceReference<LVEntryLocalService> serviceReference =
			bundleContext.getServiceReference(LVEntryLocalService.class);
	...
	private static final DCLSingleton<LVEntryLocalService>
