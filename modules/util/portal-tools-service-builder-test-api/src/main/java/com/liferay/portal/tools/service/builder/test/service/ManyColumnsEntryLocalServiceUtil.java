...
public class ManyColumnsEntryLocalServiceUtil {
	...
	public static ManyColumnsEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ManyColumnsEntryLocalServiceUtil::_getService);
	}

	private static ManyColumnsEntryLocalService _getService() {
		...
		ServiceReference<ManyColumnsEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<ManyColumnsEntryLocalService>
