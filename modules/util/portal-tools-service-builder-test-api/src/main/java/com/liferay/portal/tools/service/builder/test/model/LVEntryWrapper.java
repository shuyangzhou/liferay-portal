...
public class LVEntryWrapper implements LVEntry, ModelWrapper<LVEntry> {
	...
	*/
	...
	/**
	* Returns the entry ID of this lv entry.
	*
	* @return the entry ID of this lv entry
	*/
	@Override
	public long getEntryId() {
		return _lvEntry.getEntryId();
	}
	...
	*/
	...
	/**
	* Sets the entry ID of this lv entry.
	*
	* @param entryId the entry ID of this lv entry
	*/
	@Override
	public void setEntryId(long entryId) {
		_lvEntry.setEntryId(entryId);
	}
