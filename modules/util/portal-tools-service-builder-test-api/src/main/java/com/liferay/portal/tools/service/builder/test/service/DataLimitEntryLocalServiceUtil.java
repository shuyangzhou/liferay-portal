...
public class DataLimitEntryLocalServiceUtil {
	...
	public static DataLimitEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DataLimitEntryLocalServiceUtil::_getService);
	}

	private static DataLimitEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			DataLimitEntryLocalServiceUtil.class);
		...
		ServiceReference<DataLimitEntryLocalService> serviceReference =
			bundleContext.getServiceReference(DataLimitEntryLocalService.class);
	...
	private static final DCLSingleton<DataLimitEntryLocalService>
