...
public class VersionedEntryUtil {
	...
	*/
	public static VersionedEntry[] findByGroupId_PrevAndNext(long entryId,
	...
	*/
	public static VersionedEntry create(long entryId) {
	...
	* @throws NoSuchVersionedEntryException if a versioned entry with the primary key could not be found
	*/
	public static VersionedEntry remove(long entryId)
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchVersionedEntryException {
	...
	* @throws NoSuchVersionedEntryException if a versioned entry with the primary key could not be found
	*/
	public static VersionedEntry findByPrimaryKey(long entryId)
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchVersionedEntryException {
	...
	*/
	public static VersionedEntry fetchByPrimaryKey(long entryId) {
