...
public class LocalizedEntryLocalServiceWrapper
	...
	*/
	@Override
	public com.liferay.portal.tools.service.builder.test.model.LocalizedEntry addLocalizedEntry(
	...
	*/
	@Override
	public com.liferay.portal.tools.service.builder.test.model.LocalizedEntry createLocalizedEntry(
		long entryId) {
		return _localizedEntryLocalService.createLocalizedEntry(entryId);
	}
	...
	*/
	@Override
	public com.liferay.portal.tools.service.builder.test.model.LocalizedEntry deleteLocalizedEntry(
		com.liferay.portal.tools.service.builder.test.model.LocalizedEntry localizedEntry) {
	...
	*/
	...
	public com.liferay.portal.tools.service.builder.test.model.LocalizedEntry deleteLocalizedEntry(
		...
		return _localizedEntryLocalService.deleteLocalizedEntry(entryId);
	}
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		int end) {
		return _localizedEntryLocalService.dynamicQuery(dynamicQuery, start, end);
	}
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		return _localizedEntryLocalService.dynamicQuery(dynamicQuery, start,
	...
	*/
	...
	@Override
	public com.liferay.portal.tools.service.builder.test.model.LocalizedEntry fetchLocalizedEntry(
		long entryId) {
		return _localizedEntryLocalService.fetchLocalizedEntry(entryId);
	}

	@Override
	public com.liferay.portal.tools.service.builder.test.model.LocalizedEntryLocalization fetchLocalizedEntryLocalization(
		long entryId, String languageId) {
		return _localizedEntryLocalService.fetchLocalizedEntryLocalization(entryId,
			languageId);
	}
	...
	*/
	@Override
	public java.util.List<com.liferay.portal.tools.service.builder.test.model.LocalizedEntry> getLocalizedEntries(
		int start, int end) {
	...
	*/
	@Override
	public com.liferay.portal.tools.service.builder.test.model.LocalizedEntry getLocalizedEntry(
		long entryId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _localizedEntryLocalService.getLocalizedEntry(entryId);
	}

	@Override
	public com.liferay.portal.tools.service.builder.test.model.LocalizedEntryLocalization getLocalizedEntryLocalization(
		long entryId, String languageId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _localizedEntryLocalService.getLocalizedEntryLocalization(entryId,
			languageId);
	}

	@Override
	public java.util.List<com.liferay.portal.tools.service.builder.test.model.LocalizedEntryLocalization> getLocalizedEntryLocalizations(
		long entryId) {
		return _localizedEntryLocalService.getLocalizedEntryLocalizations(entryId);
	}
	...
	*/
	@Override
	public com.liferay.portal.tools.service.builder.test.model.LocalizedEntry updateLocalizedEntry(
		com.liferay.portal.tools.service.builder.test.model.LocalizedEntry localizedEntry) {
		return _localizedEntryLocalService.updateLocalizedEntry(localizedEntry);
	}

	@Override
	public com.liferay.portal.tools.service.builder.test.model.LocalizedEntryLocalization updateLocalizedEntryLocalization(
		com.liferay.portal.tools.service.builder.test.model.LocalizedEntry localizedEntry,
		String languageId, String title, String content)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _localizedEntryLocalService.updateLocalizedEntryLocalization(localizedEntry,
			languageId, title, content);
	}

	@Override
	public java.util.List<com.liferay.portal.tools.service.builder.test.model.LocalizedEntryLocalization> updateLocalizedEntryLocalizations(
		com.liferay.portal.tools.service.builder.test.model.LocalizedEntry localizedEntry,
		java.util.Map<String, String> titleMap,
		java.util.Map<String, String> contentMap)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _localizedEntryLocalService.updateLocalizedEntryLocalizations(localizedEntry,
			titleMap, contentMap);
	}
