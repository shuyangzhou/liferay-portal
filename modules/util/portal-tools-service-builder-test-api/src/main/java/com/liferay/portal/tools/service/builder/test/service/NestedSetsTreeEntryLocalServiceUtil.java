...
public class NestedSetsTreeEntryLocalServiceUtil {
	...
	public static NestedSetsTreeEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			NestedSetsTreeEntryLocalServiceUtil::_getService);
	}

	private static NestedSetsTreeEntryLocalService _getService() {
		...
		ServiceReference<NestedSetsTreeEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<NestedSetsTreeEntryLocalService>
