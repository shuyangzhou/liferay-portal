...
public class UADPartialEntryLocalServiceUtil {
	...
	public static UADPartialEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			UADPartialEntryLocalServiceUtil::_getService);
	}

	private static UADPartialEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			UADPartialEntryLocalServiceUtil.class);
		...
		ServiceReference<UADPartialEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<UADPartialEntryLocalService>
