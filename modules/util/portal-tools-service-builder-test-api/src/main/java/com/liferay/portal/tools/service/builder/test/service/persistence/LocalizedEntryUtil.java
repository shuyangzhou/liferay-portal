...
/**
 * The persistence utility for the localized entry service. This utility wraps {@link com.liferay.portal.tools.service.builder.test.service.persistence.impl.LocalizedEntryPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class LocalizedEntryUtil {
	...
	*/
	public static LocalizedEntry create(long entryId) {
	...
	*/
	public static LocalizedEntry remove(long entryId)
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchLocalizedEntryException {
	...
	* @throws NoSuchLocalizedEntryException if a localized entry with the primary key could not be found
	*/
	public static LocalizedEntry findByPrimaryKey(long entryId)
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchLocalizedEntryException {
	...
	*/
	public static LocalizedEntry fetchByPrimaryKey(long entryId) {
		return getPersistence().fetchByPrimaryKey(entryId);
	}

	public static java.util.Map<java.io.Serializable, LocalizedEntry> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<LocalizedEntryPersistence, LocalizedEntryPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(LocalizedEntryPersistence.class);

		ServiceTracker<LocalizedEntryPersistence, LocalizedEntryPersistence> serviceTracker =
			new ServiceTracker<LocalizedEntryPersistence, LocalizedEntryPersistence>(bundle.getBundleContext(),
