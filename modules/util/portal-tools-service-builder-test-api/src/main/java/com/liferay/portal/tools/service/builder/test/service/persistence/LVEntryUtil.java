...
public class LVEntryUtil {
	...
	*/
	public static LVEntry[] findByGroupId_PrevAndNext(long entryId,
	...
	*/
	public static LVEntry create(long entryId) {
	...
	* @throws NoSuchLVEntryException if a lv entry with the primary key could not be found
	*/
	public static LVEntry remove(long entryId)
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchLVEntryException {
	...
	* @throws NoSuchLVEntryException if a lv entry with the primary key could not be found
	*/
	public static LVEntry findByPrimaryKey(long entryId)
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchLVEntryException {
	...
	*/
	public static LVEntry fetchByPrimaryKey(long entryId) {
