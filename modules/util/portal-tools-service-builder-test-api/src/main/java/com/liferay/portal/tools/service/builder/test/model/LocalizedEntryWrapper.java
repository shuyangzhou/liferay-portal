...
public class LocalizedEntryWrapper implements LocalizedEntry,
	...
	*/
	...
	/**
	* Returns the entry ID of this localized entry.
	*
	* @return the entry ID of this localized entry
	*/
	@Override
	public long getEntryId() {
		return _localizedEntry.getEntryId();
	}
	...
	*/
	...
	/**
	* Sets the entry ID of this localized entry.
	*
	* @param entryId the entry ID of this localized entry
	*/
	@Override
	public void setEntryId(long entryId) {
		_localizedEntry.setEntryId(entryId);
	}
