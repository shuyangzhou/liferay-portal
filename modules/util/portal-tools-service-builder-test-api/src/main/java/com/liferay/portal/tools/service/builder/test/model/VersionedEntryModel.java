...
public interface VersionedEntryModel extends BaseModel<VersionedEntry>, MVCCModel,
	...
	/**
	 * Returns the default language ID of this versioned entry.
	 *
	 * @return the default language ID of this versioned entry
	 */
	@AutoEscape
	public String getDefaultLanguageId();

	/**
	 * Sets the default language ID of this versioned entry.
	 *
	 * @param defaultLanguageId the default language ID of this versioned entry
	 */
