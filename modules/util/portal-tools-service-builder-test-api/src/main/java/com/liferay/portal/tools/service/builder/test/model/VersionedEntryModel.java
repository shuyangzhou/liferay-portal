...
public interface VersionedEntryModel extends BaseModel<VersionedEntry>, MVCCModel,
	...
	/**
	 * Returns the entry ID of this versioned entry.
	 *
	 * @return the entry ID of this versioned entry
	 */
	public long getEntryId();

	/**
	 * Sets the entry ID of this versioned entry.
	 *
	 * @param entryId the entry ID of this versioned entry
	 */
