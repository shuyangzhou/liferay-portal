...
public class RenameFinderColumnEntryLocalServiceUtil {
	...
	public static RenameFinderColumnEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			RenameFinderColumnEntryLocalServiceUtil::_getService);
	}

	private static RenameFinderColumnEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			RenameFinderColumnEntryLocalServiceUtil.class);
		...
		ServiceReference<RenameFinderColumnEntryLocalService> serviceReference =
			bundleContext.getServiceReference(
				RenameFinderColumnEntryLocalService.class);
	...
	private static final DCLSingleton<RenameFinderColumnEntryLocalService>
