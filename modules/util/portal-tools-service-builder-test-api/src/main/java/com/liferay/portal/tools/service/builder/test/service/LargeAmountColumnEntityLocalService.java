...
/**
 * Provides the local service interface for LargeAmountColumnEntity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LargeAmountColumnEntityLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LargeAmountColumnEntityLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.portal.tools.service.builder.test.service.impl.LargeAmountColumnEntityLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the large amount column entity local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link LargeAmountColumnEntityLocalServiceUtil} if injection and service tracking are not available.
	 */
