...
/**
 * This class is used by SOAP remote services, specifically {@link com.liferay.portal.tools.service.builder.test.service.http.LargeAmountColumnEntityServiceSoap}.
 *
 ...
 */
@Deprecated
public class LargeAmountColumnEntitySoap implements Serializable {

	public static LargeAmountColumnEntitySoap toSoapModel(
		LargeAmountColumnEntity model) {

		LargeAmountColumnEntitySoap soapModel =
			new LargeAmountColumnEntitySoap();

		soapModel.setLargeAmountColumnEntityId(
			model.getLargeAmountColumnEntityId());
	...
	public static LargeAmountColumnEntitySoap[] toSoapModels(
		LargeAmountColumnEntity[] models) {

		LargeAmountColumnEntitySoap[] soapModels =
			new LargeAmountColumnEntitySoap[models.length];
	...
	public static LargeAmountColumnEntitySoap[][] toSoapModels(
		...
		LargeAmountColumnEntitySoap[][] soapModels = null;
		...
		if (models.length > 0) {
			...
			soapModels = new LargeAmountColumnEntitySoap[0][0];
		}
	...
	public static LargeAmountColumnEntitySoap[] toSoapModels(
		...
		List<LargeAmountColumnEntitySoap> soapModels =
			new ArrayList<LargeAmountColumnEntitySoap>(models.size());

		for (LargeAmountColumnEntity model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(
			new LargeAmountColumnEntitySoap[soapModels.size()]);
	}

	public LargeAmountColumnEntitySoap() {
	}
	...
	public void setPrimaryKey(long pk) {
		setLargeAmountColumnEntityId(pk);
	}
