...
public class LVEntryLocalizationVersionWrapper
	...
	*/
	...
	/**
	* Returns the entry ID of this lv entry localization version.
	*
	* @return the entry ID of this lv entry localization version
	*/
	@Override
	public long getEntryId() {
		return _lvEntryLocalizationVersion.getEntryId();
	}
	...
	*/
	...
	/**
	* Sets the entry ID of this lv entry localization version.
	*
	* @param entryId the entry ID of this lv entry localization version
	*/
	@Override
	public void setEntryId(long entryId) {
		_lvEntryLocalizationVersion.setEntryId(entryId);
	}
