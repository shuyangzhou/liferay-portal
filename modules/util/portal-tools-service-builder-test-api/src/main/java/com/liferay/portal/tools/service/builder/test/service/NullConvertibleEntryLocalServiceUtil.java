...
public class NullConvertibleEntryLocalServiceUtil {
	...
	public static NullConvertibleEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			NullConvertibleEntryLocalServiceUtil::_getService);
	}

	private static NullConvertibleEntryLocalService _getService() {
		...
		ServiceReference<NullConvertibleEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<NullConvertibleEntryLocalService>
