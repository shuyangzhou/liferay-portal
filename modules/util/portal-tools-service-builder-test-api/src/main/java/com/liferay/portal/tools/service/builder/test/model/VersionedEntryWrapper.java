...
public class VersionedEntryWrapper implements VersionedEntry,
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<VersionedEntry, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<VersionedEntry, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<VersionedEntry, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<VersionedEntry, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<VersionedEntry, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
