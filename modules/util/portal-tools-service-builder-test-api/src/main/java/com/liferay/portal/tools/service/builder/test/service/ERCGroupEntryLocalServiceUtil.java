...
public class ERCGroupEntryLocalServiceUtil {
	...
	public static ERCGroupEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ERCGroupEntryLocalServiceUtil::_getService);
	}

	private static ERCGroupEntryLocalService _getService() {
		...
		ServiceReference<ERCGroupEntryLocalService> serviceReference =
			bundleContext.getServiceReference(ERCGroupEntryLocalService.class);
	...
	private static final DCLSingleton<ERCGroupEntryLocalService>
