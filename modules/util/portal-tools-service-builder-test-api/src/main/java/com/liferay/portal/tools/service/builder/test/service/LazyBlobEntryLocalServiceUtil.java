...
public class LazyBlobEntryLocalServiceUtil {
	...
	public static LazyBlobEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			LazyBlobEntryLocalServiceUtil::_getService);
	}

	private static LazyBlobEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			LazyBlobEntryLocalServiceUtil.class);
		...
		ServiceReference<LazyBlobEntryLocalService> serviceReference =
			bundleContext.getServiceReference(LazyBlobEntryLocalService.class);
	...
	private static final DCLSingleton<LazyBlobEntryLocalService>
