...
public interface LVEntryLocalizationVersionPersistence extends BasePersistence<LVEntryLocalizationVersion> {
	...
	* @return the matching lv entry localization versions
	*/
	public java.util.List<LVEntryLocalizationVersion> findByEntryId(
		long entryId);
	...
	* @return the matching lv entry localization versions
	*/
	public java.util.List<LVEntryLocalizationVersion> findByEntryId_Version(
	...
	* @return the matching lv entry localization versions
	*/
	public java.util.List<LVEntryLocalizationVersion> findByEntryId_LanguageId(
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, LVEntryLocalizationVersion> fetchByPrimaryKeys(
