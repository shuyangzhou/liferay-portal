...
public class DSLQueryEntryLocalServiceUtil {
	...
	public static DSLQueryEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DSLQueryEntryLocalServiceUtil::_getService);
	}

	private static DSLQueryEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			DSLQueryEntryLocalServiceUtil.class);
		...
		ServiceReference<DSLQueryEntryLocalService> serviceReference =
			bundleContext.getServiceReference(DSLQueryEntryLocalService.class);
	...
	private static final DCLSingleton<DSLQueryEntryLocalService>
