...
public class EagerBlobEntryServiceUtil {
	...
	public static EagerBlobEntryService getService() {
		return _serviceDCLSingleton.getSingleton(
			EagerBlobEntryServiceUtil::_getService);
	}

	private static EagerBlobEntryService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			EagerBlobEntryServiceUtil.class);
		...
		ServiceReference<EagerBlobEntryService> serviceReference =
			bundleContext.getServiceReference(EagerBlobEntryService.class);
	...
	private static final DCLSingleton<EagerBlobEntryService>
