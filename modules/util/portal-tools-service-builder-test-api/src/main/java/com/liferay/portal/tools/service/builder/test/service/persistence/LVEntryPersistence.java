...
public interface LVEntryPersistence extends BasePersistence<LVEntry> {
	...
	*
	* @param entryId the primary key of the current lv entry
	* @param groupId the group ID
	* @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	*/
	public LVEntry[] findByGroupId_PrevAndNext(long entryId, long groupId,
		com.liferay.portal.kernel.util.OrderByComparator<LVEntry> orderByComparator)
		throws NoSuchLVEntryException;
	...
	*
	* @param entryId the primary key for the new lv entry
	* @return the new lv entry
	*/
	public LVEntry create(long entryId);
	...
	* @throws NoSuchLVEntryException if a lv entry with the primary key could not be found
	*/
	public LVEntry remove(long entryId) throws NoSuchLVEntryException;
	...
	* @throws NoSuchLVEntryException if a lv entry with the primary key could not be found
	*/
	public LVEntry findByPrimaryKey(long entryId) throws NoSuchLVEntryException;
	...
	*/
	public LVEntry fetchByPrimaryKey(long entryId);
