...
public class LazyBlobEntryServiceUtil {
	...
	public static LazyBlobEntryService getService() {
		return _serviceDCLSingleton.getSingleton(
			LazyBlobEntryServiceUtil::_getService);
	}

	private static LazyBlobEntryService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(LazyBlobEntryServiceUtil.class);
	...
	private static final DCLSingleton<LazyBlobEntryService>
