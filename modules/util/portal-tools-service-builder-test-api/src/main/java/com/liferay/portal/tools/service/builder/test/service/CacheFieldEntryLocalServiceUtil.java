...
public class CacheFieldEntryLocalServiceUtil {
	...
	public static CacheFieldEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CacheFieldEntryLocalServiceUtil::_getService);
	}

	private static CacheFieldEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			CacheFieldEntryLocalServiceUtil.class);
		...
		ServiceReference<CacheFieldEntryLocalService> serviceReference =
			bundleContext.getServiceReference(
				CacheFieldEntryLocalService.class);
	...
	private static final DCLSingleton<CacheFieldEntryLocalService>
