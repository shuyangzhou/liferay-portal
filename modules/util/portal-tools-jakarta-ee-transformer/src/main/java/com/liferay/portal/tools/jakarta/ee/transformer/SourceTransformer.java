	...
	private static void _generateThirdPartyPathModules() throws Exception {
		...
		for (Map.Entry<String, String> entry : _libMappings.entrySet()) {
			...
			if (Objects.equals(
				...
				sb.append("jarTransformed {\n\tfinalizedBy updateSPIFile\n}\n");
				sb.append("\nupdateSPIFile {\n\tfrom {\n\t\t");
				sb.append("zipTree(jar.archivePath)\n\t}\n\t");
				sb.append("rename(\"javax.ws.rs.sse.SseEventSource.Builder\"");
				sb.append(", \"jakarta.ws.rs.sse.SseEventSource.Builder\")\n");
				sb.append("\n\tdoLast {\n\t\t");
				sb.append("archivePath.renameTo(jar.archivePath)\n\t}\n}");
			}
