...
import ${servicePackagePath}.model.${entity.name}Model;
import ${servicePackagePath}.model.${entity.name}Soap;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link ${servicePackagePath}.model.${entity.name}Model} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ${entity.name}Impl}.
 * </p>
 *
 * @author ${author}
 * @see ${entity.name}Impl
 * @see ${servicePackagePath}.model.${entity.name}
 * @see ${servicePackagePath}.model.${entity.name}Model
<#if classDeprecated>
...
public class ${entity.name}ModelImpl extends BaseModelImpl<${entity.name}> implements ${entity.name}Model {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a ${entity.humanName} model instance should use the {@link ${servicePackagePath}.model.${entity.name}} interface instead.
	 */
	...
	<#compress>
		public static final Object[][] TABLE_COLUMNS = {
			<#list entity.getRegularColList() as column>
				<#assign sqlType = serviceBuilder.getSqlType(servicePackagePath + ".model." + entity.getName(), column.getName(), column.getType())>
	...
	public String toXmlString() {
		...
		sb.append("${servicePackagePath}.model.${entity.name}");
