...
import ${servicePackagePath}.service.${entity.name}ServiceUtil;
 ...
 * {@link ${servicePackagePath}.service.${entity.name}ServiceUtil} service utility. The
 ...
 * is translated to an array of {@link ${servicePackagePath}.model.${entity.name}Soap}.
 * If the method in the service utility returns a
 * {@link ${servicePackagePath}.model.${entity.name}}, that is translated to a
 * {@link ${servicePackagePath}.model.${entity.name}Soap}. Methods that SOAP cannot
...
<#if entity.hasColumns()>
 * @see ${servicePackagePath}.model.${entity.name}Soap
</#if>
...
public class ${entity.name}ServiceSoap {
	...
	<#list methods as method>
		<#if !method.isConstructor() && method.isPublic() && serviceBuilder.isCustomMethod(method) && serviceBuilder.isSoapMethod(method)>
			...
			<#assign extendedModelName = servicePackagePath + ".model." + entity.name>
			<#assign soapModelName = servicePackagePath + ".model." + entity.name + "Soap">
			...
			<#elseif stringUtil.startsWith(returnValueName, servicePackagePath + ".model.") && serviceBuilder.hasEntityByGenericsName(returnValueName)>
			...
			<#list method.parameters as parameter>
				...
				<#elseif (parameter.type.value == "java.util.List") && serviceBuilder.hasEntityByGenericsName(parameterListActualType)>
					...
					<#assign parameterTypeName = parameterEntity.servicePackagePath + ".model." + parameterEntity.name + "Soap[]">
