...
public class ${entity.name}JSONSerializer {
	...
	public static JSONArray toJSONArray(${servicePackagePath}.model.${entity.name}[] models) {
	...
	public static JSONArray toJSONArray(List<${servicePackagePath}.model.${entity.name}> models) {
		JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
