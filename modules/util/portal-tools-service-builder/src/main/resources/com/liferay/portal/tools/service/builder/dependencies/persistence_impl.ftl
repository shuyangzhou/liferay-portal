...
public class ${entity.name}PersistenceImpl extends BasePersistenceImpl<${entity.name}> implements ${entity.name}Persistence {
	 ...
	 * @throws ${servicePackagePath}.exception.${noSuchEntity}Exception if a ${entity.humanName} with the primary key could not be found
	 */
	@Override
	...
	/**
	 * Returns the ${entity.humanName} with the primary key or throws a {@link ${servicePackagePath}.exception.${noSuchEntity}Exception} if it could not be found.
	 *
	 * @param ${entity.PKVarName} the primary key of the ${entity.humanName}
	 * @return the ${entity.humanName}
	 * @throws ${servicePackagePath}.exception.${noSuchEntity}Exception if a ${entity.humanName} with the primary key could not be found
