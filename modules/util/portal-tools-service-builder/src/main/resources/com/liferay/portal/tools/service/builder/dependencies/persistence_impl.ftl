...
public class ${entity.name}PersistenceImpl extends BasePersistenceImpl<${entity.name}> implements ${entity.name}Persistence {
	...
	<#if entity.isChangeTrackingEnabled()>
		...
		private static final List<String[]> _uniqueColumnNames = new ArrayList<String[]>();
	...
	<#elseif entity.isChangeTrackingEnabled()>
		...
		@Override
		public ${entity.name} fetchByPrimaryKey(Serializable primaryKey) {
			if (${ctPersistenceHelper}.isCTMode(${entity.name}.class)) {
	...
	public List<${entity.name}> findAll(int start, int end, OrderByComparator<${entity.name}> orderByComparator) {
		<#if entity.isChangeTrackingEnabled()>
			return findAll(start, end, orderByComparator, ${ctPersistenceHelper}.isCTMode(${entity.name}.class));
		<#else>
	...
	public int countAll() {
		<#if entity.isChangeTrackingEnabled()>
			boolean useFinderCache = ${ctPersistenceHelper}.isCTMode(${entity.name}.class);
