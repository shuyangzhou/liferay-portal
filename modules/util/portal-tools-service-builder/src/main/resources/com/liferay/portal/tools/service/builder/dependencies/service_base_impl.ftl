	...
	<#if stringUtil.equals(sessionTypeName, "Local") && entity.hasLocalizationColumns()>
		...
		protected ${localizationEntity.name} update${localizationEntity.name}(
			...
			if (${localizationEntity.varName} == null) {
				...
				${localizationEntity.varName}.set${localizationEntity.primaryEntityName}PK(${entity.varName}.getPrimaryKey());
		...
		protected List<${localizationEntity.name}> update${localizationEntity.name}s(
			...
			List<${localizationEntity.name}> ${localizationEntity.varName}s = ${localizationEntity.varName}Persistence.findBy${localizationEntity.primaryEntityName}PK(${entity.varName}.getPrimaryKey());
