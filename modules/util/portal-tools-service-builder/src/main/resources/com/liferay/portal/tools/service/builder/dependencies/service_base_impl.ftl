...
import ${servicePackagePath}.service.${entity.name}${sessionTypeName}Service;
...
<#if entity.hasColumns()>
	...
	<#list entity.blobList as column>
		<#if column.lazy>
			import ${servicePackagePath}.model.${entity.name}${column.methodName}BlobModel;
		</#if>
	</#list>
...
<#list referenceList as tempEntity>
	<#if tempEntity.hasColumns() && (entity.name == "Counter" || tempEntity.name != "Counter")>
		import ${tempEntity.servicePackagePath}.service.persistence.${tempEntity.name}Persistence;
		import ${tempEntity.servicePackagePath}.service.persistence.${tempEntity.name}Util;
	</#if>

	<#if tempEntity.hasFinderClass() && (entity.name == "Counter" || tempEntity.name != "Counter")>
		import ${tempEntity.servicePackagePath}.service.persistence.${tempEntity.name}Finder;
		import ${tempEntity.servicePackagePath}.service.persistence.${tempEntity.name}FinderUtil;
	</#if>
</#list>
 ...
 * @see ${servicePackagePath}.service.${entity.name}LocalServiceUtil
<#if classDeprecated>
...
<#if classDeprecated>
	...
	public abstract class ${entity.name}LocalServiceBaseImpl extends BaseLocalServiceImpl implements ${entity.name}LocalService, IdentifiableOSGiService {
		 ...
		 * NOTE FOR DEVELOPERS:
		 *
		 * Never modify or reference this class directly. Always use {@link ${servicePackagePath}.service.${entity.name}LocalServiceUtil} to access the ${entity.humanName} local service.
		 */
<#else>
/**
 ...
 * @see ${servicePackagePath}.service.${entity.name}ServiceUtil
<#if classDeprecated>
 * @deprecated ${classDeprecatedComment}
</#if>
 * @generated
...
<#if classDeprecated>
	...
	public abstract class ${entity.name}ServiceBaseImpl extends BaseServiceImpl implements ${entity.name}Service, IdentifiableOSGiService {
		 ...
		 * NOTE FOR DEVELOPERS:
		 *
		 * Never modify or reference this class directly. Always use {@link ${servicePackagePath}.service.${entity.name}ServiceUtil} to access the ${entity.humanName} remote service.
		 */
</#if>

	<#if (sessionTypeName == "Local") && entity.hasColumns()>
		<#assign serviceBaseExceptions = serviceBuilder.getServiceBaseExceptions(methods, "add" + entity.name, [servicePackagePath + ".model." + entity.name], [])>
		...
		<#assign serviceBaseExceptions = serviceBuilder.getServiceBaseExceptions(methods, "delete" + entity.name, [servicePackagePath + ".model." + entity.name], [])>
		...
		<#if entity.hasActionableDynamicQuery()>
			...
			public ActionableDynamicQuery getActionableDynamicQuery() {
				...
				actionableDynamicQuery.setBaseLocalService(${servicePackagePath}.service.${entity.name}LocalServiceUtil.getService());
			...
			public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
				...
				indexableActionableDynamicQuery.setBaseLocalService(${servicePackagePath}.service.${entity.name}LocalServiceUtil.getService());
		...
		<#assign serviceBaseExceptions = serviceBuilder.getServiceBaseExceptions(methods, "update" + entity.name, [servicePackagePath + ".model." + entity.name], [])>
			...
			<#if column.lazy>
				...
				public ${entity.name}${column.methodName}BlobModel get${column.methodName}BlobModel(Serializable primaryKey) {
					...
					try {
						...
						return (${servicePackagePath}.model.${entity.name}${column.methodName}BlobModel)session.get(${entity.name}${column.methodName}BlobModel.class, primaryKey);
					}
					catch (Exception e) {
		...
		<#list entity.columnList as column>
			<#if column.isCollection() && column.isMappingManyToMany()>
				...
				<#assign serviceBaseExceptions = serviceBuilder.getServiceBaseExceptions(methods, "add" + tempEntity.name + entity.name, [tempEntity.PKClassName, servicePackagePath + ".model." + entity.name], [])>
				...
				<#assign serviceBaseExceptions = serviceBuilder.getServiceBaseExceptions(methods, "delete" + tempEntity.name + entity.name, [tempEntity.PKClassName, servicePackagePath + ".model." + entity.name], [])>
	...
	<#list referenceList as tempEntity>
		<#if tempEntity.hasLocalService()>
			...
			public ${tempEntity.servicePackagePath}.service.${tempEntity.name}LocalService get${tempEntity.name}LocalService() {
			...
			public void set${tempEntity.name}LocalService(${tempEntity.servicePackagePath}.service.${tempEntity.name}LocalService ${tempEntity.varName}LocalService) {
		...
		<#if (sessionTypeName != "Local") && tempEntity.hasRemoteService()>
			...
			public ${tempEntity.servicePackagePath}.service.${tempEntity.name}Service get${tempEntity.name}Service() {
			...
			public void set${tempEntity.name}Service(${tempEntity.servicePackagePath}.service.${tempEntity.name}Service ${tempEntity.varName}Service) {
	...
	public void afterPropertiesSet() {
		...
		<#if (sessionTypeName == "Local") && entity.hasColumns()>
			<#if pluginName != "">
				PersistedModelLocalServiceRegistryUtil.register("${servicePackagePath}.model.${entity.name}", ${entity.varName}LocalService);
			<#else>
				persistedModelLocalServiceRegistry.register("${servicePackagePath}.model.${entity.name}", ${entity.varName}LocalService);
			</#if>
		</#if>
	}
	...
	public void destroy() {
		<#if (sessionTypeName == "Local") && entity.hasColumns()>
			<#if pluginName != "">
				PersistedModelLocalServiceRegistryUtil.unregister("${servicePackagePath}.model.${entity.name}");
			<#else>
				persistedModelLocalServiceRegistry.unregister("${servicePackagePath}.model.${entity.name}");
			</#if>
		</#if>
	}
	...
	<#list referenceList as tempEntity>
		<#if tempEntity.hasLocalService()>
			<#if osgiModule && (tempEntity.servicePackagePath != servicePackagePath)>
				@ServiceReference(type = ${tempEntity.servicePackagePath}.service.${tempEntity.name}LocalService.class)
			<#else>
				@BeanReference(type = ${tempEntity.servicePackagePath}.service.${tempEntity.name}LocalService.class)
			</#if>
			...
			protected ${tempEntity.servicePackagePath}.service.${tempEntity.name}LocalService ${tempEntity.varName}LocalService;
		</#if>

		<#if (sessionTypeName != "Local") && tempEntity.hasRemoteService()>
			<#if osgiModule && (tempEntity.servicePackagePath != servicePackagePath)>
				@ServiceReference(type = ${tempEntity.servicePackagePath}.service.${tempEntity.name}Service.class)
			<#else>
				@BeanReference(type = ${tempEntity.servicePackagePath}.service.${tempEntity.name}Service.class)
			</#if>
			...
			protected ${tempEntity.servicePackagePath}.service.${tempEntity.name}Service ${tempEntity.varName}Service;
		</#if>
