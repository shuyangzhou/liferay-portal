...
public class SequenceEntryLocalServiceUtil {
	...
	public static SequenceEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SequenceEntryLocalServiceUtil::_getService);
	}

	private static SequenceEntryLocalService _getService() {
		...
		ServiceReference<SequenceEntryLocalService> serviceReference =
			bundleContext.getServiceReference(SequenceEntryLocalService.class);
	...
	private static final DCLSingleton<SequenceEntryLocalService>
