...
public interface TestEntityResource {
	...
	public void deleteTestEntity(Long testEntityId, Boolean permanent)
		throws Exception;

	public HttpInvoker.HttpResponse deleteTestEntityHttpResponse(
			Long testEntityId, Boolean permanent)
		throws Exception;

	public void deleteTestEntityBatch(
			Boolean permanent, String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse deleteTestEntityBatchHttpResponse(
			Boolean permanent, String callbackURL, Object object)
		throws Exception;
	...
	public static class TestEntityResourceImpl implements TestEntityResource {
		...
		public void deleteTestEntity(Long testEntityId, Boolean permanent)
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteTestEntityHttpResponse(testEntityId, permanent);
		...
		public HttpInvoker.HttpResponse deleteTestEntityHttpResponse(
			...
			if (permanent != null) {
				httpInvoker.parameter("permanent", String.valueOf(permanent));
			}
		...
		public void deleteTestEntityBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteTestEntityBatchHttpResponse(
