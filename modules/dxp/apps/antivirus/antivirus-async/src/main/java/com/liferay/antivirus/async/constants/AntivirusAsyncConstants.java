...
package com.liferay.antivirus.async.constants;
...
public class AntivirusAsyncConstants {
	...
	public static final String ANTIVIRUS_ASYNC_COMPONENT =
		"antivirus.async.component";
	...
	public static final String TAG_NOT_SCANNED_FAILURE =
		"antivirus-not-scanned-process-failure";

	public static final String TAG_NOT_SCANNED_MISSING =
		"antivirus-not-scanned-file-missing";

	public static final String TAG_NOT_SCANNED_SIZE =
		"antivirus-not-scanned-size-limit-exceeded";

	public static final String TAG_SCAN_PENDING = "antivirus-scan-pending";

	public static final String TAG_SCANNED = "antivirus-scanned";

	public static final String TAG_VIRUS_DETECTED = "antivirus-virus-detected";

	public static final List<String> tagList = ListUtil.fromArray(
		TAG_NOT_SCANNED_FAILURE, TAG_NOT_SCANNED_MISSING, TAG_NOT_SCANNED_SIZE,
		TAG_SCANNED, TAG_SCAN_PENDING, TAG_VIRUS_DETECTED);
