...
import com.liferay.antivirus.async.jmx.AntivirusAsyncStatisticsManagerMBean;
...
public class AsyncAntivirusStatisticsTest {
					...
					try (LogCapture logCapture =
							LoggerTestUtil.configureLog4JLogger(
								StringBundler.concat(
									"com.liferay.antivirus.async.internal.",
									"notifications.",
	...
	private AntivirusAsyncStatisticsManagerMBean
		...
		if (antivirusAsyncStatisticsManagerMBean == null) {
			Assert.fail("antivirusAsyncStatisticsManagerMBean not found");
		}
