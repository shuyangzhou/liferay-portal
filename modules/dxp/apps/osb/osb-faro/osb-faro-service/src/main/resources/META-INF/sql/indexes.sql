...
create unique index IX_488323F on OSBFaro_FaroChannel (workspaceGroupId, channelId[$COLUMN_LENGTH:75$]);

create index IX_8C52A745 on OSBFaro_FaroNotification (createTime, groupId, ownerId, type_[$COLUMN_LENGTH:75$], subtype[$COLUMN_LENGTH:75$], read_);
...
create index IX_5E384504 on OSBFaro_FaroUser (status, emailAddress[$COLUMN_LENGTH:75$]);
create index IX_F3CF931E on OSBFaro_FaroUser (status, liveUserId);