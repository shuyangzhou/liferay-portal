...
public class MFAFIDO2CredentialEntryLocalServiceUtil {
	...
	public static MFAFIDO2CredentialEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			MFAFIDO2CredentialEntryLocalServiceUtil::_getService);
	}

	private static MFAFIDO2CredentialEntryLocalService _getService() {
		...
		ServiceReference<MFAFIDO2CredentialEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<MFAFIDO2CredentialEntryLocalService>
