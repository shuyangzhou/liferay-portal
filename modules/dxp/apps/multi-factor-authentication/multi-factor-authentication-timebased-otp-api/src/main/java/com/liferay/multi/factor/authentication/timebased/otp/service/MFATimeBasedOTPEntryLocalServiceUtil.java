...
public class MFATimeBasedOTPEntryLocalServiceUtil {
	...
	public static MFATimeBasedOTPEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			MFATimeBasedOTPEntryLocalServiceUtil::_getService);
	}

	private static MFATimeBasedOTPEntryLocalService _getService() {
		...
		ServiceReference<MFATimeBasedOTPEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<MFATimeBasedOTPEntryLocalService>
