...
/**
 * The table class for the MFAEmailOTPEntry.
 *
 * @author Arthur Chan
 * @generated
 */
public class MFAEmailOTPEntryTable extends Table<MFAEmailOTPEntryTable> {
	...
	public final Column<MFAEmailOTPEntryTable, Long> mfaEmailOTPEntryId =
		createColumn("mfaEmailOTPEntryId", Long.class, Types.BIGINT);
	...
	public final Column<MFAEmailOTPEntryTable, Integer> failedAttempts =
		createColumn("failedAttempts", Integer.class, Types.INTEGER);
	public final Column<MFAEmailOTPEntryTable, Date> lastFailDate =
		createColumn("lastFailDate", Date.class, Types.TIMESTAMP);
	public final Column<MFAEmailOTPEntryTable, String> lastFailIP =
		createColumn("lastFailIP", String.class, Types.VARCHAR);
	public final Column<MFAEmailOTPEntryTable, Date> lastSuccessDate =
		createColumn("lastSuccessDate", Date.class, Types.TIMESTAMP);
	public final Column<MFAEmailOTPEntryTable, String> lastSuccessIP =
		createColumn("lastSuccessIP", String.class, Types.VARCHAR);
