...
public class MFAEmailOTPEntryLocalServiceUtil {
	...
	public static MFAEmailOTPEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			MFAEmailOTPEntryLocalServiceUtil::_getService);
	}

	private static MFAEmailOTPEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			MFAEmailOTPEntryLocalServiceUtil.class);
		...
		ServiceReference<MFAEmailOTPEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<MFAEmailOTPEntryLocalService>
