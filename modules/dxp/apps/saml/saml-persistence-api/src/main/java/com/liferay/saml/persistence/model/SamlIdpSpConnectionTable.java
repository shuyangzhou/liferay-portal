...
/**
 * The table class for the SamlIdpSpConnection.
 *
 * @author Mika Koivisto
 * @generated
 */
public class SamlIdpSpConnectionTable extends Table<SamlIdpSpConnectionTable> {
	...
	public final Column<SamlIdpSpConnectionTable, Long> samlIdpSpConnectionId =
		createColumn("samlIdpSpConnectionId", Long.class, Types.BIGINT);
	...
	public final Column<SamlIdpSpConnectionTable, String> samlSpEntityId =
		createColumn("samlSpEntityId", String.class, Types.VARCHAR);
	public final Column<SamlIdpSpConnectionTable, Integer> assertionLifetime =
		createColumn("assertionLifetime", Integer.class, Types.INTEGER);
	public final Column<SamlIdpSpConnectionTable, String> attributeNames =
		createColumn("attributeNames", String.class, Types.VARCHAR);
	public final Column<SamlIdpSpConnectionTable, Boolean> attributesEnabled =
		createColumn("attributesEnabled", Boolean.class, Types.BOOLEAN);
	...
	public final Column<SamlIdpSpConnectionTable, Boolean> encryptionForced =
		createColumn("encryptionForced", Boolean.class, Types.BOOLEAN);
	public final Column<SamlIdpSpConnectionTable, String> metadataUrl =
		createColumn("metadataUrl", String.class, Types.VARCHAR);
	public final Column<SamlIdpSpConnectionTable, String> metadataXml =
		createColumn("metadataXml", String.class, Types.CLOB);
	public final Column<SamlIdpSpConnectionTable, Date> metadataUpdatedDate =
		createColumn("metadataUpdatedDate", Date.class, Types.TIMESTAMP);
	...
	public final Column<SamlIdpSpConnectionTable, String> nameIdAttribute =
		createColumn("nameIdAttribute", String.class, Types.VARCHAR);
	public final Column<SamlIdpSpConnectionTable, String> nameIdFormat =
		createColumn("nameIdFormat", String.class, Types.VARCHAR);
