...
public class SamlSpIdpConnectionLocalServiceUtil {
	...
	public static SamlSpIdpConnectionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SamlSpIdpConnectionLocalServiceUtil::_getService);
	}

	private static SamlSpIdpConnectionLocalService _getService() {
		...
		ServiceReference<SamlSpIdpConnectionLocalService> serviceReference =
	...
	private static final DCLSingleton<SamlSpIdpConnectionLocalService>
