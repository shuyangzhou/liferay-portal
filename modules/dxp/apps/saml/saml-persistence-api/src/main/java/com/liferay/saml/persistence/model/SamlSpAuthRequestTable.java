...
/**
 * The table class for the SamlSpAuthRequest.
 *
 * @author Mika Koivisto
 * @generated
 */
public class SamlSpAuthRequestTable extends Table<SamlSpAuthRequestTable> {
	...
	public final Column<SamlSpAuthRequestTable, Long> samlSpAuthnRequestId =
		createColumn("samlSpAuthnRequestId", Long.class, Types.BIGINT);
	...
	public final Column<SamlSpAuthRequestTable, String> samlSpAuthRequestKey =
		createColumn("samlSpAuthRequestKey", String.class, Types.VARCHAR);
