...
/**
 * The table class for the SamlIdpSpSession.
 *
 * @author Mika Koivisto
 * @generated
 */
public class SamlIdpSpSessionTable extends Table<SamlIdpSpSessionTable> {
	...
	public final Column<SamlIdpSpSessionTable, Long> samlIdpSpSessionId =
		createColumn("samlIdpSpSessionId", Long.class, Types.BIGINT);
	...
	public final Column<SamlIdpSpSessionTable, String> nameIdValue =
		createColumn("nameIdValue", String.class, Types.VARCHAR);
