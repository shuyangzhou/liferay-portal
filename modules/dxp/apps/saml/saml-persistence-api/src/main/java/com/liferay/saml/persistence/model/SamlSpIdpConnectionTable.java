...
/**
 * The table class for the SamlSpIdpConnection.
 *
 * @author Mika Koivisto
 * @generated
 */
public class SamlSpIdpConnectionTable extends Table<SamlSpIdpConnectionTable> {
	...
	public final Column<SamlSpIdpConnectionTable, Long> samlSpIdpConnectionId =
		createColumn("samlSpIdpConnectionId", Long.class, Types.BIGINT);
	...
	public final Column<SamlSpIdpConnectionTable, Long> clockSkew =
		createColumn("clockSkew", Long.class, Types.BIGINT);
	...
	public final Column<SamlSpIdpConnectionTable, Boolean> signAuthnRequest =
		createColumn("signAuthnRequest", Boolean.class, Types.BOOLEAN);
