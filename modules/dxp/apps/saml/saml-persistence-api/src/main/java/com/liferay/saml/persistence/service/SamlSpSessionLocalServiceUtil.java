...
public class SamlSpSessionLocalServiceUtil {
	...
	public static SamlSpSessionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SamlSpSessionLocalServiceUtil::_getService);
	}

	private static SamlSpSessionLocalService _getService() {
		...
		ServiceReference<SamlSpSessionLocalService> serviceReference =
			bundleContext.getServiceReference(SamlSpSessionLocalService.class);
	...
	private static final DCLSingleton<SamlSpSessionLocalService>
