...
public class SamlSpAuthRequestLocalServiceUtil {
	...
	public static SamlSpAuthRequestLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SamlSpAuthRequestLocalServiceUtil::_getService);
	}

	private static SamlSpAuthRequestLocalService _getService() {
		...
		ServiceReference<SamlSpAuthRequestLocalService> serviceReference =
	...
	private static final DCLSingleton<SamlSpAuthRequestLocalService>
