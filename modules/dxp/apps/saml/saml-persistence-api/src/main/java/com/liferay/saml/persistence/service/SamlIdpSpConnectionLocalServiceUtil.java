...
public class SamlIdpSpConnectionLocalServiceUtil {
	...
	public static SamlIdpSpConnectionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SamlIdpSpConnectionLocalServiceUtil::_getService);
	}

	private static SamlIdpSpConnectionLocalService _getService() {
		...
		ServiceReference<SamlIdpSpConnectionLocalService> serviceReference =
	...
	private static final DCLSingleton<SamlIdpSpConnectionLocalService>
