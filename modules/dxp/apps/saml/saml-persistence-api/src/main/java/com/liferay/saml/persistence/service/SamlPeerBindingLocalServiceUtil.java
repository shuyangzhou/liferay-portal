...
public class SamlPeerBindingLocalServiceUtil {
	...
	public static SamlPeerBindingLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SamlPeerBindingLocalServiceUtil::_getService);
	}

	private static SamlPeerBindingLocalService _getService() {
		...
		ServiceReference<SamlPeerBindingLocalService> serviceReference =
	...
	private static final DCLSingleton<SamlPeerBindingLocalService>
