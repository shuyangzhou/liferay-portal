...
/**
 * The table class for the OAuthApplication.
 *
 * @author Ivica Cardic
 * @generated
 */
public class OAuthApplicationTable extends Table<OAuthApplicationTable> {
	...
	public final Column<OAuthApplicationTable, Long> oAuthApplicationId =
		createColumn("oAuthApplicationId", Long.class, Types.BIGINT);
	...
	public final Column<OAuthApplicationTable, String> consumerKey =
		createColumn("consumerKey", String.class, Types.VARCHAR);
	public final Column<OAuthApplicationTable, String> consumerSecret =
		createColumn("consumerSecret", String.class, Types.VARCHAR);
	public final Column<OAuthApplicationTable, Integer> accessLevel =
		createColumn("accessLevel", Integer.class, Types.INTEGER);
	...
	public final Column<OAuthApplicationTable, Boolean> shareableAccessToken =
		createColumn("shareableAccessToken", Boolean.class, Types.BOOLEAN);
	public final Column<OAuthApplicationTable, String> callbackURI =
		createColumn("callbackURI", String.class, Types.VARCHAR);
	public final Column<OAuthApplicationTable, String> websiteURL =
		createColumn("websiteURL", String.class, Types.VARCHAR);
