...
public class SharepointOAuth2TokenEntryLocalServiceUtil {
	...
	public static SharepointOAuth2TokenEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SharepointOAuth2TokenEntryLocalServiceUtil::_getService);
	}

	private static SharepointOAuth2TokenEntryLocalService _getService() {
		...
		ServiceReference<SharepointOAuth2TokenEntryLocalService>
	...
	private static final DCLSingleton<SharepointOAuth2TokenEntryLocalService>
