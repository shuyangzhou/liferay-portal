...
public class SharepointOAuth2TokenEntryTable
	...
	public final Column<SharepointOAuth2TokenEntryTable, String> accessToken =
		createColumn("accessToken", String.class, Types.CLOB);
	...
	public final Column<SharepointOAuth2TokenEntryTable, String> refreshToken =
		createColumn("refreshToken", String.class, Types.CLOB);
