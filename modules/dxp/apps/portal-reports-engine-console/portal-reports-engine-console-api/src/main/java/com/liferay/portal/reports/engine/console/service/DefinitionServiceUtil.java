...
public class DefinitionServiceUtil {
	...
	public static DefinitionService getService() {
		return _serviceDCLSingleton.getSingleton(
			DefinitionServiceUtil::_getService);
	}

	private static DefinitionService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(DefinitionServiceUtil.class);
		...
		ServiceReference<DefinitionService> serviceReference =
			bundleContext.getServiceReference(DefinitionService.class);
	...
	private static final DCLSingleton<DefinitionService> _serviceDCLSingleton =
		new DCLSingleton<>();
