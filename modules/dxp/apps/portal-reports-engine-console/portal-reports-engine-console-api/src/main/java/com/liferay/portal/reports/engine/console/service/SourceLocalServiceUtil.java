...
public class SourceLocalServiceUtil {
	...
	public static SourceLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SourceLocalServiceUtil::_getService);
	}

	private static SourceLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(SourceLocalServiceUtil.class);
		...
		ServiceReference<SourceLocalService> serviceReference =
			bundleContext.getServiceReference(SourceLocalService.class);
	...
	private static final DCLSingleton<SourceLocalService> _serviceDCLSingleton =
		new DCLSingleton<>();
