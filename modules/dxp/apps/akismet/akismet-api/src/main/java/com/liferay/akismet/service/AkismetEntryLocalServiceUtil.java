...
public class AkismetEntryLocalServiceUtil {
	...
	public static AkismetEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			AkismetEntryLocalServiceUtil::_getService);
	}

	private static AkismetEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			AkismetEntryLocalServiceUtil.class);
		...
		ServiceReference<AkismetEntryLocalService> serviceReference =
			bundleContext.getServiceReference(AkismetEntryLocalService.class);
	...
	private static final DCLSingleton<AkismetEntryLocalService>
