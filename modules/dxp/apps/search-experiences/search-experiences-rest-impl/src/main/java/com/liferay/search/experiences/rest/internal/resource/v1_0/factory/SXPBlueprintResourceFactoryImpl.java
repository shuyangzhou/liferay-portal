	...
	public SXPBlueprintResource.Builder create() {
		return new SXPBlueprintResource.Builder() {
			...
			public SXPBlueprintResource build() {
				...
				Function<InvocationHandler, SXPBlueprintResource>
					sxpBlueprintResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_sxpBlueprintResourceProxyProviderFunction;

				return sxpBlueprintResourceProxyProviderFunction.apply(
			...
			@Override
			public SXPBlueprintResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
