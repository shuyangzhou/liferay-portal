	...
	public SXPElementResource.Builder create() {
		return new SXPElementResource.Builder() {
			...
			public SXPElementResource build() {
				...
				Function<InvocationHandler, SXPElementResource>
					sxpElementResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_sxpElementResourceProxyProviderFunction;

				return sxpElementResourceProxyProviderFunction.apply(
			...
			@Override
			public SXPElementResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
