...
public class SXPBlueprintServiceUtil {
	...
	public static SXPBlueprintService getService() {
		return _serviceDCLSingleton.getSingleton(
			SXPBlueprintServiceUtil::_getService);
	}

	private static SXPBlueprintService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(SXPBlueprintServiceUtil.class);
		...
		ServiceReference<SXPBlueprintService> serviceReference =
			bundleContext.getServiceReference(SXPBlueprintService.class);
	...
	private static final DCLSingleton<SXPBlueprintService>
