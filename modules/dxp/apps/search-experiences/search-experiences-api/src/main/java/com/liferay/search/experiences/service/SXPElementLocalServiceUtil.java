...
public class SXPElementLocalServiceUtil {
	...
	public static SXPElementLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SXPElementLocalServiceUtil::_getService);
	}

	private static SXPElementLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			SXPElementLocalServiceUtil.class);
		...
		ServiceReference<SXPElementLocalService> serviceReference =
			bundleContext.getServiceReference(SXPElementLocalService.class);
	...
	private static final DCLSingleton<SXPElementLocalService>
