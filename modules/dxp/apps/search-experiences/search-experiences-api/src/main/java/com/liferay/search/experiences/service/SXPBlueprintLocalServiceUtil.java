...
public class SXPBlueprintLocalServiceUtil {
	...
	public static SXPBlueprintLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SXPBlueprintLocalServiceUtil::_getService);
	}

	private static SXPBlueprintLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			SXPBlueprintLocalServiceUtil.class);
		...
		ServiceReference<SXPBlueprintLocalService> serviceReference =
			bundleContext.getServiceReference(SXPBlueprintLocalService.class);
	...
	private static final DCLSingleton<SXPBlueprintLocalService>
