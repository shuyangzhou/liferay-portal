...
public class WorkflowMetricsSLADefinitionLocalServiceUtil {
	...
	public static WorkflowMetricsSLADefinitionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			WorkflowMetricsSLADefinitionLocalServiceUtil::_getService);
	}

	private static WorkflowMetricsSLADefinitionLocalService _getService() {
		...
		ServiceReference<WorkflowMetricsSLADefinitionLocalService>
	...
	private static final DCLSingleton<WorkflowMetricsSLADefinitionLocalService>
