	...
	public NodeResource.Builder create() {
		return new NodeResource.Builder() {
			...
			public NodeResource build() {
				...
				Function<InvocationHandler, NodeResource>
					nodeResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_nodeResourceProxyProviderFunction;

				return nodeResourceProxyProviderFunction.apply(
			...
			@Override
			public NodeResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
