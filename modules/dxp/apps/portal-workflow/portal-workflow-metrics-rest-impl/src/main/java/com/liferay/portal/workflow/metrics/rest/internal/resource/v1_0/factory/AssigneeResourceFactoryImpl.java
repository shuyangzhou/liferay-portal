...
public class AssigneeResourceFactoryImpl implements AssigneeResource.Factory {
	...
	public AssigneeResource.Builder create() {
		return new AssigneeResource.Builder() {
			...
			public AssigneeResource build() {
				...
				Function<InvocationHandler, AssigneeResource>
					assigneeResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_assigneeResourceProxyProviderFunction;

				return assigneeResourceProxyProviderFunction.apply(
			...
			@Override
			public AssigneeResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
	...
	private Object _invoke(
		...
		assigneeResource.setContextUriInfo(uriInfo);
