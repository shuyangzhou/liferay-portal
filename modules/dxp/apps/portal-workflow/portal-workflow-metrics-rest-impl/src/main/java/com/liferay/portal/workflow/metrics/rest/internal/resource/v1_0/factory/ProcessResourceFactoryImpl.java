	...
	public ProcessResource.Builder create() {
		return new ProcessResource.Builder() {
			...
			public ProcessResource build() {
				...
				Function<InvocationHandler, ProcessResource>
					processResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_processResourceProxyProviderFunction;

				return processResourceProxyProviderFunction.apply(
			...
			@Override
			public ProcessResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
