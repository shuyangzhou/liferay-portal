...
public class KaleoProcessLocalServiceUtil {
	...
	public static KaleoProcessLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			KaleoProcessLocalServiceUtil::_getService);
	}

	private static KaleoProcessLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			KaleoProcessLocalServiceUtil.class);
		...
		ServiceReference<KaleoProcessLocalService> serviceReference =
			bundleContext.getServiceReference(KaleoProcessLocalService.class);
	...
	private static final DCLSingleton<KaleoProcessLocalService>
