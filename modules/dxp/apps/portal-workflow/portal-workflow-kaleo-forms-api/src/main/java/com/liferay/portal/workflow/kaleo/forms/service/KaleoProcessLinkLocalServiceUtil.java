...
public class KaleoProcessLinkLocalServiceUtil {
	...
	public static KaleoProcessLinkLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			KaleoProcessLinkLocalServiceUtil::_getService);
	}

	private static KaleoProcessLinkLocalService _getService() {
		...
		ServiceReference<KaleoProcessLinkLocalService> serviceReference =
	...
	private static final DCLSingleton<KaleoProcessLinkLocalService>
