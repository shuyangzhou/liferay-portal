...
public class KaleoProcessServiceUtil {
	...
	public static KaleoProcessService getService() {
		return _serviceDCLSingleton.getSingleton(
			KaleoProcessServiceUtil::_getService);
	}

	private static KaleoProcessService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(KaleoProcessServiceUtil.class);
		...
		ServiceReference<KaleoProcessService> serviceReference =
			bundleContext.getServiceReference(KaleoProcessService.class);
	...
	private static final DCLSingleton<KaleoProcessService>
