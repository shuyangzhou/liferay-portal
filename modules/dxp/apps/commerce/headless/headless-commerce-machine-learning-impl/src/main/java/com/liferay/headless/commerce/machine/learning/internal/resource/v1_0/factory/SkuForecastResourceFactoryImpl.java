	...
	public SkuForecastResource.Builder create() {
		return new SkuForecastResource.Builder() {
			...
			public SkuForecastResource build() {
				...
				Function<InvocationHandler, SkuForecastResource>
					skuForecastResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_skuForecastResourceProxyProviderFunction;

				return skuForecastResourceProxyProviderFunction.apply(
			...
			@Override
			public SkuForecastResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
