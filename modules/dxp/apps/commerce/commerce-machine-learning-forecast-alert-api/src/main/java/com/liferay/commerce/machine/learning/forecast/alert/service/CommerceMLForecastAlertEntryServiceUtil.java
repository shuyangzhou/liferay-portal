...
public class CommerceMLForecastAlertEntryServiceUtil {
	...
	public static CommerceMLForecastAlertEntryService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceMLForecastAlertEntryServiceUtil::_getService);
	}

	private static CommerceMLForecastAlertEntryService _getService() {
		...
		ServiceReference<CommerceMLForecastAlertEntryService> serviceReference =
	...
	private static final DCLSingleton<CommerceMLForecastAlertEntryService>
