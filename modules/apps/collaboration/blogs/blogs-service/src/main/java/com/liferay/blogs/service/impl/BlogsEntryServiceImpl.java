...
import com.liferay.blogs.internal.permission.BlogsPortletPermissionChecker;
...
public class BlogsEntryServiceImpl extends BlogsEntryServiceBaseImpl {
	...
	public BlogsEntry addEntry(
		...
		_blogsPortletPermissionChecker.check(
	...
	public void deleteEntry(long entryId) throws PortalException {
		_blogsEntryPermissionChecker.check(
	...
	public List<BlogsEntry> getCompanyEntries(
		...
		while ((entries.size() < max) && listNotExhausted) {
			...
			for (BlogsEntry entry : entryList) {
				...
				if (_blogsEntryPermissionChecker.contains(
	...
	@BeanReference(type = BlogsEntryPermissionChecker.class)
	private BlogsEntryPermissionChecker _blogsEntryPermissionChecker;

	@BeanReference(type = BlogsPortletPermissionChecker.class)
	private BlogsPortletPermissionChecker _blogsPortletPermissionChecker;
