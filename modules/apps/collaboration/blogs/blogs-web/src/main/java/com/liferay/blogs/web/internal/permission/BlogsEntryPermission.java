...
public class BlogsEntryPermission {
	...
	public static boolean contains(
		...
		return _modelPermissionChecker.contains(
	...
	protected void setModelPermissionChecker(
		ModelPermissionChecker<BlogsEntry> modelPermissionChecker) {

		_modelPermissionChecker = modelPermissionChecker;
	}

	private static ModelPermissionChecker<BlogsEntry> _modelPermissionChecker;
