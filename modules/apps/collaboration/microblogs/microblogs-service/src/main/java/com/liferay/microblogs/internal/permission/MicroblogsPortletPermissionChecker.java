 ...
 */
public class MicroblogsPortletPermissionChecker
	extends PortletResourcePermissionChecker {

	public MicroblogsPortletPermissionChecker() {
		super(
			MicroblogsConstants.RESOURCE_NAME,
			new StagedPortletPermissionCheck(MicroblogsPortletKeys.MICROBLOGS));
	}
