...
page import="com.liferay.microblogs.web.internal.security.permission.MicroblogsEntryPermission" %><%@
page import="com.liferay.microblogs.web.internal.security.permission.MicroblogsPermission" %><%@
