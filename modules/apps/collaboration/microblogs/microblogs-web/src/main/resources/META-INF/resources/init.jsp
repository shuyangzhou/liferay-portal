...
page import="com.liferay.microblogs.web.internal.permission.MicroblogsEntryPermission" %><%@
page import="com.liferay.microblogs.web.internal.permission.MicroblogsPermission" %><%@
