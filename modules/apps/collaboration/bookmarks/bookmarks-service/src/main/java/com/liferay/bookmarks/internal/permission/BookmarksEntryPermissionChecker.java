...
import com.liferay.portal.kernel.security.permission.checker.BaseModelPermission;
import com.liferay.portal.kernel.security.permission.checker.ChildModelPermissionCheck;
...
@OSGiBeanProperties(
	...
	service = ModelPermission.class
)
public class BookmarksEntryPermissionChecker
	extends ModelPermissionChecker<BookmarksEntry> {
	...
	private class DynamicInheritanceCheck
		extends ChildModelPermissionCheck<BookmarksEntry, BookmarksFolder> {

		@Override
		protected BookmarksFolder fetchParentModel(BookmarksEntry entry)
		...
		@Override
		protected BaseModelPermission<BookmarksFolder> getParentPermission() {
			return _parentModelPermission;
		}
