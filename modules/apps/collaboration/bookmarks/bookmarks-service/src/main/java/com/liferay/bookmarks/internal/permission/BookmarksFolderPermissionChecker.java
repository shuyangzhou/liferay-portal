...
import com.liferay.portal.kernel.security.permission.checker.ParentModelPermissionCheck;
import com.liferay.portal.kernel.security.permission.checker.ParentModelPermissionChecker;
...
@OSGiBeanProperties(
	...
	service = ParentModelPermission.class
)
public class BookmarksFolderPermissionChecker
	extends ParentModelPermissionChecker<BookmarksFolder> {
	...
	private class DynamicInheritanceCheck
		extends ParentModelPermissionCheck<BookmarksFolder> {
