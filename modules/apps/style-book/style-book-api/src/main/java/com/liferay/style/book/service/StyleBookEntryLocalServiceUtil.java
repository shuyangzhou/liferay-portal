...
public class StyleBookEntryLocalServiceUtil {
	...
	public static StyleBookEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			StyleBookEntryLocalServiceUtil::_getService);
	}

	private static StyleBookEntryLocalService _getService() {
		...
		ServiceReference<StyleBookEntryLocalService> serviceReference =
			bundleContext.getServiceReference(StyleBookEntryLocalService.class);
	...
	private static final DCLSingleton<StyleBookEntryLocalService>
