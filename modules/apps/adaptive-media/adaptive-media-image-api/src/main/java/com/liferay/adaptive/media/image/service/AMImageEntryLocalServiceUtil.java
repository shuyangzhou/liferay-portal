...
public class AMImageEntryLocalServiceUtil {
	...
	public static AMImageEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			AMImageEntryLocalServiceUtil::_getService);
	}

	private static AMImageEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			AMImageEntryLocalServiceUtil.class);
		...
		ServiceReference<AMImageEntryLocalService> serviceReference =
			bundleContext.getServiceReference(AMImageEntryLocalService.class);
	...
	private static final DCLSingleton<AMImageEntryLocalService>
