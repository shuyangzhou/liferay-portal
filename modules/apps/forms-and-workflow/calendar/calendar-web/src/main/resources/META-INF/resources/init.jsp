...
page import="com.liferay.calendar.web.internal.permission.CalendarPermission" %><%@
page import="com.liferay.calendar.web.internal.permission.CalendarPortletPermission" %><%@
page import="com.liferay.calendar.web.internal.permission.CalendarResourcePermission" %><%@
