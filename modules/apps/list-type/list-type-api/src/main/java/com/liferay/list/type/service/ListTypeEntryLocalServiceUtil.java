...
public class ListTypeEntryLocalServiceUtil {
	...
	public static ListTypeEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ListTypeEntryLocalServiceUtil::_getService);
	}

	private static ListTypeEntryLocalService _getService() {
		...
		ServiceReference<ListTypeEntryLocalService> serviceReference =
			bundleContext.getServiceReference(ListTypeEntryLocalService.class);
	...
	private static final DCLSingleton<ListTypeEntryLocalService>
