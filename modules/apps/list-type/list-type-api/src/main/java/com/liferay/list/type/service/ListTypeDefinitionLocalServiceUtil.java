...
public class ListTypeDefinitionLocalServiceUtil {
	...
	public static ListTypeDefinitionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ListTypeDefinitionLocalServiceUtil::_getService);
	}

	private static ListTypeDefinitionLocalService _getService() {
		...
		ServiceReference<ListTypeDefinitionLocalService> serviceReference =
	...
	private static final DCLSingleton<ListTypeDefinitionLocalService>
