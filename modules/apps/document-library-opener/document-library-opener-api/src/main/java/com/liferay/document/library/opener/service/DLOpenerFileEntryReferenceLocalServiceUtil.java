...
public class DLOpenerFileEntryReferenceLocalServiceUtil {
	...
	public static DLOpenerFileEntryReferenceLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DLOpenerFileEntryReferenceLocalServiceUtil::_getService);
	}

	private static DLOpenerFileEntryReferenceLocalService _getService() {
		...
		ServiceReference<DLOpenerFileEntryReferenceLocalService>
	...
	private static final DCLSingleton<DLOpenerFileEntryReferenceLocalService>
