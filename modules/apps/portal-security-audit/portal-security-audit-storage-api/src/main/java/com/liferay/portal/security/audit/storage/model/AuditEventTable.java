 ...
 * @generated
 */
public class AuditEventTable extends Table<AuditEventTable> {
	...
	public final Column<AuditEventTable, String> additionalInfo = createColumn(
		"additionalInfo", String.class, Types.CLOB);
