...
public class AuditEventServiceUtil {
	...
	public static AuditEventService getService() {
		return _serviceDCLSingleton.getSingleton(
			AuditEventServiceUtil::_getService);
	}

	private static AuditEventService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(AuditEventServiceUtil.class);
		...
		ServiceReference<AuditEventService> serviceReference =
	...
	private static final DCLSingleton<AuditEventService> _serviceDCLSingleton =
		new DCLSingleton<>();
