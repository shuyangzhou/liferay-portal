...
public class ReadingTimeEntryLocalServiceUtil {
	...
	public static ReadingTimeEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ReadingTimeEntryLocalServiceUtil::_getService);
	}

	private static ReadingTimeEntryLocalService _getService() {
		...
		ServiceReference<ReadingTimeEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<ReadingTimeEntryLocalService>
