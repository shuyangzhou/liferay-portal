...
public class MDRActionWrapper implements MDRAction, ModelWrapper<MDRAction> {
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<MDRAction, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<MDRAction, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<MDRAction, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<MDRAction, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<MDRAction, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<MDRAction, Object> attributeBiConsumer = entry.getValue();
	...
	public Map<String, Function<MDRAction, Object>> getAttributeGetters() {
		return _mdrAction.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<MDRAction, Object>> getAttributeSetters() {
		return _mdrAction.getAttributeSetters();
	}
