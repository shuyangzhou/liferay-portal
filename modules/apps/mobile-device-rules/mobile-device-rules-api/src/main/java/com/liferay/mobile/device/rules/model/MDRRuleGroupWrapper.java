...
public class MDRRuleGroupWrapper implements MDRRuleGroup,
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<MDRRuleGroup, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<MDRRuleGroup, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<MDRRuleGroup, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<MDRRuleGroup, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<MDRRuleGroup, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<MDRRuleGroup, Object> attributeBiConsumer = entry.getValue();
	...
	@Override
	public Map<String, Function<MDRRuleGroup, Object>> getAttributeGetters() {
		return _mdrRuleGroup.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<MDRRuleGroup, Object>> getAttributeSetters() {
		return _mdrRuleGroup.getAttributeSetters();
	}
