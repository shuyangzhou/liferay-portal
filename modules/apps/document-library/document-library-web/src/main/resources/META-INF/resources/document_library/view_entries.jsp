		...
		>
			...
			<c:choose>
				<c:when test="<%= fileEntry != null %>">
					...
					rowData.put("actions", StringUtil.merge(dlAdminManagementToolbarDisplayContext.getAvailableActionDropdownItems(fileEntry)));
				...
				<c:otherwise>
					...
					rowData.put("actions", StringUtil.merge(dlAdminManagementToolbarDisplayContext.getAvailableActionDropdownItems(curFolder)));
					rowData.put("draggable", draggable);
