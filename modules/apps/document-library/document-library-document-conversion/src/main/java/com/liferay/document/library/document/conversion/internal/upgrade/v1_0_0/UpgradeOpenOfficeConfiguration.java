...
public class UpgradeOpenOfficeConfiguration extends UpgradeProcess {
	...
	protected void doUpgrade() throws Exception {
		_prefsPropsToConfigurationUpgradeHelper.mapConfigurations(
			...
			(openOfficeConfiguration, configurationMappingCollector) -> {
				configurationMappingCollector.mapConfiguration(
					LegacyOpenOfficePropsKeys.OPENOFFICE_CACHE_ENABLED,
					"cacheEnabled", openOfficeConfiguration.cacheEnabled());
				configurationMappingCollector.mapConfiguration(
					LegacyOpenOfficePropsKeys.OPENOFFICE_SERVER_ENABLED,
					"serverEnabled", openOfficeConfiguration.serverEnabled());
				configurationMappingCollector.mapConfiguration(
					LegacyOpenOfficePropsKeys.OPENOFFICE_SERVER_HOST,
					"serverHost", openOfficeConfiguration.serverHost());
				configurationMappingCollector.mapConfiguration(
					LegacyOpenOfficePropsKeys.OPENOFFICE_SERVER_PORT,
					"serverPort", openOfficeConfiguration.serverPort());
			});
	}
