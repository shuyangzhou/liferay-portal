...
public class DLStorageQuotaLocalServiceUtil {
	...
	public static DLStorageQuotaLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DLStorageQuotaLocalServiceUtil::_getService);
	}

	private static DLStorageQuotaLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			DLStorageQuotaLocalServiceUtil.class);
		...
		ServiceReference<DLStorageQuotaLocalService> serviceReference =
			bundleContext.getServiceReference(DLStorageQuotaLocalService.class);
	...
	private static final DCLSingleton<DLStorageQuotaLocalService>
