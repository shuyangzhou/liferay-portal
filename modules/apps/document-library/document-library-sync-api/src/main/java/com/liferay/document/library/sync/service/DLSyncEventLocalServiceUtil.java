...
public class DLSyncEventLocalServiceUtil {
	...
	public static DLSyncEventLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DLSyncEventLocalServiceUtil::_getService);
	}

	private static DLSyncEventLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			DLSyncEventLocalServiceUtil.class);
		...
		ServiceReference<DLSyncEventLocalService> serviceReference =
			bundleContext.getServiceReference(DLSyncEventLocalService.class);
	...
	private static final DCLSingleton<DLSyncEventLocalService>
