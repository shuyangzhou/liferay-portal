...
public class AccountGroupRelLocalServiceUtil {
	...
	public static AccountGroupRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			AccountGroupRelLocalServiceUtil::_getService);
	}

	private static AccountGroupRelLocalService _getService() {
		...
		ServiceReference<AccountGroupRelLocalService> serviceReference =
	...
	private static final DCLSingleton<AccountGroupRelLocalService>
