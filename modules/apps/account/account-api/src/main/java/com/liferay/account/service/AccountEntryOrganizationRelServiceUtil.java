...
public class AccountEntryOrganizationRelServiceUtil {
	...
	public static AccountEntryOrganizationRelService getService() {
		return _serviceDCLSingleton.getSingleton(
			AccountEntryOrganizationRelServiceUtil::_getService);
	}

	private static AccountEntryOrganizationRelService _getService() {
		...
		ServiceReference<AccountEntryOrganizationRelService> serviceReference =
	...
	private static final DCLSingleton<AccountEntryOrganizationRelService>
