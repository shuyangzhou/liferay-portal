...
public class AccountRoleServiceUtil {
	...
	public static AccountRoleService getService() {
		return _serviceDCLSingleton.getSingleton(
			AccountRoleServiceUtil::_getService);
	}

	private static AccountRoleService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(AccountRoleServiceUtil.class);
		...
		ServiceReference<AccountRoleService> serviceReference =
			bundleContext.getServiceReference(AccountRoleService.class);
	...
	private static final DCLSingleton<AccountRoleService> _serviceDCLSingleton =
		new DCLSingleton<>();
