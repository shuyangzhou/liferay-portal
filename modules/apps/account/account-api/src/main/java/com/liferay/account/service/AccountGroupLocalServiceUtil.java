...
public class AccountGroupLocalServiceUtil {
	...
	public static AccountGroupLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			AccountGroupLocalServiceUtil::_getService);
	}

	private static AccountGroupLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			AccountGroupLocalServiceUtil.class);
		...
		ServiceReference<AccountGroupLocalService> serviceReference =
			bundleContext.getServiceReference(AccountGroupLocalService.class);
	...
	private static final DCLSingleton<AccountGroupLocalService>
