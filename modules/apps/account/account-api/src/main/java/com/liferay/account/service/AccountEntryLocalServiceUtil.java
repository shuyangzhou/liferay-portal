...
public class AccountEntryLocalServiceUtil {
	...
	public static AccountEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			AccountEntryLocalServiceUtil::_getService);
	}

	private static AccountEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			AccountEntryLocalServiceUtil.class);
		...
		ServiceReference<AccountEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<AccountEntryLocalService>
