...
public class BatchEngineImportTaskLocalServiceUtil {
	...
	public static BatchEngineImportTaskLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			BatchEngineImportTaskLocalServiceUtil::_getService);
	}

	private static BatchEngineImportTaskLocalService _getService() {
		...
		ServiceReference<BatchEngineImportTaskLocalService> serviceReference =
	...
	private static final DCLSingleton<BatchEngineImportTaskLocalService>
