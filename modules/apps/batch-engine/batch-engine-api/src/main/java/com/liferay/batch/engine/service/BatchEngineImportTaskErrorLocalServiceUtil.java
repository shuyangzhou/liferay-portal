...
public class BatchEngineImportTaskErrorLocalServiceUtil {
	...
	public static BatchEngineImportTaskErrorLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			BatchEngineImportTaskErrorLocalServiceUtil::_getService);
	}

	private static BatchEngineImportTaskErrorLocalService _getService() {
		...
		ServiceReference<BatchEngineImportTaskErrorLocalService>
	...
	private static final DCLSingleton<BatchEngineImportTaskErrorLocalService>
