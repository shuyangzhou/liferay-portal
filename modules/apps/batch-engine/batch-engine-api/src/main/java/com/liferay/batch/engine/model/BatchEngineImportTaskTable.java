...
public class BatchEngineImportTaskTable
	extends Table<BatchEngineImportTaskTable> {
	...
	public final Column<BatchEngineImportTaskTable, String> fieldNameMapping =
		createColumn("fieldNameMapping", String.class, Types.CLOB);
	public final Column<BatchEngineImportTaskTable, String> operation =
		createColumn("operation", String.class, Types.VARCHAR);
	public final Column<BatchEngineImportTaskTable, String> parameters =
		createColumn("parameters", String.class, Types.CLOB);
