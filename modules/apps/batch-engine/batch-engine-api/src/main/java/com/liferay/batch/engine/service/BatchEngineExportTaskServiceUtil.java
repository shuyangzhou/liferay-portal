...
public class BatchEngineExportTaskServiceUtil {
	...
	public static BatchEngineExportTaskService getService() {
		return _serviceDCLSingleton.getSingleton(
			BatchEngineExportTaskServiceUtil::_getService);
	}

	private static BatchEngineExportTaskService _getService() {
		...
		ServiceReference<BatchEngineExportTaskService> serviceReference =
	...
	private static final DCLSingleton<BatchEngineExportTaskService>
