...
public class BookmarksEntryWrapper implements BookmarksEntry,
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<BookmarksEntry, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<BookmarksEntry, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<BookmarksEntry, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<BookmarksEntry, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<BookmarksEntry, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<BookmarksEntry, Object> attributeBiConsumer = entry.getValue();
	...
	public Map<String, Function<BookmarksEntry, Object>> getAttributeGetters() {
		return _bookmarksEntry.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<BookmarksEntry, Object>> getAttributeSetters() {
		return _bookmarksEntry.getAttributeSetters();
	}
