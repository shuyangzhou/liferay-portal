...
public class BookmarksFolderServiceUtil {
	...
	public static BookmarksFolderService getService() {
		return _serviceDCLSingleton.getSingleton(
			BookmarksFolderServiceUtil::_getService);
	}

	private static BookmarksFolderService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			BookmarksFolderServiceUtil.class);
		...
		ServiceReference<BookmarksFolderService> serviceReference =
			bundleContext.getServiceReference(BookmarksFolderService.class);
	...
	private static final DCLSingleton<BookmarksFolderService>
