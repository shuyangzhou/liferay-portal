...
public class BookmarksFolderWrapper implements BookmarksFolder,
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<BookmarksFolder, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<BookmarksFolder, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<BookmarksFolder, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<BookmarksFolder, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<BookmarksFolder, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<BookmarksFolder, Object> attributeBiConsumer = entry.getValue();
	...
	@Override
	public Map<String, Function<BookmarksFolder, Object>> getAttributeGetters() {
		return _bookmarksFolder.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<BookmarksFolder, Object>> getAttributeSetters() {
		return _bookmarksFolder.getAttributeSetters();
	}
