...
public class BookmarksEntryModelImpl extends BaseModelImpl<BookmarksEntry>
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.bookmarks.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.bookmarks.model.BookmarksEntry"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.bookmarks.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.bookmarks.model.BookmarksEntry"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.bookmarks.util.service.ServiceProps.get(
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.bookmarks.util.service.ServiceProps.get(
