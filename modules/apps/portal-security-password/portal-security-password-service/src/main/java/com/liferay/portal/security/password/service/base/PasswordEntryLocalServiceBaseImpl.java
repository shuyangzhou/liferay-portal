...
public abstract class PasswordEntryLocalServiceBaseImpl
	...
	public PasswordEntry createPasswordEntry(long entryId) {
		return passwordEntryPersistence.create(entryId);
	}
	...
	public PasswordEntry fetchPasswordEntry(long entryId) {
		return passwordEntryPersistence.fetchByPrimaryKey(entryId);
	}
	...
	public PasswordEntry getPasswordEntry(long entryId) throws PortalException {
		return passwordEntryPersistence.findByPrimaryKey(entryId);
	}
