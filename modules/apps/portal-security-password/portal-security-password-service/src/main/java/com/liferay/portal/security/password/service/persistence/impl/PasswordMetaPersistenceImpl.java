...
public class PasswordMetaPersistenceImpl
	...
	public List<PasswordMeta> findByUuid(
		...
		if (list == null) {
			...
			query.append(_SQL_SELECT_PASSWORDMETA_WHERE);
			...
			if (orderByComparator != null) {
				...
				query.append(PasswordMetaModelImpl.ORDER_BY_JPQL);
			}
	...
	public PasswordMeta findByUuid_First(
		...
		throw new NoSuchMetaException(msg.toString());
	}
	...
	public PasswordMeta[] findByUuid_PrevAndNext(
		...
		PasswordMeta passwordMeta = findByPrimaryKey(metaId);
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			query.append(_SQL_COUNT_PASSWORDMETA_WHERE);
	...
	public List<PasswordMeta> findByPasswordEntryId(
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_PASSWORDENTRYID_PASSWORDENTRYID_2);
	...
	private FinderPath _finderPathWithPaginationFindByHashAlgorithmEntryId;
	private FinderPath _finderPathWithoutPaginationFindByHashAlgorithmEntryId;
	private FinderPath _finderPathCountByHashAlgorithmEntryId;
	 ...
	 */
	@Override
	public List<PasswordMeta> findByHashAlgorithmEntryId(
		long hashAlgorithmEntryId) {

		return findByHashAlgorithmEntryId(
			hashAlgorithmEntryId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<PasswordMeta> findByHashAlgorithmEntryId(
		...
		return findByHashAlgorithmEntryId(
			hashAlgorithmEntryId, start, end, null);
	}
	...
	public List<PasswordMeta> findByHashAlgorithmEntryId(
		...
		return findByHashAlgorithmEntryId(
			hashAlgorithmEntryId, start, end, orderByComparator, true);
	}
	...
	public List<PasswordMeta> findByHashAlgorithmEntryId(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath =
					_finderPathWithoutPaginationFindByHashAlgorithmEntryId;
				finderArgs = new Object[] {hashAlgorithmEntryId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByHashAlgorithmEntryId;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			query.append(
				_FINDER_COLUMN_HASHALGORITHMENTRYID_HASHALGORITHMENTRYID_2);
	...
	public PasswordMeta findByHashAlgorithmEntryId_First(
		...
		PasswordMeta passwordMeta = fetchByHashAlgorithmEntryId_First(
		...
		msg.append("hashAlgorithmEntryId=");
		msg.append(hashAlgorithmEntryId);
	...
	public PasswordMeta fetchByHashAlgorithmEntryId_First(
		...
		List<PasswordMeta> list = findByHashAlgorithmEntryId(
			hashAlgorithmEntryId, 0, 1, orderByComparator);
	...
	public PasswordMeta findByHashAlgorithmEntryId_Last(
		...
		PasswordMeta passwordMeta = fetchByHashAlgorithmEntryId_Last(
			hashAlgorithmEntryId, orderByComparator);
	...
	public PasswordMeta fetchByHashAlgorithmEntryId_Last(
		...
		int count = countByHashAlgorithmEntryId(hashAlgorithmEntryId);
		...
		List<PasswordMeta> list = findByHashAlgorithmEntryId(
			hashAlgorithmEntryId, count - 1, count, orderByComparator);
	...
	public PasswordMeta[] findByHashAlgorithmEntryId_PrevAndNext(
		...
		try {
			...
			array[0] = getByHashAlgorithmEntryId_PrevAndNext(
				session, passwordMeta, hashAlgorithmEntryId, orderByComparator,
				true);

			array[1] = passwordMeta;

			array[2] = getByHashAlgorithmEntryId_PrevAndNext(
				session, passwordMeta, hashAlgorithmEntryId, orderByComparator,
				false);
	...
	protected PasswordMeta getByHashAlgorithmEntryId_PrevAndNext(
		Session session, PasswordMeta passwordMeta, long hashAlgorithmEntryId,
		OrderByComparator<PasswordMeta> orderByComparator, boolean previous) {
	...
	public void removeByHashAlgorithmEntryId(long hashAlgorithmEntryId) {
		for (PasswordMeta passwordMeta :
				findByHashAlgorithmEntryId(
					hashAlgorithmEntryId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	...
	public int countByHashAlgorithmEntryId(long hashAlgorithmEntryId) {
		FinderPath finderPath = _finderPathCountByHashAlgorithmEntryId;

		Object[] finderArgs = new Object[] {hashAlgorithmEntryId};
	...
	private static final String
		_FINDER_COLUMN_HASHALGORITHMENTRYID_HASHALGORITHMENTRYID_2 =
			"passwordMeta.hashAlgorithmEntryId = ?";
	...
	public PasswordMeta create(long metaId) {
		...
		passwordMeta.setPrimaryKey(metaId);
	...
	public PasswordMeta remove(Serializable primaryKey)
		...
		catch (NoSuchMetaException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	public PasswordMeta updateImpl(PasswordMeta passwordMeta) {
		...
		if (!_columnBitmaskEnabled) {
			...
			args = new Object[] {
				passwordMetaModelImpl.getHashAlgorithmEntryId()
			};

			finderCache.removeResult(
				_finderPathCountByHashAlgorithmEntryId, args);
			finderCache.removeResult(
				_finderPathWithoutPaginationFindByHashAlgorithmEntryId, args);
			...
			if ((passwordMetaModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					passwordMetaModelImpl.getOriginalHashAlgorithmEntryId()
				};
	...
	public List<PasswordMeta> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				query.append(_SQL_SELECT_PASSWORDMETA);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query q = session.createQuery(_SQL_COUNT_PASSWORDMETA);
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByHashAlgorithmEntryId = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, PasswordMetaImpl.class,
		...
		_finderPathWithoutPaginationFindByHashAlgorithmEntryId = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, PasswordMetaImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByHashAlgorithmEntryId", new String[] {Long.class.getName()},
			PasswordMetaModelImpl.HASHALGORITHMENTRYID_COLUMN_BITMASK |
			PasswordMetaModelImpl.MODIFIEDDATE_COLUMN_BITMASK);

		_finderPathCountByHashAlgorithmEntryId = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByHashAlgorithmEntryId", new String[] {Long.class.getName()});
	}
