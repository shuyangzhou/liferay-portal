...
public class DEDataListViewLocalServiceUtil {
	...
	public static DEDataListViewLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DEDataListViewLocalServiceUtil::_getService);
	}

	private static DEDataListViewLocalService _getService() {
		...
		ServiceReference<DEDataListViewLocalService> serviceReference =
			bundleContext.getServiceReference(DEDataListViewLocalService.class);
	...
	private static final DCLSingleton<DEDataListViewLocalService>
