...
public class DEDataDefinitionFieldLinkLocalServiceUtil {
	...
	public static DEDataDefinitionFieldLinkLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DEDataDefinitionFieldLinkLocalServiceUtil::_getService);
	}

	private static DEDataDefinitionFieldLinkLocalService _getService() {
		...
		ServiceReference<DEDataDefinitionFieldLinkLocalService>
	...
	private static final DCLSingleton<DEDataDefinitionFieldLinkLocalService>
