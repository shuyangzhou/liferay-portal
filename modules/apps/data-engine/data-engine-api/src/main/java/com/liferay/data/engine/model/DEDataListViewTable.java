...
public class DEDataListViewTable extends Table<DEDataListViewTable> {
	...
	public final Column<DEDataListViewTable, String> appliedFilters =
		createColumn("appliedFilters", String.class, Types.CLOB);
	public final Column<DEDataListViewTable, Long> ddmStructureId =
		createColumn("ddmStructureId", Long.class, Types.BIGINT);
	public final Column<DEDataListViewTable, String> fieldNames = createColumn(
		"fieldNames", String.class, Types.CLOB);
