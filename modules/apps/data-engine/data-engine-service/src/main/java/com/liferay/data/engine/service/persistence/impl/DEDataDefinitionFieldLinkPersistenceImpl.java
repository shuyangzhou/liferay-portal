...
public class DEDataDefinitionFieldLinkPersistenceImpl
	...
	public List<DEDataDefinitionFieldLink> findByUuid(
		...
		List<DEDataDefinitionFieldLink> list =
			(List<DEDataDefinitionFieldLink>)finderCache.getResult(
				finderPath, finderArgs, this);

		if ((list != null) && !list.isEmpty()) {
			for (DEDataDefinitionFieldLink deDataDefinitionFieldLink : list) {
	...
	public DEDataDefinitionFieldLink fetchByC_C_D_F(
		...
		return fetchByC_C_D_F(classNameId, classPK, ddmStructureId, fieldName);
	}
