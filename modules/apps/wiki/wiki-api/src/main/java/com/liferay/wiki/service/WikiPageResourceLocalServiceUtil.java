...
public class WikiPageResourceLocalServiceUtil {
	...
	public static WikiPageResourceLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			WikiPageResourceLocalServiceUtil::_getService);
	}

	private static WikiPageResourceLocalService _getService() {
		...
		ServiceReference<WikiPageResourceLocalService> serviceReference =
	...
	private static final DCLSingleton<WikiPageResourceLocalService>
