...
public class WikiPageLocalServiceUtil {
	...
	public static WikiPageLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			WikiPageLocalServiceUtil::_getService);
	}

	private static WikiPageLocalService _getService() {
		...
		ServiceReference<WikiPageLocalService> serviceReference =
			bundleContext.getServiceReference(WikiPageLocalService.class);
	...
	private static final DCLSingleton<WikiPageLocalService>
