...
DispatchTask dispatchTask = dispatchLogDisplayContext.getDispatchTask();
...
<div id="<portlet:namespace />dispatchTaskLogsContainer">
	<div class="closed container-fluid-1280" id="<portlet:namespace />infoPanelId">
		<aui:form action="<%= portletURL.toString() %>" method="post" name="fm">
			...
			<div class="task-lists-container" id="<portlet:namespace />entriesContainer">
				...
				>
					...
					>
						...
						<liferay-ui:search-container-column-text
							cssClass="table-cell-content"
							name="task"
							value="<%= HtmlUtil.escape(dispatchTask.getName()) %>"
						/>
