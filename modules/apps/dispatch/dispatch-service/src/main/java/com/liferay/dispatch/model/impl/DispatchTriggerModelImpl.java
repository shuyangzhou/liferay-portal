...
public class DispatchTriggerModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"jobProperties", Types.VARCHAR}, {"jobType", Types.VARCHAR},
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("jobProperties", Types.VARCHAR);
	 ...
	 */
	@Deprecated
	public static final long JOBTYPE_COLUMN_BITMASK = 2L;
	...
	public static DispatchTrigger toModel(DispatchTriggerSoap soapModel) {
		...
		model.setJobProperties(soapModel.getJobProperties());
	...
	static {
		...
		attributeSetterBiConsumers.put(
			"jobProperties",
			(BiConsumer<DispatchTrigger, String>)
				DispatchTrigger::setJobProperties);
		attributeGetterFunctions.put("jobType", DispatchTrigger::getJobType);
		attributeSetterBiConsumers.put(
			"jobType",
			(BiConsumer<DispatchTrigger, String>)DispatchTrigger::setJobType);
	...
	public String getOriginalJobType() {
		return getColumnOriginalValue("jobType");
	}
	...
	public Object clone() {
		...
		dispatchTriggerImpl.setJobProperties(getJobProperties());
		dispatchTriggerImpl.setJobType(getJobType());
	...
	public CacheModel<DispatchTrigger> toCacheModel() {
		...
		dispatchTriggerCacheModel.jobProperties = getJobProperties();

		String jobProperties = dispatchTriggerCacheModel.jobProperties;

		if ((jobProperties != null) && (jobProperties.length() == 0)) {
			dispatchTriggerCacheModel.jobProperties = null;
		}

		dispatchTriggerCacheModel.jobType = getJobType();

		String jobType = dispatchTriggerCacheModel.jobType;

		if ((jobType != null) && (jobType.length() == 0)) {
			dispatchTriggerCacheModel.jobType = null;
		}
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("jobProperties", _jobProperties);
	...
	static {
		...
		columnBitmasks.put("jobProperties", 1024L);
