...
public class DispatchTriggerPersistenceImpl
	...
	private BaseFinder<DispatchTrigger> _baseFinderUuid;
	...
	private BaseFinder<DispatchTrigger> _baseFinderUuid_C;
	...
	private BaseFinder<DispatchTrigger> _baseFinderCompanyId;
	...
	private BaseFinder<DispatchTrigger> _baseFinderActive;
	...
	public List<DispatchTrigger> findByActive(
		...
		return _baseFinderActive.findList(
			new Object[] {active}, start, end, orderByComparator,
			useFinderCache);
	}
	...
	public int countByActive(boolean active) {
		return _baseFinderActive.count(new Object[] {active});
	}
	...
	private BaseFinder<DispatchTrigger> _baseFinderC_U;
	...
	private BaseFinder<DispatchTrigger> _baseFinderC_DTET;
	...
	public List<DispatchTrigger> findByC_DTET(
		...
		return _baseFinderC_DTET.findList(
			new Object[] {companyId, dispatchTaskExecutorType}, start, end,
	...
	public int countByC_DTET(long companyId, String dispatchTaskExecutorType) {
		return _baseFinderC_DTET.count(
	...
	private BaseFinder<DispatchTrigger> _baseFinderC_N;
	...
	public DispatchTrigger fetchByC_N(
		...
		return _baseFinderC_N.fetchOne(
	...
	private BaseFinder<DispatchTrigger> _baseFinderERC_C;
	...
	public void activate() {
		...
		_baseFinderUuid = new BaseFinder.Builder<>(
			...
			DispatchTriggerModelImpl.ORDER_BY_JPQL
		).orderByEntityAlias(
		...
		_baseFinderActive = new BaseFinder.Builder<>(
			this, finderCache
		).columns(
			new FinderColumn(_FINDER_COLUMN_ACTIVE_ACTIVE_2)
		).sqlSelectWhere(
			_SQL_SELECT_DISPATCHTRIGGER_WHERE
		).sqlCountWhere(
			_SQL_COUNT_DISPATCHTRIGGER_WHERE
			...
			(columnValues, model) -> {
				if (!Objects.equals(columnValues[0], model.isActive())) {
					return false;
				}
		...
		_baseFinderC_DTET = new BaseFinder.Builder<>(
			this, finderCache
		).columns(
			new FinderColumn(_FINDER_COLUMN_C_DTET_COMPANYID_2),
			new FinderColumn(
				_FINDER_COLUMN_C_DTET_DISPATCHTASKEXECUTORTYPE_2,
				_FINDER_COLUMN_C_DTET_DISPATCHTASKEXECUTORTYPE_3)
		).sqlSelectWhere(
			...
			(columnValues, model) -> {
				...
				if (!Objects.equals(
						columnValues[1], model.getDispatchTaskExecutorType())) {
		...
		_baseFinderC_N = new BaseFinder.Builder<>(
			this, finderCache
		).columns(
			new FinderColumn(_FINDER_COLUMN_C_N_COMPANYID_2),
			new FinderColumn(
				_FINDER_COLUMN_C_N_NAME_2, _FINDER_COLUMN_C_N_NAME_3)
		).sqlSelectWhere(
			_SQL_SELECT_DISPATCHTRIGGER_WHERE
		).sqlCountWhere(
			_SQL_COUNT_DISPATCHTRIGGER_WHERE
