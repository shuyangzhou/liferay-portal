...
DispatchTalendScheduledJobHelper dispatchTalendScheduledJobHelper = (DispatchTalendScheduledJobHelper)request.getAttribute("dispatchTalendScheduledTaskExecutorHelper");
%>
...
<div class="closed container-fluid-1280" id="<portlet:namespace />editDispatchTriggerId">
	<div class="container main-content-body sheet">
		<aui:form action="<%= editDispatchTalendJobArchiveActionURL %>" cssClass="container-fluid-1280" enctype="multipart/form-data" method="post" name="fm">
			...
			<%
			FileEntry fileEntry = dispatchTalendScheduledJobHelper.getFileEntry(dispatchTrigger.getDispatchTriggerId());
			%>
