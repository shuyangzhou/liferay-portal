...
public class DispatchLogTable extends Table<DispatchLogTable> {
	...
	public final Column<DispatchLogTable, String> error = createColumn(
		"error", String.class, Types.CLOB);
	public final Column<DispatchLogTable, String> output = createColumn(
		"output_", String.class, Types.CLOB);
