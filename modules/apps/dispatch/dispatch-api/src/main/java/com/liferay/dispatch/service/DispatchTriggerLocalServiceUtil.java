...
public class DispatchTriggerLocalServiceUtil {
	...
	public static DispatchTriggerLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DispatchTriggerLocalServiceUtil::_getService);
	}

	private static DispatchTriggerLocalService _getService() {
		...
		ServiceReference<DispatchTriggerLocalService> serviceReference =
	...
	private static final DCLSingleton<DispatchTriggerLocalService>
