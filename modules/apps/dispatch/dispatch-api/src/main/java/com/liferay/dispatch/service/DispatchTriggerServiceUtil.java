...
public class DispatchTriggerServiceUtil {
	...
	public static DispatchTriggerService getService() {
		return _serviceDCLSingleton.getSingleton(
			DispatchTriggerServiceUtil::_getService);
	}

	private static DispatchTriggerService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			DispatchTriggerServiceUtil.class);
		...
		ServiceReference<DispatchTriggerService> serviceReference =
			bundleContext.getServiceReference(DispatchTriggerService.class);
	...
	private static final DCLSingleton<DispatchTriggerService>
