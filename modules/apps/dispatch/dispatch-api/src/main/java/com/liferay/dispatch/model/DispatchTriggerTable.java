...
public class DispatchTriggerTable extends BaseTable<DispatchTriggerTable> {
	...
	public final Column<DispatchTriggerTable, String> jobProperties =
		createColumn(
			"jobProperties", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
	public final Column<DispatchTriggerTable, String> jobType = createColumn(
