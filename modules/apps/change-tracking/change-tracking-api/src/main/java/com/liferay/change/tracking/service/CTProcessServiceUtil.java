...
public class CTProcessServiceUtil {
	...
	public static CTProcessService getService() {
		return _serviceDCLSingleton.getSingleton(
			CTProcessServiceUtil::_getService);
	}

	private static CTProcessService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(CTProcessServiceUtil.class);
		...
		ServiceReference<CTProcessService> serviceReference =
			bundleContext.getServiceReference(CTProcessService.class);
	...
	private static final DCLSingleton<CTProcessService> _serviceDCLSingleton =
		new DCLSingleton<>();
