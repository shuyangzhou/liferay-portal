...
public class CTMessageLocalServiceUtil {
	...
	public static CTMessageLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CTMessageLocalServiceUtil::_getService);
	}

	private static CTMessageLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			CTMessageLocalServiceUtil.class);
		...
		ServiceReference<CTMessageLocalService> serviceReference =
			bundleContext.getServiceReference(CTMessageLocalService.class);
	...
	private static final DCLSingleton<CTMessageLocalService>
