...
public class CTCommentLocalServiceUtil {
	...
	public static CTCommentLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CTCommentLocalServiceUtil::_getService);
	}

	private static CTCommentLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			CTCommentLocalServiceUtil.class);
		...
		ServiceReference<CTCommentLocalService> serviceReference =
			bundleContext.getServiceReference(CTCommentLocalService.class);
	...
	private static final DCLSingleton<CTCommentLocalService>
