...
public class CTCollectionLocalServiceUtil {
	...
	public static CTCollectionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CTCollectionLocalServiceUtil::_getService);
	}

	private static CTCollectionLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			CTCollectionLocalServiceUtil.class);
		...
		ServiceReference<CTCollectionLocalService> serviceReference =
			bundleContext.getServiceReference(CTCollectionLocalService.class);
	...
	private static final DCLSingleton<CTCollectionLocalService>
