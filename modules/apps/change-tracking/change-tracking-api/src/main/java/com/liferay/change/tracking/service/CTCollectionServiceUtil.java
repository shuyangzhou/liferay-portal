...
public class CTCollectionServiceUtil {
	...
	public static CTCollectionService getService() {
		return _serviceDCLSingleton.getSingleton(
			CTCollectionServiceUtil::_getService);
	}

	private static CTCollectionService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(CTCollectionServiceUtil.class);
		...
		ServiceReference<CTCollectionService> serviceReference =
			bundleContext.getServiceReference(CTCollectionService.class);
	...
	private static final DCLSingleton<CTCollectionService>
