...
public class CTPreferencesLocalServiceUtil {
	...
	public static CTPreferencesLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CTPreferencesLocalServiceUtil::_getService);
	}

	private static CTPreferencesLocalService _getService() {
		...
		ServiceReference<CTPreferencesLocalService> serviceReference =
			bundleContext.getServiceReference(CTPreferencesLocalService.class);
	...
	private static final DCLSingleton<CTPreferencesLocalService>
