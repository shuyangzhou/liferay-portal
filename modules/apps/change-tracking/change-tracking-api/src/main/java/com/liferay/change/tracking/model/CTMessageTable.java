 ...
 * @generated
 */
public class CTMessageTable extends Table<CTMessageTable> {
	...
	public final Column<CTMessageTable, String> messageContent = createColumn(
		"messageContent", String.class, Types.CLOB);
