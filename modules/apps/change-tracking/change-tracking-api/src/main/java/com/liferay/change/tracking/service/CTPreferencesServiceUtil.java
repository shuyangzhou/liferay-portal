...
public class CTPreferencesServiceUtil {
	...
	public static CTPreferencesService getService() {
		return _serviceDCLSingleton.getSingleton(
			CTPreferencesServiceUtil::_getService);
	}

	private static CTPreferencesService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(CTPreferencesServiceUtil.class);
		...
		ServiceReference<CTPreferencesService> serviceReference =
			bundleContext.getServiceReference(CTPreferencesService.class);
	...
	private static final DCLSingleton<CTPreferencesService>
