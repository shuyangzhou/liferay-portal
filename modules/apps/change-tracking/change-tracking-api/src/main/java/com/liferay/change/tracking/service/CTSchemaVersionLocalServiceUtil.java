...
public class CTSchemaVersionLocalServiceUtil {
	...
	public static CTSchemaVersionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CTSchemaVersionLocalServiceUtil::_getService);
	}

	private static CTSchemaVersionLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			CTSchemaVersionLocalServiceUtil.class);
		...
		ServiceReference<CTSchemaVersionLocalService> serviceReference =
	...
	private static final DCLSingleton<CTSchemaVersionLocalService>
