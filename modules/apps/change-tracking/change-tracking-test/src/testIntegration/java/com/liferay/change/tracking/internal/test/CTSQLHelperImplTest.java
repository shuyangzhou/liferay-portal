...
public class CTSQLHelperImplTest {
	...
	private static void _createCTEntries(
	...
	@SafeVarargs
	private final void _assertSelect(
	...
	private String _getSQL(
		...
		String newSQL = _querySQLTransformer.transform(inputSQL);
	...
	@Inject
	private static QuerySQLTransformer _querySQLTransformer;
