...
public class CTMessagePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newCTMessage.setDestinationName(RandomTestUtil.randomString());
		...
		Assert.assertEquals(
			existingCTMessage.getDestinationName(),
			newCTMessage.getDestinationName());
		Assert.assertEquals(
	...
	protected OrderByComparator<CTMessage> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			true, "userId", true, "ctCollectionId", true, "destinationName",
			true);
	}
	...
	protected CTMessage addCTMessage() throws Exception {
		...
		ctMessage.setDestinationName(RandomTestUtil.randomString());
