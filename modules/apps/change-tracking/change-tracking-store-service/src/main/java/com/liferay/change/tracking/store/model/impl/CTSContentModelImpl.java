...
public class CTSContentModelImpl
	...
	public void setCtsContentId(long ctsContentId) {
		if ((_columnBitmask & CTSCONTENTID_COLUMN_BITMASK) == 0) {
			...
			_originalValues[CTSCONTENTID_COLUMN_INDEX] = _ctsContentId;
		}
	...
	public void setStoreType(String storeType) {
		if ((_columnBitmask & STORETYPE_COLUMN_BITMASK) == 0) {
	...
	public String getOriginalStoreType() {
		if (_originalValues != null) {
			Object originalStoreType = _originalValues[STORETYPE_COLUMN_INDEX];

			if (originalStoreType != null) {
				return GetterUtil.getString((String)originalStoreType);
			}
		}

		return GetterUtil.getString(_storeType);
	}
