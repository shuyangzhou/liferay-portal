...
public class CTSContentPersistenceImpl
	 ...
	 */
	@Override
	public List<CTSContent> findByCTCollectionId(long ctCollectionId) {
	 ...
	 */
	@Override
	public List<CTSContent> findByCTCollectionId(
	...
	public List<CTSContent> findByCTCollectionId(
		...
		if (useFinderCache && productionMode) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (CTSContent ctsContent : list) {
					if (ctCollectionId != ctsContent.getCtCollectionId()) {
						list = null;
		...
		if (list == null) {
			...
			query.append(_SQL_SELECT_CTSCONTENT_WHERE);
			...
			if (orderByComparator != null) {
				...
				query.append(CTSContentModelImpl.ORDER_BY_JPQL);
			}
	...
	public CTSContent findByCTCollectionId_First(
		...
		CTSContent ctsContent = fetchByCTCollectionId_First(
	...
	public CTSContent fetchByCTCollectionId_First(
		...
		List<CTSContent> list = findByCTCollectionId(
	...
	public CTSContent findByCTCollectionId_Last(
		...
		CTSContent ctsContent = fetchByCTCollectionId_Last(
			ctCollectionId, orderByComparator);
	...
	public CTSContent[] findByCTCollectionId_PrevAndNext(
		...
		try {
			...
			array[0] = getByCTCollectionId_PrevAndNext(
				session, ctsContent, ctCollectionId, orderByComparator, true);

			array[1] = ctsContent;

			array[2] = getByCTCollectionId_PrevAndNext(
				session, ctsContent, ctCollectionId, orderByComparator, false);
	...
	protected CTSContent getByCTCollectionId_PrevAndNext(
		Session session, CTSContent ctsContent, long ctCollectionId,
	...
	public int countByCTCollectionId(long ctCollectionId) {
		...
		if (count == null) {
			...
			query.append(_SQL_COUNT_CTSCONTENT_WHERE);
	...
	public List<CTSContent> findByC_R_S(
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_R_S_COMPANYID_2);

			query.append(_FINDER_COLUMN_C_R_S_REPOSITORYID_2);

			boolean bindStoreType = false;

			if (storeType.isEmpty()) {
				query.append(_FINDER_COLUMN_C_R_S_STORETYPE_3);
			}
			else {
				bindStoreType = true;

				query.append(_FINDER_COLUMN_C_R_S_STORETYPE_2);
			}
	...
	public List<CTSContent> findByC_R_P_S(
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_R_P_S_COMPANYID_2);

			query.append(_FINDER_COLUMN_C_R_P_S_REPOSITORYID_2);

			boolean bindPath = false;

			if (path.isEmpty()) {
				query.append(_FINDER_COLUMN_C_R_P_S_PATH_3);
			}
			else {
				bindPath = true;

				query.append(_FINDER_COLUMN_C_R_P_S_PATH_2);
			}

			boolean bindStoreType = false;

			if (storeType.isEmpty()) {
				query.append(_FINDER_COLUMN_C_R_P_S_STORETYPE_3);
			}
			else {
				bindStoreType = true;

				query.append(_FINDER_COLUMN_C_R_P_S_STORETYPE_2);
			}
	...
	public List<CTSContent> findByC_R_LikeP_S(
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_R_LIKEP_S_COMPANYID_2);

			query.append(_FINDER_COLUMN_C_R_LIKEP_S_REPOSITORYID_2);

			boolean bindPath = false;

			if (path.isEmpty()) {
				query.append(_FINDER_COLUMN_C_R_LIKEP_S_PATH_3);
			}
			else {
				bindPath = true;

				query.append(_FINDER_COLUMN_C_R_LIKEP_S_PATH_2);
			}

			boolean bindStoreType = false;

			if (storeType.isEmpty()) {
				query.append(_FINDER_COLUMN_C_R_LIKEP_S_STORETYPE_3);
			}
			else {
				bindStoreType = true;

				query.append(_FINDER_COLUMN_C_R_LIKEP_S_STORETYPE_2);
			}
	...
	public CTSContent fetchByC_R_P_V_S(
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_C_R_P_V_S_COMPANYID_2);

			query.append(_FINDER_COLUMN_C_R_P_V_S_REPOSITORYID_2);

			boolean bindPath = false;

			if (path.isEmpty()) {
				query.append(_FINDER_COLUMN_C_R_P_V_S_PATH_3);
			}
			else {
				bindPath = true;

				query.append(_FINDER_COLUMN_C_R_P_V_S_PATH_2);
			}

			boolean bindVersion = false;

			if (version.isEmpty()) {
				query.append(_FINDER_COLUMN_C_R_P_V_S_VERSION_3);
			}
			else {
				bindVersion = true;

				query.append(_FINDER_COLUMN_C_R_P_V_S_VERSION_2);
			}

			boolean bindStoreType = false;

			if (storeType.isEmpty()) {
				query.append(_FINDER_COLUMN_C_R_P_V_S_STORETYPE_3);
			}
			else {
				bindStoreType = true;

				query.append(_FINDER_COLUMN_C_R_P_V_S_STORETYPE_2);
			}
	...
	public CTSContent updateImpl(CTSContent ctsContent) {
		...
		if (ctsContent.getCtCollectionId() != 0) {
			if (!_columnBitmaskEnabled) {
			...
			else if ((ctsContentModelImpl.getColumnBitmask() &
					  _finderPathWithoutPaginationFindByCTCollectionId.
						  getColumnBitmask()) != 0) {

				Object[] args = new Object[] {
					ctsContentModelImpl.getOriginalCtCollectionId()
				};
				...
				args = new Object[] {ctsContentModelImpl.getCtCollectionId()};
	...
	public Map<Serializable, CTSContent> fetchByPrimaryKeys(
		...
		try {
			...
			for (CTSContent ctsContent : (List<CTSContent>)q.list()) {
	...
	public List<CTSContent> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				query.append(_SQL_SELECT_CTSCONTENT);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query q = session.createQuery(_SQL_COUNT_CTSCONTENT);
	...
	@Override
	public CTSContent removeCTModel(CTSContent ctsContent, boolean quiet) {
		if (quiet) {
			return removeImpl(ctsContent);
		}
	...
	@Override
	public CTSContent updateCTModel(CTSContent ctsContent, boolean quiet) {
		if (quiet) {
			return updateImpl(ctsContent);
		}

		return update(ctsContent);
	}
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByCTCollectionId = new FinderPath(
			...
			CTSContentModelImpl.CTCOLLECTIONID_COLUMN_BITMASK |
