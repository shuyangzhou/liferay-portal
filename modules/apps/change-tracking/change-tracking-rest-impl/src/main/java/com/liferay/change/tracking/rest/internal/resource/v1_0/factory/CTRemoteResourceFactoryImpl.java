 ...
 */
@Component(
	property = "resource.locator.key=/change-tracking-rest/v1.0/CTRemote",
	service = CTRemoteResource.Factory.class
)
@Generated("")
public class CTRemoteResourceFactoryImpl implements CTRemoteResource.Factory {

	@Override
	public CTRemoteResource.Builder create() {
		return new CTRemoteResource.Builder() {
			...
			@Override
			public CTRemoteResource.Builder checkPermissions(
			...
			@Override
			public CTRemoteResource.Builder httpServletRequest(
			...
			@Override
			public CTRemoteResource.Builder httpServletResponse(
			...
			@Override
			public CTRemoteResource.Builder preferredLocale(
			...
			@Override
			public CTRemoteResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
			...
			@Override
			public CTRemoteResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, CTRemoteResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			CTRemoteResource.class.getClassLoader(), CTRemoteResource.class);

		try {
			Constructor<CTRemoteResource> constructor =
				(Constructor<CTRemoteResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(ctRemoteResource);
	...
	private ComponentServiceObjects<CTRemoteResource> _componentServiceObjects;
