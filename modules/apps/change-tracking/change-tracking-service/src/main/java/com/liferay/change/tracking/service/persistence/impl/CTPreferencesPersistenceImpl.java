...
public class CTPreferencesPersistenceImpl
	...
	private BaseFinder<CTPreferences> _baseFinderCtCollectionId;
	...
	public CTPreferences[] findByCtCollectionId_PrevAndNext(
		...
		_baseFinderCtCollectionId.findPrevAndNext(
			array, ctPreferences, new Object[] {ctCollectionId},
			orderByComparator);
	...
	private BaseFinder<CTPreferences> _baseFinderPreviousCtCollectionId;
	...
	public List<CTPreferences> findByPreviousCtCollectionId(
		...
		return _baseFinderPreviousCtCollectionId.findList(
			new Object[] {previousCtCollectionId}, start, end,
	...
	public CTPreferences[] findByPreviousCtCollectionId_PrevAndNext(
		...
		_baseFinderPreviousCtCollectionId.findPrevAndNext(
			array, ctPreferences, new Object[] {previousCtCollectionId},
			orderByComparator);
	...
	public int countByPreviousCtCollectionId(long previousCtCollectionId) {
		return _baseFinderPreviousCtCollectionId.count(
	...
	private BaseFinder<CTPreferences> _baseFinderC_U;
	...
	public CTPreferences fetchByC_U(
		...
		return _baseFinderC_U.fetchOne(
	...
	public void activate() {
		...
		_baseFinderCtCollectionId = new BaseFinder.Builder<>(
			...
			_SQL_COUNT_CTPREFERENCES_WHERE
			...
			CTPreferencesModelImpl.ORDER_BY_JPQL
		).orderByEntityAlias(
		...
		_baseFinderPreviousCtCollectionId = new BaseFinder.Builder<>(
			this, finderCache
		).columns(
			new FinderColumn(
				_FINDER_COLUMN_PREVIOUSCTCOLLECTIONID_PREVIOUSCTCOLLECTIONID_2)
			...
			(columnValues, model) -> {
				if (!Objects.equals(
						columnValues[0], model.getPreviousCtCollectionId())) {
