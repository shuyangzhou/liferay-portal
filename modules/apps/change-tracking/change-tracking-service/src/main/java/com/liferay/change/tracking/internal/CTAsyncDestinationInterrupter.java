 ...
 * @author Tina Tian
 */
@Component(immediate = true, service = AsyncDestinationInterrupter.class)
public class CTAsyncDestinationInterrupter
	implements AsyncDestinationInterrupter {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CTAsyncDestinationInterrupter.class);
