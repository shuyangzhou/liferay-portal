...
public class CTMessageModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"ctCollectionId", Types.BIGINT}, {"destinationName", Types.VARCHAR},
	...
	public static final String TABLE_SQL_CREATE =
		"create table CTMessage (mvccVersion LONG default 0 not null,ctMessageId LONG not null primary key,companyId LONG,userId LONG,ctCollectionId LONG,destinationName VARCHAR(75) null,messageContent TEXT null)";
	...
	static {
		...
		attributeGetterFunctions.put(
			"destinationName", CTMessage::getDestinationName);
		attributeSetterBiConsumers.put(
			"destinationName",
			(BiConsumer<CTMessage, String>)CTMessage::setDestinationName);
		attributeGetterFunctions.put(
	...
	public Object clone() {
		...
		ctMessageImpl.setDestinationName(getDestinationName());
	...
	public CacheModel<CTMessage> toCacheModel() {
		...
		ctMessageCacheModel.destinationName = getDestinationName();

		String destinationName = ctMessageCacheModel.destinationName;

		if ((destinationName != null) && (destinationName.length() == 0)) {
			ctMessageCacheModel.destinationName = null;
		}
