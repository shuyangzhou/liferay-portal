...
public class CTCollectionModelImpl extends BaseModelImpl<CTCollection>
	...
	static {
		...
		attributeSetters.put("ctCollectionId",
			new BiConsumer<CTCollection, Object>() {
				@Override
				public void accept(CTCollection ctCollection,
					Object ctCollectionId) {
					ctCollection.setCtCollectionId((Long)ctCollectionId);
				}
			});
		attributeSetters.put("companyId",
			new BiConsumer<CTCollection, Object>() {
				@Override
				public void accept(CTCollection ctCollection, Object companyId) {
					ctCollection.setCompanyId((Long)companyId);
				}
			});
		attributeSetters.put("userId",
			new BiConsumer<CTCollection, Object>() {
				@Override
				public void accept(CTCollection ctCollection, Object userId) {
					ctCollection.setUserId((Long)userId);
				}
			});
		attributeSetters.put("userName",
			new BiConsumer<CTCollection, Object>() {
				@Override
				public void accept(CTCollection ctCollection, Object userName) {
					ctCollection.setUserName((String)userName);
				}
			});
		attributeSetters.put("createDate",
			new BiConsumer<CTCollection, Object>() {
				@Override
				public void accept(CTCollection ctCollection, Object createDate) {
					ctCollection.setCreateDate((Date)createDate);
				}
			});
		attributeSetters.put("modifiedDate",
			new BiConsumer<CTCollection, Object>() {
				...
				public void accept(CTCollection ctCollection,
					Object modifiedDate) {
					ctCollection.setModifiedDate((Date)modifiedDate);
				}
			});
		attributeSetters.put("name",
			new BiConsumer<CTCollection, Object>() {
				@Override
				public void accept(CTCollection ctCollection, Object name) {
					ctCollection.setName((String)name);
				}
			});
		attributeSetters.put("description",
			new BiConsumer<CTCollection, Object>() {
				@Override
				public void accept(CTCollection ctCollection, Object description) {
					ctCollection.setDescription((String)description);
				}
			});
		attributeSetters.put("status",
			new BiConsumer<CTCollection, Object>() {
				@Override
				public void accept(CTCollection ctCollection, Object status) {
					ctCollection.setStatus((Integer)status);
				}
			});
		attributeSetters.put("statusByUserId",
			new BiConsumer<CTCollection, Object>() {
				...
				public void accept(CTCollection ctCollection,
					...
					ctCollection.setStatusByUserId((Long)statusByUserId);
				}
			});
		attributeSetters.put("statusByUserName",
			new BiConsumer<CTCollection, Object>() {
				...
				public void accept(CTCollection ctCollection,
					...
					ctCollection.setStatusByUserName((String)statusByUserName);
				}
			});
		attributeSetters.put("statusDate",
			new BiConsumer<CTCollection, Object>() {
				@Override
				public void accept(CTCollection ctCollection, Object statusDate) {
					ctCollection.setStatusDate((Date)statusDate);
				}
			});
