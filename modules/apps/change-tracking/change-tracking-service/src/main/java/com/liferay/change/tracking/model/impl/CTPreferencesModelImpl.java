...
public class CTPreferencesModelImpl
	...
	public void setCtPreferencesId(long ctPreferencesId) {
		if ((_columnBitmask & CTPREFERENCESID_COLUMN_BITMASK) == 0) {
			...
			_originalValues[CTPREFERENCESID_COLUMN_INDEX] = _ctPreferencesId;
		}
	...
	public void setConfirmationEnabled(boolean confirmationEnabled) {
		if ((_columnBitmask & CONFIRMATIONENABLED_COLUMN_BITMASK) == 0) {
			...
			_originalValues[CONFIRMATIONENABLED_COLUMN_INDEX] =
