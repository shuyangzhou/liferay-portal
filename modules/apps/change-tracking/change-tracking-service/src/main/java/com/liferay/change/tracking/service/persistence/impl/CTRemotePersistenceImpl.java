...
public class CTRemotePersistenceImpl
	...
	private BaseFinder<CTRemote> _baseFinderCompanyId;
	...
	public CTRemote[] findByCompanyId_PrevAndNext(
		...
		_baseFinderCompanyId.findPrevAndNext(
			array, ctRemote, new Object[] {companyId}, orderByComparator);
	...
	public void activate() {
		...
		_baseFinderCompanyId = new BaseFinder.Builder<>(
			...
			_SQL_SELECT_CTREMOTE_WHERE
		).sqlCountWhere(
			_SQL_COUNT_CTREMOTE_WHERE
			...
			CTRemoteModelImpl.ORDER_BY_JPQL
		).orderByEntityAlias(
