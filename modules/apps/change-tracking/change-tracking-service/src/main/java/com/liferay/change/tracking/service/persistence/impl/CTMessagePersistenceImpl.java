...
public class CTMessagePersistenceImpl
	...
	private BaseFinder<CTMessage> _baseFinderCtCollectionId;
	...
	public CTMessage[] findByCtCollectionId_PrevAndNext(
		...
		_baseFinderCtCollectionId.findPrevAndNext(
			array, ctMessage, new Object[] {ctCollectionId}, orderByComparator);
	...
	public void activate() {
		...
		_baseFinderCtCollectionId = new BaseFinder.Builder<>(
			...
			_SQL_SELECT_CTMESSAGE_WHERE
		).sqlCountWhere(
			_SQL_COUNT_CTMESSAGE_WHERE
			...
			CTMessageModelImpl.ORDER_BY_JPQL
		).orderByEntityAlias(
