...
public class FinderCacheImpl
	...
	protected void activate() {
		...
		_valueObjectFinderCacheThreshold = GetterUtil.getInteger(
			_props.get(PropsKeys.VALUE_OBJECT_FINDER_CACHE_MAPPING_THRESHOLD));

		if (_valueObjectFinderCacheThreshold == 0) {
	...
	private Serializable _resultToPrimaryKey(
		...
		if (result instanceof List<?>) {
			...
			if ((list.size() > _valueObjectFinderCacheThreshold) &&
				(_valueObjectFinderCacheThreshold > 0)) {
	...
	private int _valueObjectFinderCacheThreshold;
