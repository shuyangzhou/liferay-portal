...
public class MDRRuleGroupInstancePermission
	...
	public static void check(
		...
		_ruleGroupInstanceModelResourcePermission.check(
	...
	public static boolean contains(
		...
		return _ruleGroupInstanceModelResourcePermission.contains(
			permissionChecker, ruleGroupInstanceId, actionId);
	}
	...
	protected void setModelResourcePermission(
		...
		_ruleGroupInstanceModelResourcePermission = modelResourcePermission;
	}

	private static ModelResourcePermission<MDRRuleGroupInstance>
		_ruleGroupInstanceModelResourcePermission;
