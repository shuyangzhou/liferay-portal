 ...
 */
public class MDRRuleGroupPermissionCheckerFactory {

	public static ModelResourcePermission<MDRRuleGroup> create(
		MDRRuleGroupLocalService mdrRuleGroupLocalService,
		PortletResourcePermission portletResourcePermission) {

		return ModelResourcePermissionChecker.create(
			MDRRuleGroup.class.getName(), MDRRuleGroup::getRuleGroupId,
			mdrRuleGroupLocalService::getMDRRuleGroup,
