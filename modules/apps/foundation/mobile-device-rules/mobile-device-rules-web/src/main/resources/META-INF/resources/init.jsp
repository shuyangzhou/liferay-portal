...
page import="com.liferay.mobile.device.rules.web.internal.permission.MDRPermission" %><%@
page import="com.liferay.mobile.device.rules.web.internal.permission.MDRRuleGroupInstancePermission" %><%@
page import="com.liferay.mobile.device.rules.web.internal.permission.MDRRuleGroupPermission" %><%@
