...
package com.liferay.mobile.device.rules.web.internal.permission;
...
public class MDRRuleGroupPermission {
	...
	public static boolean contains(
		...
		return _ruleGroupModelResourcePermission.contains(
	...
	protected void setModelResourcePermission(
		...
		_ruleGroupModelResourcePermission = modelResourcePermission;
	}

	private static ModelResourcePermission<MDRRuleGroup>
		_ruleGroupModelResourcePermission;
