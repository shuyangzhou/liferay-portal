...
public class SearchPermissionCheckerImpl implements SearchPermissionChecker {
	...
	private BooleanFilter _getPermissionBooleanFilter(
		...
		Object searchPermissionContextObject =
			searchContext.getSearchPermissionContext();
		...
		if (searchPermissionContext == null) {
			searchContext.setSearchPermissionContext(
				_nullSearchPermissionContext);
	...
	private static final Object _nullSearchPermissionContext = new Object();
