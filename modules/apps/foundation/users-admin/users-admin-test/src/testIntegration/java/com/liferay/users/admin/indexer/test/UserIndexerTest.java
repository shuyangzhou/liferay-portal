...
public class UserIndexerTest {
	...
	protected List<User> assertSearch(Hits hits, User... _expectedUsers)
		throws Exception {
	...
	protected List<User> assertSearch(String keywords, User... _expectedUsers)
		throws Exception {

		Hits hits = search(keywords);

		return assertSearch(hits, _expectedUsers);
	}
