...
public class SAPEntryPermissionChecker
	...
	public static ModelResourcePermission<SAPEntry> create(
		SAPEntryLocalService sapEntryLocalService,
		PortletResourcePermission portletResourcePermission) {

		return new SAPEntryPermissionChecker(
			sapEntryLocalService, portletResourcePermission);
	}
	...
	private SAPEntryPermissionChecker(
		SAPEntryLocalService sapEntryLocalService,
		PortletResourcePermission portletResourcePermission) {
