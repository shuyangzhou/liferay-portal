...
public class BackgroundTaskLocalServiceImpl
	...
	public BackgroundTask amendBackgroundTask(
		...
		if ((status == BackgroundTaskConstants.STATUS_SUCCESSFUL) && (backgroundTask.getMvccVersion() == 0)) {
			System.out.println("@@@@@@ Thread id : " + Thread.currentThread().getId() + " name : " + Thread.currentThread().getName() + ", found a wrong" + backgroundTask + ", id : " + System.identityHashCode(backgroundTask));
			...
			System.out.println("@@@@@@ Thread id : " + Thread.currentThread().getId() + " name : " + Thread.currentThread().getName() + ", load from entity cache " + backgroundTask2 + ", id : " + System.identityHashCode(backgroundTask2));
			...
			System.out.println("@@@@@@ Thread id : " + Thread.currentThread().getId() + " name : " + Thread.currentThread().getName() + ", load from entity cache after clearing thread local cache " + backgroundTask2  + ", id : " + System.identityHashCode(backgroundTask2));

			EntityCacheUtil.clearCache();

			backgroundTask2 = backgroundTaskPersistence.fetchByPrimaryKey(backgroundTaskId);

			System.out.println("@@@@@@ Thread id : " + Thread.currentThread().getId() + " name : " + Thread.currentThread().getName() + ", load from persistence after clearing entity cache " + backgroundTask2  + ", id : " + System.identityHashCode(backgroundTask2));
		}
