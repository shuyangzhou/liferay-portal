		...
		new JSPNavigationItemList(pageContext) {
			{
				add(
					navigationItem -> {
						...
						navigationItem.setHref((PortletURL)renderResponse.createRenderURL(), "tabs2", "portlets");
				...
				add(
					navigationItem -> {
						...
						navigationItem.setHref((PortletURL)renderResponse.createRenderURL(), "tabs2", "themes");
				...
				add(
					navigationItem -> {
						...
						navigationItem.setHref((PortletURL)renderResponse.createRenderURL(), "tabs2", "layout-templates");
