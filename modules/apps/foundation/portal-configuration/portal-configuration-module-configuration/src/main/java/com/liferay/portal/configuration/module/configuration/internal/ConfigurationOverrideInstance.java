...
public class ConfigurationOverrideInstance {
	...
	public Object invoke(Method method, Object[] args)
		...
		Method overriddenMethod = _methods.get(
			new MethodKey(
				_configurationOverrideClass, method.getName(),
		...
		return overriddenMethod.invoke(_configurationOverrideInstance, args);
	}
	...
	private ConfigurationOverrideInstance(
		...
		_configurationOverrideClass = configurationOverrideClass;
	...
	private final Class<?> _configurationOverrideClass;
	private final Object _configurationOverrideInstance;
	private final Map<MethodKey, Method> _methods = new HashMap<>();
