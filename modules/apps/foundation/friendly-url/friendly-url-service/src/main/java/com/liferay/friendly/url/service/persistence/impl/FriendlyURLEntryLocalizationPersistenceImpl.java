...
public class FriendlyURLEntryLocalizationPersistenceImpl
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_G_C_C_U = new FinderPath(FriendlyURLEntryLocalizationModelImpl.ENTITY_CACHE_ENABLED,
			FriendlyURLEntryLocalizationModelImpl.FINDER_CACHE_ENABLED,
			FriendlyURLEntryLocalizationImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByG_C_C_U",
			new String[] {
			...
			FriendlyURLEntryLocalizationModelImpl.COMPANYID_COLUMN_BITMASK |
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_G_C_C_U = new FinderPath(FriendlyURLEntryLocalizationModelImpl.ENTITY_CACHE_ENABLED,
			FriendlyURLEntryLocalizationModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByG_C_C_U",
			new String[] {
	...
	/**
	 * Returns the friendly url entry localization where groupId = &#63; and companyId = &#63; and classNameId = &#63; and urlTitle = &#63; or throws a {@link NoSuchFriendlyURLEntryLocalizationException} if it could not be found.
	 *
	 ...
	 */
	@Override
	public FriendlyURLEntryLocalization findByG_C_C_U(long groupId,
		long companyId, long classNameId, String urlTitle)
		throws NoSuchFriendlyURLEntryLocalizationException {
		FriendlyURLEntryLocalization friendlyURLEntryLocalization = fetchByG_C_C_U(groupId,
	...
	/**
	 * Returns the friendly url entry localization where groupId = &#63; and companyId = &#63; and classNameId = &#63; and urlTitle = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param groupId the group ID
	 * @param companyId the company ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public FriendlyURLEntryLocalization fetchByG_C_C_U(long groupId,
		long companyId, long classNameId, String urlTitle) {
		return fetchByG_C_C_U(groupId, companyId, classNameId, urlTitle, true);
	}

	/**
	 * Returns the friendly url entry localization where groupId = &#63; and companyId = &#63; and classNameId = &#63; and urlTitle = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param groupId the group ID
	 * @param companyId the company ID
	 * @param classNameId the class name ID
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((friendlyURLEntryLocalization.getGroupId() != groupId) ||
							(friendlyURLEntryLocalization.getCompanyId() != companyId) ||
	...
	/**
	 * Removes the friendly url entry localization where groupId = &#63; and companyId = &#63; and classNameId = &#63; and urlTitle = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param companyId the company ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public FriendlyURLEntryLocalization removeByG_C_C_U(long groupId,
		long companyId, long classNameId, String urlTitle)
		throws NoSuchFriendlyURLEntryLocalizationException {
		FriendlyURLEntryLocalization friendlyURLEntryLocalization = findByG_C_C_U(groupId,
				companyId, classNameId, urlTitle);
	...
	/**
	 * Returns the number of friendly url entry localizations where groupId = &#63; and companyId = &#63; and classNameId = &#63; and urlTitle = &#63;.
	 *
	 * @param groupId the group ID
	 * @param companyId the company ID
	 * @param classNameId the class name ID
	...
	private static final String _FINDER_COLUMN_G_C_C_U_GROUPID_2 = "friendlyURLEntryLocalization.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_C_C_U_COMPANYID_2 = "friendlyURLEntryLocalization.companyId = ? AND ";
	private static final String _FINDER_COLUMN_G_C_C_U_CLASSNAMEID_2 = "friendlyURLEntryLocalization.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_G_C_C_U_URLTITLE_1 = "friendlyURLEntryLocalization.urlTitle IS NULL";
	private static final String _FINDER_COLUMN_G_C_C_U_URLTITLE_2 = "friendlyURLEntryLocalization.urlTitle = ?";
	private static final String _FINDER_COLUMN_G_C_C_U_URLTITLE_3 = "(friendlyURLEntryLocalization.urlTitle IS NULL OR friendlyURLEntryLocalization.urlTitle = '')";
	...
	protected void cacheUniqueFindersCache(
		...
		args = new Object[] {
				...
				friendlyURLEntryLocalizationModelImpl.getCompanyId(),
	...
	protected void clearUniqueFindersCache(
		...
		if ((friendlyURLEntryLocalizationModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
					...
					friendlyURLEntryLocalizationModelImpl.getOriginalCompanyId(),
