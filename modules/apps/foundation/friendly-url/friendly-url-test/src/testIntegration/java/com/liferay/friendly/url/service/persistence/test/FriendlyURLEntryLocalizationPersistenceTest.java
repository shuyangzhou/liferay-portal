...
public class FriendlyURLEntryLocalizationPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newFriendlyURLEntryLocalization.setMvccVersion(RandomTestUtil.nextLong());
		...
		newFriendlyURLEntryLocalization.setClassNameId(RandomTestUtil.nextLong());
		...
		Assert.assertEquals(existingFriendlyURLEntryLocalization.getMvccVersion(),
		...
		Assert.assertEquals(existingFriendlyURLEntryLocalization.getClassNameId(),
			newFriendlyURLEntryLocalization.getClassNameId());
		Assert.assertEquals(existingFriendlyURLEntryLocalization.getClassPK(),
	...
	protected OrderByComparator<FriendlyURLEntryLocalization> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("FriendlyURLEntryLocalization",
			"mvccVersion", true, "friendlyURLEntryLocalizationId", true,
	...
	public void testResetOriginalValues() throws Exception {
		...
		Assert.assertEquals(Long.valueOf(
			...
			ReflectionTestUtil.<Long>invoke(
				existingFriendlyURLEntryLocalization, "getOriginalCompanyId",
				new Class<?>[0]));
		Assert.assertEquals(Long.valueOf(
