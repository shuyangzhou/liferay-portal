...
public class RedirectEntryLocalServiceUtil {
	...
	public static RedirectEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			RedirectEntryLocalServiceUtil::_getService);
	}

	private static RedirectEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			RedirectEntryLocalServiceUtil.class);
		...
		ServiceReference<RedirectEntryLocalService> serviceReference =
			bundleContext.getServiceReference(RedirectEntryLocalService.class);
	...
	private static final DCLSingleton<RedirectEntryLocalService>
