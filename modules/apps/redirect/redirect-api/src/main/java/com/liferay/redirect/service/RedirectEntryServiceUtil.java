...
public class RedirectEntryServiceUtil {
	...
	public static RedirectEntryService getService() {
		return _serviceDCLSingleton.getSingleton(
			RedirectEntryServiceUtil::_getService);
	}

	private static RedirectEntryService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(RedirectEntryServiceUtil.class);
		...
		ServiceReference<RedirectEntryService> serviceReference =
			bundleContext.getServiceReference(RedirectEntryService.class);
	...
	private static final DCLSingleton<RedirectEntryService>
