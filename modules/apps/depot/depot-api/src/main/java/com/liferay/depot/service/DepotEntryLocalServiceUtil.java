...
public class DepotEntryLocalServiceUtil {
	...
	public static DepotEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DepotEntryLocalServiceUtil::_getService);
	}

	private static DepotEntryLocalService _getService() {
		...
		ServiceReference<DepotEntryLocalService> serviceReference =
			bundleContext.getServiceReference(DepotEntryLocalService.class);
	...
	private static final DCLSingleton<DepotEntryLocalService>
