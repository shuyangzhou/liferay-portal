...
public class DepotAppCustomizationLocalServiceUtil {
	...
	public static DepotAppCustomizationLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DepotAppCustomizationLocalServiceUtil::_getService);
	}

	private static DepotAppCustomizationLocalService _getService() {
		...
		ServiceReference<DepotAppCustomizationLocalService> serviceReference =
	...
	private static final DCLSingleton<DepotAppCustomizationLocalService>
