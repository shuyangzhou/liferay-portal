...
public class DepotEntryServiceUtil {
	...
	public static DepotEntryService getService() {
		return _serviceDCLSingleton.getSingleton(
			DepotEntryServiceUtil::_getService);
	}

	private static DepotEntryService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(DepotEntryServiceUtil.class);
		...
		ServiceReference<DepotEntryService> serviceReference =
			bundleContext.getServiceReference(DepotEntryService.class);
	...
	private static final DCLSingleton<DepotEntryService> _serviceDCLSingleton =
		new DCLSingleton<>();
