...
public class ViewRendererMvcImpl
	implements ViewRenderer, ApplicationContextAware {

	@PostConstruct
	public void postConstruct() {
		_viewEngines = new ArrayList<>();
		...
		for (Map.Entry<String, ViewEngine> entry : beansOfType.entrySet()) {
			_viewEngines.add(entry.getValue());
		}
	...
	public void render(
		...
		if (viewName != null) {
			...
			for (ViewEngine viewEngine : _viewEngines) {
	...
	private List<ViewEngine> _viewEngines;
