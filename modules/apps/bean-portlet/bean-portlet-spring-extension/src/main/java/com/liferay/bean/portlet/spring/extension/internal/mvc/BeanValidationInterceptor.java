 ...
 * @author Neil Griffin
 */
public class BeanValidationInterceptor extends BeanMethodInterceptor {

	public BeanValidationInterceptor(
		BeanMethod beanMethod, boolean controller, MvcContext mvcContext,
		MessageInterpolator messageInterpolator, Validator validator,
		MutableBindingResult mutableBindingResult, Object target) {
