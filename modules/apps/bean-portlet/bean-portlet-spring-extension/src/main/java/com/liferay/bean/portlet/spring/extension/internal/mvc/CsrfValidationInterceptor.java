 ...
 * @author Neil Griffin
 */
public class CsrfValidationInterceptor extends BeanMethodInterceptor {

	public CsrfValidationInterceptor(
		BeanMethod beanMethod, boolean controller,
		Configuration configuration) {

		super(beanMethod, controller);

		_configuration = configuration;
		_targetMethod = beanMethod.getMethod();
	}
