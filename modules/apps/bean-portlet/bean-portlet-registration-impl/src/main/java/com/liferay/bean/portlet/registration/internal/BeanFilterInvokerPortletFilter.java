...
public class BeanFilterInvokerPortletFilter
	...
	public BeanFilterInvokerPortletFilter(
		...
		_managedBean = beanManager.resolveBean(filterClass);
	...
	public void doFilter(
		...
		if (ActionFilter.class.isAssignableFrom(_managedBean.getBeanType())) {
	...
	public void doFilter(
		...
		if (EventFilter.class.isAssignableFrom(_managedBean.getBeanType())) {
			_invokeMethodWithActiveScopes(
	...
	public void doFilter(
		...
		if (HeaderFilter.class.isAssignableFrom(_managedBean.getBeanType())) {
			_invokeMethodWithActiveScopes(
	...
	public void doFilter(
		...
		if (RenderFilter.class.isAssignableFrom(_managedBean.getBeanType())) {
			_invokeMethodWithActiveScopes(
	...
	public void doFilter(
		...
		if (ResourceFilter.class.isAssignableFrom(_managedBean.getBeanType())) {
			_invokeMethodWithActiveScopes(
	...
	private void _invokeMethodWithActiveScopes(
		...
		_beanFilterMethodInvoker.invokeWithActiveScopes(
			new BeanFilterMethod(_beanManager, _managedBean, method),
