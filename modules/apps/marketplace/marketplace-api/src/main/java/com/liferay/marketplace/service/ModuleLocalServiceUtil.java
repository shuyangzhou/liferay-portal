...
public class ModuleLocalServiceUtil {
	...
	public static ModuleLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ModuleLocalServiceUtil::_getService);
	}

	private static ModuleLocalService _getService() {
		...
		ServiceReference<ModuleLocalService> serviceReference =
			bundleContext.getServiceReference(ModuleLocalService.class);
	...
	private static final DCLSingleton<ModuleLocalService> _serviceDCLSingleton =
		new DCLSingleton<>();
