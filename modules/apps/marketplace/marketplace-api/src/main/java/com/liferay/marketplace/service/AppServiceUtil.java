...
public class AppServiceUtil {
	...
	public static AppService getService() {
		return _serviceDCLSingleton.getSingleton(AppServiceUtil::_getService);
	}

	private static AppService _getService() {
		...
		ServiceReference<AppService> serviceReference =
			bundleContext.getServiceReference(AppService.class);
	...
	private static final DCLSingleton<AppService> _serviceDCLSingleton =
		new DCLSingleton<>();
