...
public class AppLocalServiceUtil {
	...
	public static AppLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			AppLocalServiceUtil::_getService);
	}

	private static AppLocalService _getService() {
		...
		ServiceReference<AppLocalService> serviceReference =
			bundleContext.getServiceReference(AppLocalService.class);
	...
	private static final DCLSingleton<AppLocalService> _serviceDCLSingleton =
		new DCLSingleton<>();
