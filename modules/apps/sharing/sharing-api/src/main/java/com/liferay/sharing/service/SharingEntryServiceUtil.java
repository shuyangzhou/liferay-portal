...
public class SharingEntryServiceUtil {
	...
	public static SharingEntryService getService() {
		return _serviceDCLSingleton.getSingleton(
			SharingEntryServiceUtil::_getService);
	}

	private static SharingEntryService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(SharingEntryServiceUtil.class);
		...
		ServiceReference<SharingEntryService> serviceReference =
			bundleContext.getServiceReference(SharingEntryService.class);
	...
	private static final DCLSingleton<SharingEntryService>
