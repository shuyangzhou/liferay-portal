...
public class SharingEntryLocalServiceUtil {
	...
	public static SharingEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SharingEntryLocalServiceUtil::_getService);
	}

	private static SharingEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			SharingEntryLocalServiceUtil.class);
		...
		ServiceReference<SharingEntryLocalService> serviceReference =
			bundleContext.getServiceReference(SharingEntryLocalService.class);
	...
	private static final DCLSingleton<SharingEntryLocalService>
