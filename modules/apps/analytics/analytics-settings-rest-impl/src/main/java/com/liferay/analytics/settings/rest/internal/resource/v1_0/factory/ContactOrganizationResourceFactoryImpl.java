...
public class ContactOrganizationResourceFactoryImpl
	...
	public ContactOrganizationResource.Builder create() {
		return new ContactOrganizationResource.Builder() {
			...
			public ContactOrganizationResource build() {
				...
				Function<InvocationHandler, ContactOrganizationResource>
					contactOrganizationResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_contactOrganizationResourceProxyProviderFunction;

				return contactOrganizationResourceProxyProviderFunction.apply(
			...
			@Override
			public ContactOrganizationResource.Builder uriInfo(
				UriInfo uriInfo) {
	...
	private Object _invoke(
		...
		contactOrganizationResource.setContextHttpServletResponse(
			httpServletResponse);
		contactOrganizationResource.setContextUriInfo(uriInfo);
