...
public class BatchPlannerPolicyLocalServiceUtil {
	...
	public static BatchPlannerPolicyLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			BatchPlannerPolicyLocalServiceUtil::_getService);
	}

	private static BatchPlannerPolicyLocalService _getService() {
		...
		ServiceReference<BatchPlannerPolicyLocalService> serviceReference =
	...
	private static final DCLSingleton<BatchPlannerPolicyLocalService>
