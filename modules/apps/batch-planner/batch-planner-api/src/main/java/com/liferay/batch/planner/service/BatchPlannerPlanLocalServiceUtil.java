...
public class BatchPlannerPlanLocalServiceUtil {
	...
	public static BatchPlannerPlanLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			BatchPlannerPlanLocalServiceUtil::_getService);
	}

	private static BatchPlannerPlanLocalService _getService() {
		...
		ServiceReference<BatchPlannerPlanLocalService> serviceReference =
	...
	private static final DCLSingleton<BatchPlannerPlanLocalService>
