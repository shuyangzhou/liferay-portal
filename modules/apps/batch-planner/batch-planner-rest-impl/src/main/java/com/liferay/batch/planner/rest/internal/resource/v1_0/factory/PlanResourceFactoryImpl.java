	...
	public PlanResource.Builder create() {
		return new PlanResource.Builder() {
			...
			public PlanResource build() {
				...
				Function<InvocationHandler, PlanResource>
					planResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_planResourceProxyProviderFunction;

				return planResourceProxyProviderFunction.apply(
			...
			@Override
			public PlanResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
