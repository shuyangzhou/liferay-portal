...
public class ClusterClassLoaderPoolTest {
	...
	public void testConcurrentRegister()
		...
		Thread thread = new Thread(
			futureTask, "ClusterClassLoaderPoolTest-testConcurrentRegister");
	...
	public void testConcurrentUnregister()
		...
		Thread thread = new Thread(
			futureTask, "ClusterClassLoaderPoolTest-testConcurrentUnregister");
	...
	private class BlockingInvocationHandler implements InvocationHandler {
		...
		public void waitUntilBlock() {
			while (_semaphore.getQueueLength() < 1);
		}
