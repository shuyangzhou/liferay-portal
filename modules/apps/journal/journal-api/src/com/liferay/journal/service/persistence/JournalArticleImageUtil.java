...
public class JournalArticleImageUtil {
	...
	*/
	public static List<JournalArticleImage> findByTempImage(boolean tempImage,
		boolean retrieveFromCache) {
		return getPersistence().findByTempImage(tempImage, retrieveFromCache);
	}
	...
	*/
	public static List<JournalArticleImage> findByTempImage(boolean tempImage,
		int start, int end, boolean retrieveFromCache) {
		return getPersistence()
				   .findByTempImage(tempImage, start, end, retrieveFromCache);
	}
	...
	*/
	public static List<JournalArticleImage> findByG_A_V(long groupId,
		...
		return getPersistence()
				   .findByG_A_V(groupId, articleId, version, retrieveFromCache);
	}
