...
public class JournalFolderServiceUtil {
	...
	public static JournalFolderService getService() {
		return _serviceDCLSingleton.getSingleton(
			JournalFolderServiceUtil::_getService);
	}

	private static JournalFolderService _getService() {
		...
		ServiceReference<JournalFolderService> serviceReference =
			bundleContext.getServiceReference(JournalFolderService.class);
	...
	private static final DCLSingleton<JournalFolderService>
