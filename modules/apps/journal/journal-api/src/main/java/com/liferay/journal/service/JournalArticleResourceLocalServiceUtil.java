...
public class JournalArticleResourceLocalServiceUtil {
	...
	public static JournalArticleResourceLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			JournalArticleResourceLocalServiceUtil::_getService);
	}

	private static JournalArticleResourceLocalService _getService() {
		...
		ServiceReference<JournalArticleResourceLocalService> serviceReference =
	...
	private static final DCLSingleton<JournalArticleResourceLocalService>
