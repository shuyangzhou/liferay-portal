...
public class JournalFolderWrapper implements JournalFolder,
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<JournalFolder, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<JournalFolder, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<JournalFolder, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<JournalFolder, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<JournalFolder, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<JournalFolder, Object> attributeBiConsumer = entry.getValue();
	...
	@Override
	public Map<String, Function<JournalFolder, Object>> getAttributeGetters() {
		return _journalFolder.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<JournalFolder, Object>> getAttributeSetters() {
		return _journalFolder.getAttributeSetters();
	}
