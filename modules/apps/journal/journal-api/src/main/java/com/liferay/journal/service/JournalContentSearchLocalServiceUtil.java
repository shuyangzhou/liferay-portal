...
public class JournalContentSearchLocalServiceUtil {
	...
	public static JournalContentSearchLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			JournalContentSearchLocalServiceUtil::_getService);
	}

	private static JournalContentSearchLocalService _getService() {
		...
		ServiceReference<JournalContentSearchLocalService> serviceReference =
	...
	private static final DCLSingleton<JournalContentSearchLocalService>
