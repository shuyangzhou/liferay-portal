...
public class JournalArticleLocalServiceUtil {
	...
	public static JournalArticleLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			JournalArticleLocalServiceUtil::_getService);
	}

	private static JournalArticleLocalService _getService() {
		...
		ServiceReference<JournalArticleLocalService> serviceReference =
	...
	private static final DCLSingleton<JournalArticleLocalService>
