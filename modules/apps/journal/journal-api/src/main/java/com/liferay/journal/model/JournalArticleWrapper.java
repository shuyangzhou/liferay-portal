...
public class JournalArticleWrapper implements JournalArticle,
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<JournalArticle, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<JournalArticle, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<JournalArticle, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<JournalArticle, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<JournalArticle, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<JournalArticle, Object> attributeBiConsumer = entry.getValue();
	...
	public Map<String, Function<JournalArticle, Object>> getAttributeGetters() {
		return _journalArticle.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<JournalArticle, Object>> getAttributeSetters() {
		return _journalArticle.getAttributeSetters();
	}
