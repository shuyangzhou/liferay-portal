...
public class JournalFeedLocalServiceUtil {
	...
	public static JournalFeedLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			JournalFeedLocalServiceUtil::_getService);
	}

	private static JournalFeedLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			JournalFeedLocalServiceUtil.class);
		...
		ServiceReference<JournalFeedLocalService> serviceReference =
			bundleContext.getServiceReference(JournalFeedLocalService.class);
	...
	private static final DCLSingleton<JournalFeedLocalService>
