...
public class AssetAutoTaggerEntryLocalServiceUtil {
	...
	public static AssetAutoTaggerEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			AssetAutoTaggerEntryLocalServiceUtil::_getService);
	}

	private static AssetAutoTaggerEntryLocalService _getService() {
		...
		ServiceReference<AssetAutoTaggerEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<AssetAutoTaggerEntryLocalService>
