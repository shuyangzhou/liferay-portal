...
public class AssetListEntryLocalServiceUtil {
	...
	public static AssetListEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			AssetListEntryLocalServiceUtil::_getService);
	}

	private static AssetListEntryLocalService _getService() {
		...
		ServiceReference<AssetListEntryLocalService> serviceReference =
			bundleContext.getServiceReference(AssetListEntryLocalService.class);
	...
	private static final DCLSingleton<AssetListEntryLocalService>
