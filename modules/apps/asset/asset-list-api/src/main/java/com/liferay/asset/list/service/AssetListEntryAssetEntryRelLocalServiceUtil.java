...
public class AssetListEntryAssetEntryRelLocalServiceUtil {
	...
	public static AssetListEntryAssetEntryRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			AssetListEntryAssetEntryRelLocalServiceUtil::_getService);
	}

	private static AssetListEntryAssetEntryRelLocalService _getService() {
		...
		ServiceReference<AssetListEntryAssetEntryRelLocalService>
	...
	private static final DCLSingleton<AssetListEntryAssetEntryRelLocalService>
