...
public class AssetListEntryUsageLocalServiceUtil {
	...
	public static AssetListEntryUsageLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			AssetListEntryUsageLocalServiceUtil::_getService);
	}

	private static AssetListEntryUsageLocalService _getService() {
		...
		ServiceReference<AssetListEntryUsageLocalService> serviceReference =
	...
	private static final DCLSingleton<AssetListEntryUsageLocalService>
