...
public class AssetListEntrySegmentsEntryRelLocalServiceUtil {
	...
	public static AssetListEntrySegmentsEntryRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			AssetListEntrySegmentsEntryRelLocalServiceUtil::_getService);
	}

	private static AssetListEntrySegmentsEntryRelLocalService _getService() {
		...
		ServiceReference<AssetListEntrySegmentsEntryRelLocalService>
	...
	private static final DCLSingleton
		<AssetListEntrySegmentsEntryRelLocalService> _serviceDCLSingleton =
			new DCLSingleton<>();
