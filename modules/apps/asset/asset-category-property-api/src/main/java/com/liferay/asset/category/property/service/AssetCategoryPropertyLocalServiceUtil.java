...
public class AssetCategoryPropertyLocalServiceUtil {
	...
	public static AssetCategoryPropertyLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			AssetCategoryPropertyLocalServiceUtil::_getService);
	}

	private static AssetCategoryPropertyLocalService _getService() {
		...
		ServiceReference<AssetCategoryPropertyLocalService> serviceReference =
	...
	private static final DCLSingleton<AssetCategoryPropertyLocalService>
