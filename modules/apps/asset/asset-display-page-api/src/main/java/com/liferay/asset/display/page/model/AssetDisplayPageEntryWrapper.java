...
public class AssetDisplayPageEntryWrapper implements AssetDisplayPageEntry,
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<AssetDisplayPageEntry, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<AssetDisplayPageEntry, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<AssetDisplayPageEntry, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<AssetDisplayPageEntry, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<AssetDisplayPageEntry, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<AssetDisplayPageEntry, Object> attributeBiConsumer = entry.getValue();
	...
	public Map<String, Function<AssetDisplayPageEntry, Object>> getAttributeGetters() {
		return _assetDisplayPageEntry.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<AssetDisplayPageEntry, Object>> getAttributeSetters() {
		return _assetDisplayPageEntry.getAttributeSetters();
	}
