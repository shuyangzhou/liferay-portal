...
public class AssetEntryAssetCategoryRelLocalServiceUtil {
	...
	public static AssetEntryAssetCategoryRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			AssetEntryAssetCategoryRelLocalServiceUtil::_getService);
	}

	private static AssetEntryAssetCategoryRelLocalService _getService() {
		...
		ServiceReference<AssetEntryAssetCategoryRelLocalService>
	...
	private static final DCLSingleton<AssetEntryAssetCategoryRelLocalService>
