...
public class AssetListEntryModelImpl extends BaseModelImpl<AssetListEntry>
	...
	static {
		...
		attributeGetters.put("uuid",
			new Function<AssetListEntry, Object>() {
				@Override
				public Object apply(AssetListEntry assetListEntry) {
		...
		attributeSetters.put("uuid",
			new BiConsumer<AssetListEntry, Object>() {
				@Override
				public void accept(AssetListEntry assetListEntry, Object uuid) {
					assetListEntry.setUuid((String)uuid);
				}
			});
		attributeSetters.put("assetListEntryId",
			new BiConsumer<AssetListEntry, Object>() {
				...
				public void accept(AssetListEntry assetListEntry,
					Object assetListEntryId) {
					assetListEntry.setAssetListEntryId((Long)assetListEntryId);
				}
			});
		attributeSetters.put("groupId",
			new BiConsumer<AssetListEntry, Object>() {
				@Override
				public void accept(AssetListEntry assetListEntry, Object groupId) {
					assetListEntry.setGroupId((Long)groupId);
				}
			});
		attributeSetters.put("companyId",
			new BiConsumer<AssetListEntry, Object>() {
				...
				public void accept(AssetListEntry assetListEntry,
					Object companyId) {
					assetListEntry.setCompanyId((Long)companyId);
				}
			});
		attributeSetters.put("userId",
			new BiConsumer<AssetListEntry, Object>() {
				@Override
				public void accept(AssetListEntry assetListEntry, Object userId) {
					assetListEntry.setUserId((Long)userId);
				}
			});
		attributeSetters.put("userName",
			new BiConsumer<AssetListEntry, Object>() {
				...
				public void accept(AssetListEntry assetListEntry,
					Object userName) {
					assetListEntry.setUserName((String)userName);
				}
			});
		attributeSetters.put("createDate",
			new BiConsumer<AssetListEntry, Object>() {
				...
				public void accept(AssetListEntry assetListEntry,
					Object createDate) {
					assetListEntry.setCreateDate((Date)createDate);
				}
			});
		attributeSetters.put("modifiedDate",
			new BiConsumer<AssetListEntry, Object>() {
				...
				public void accept(AssetListEntry assetListEntry,
					Object modifiedDate) {
					assetListEntry.setModifiedDate((Date)modifiedDate);
				}
			});
		attributeSetters.put("title",
			new BiConsumer<AssetListEntry, Object>() {
				@Override
				public void accept(AssetListEntry assetListEntry, Object title) {
					assetListEntry.setTitle((String)title);
				}
			});
		attributeSetters.put("type",
			new BiConsumer<AssetListEntry, Object>() {
				@Override
				public void accept(AssetListEntry assetListEntry, Object type) {
					assetListEntry.setType((Integer)type);
				}
			});
		attributeSetters.put("typeSettings",
			new BiConsumer<AssetListEntry, Object>() {
				...
				public void accept(AssetListEntry assetListEntry,
					Object typeSettings) {
					assetListEntry.setTypeSettings((String)typeSettings);
				}
			});
		attributeSetters.put("lastPublishDate",
			new BiConsumer<AssetListEntry, Object>() {
				...
				public void accept(AssetListEntry assetListEntry,
					...
					assetListEntry.setLastPublishDate((Date)lastPublishDate);
				}
			});
