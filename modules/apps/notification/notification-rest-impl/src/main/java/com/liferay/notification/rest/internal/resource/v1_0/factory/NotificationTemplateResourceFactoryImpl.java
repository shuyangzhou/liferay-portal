...
public class NotificationTemplateResourceFactoryImpl
	implements NotificationTemplateResource.Factory {

	@Override
	public NotificationTemplateResource.Builder create() {
		return new NotificationTemplateResource.Builder() {
			...
			@Override
			public NotificationTemplateResource.Builder checkPermissions(
			...
			@Override
			public NotificationTemplateResource.Builder httpServletRequest(
			...
			@Override
			public NotificationTemplateResource.Builder httpServletResponse(
			...
			@Override
			public NotificationTemplateResource.Builder preferredLocale(
			...
			@Override
			public NotificationTemplateResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		NotificationTemplateResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		NotificationTemplateResource.FactoryHolder.factory = null;
	}

	private static Function<InvocationHandler, NotificationTemplateResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			NotificationTemplateResource.class.getClassLoader(),
			NotificationTemplateResource.class);

		try {
			Constructor<NotificationTemplateResource> constructor =
				(Constructor<NotificationTemplateResource>)
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(notificationTemplateResource);
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NotificationTemplateResourceFactoryImpl.class);
