...
public class NotificationTemplateServiceUtil {
	...
	public static NotificationTemplateService getService() {
		return _serviceDCLSingleton.getSingleton(
			NotificationTemplateServiceUtil::_getService);
	}

	private static NotificationTemplateService _getService() {
		...
		ServiceReference<NotificationTemplateService> serviceReference =
	...
	private static final DCLSingleton<NotificationTemplateService>
