...
public class NotificationRecipientSettingLocalServiceUtil {
	...
	public static NotificationRecipientSettingLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			NotificationRecipientSettingLocalServiceUtil::_getService);
	}

	private static NotificationRecipientSettingLocalService _getService() {
		...
		ServiceReference<NotificationRecipientSettingLocalService>
	...
	private static final DCLSingleton<NotificationRecipientSettingLocalService>
