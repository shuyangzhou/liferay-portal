...
public class NotificationQueueEntryAttachmentLocalServiceUtil {
	...
	public static NotificationQueueEntryAttachmentLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			NotificationQueueEntryAttachmentLocalServiceUtil::_getService);
	}

	private static NotificationQueueEntryAttachmentLocalService _getService() {
		...
		ServiceReference<NotificationQueueEntryAttachmentLocalService>
	...
	private static final DCLSingleton
		<NotificationQueueEntryAttachmentLocalService> _serviceDCLSingleton =
			new DCLSingleton<>();
