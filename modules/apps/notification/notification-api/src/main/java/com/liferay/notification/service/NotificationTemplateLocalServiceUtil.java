...
public class NotificationTemplateLocalServiceUtil {
	...
	public static NotificationTemplateLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			NotificationTemplateLocalServiceUtil::_getService);
	}

	private static NotificationTemplateLocalService _getService() {
		...
		ServiceReference<NotificationTemplateLocalService> serviceReference =
	...
	private static final DCLSingleton<NotificationTemplateLocalService>
