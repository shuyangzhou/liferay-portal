...
public class NotificationQueueEntryLocalServiceUtil {
	...
	public static NotificationQueueEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			NotificationQueueEntryLocalServiceUtil::_getService);
	}

	private static NotificationQueueEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			NotificationQueueEntryLocalServiceUtil.class);
		...
		ServiceReference<NotificationQueueEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<NotificationQueueEntryLocalService>
