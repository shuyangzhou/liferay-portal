...
public class NotificationQueueEntryLocalServiceUtil {
	...
	public static void deleteCompanyNotificationQueueEntries(long companyId)
		throws PortalException {

		getService().deleteCompanyNotificationQueueEntries(companyId);
	}
	...
	private static final Snapshot<NotificationQueueEntryLocalService>
		_serviceSnapshot = new Snapshot<>(
			NotificationQueueEntryLocalServiceUtil.class,
			NotificationQueueEntryLocalService.class);

}
// SB-Hash:1448158606:-465969577:1773456076913