...
public class NotificationRecipientPersistenceImpl
	...
	private BaseFinder<NotificationRecipient> _baseFinderUuid;
	...
	private BaseFinder<NotificationRecipient> _baseFinderUuid_C;
	...
	private BaseFinder<NotificationRecipient> _baseFinderClassPK;
	...
	public NotificationRecipient fetchByClassPK(
		...
		return _baseFinderClassPK.fetchOne(
			new Object[] {classPK}, useFinderCache);
	}
	...
	public void activate() {
		...
		_baseFinderClassPK = new BaseFinder.Builder<>(
			this, finderCache
		).columns(
			new FinderColumn(_FINDER_COLUMN_CLASSPK_CLASSPK_2)
		).sqlSelectWhere(
			_SQL_SELECT_NOTIFICATIONRECIPIENT_WHERE
		).sqlCountWhere(
			_SQL_COUNT_NOTIFICATIONRECIPIENT_WHERE
			...
			(columnValues, model) -> {
				if (!Objects.equals(columnValues[0], model.getClassPK())) {
					return false;
				}
