...
public class MemberRequestLocalServiceUtil {
	...
	public static MemberRequestLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			MemberRequestLocalServiceUtil::_getService);
	}

	private static MemberRequestLocalService _getService() {
		...
		ServiceReference<MemberRequestLocalService> serviceReference =
			bundleContext.getServiceReference(MemberRequestLocalService.class);
	...
	private static final DCLSingleton<MemberRequestLocalService>
