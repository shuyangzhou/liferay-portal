...
public class ChangesetCollectionLocalServiceUtil {
	...
	public static ChangesetCollectionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ChangesetCollectionLocalServiceUtil::_getService);
	}

	private static ChangesetCollectionLocalService _getService() {
		...
		ServiceReference<ChangesetCollectionLocalService> serviceReference =
	...
	private static final DCLSingleton<ChangesetCollectionLocalService>
