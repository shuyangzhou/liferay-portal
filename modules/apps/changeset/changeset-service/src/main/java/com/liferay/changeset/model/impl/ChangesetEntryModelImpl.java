...
public class ChangesetEntryModelImpl
	...
	public void setChangesetEntryId(long changesetEntryId) {
		if ((_columnBitmask & CHANGESETENTRYID_COLUMN_BITMASK) == 0) {
			...
			_originalValues[CHANGESETENTRYID_COLUMN_INDEX] = _changesetEntryId;
		}
	...
	public void setChangesetCollectionId(long changesetCollectionId) {
		if ((_columnBitmask & CHANGESETCOLLECTIONID_COLUMN_BITMASK) == 0) {
	...
	public long getOriginalChangesetCollectionId() {
		if (_originalValues != null) {
			Object originalChangesetCollectionId =
				_originalValues[CHANGESETCOLLECTIONID_COLUMN_INDEX];

			if (originalChangesetCollectionId != null) {
				return (long)originalChangesetCollectionId;
			}
		}
