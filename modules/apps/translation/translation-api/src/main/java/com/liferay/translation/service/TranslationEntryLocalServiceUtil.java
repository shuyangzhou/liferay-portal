...
public class TranslationEntryLocalServiceUtil {
	...
	public static TranslationEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			TranslationEntryLocalServiceUtil::_getService);
	}

	private static TranslationEntryLocalService _getService() {
		...
		ServiceReference<TranslationEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<TranslationEntryLocalService>
