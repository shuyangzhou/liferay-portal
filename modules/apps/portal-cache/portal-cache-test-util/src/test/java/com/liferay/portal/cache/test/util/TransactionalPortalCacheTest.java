...
public class TransactionalPortalCacheTest {
	...
	@Test
	public void testConcurrentTransactionForMVCCPortalCache()
		...
		_invokeTransactionalPortalCacheConcurrently(
			transactionalPortalCache, _KEY_1, _VALUE_1, true, false);
		...
		_invokeTransactionalPortalCacheConcurrently(
			transactionalPortalCache, _KEY_1, null, true, false);
		...
		_invokeTransactionalPortalCacheConcurrently(
			transactionalPortalCache, _KEY_2, _VALUE_2, false, false);
		...
		_testCacheReplicator.assertUpdated(_KEY_2, _VALUE_2);
		_testCacheReplicator.assertActionsCount(2);
		...
		// Two write transactions do remove

		_invokeTransactionalPortalCacheConcurrently(
			transactionalPortalCache, _KEY_2, null, false, false);

		_testCacheListener.assertRemoved(_KEY_2, _VALUE_2);
		_testCacheListener.assertRemoved(_KEY_2, null);
		_testCacheListener.assertActionsCount(2);

		_testCacheReplicator.assertRemoved(_KEY_2, _VALUE_2);
		_testCacheReplicator.assertRemoved(_KEY_2, null);
		_testCacheReplicator.assertActionsCount(2);
		...
		_invokeTransactionalPortalCacheConcurrently(
			transactionalPortalCache, _KEY_1, null, false, true);

		_testCacheListener.assertRemoved(_KEY_1, _VALUE_1);
		_testCacheListener.assertRemoved(_KEY_1, null);
		_testCacheListener.assertActionsCount(2);
	...
	public void testConcurrentTransactionForNonmvccPortalCache()
		...
		_invokeTransactionalPortalCacheConcurrently(
			transactionalPortalCache, _KEY_1, null, false, false);

		_testCacheListener.assertRemoved(_KEY_1, _VALUE_1);
		_testCacheListener.assertRemoved(_KEY_1, null);
		_testCacheListener.assertActionsCount(2);

		_testCacheReplicator.assertRemoved(_KEY_1, _VALUE_1);
		_testCacheReplicator.assertRemoved(_KEY_1, null);
		_testCacheReplicator.assertActionsCount(2);
	...
	private void _invokeTransactionalPortalCacheConcurrently(
			TransactionalPortalCache<String, String> transactionalPortalCache,
			String key, String value, boolean readOnly, boolean skipReplicator)
		throws InterruptedException {
		...
		TestRunnable testRunnable1 = new TestRunnable(
			transactionalPortalCache, key, value, readOnly, skipReplicator);
		TestRunnable testRunnable2 = new TestRunnable(
			transactionalPortalCache, key, value, readOnly, skipReplicator);

		Thread thread1 = new Thread(
			testRunnable1, threadNamePrefix + "_Thread_1");
		Thread thread2 = new Thread(
			testRunnable2, threadNamePrefix + "_Thread_2");

		thread1.start();
		thread2.start();

		testRunnable1.waitUntilBlock();
		testRunnable2.waitUntilBlock();

		testRunnable1.unblock();
		testRunnable2.unblock();
