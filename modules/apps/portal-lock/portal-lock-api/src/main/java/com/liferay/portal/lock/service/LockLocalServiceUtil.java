...
public class LockLocalServiceUtil {
	...
	public static LockLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			LockLocalServiceUtil::_getService);
	}

	private static LockLocalService _getService() {
		...
		ServiceReference<LockLocalService> serviceReference =
			bundleContext.getServiceReference(LockLocalService.class);
	...
	private static final DCLSingleton<LockLocalService> _serviceDCLSingleton =
		new DCLSingleton<>();
