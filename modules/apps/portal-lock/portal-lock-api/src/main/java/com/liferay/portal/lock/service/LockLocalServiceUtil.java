...
public class LockLocalServiceUtil {
	...
	public static List<Lock> getLocks(long companyId, String className) {
		return getService().getLocks(companyId, className);
	}
...
// SB-Hash:235756908:63939710:1773456076913