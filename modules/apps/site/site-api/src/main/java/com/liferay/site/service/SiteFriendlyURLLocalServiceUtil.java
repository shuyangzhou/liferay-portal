...
public class SiteFriendlyURLLocalServiceUtil {
	...
	public static SiteFriendlyURLLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SiteFriendlyURLLocalServiceUtil::_getService);
	}

	private static SiteFriendlyURLLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			SiteFriendlyURLLocalServiceUtil.class);
		...
		ServiceReference<SiteFriendlyURLLocalService> serviceReference =
	...
	private static final DCLSingleton<SiteFriendlyURLLocalService>
