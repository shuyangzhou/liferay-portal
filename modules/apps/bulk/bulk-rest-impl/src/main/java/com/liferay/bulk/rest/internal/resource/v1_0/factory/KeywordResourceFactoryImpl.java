 ...
 */
@Component(
	property = "resource.locator.key=/bulk/v1.0/Keyword",
	...
	public KeywordResource.Builder create() {
		return new KeywordResource.Builder() {
			...
			public KeywordResource build() {
				...
				Function<InvocationHandler, KeywordResource>
					keywordResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_keywordResourceProxyProviderFunction;

				return keywordResourceProxyProviderFunction.apply(
			...
			@Override
			public KeywordResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
