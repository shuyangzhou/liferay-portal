...
public class SyncDeviceModelImpl
	...
	public void setSyncDeviceId(long syncDeviceId) {
		_setOriginalValue(SYNCDEVICEID_COLUMN_INDEX, _syncDeviceId);
	...
	public String getOriginalUserName() {
		return GetterUtil.getString(
			_getOriginalValue(USERNAME_COLUMN_INDEX, _userName));
	}
	...
	public void setFeatureSet(int featureSet) {
		_setOriginalValue(FEATURESET_COLUMN_INDEX, _featureSet);
