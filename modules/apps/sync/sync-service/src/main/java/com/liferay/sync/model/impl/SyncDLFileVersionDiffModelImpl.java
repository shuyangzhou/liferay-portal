...
public class SyncDLFileVersionDiffModelImpl
	...
	public void setSyncDLFileVersionDiffId(long syncDLFileVersionDiffId) {
		_setOriginalValue(
			SYNCDLFILEVERSIONDIFFID_COLUMN_INDEX, _syncDLFileVersionDiffId);
	...
	public void setSourceFileVersionId(long sourceFileVersionId) {
		_setOriginalValue(
			SOURCEFILEVERSIONID_COLUMN_INDEX, _sourceFileVersionId);
	...
	public void setTargetFileVersionId(long targetFileVersionId) {
		_setOriginalValue(
			TARGETFILEVERSIONID_COLUMN_INDEX, _targetFileVersionId);
	...
	public void setDataFileEntryId(long dataFileEntryId) {
		_setOriginalValue(DATAFILEENTRYID_COLUMN_INDEX, _dataFileEntryId);
