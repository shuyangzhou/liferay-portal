...
public class FriendlyURLEntryLocalServiceUtil {
	...
	public static FriendlyURLEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			FriendlyURLEntryLocalServiceUtil::_getService);
	}

	private static FriendlyURLEntryLocalService _getService() {
		...
		ServiceReference<FriendlyURLEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<FriendlyURLEntryLocalService>
