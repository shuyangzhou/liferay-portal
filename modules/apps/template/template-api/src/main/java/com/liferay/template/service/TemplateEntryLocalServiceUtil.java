...
public class TemplateEntryLocalServiceUtil {
	...
	public static TemplateEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			TemplateEntryLocalServiceUtil::_getService);
	}

	private static TemplateEntryLocalService _getService() {
		...
		ServiceReference<TemplateEntryLocalService> serviceReference =
			bundleContext.getServiceReference(TemplateEntryLocalService.class);
	...
	private static final DCLSingleton<TemplateEntryLocalService>
