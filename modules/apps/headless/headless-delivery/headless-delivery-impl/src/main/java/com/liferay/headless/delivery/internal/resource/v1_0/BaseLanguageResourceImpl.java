...
public abstract class BaseLanguageResourceImpl
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/asset-libraries/{assetLibraryId}/languages")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/sites/{siteId}/languages")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path("/sites/{siteId}/languages/export-batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
