...
public class ContentTemplateResourceFactoryImpl
	...
	public ContentTemplateResource.Builder create() {
		return new ContentTemplateResource.Builder() {
			...
			public ContentTemplateResource build() {
				...
				Function<InvocationHandler, ContentTemplateResource>
					contentTemplateResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_contentTemplateResourceProxyProviderFunction;

				return contentTemplateResourceProxyProviderFunction.apply(
			...
			@Override
			public ContentTemplateResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function
			<InvocationHandler, ContentTemplateResource>
				_contentTemplateResourceProxyProviderFunction =
					_getProxyProviderFunction();
