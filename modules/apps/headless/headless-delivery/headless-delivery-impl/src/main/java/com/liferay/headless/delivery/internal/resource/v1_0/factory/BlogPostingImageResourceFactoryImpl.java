...
public class BlogPostingImageResourceFactoryImpl
	...
	public BlogPostingImageResource.Builder create() {
		return new BlogPostingImageResource.Builder() {
			...
			public BlogPostingImageResource build() {
				...
				Function<InvocationHandler, BlogPostingImageResource>
					blogPostingImageResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_blogPostingImageResourceProxyProviderFunction;

				return blogPostingImageResourceProxyProviderFunction.apply(
			...
			@Override
			public BlogPostingImageResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function
			<InvocationHandler, BlogPostingImageResource>
				_blogPostingImageResourceProxyProviderFunction =
					_getProxyProviderFunction();
