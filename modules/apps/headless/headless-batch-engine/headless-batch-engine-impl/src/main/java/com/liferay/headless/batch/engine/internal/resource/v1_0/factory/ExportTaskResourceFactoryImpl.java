	...
	public ExportTaskResource.Builder create() {
		return new ExportTaskResource.Builder() {
			...
			public ExportTaskResource build() {
				...
				Function<InvocationHandler, ExportTaskResource>
					exportTaskResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_exportTaskResourceProxyProviderFunction;

				return exportTaskResourceProxyProviderFunction.apply(
			...
			@Override
			public ExportTaskResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
