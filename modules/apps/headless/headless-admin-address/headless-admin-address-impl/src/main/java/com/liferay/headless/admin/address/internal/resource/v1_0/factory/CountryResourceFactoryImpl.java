	...
	public CountryResource.Builder create() {
		return new CountryResource.Builder() {
			...
			public CountryResource build() {
				...
				Function<InvocationHandler, CountryResource>
					countryResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_countryResourceProxyProviderFunction;

				return countryResourceProxyProviderFunction.apply(
			...
			@Override
			public CountryResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
