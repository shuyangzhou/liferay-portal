	...
	public SubscriptionResource.Builder create() {
		return new SubscriptionResource.Builder() {
			...
			public SubscriptionResource build() {
				...
				Function<InvocationHandler, SubscriptionResource>
					subscriptionResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_subscriptionResourceProxyProviderFunction;

				return subscriptionResourceProxyProviderFunction.apply(
			...
			@Override
			public SubscriptionResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
