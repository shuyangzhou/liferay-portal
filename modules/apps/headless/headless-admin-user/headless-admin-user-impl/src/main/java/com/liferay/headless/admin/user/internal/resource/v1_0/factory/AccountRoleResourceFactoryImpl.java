	...
	public AccountRoleResource.Builder create() {
		return new AccountRoleResource.Builder() {
			...
			public AccountRoleResource build() {
				...
				Function<InvocationHandler, AccountRoleResource>
					accountRoleResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_accountRoleResourceProxyProviderFunction;

				return accountRoleResourceProxyProviderFunction.apply(
			...
			@Override
			public AccountRoleResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
