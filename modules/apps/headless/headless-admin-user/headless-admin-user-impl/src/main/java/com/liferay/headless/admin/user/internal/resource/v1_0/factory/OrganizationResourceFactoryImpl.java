	...
	public OrganizationResource.Builder create() {
		return new OrganizationResource.Builder() {
			...
			public OrganizationResource build() {
				...
				Function<InvocationHandler, OrganizationResource>
					organizationResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_organizationResourceProxyProviderFunction;

				return organizationResourceProxyProviderFunction.apply(
			...
			@Override
			public OrganizationResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
