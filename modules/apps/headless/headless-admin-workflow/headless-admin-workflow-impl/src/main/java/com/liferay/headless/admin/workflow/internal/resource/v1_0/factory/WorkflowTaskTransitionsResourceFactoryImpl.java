	...
	public WorkflowTaskTransitionsResource.Builder create() {
		return new WorkflowTaskTransitionsResource.Builder() {
			...
			public WorkflowTaskTransitionsResource build() {
				...
				Function<InvocationHandler, WorkflowTaskTransitionsResource>
					workflowTaskTransitionsResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_workflowTaskTransitionsResourceProxyProviderFunction;

				return workflowTaskTransitionsResourceProxyProviderFunction.
					apply(
			...
			@Override
			public WorkflowTaskTransitionsResource.Builder uriInfo(
				UriInfo uriInfo) {
