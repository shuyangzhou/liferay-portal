...
public abstract class BaseFormRecordResourceImpl
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/forms/{formId}/form-records/by-latest-draft")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public FormRecord getFormFormRecordByLatestDraft(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("formId")
			Long formId)
		throws Exception {
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/forms/{formId}/form-records")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/form-records/{formRecordId}")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public FormRecord getFormRecord(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("formRecordId")
			Long formRecordId)
		throws Exception {
	...
	@jakarta.ws.rs.Path("/forms/{formId}/form-records/batch")
	@jakarta.ws.rs.POST
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path("/forms/{formId}/form-records/export-batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path("/form-records/batch")
	@jakarta.ws.rs.Produces("application/json")
	@jakarta.ws.rs.PUT
	@Override
