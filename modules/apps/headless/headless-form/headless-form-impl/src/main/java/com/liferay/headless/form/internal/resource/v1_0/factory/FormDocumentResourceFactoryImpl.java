	...
	public FormDocumentResource.Builder create() {
		return new FormDocumentResource.Builder() {
			...
			public FormDocumentResource build() {
				...
				Function<InvocationHandler, FormDocumentResource>
					formDocumentResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_formDocumentResourceProxyProviderFunction;

				return formDocumentResourceProxyProviderFunction.apply(
			...
			@Override
			public FormDocumentResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
