...
public class KaleoTaskLocalServiceUtil {
	...
	public static KaleoTaskLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			KaleoTaskLocalServiceUtil::_getService);
	}

	private static KaleoTaskLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			KaleoTaskLocalServiceUtil.class);
		...
		ServiceReference<KaleoTaskLocalService> serviceReference =
			bundleContext.getServiceReference(KaleoTaskLocalService.class);
	...
	private static final DCLSingleton<KaleoTaskLocalService>
