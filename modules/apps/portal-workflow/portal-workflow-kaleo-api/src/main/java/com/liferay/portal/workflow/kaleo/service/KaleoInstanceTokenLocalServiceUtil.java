...
public class KaleoInstanceTokenLocalServiceUtil {
	...
	public static KaleoInstanceTokenLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			KaleoInstanceTokenLocalServiceUtil::_getService);
	}

	private static KaleoInstanceTokenLocalService _getService() {
		...
		ServiceReference<KaleoInstanceTokenLocalService> serviceReference =
	...
	private static final DCLSingleton<KaleoInstanceTokenLocalService>
