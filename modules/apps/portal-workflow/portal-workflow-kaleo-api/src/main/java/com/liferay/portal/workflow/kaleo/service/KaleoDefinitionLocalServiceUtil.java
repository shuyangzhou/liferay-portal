...
public class KaleoDefinitionLocalServiceUtil {
	...
	public static KaleoDefinitionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			KaleoDefinitionLocalServiceUtil::_getService);
	}

	private static KaleoDefinitionLocalService _getService() {
		...
		ServiceReference<KaleoDefinitionLocalService> serviceReference =
	...
	private static final DCLSingleton<KaleoDefinitionLocalService>
