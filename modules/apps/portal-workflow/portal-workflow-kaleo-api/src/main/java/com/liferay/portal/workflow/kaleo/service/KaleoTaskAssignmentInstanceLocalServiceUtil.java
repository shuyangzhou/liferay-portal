...
public class KaleoTaskAssignmentInstanceLocalServiceUtil {
	...
	public static KaleoTaskAssignmentInstanceLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			KaleoTaskAssignmentInstanceLocalServiceUtil::_getService);
	}

	private static KaleoTaskAssignmentInstanceLocalService _getService() {
		...
		ServiceReference<KaleoTaskAssignmentInstanceLocalService>
	...
	private static final DCLSingleton<KaleoTaskAssignmentInstanceLocalService>
