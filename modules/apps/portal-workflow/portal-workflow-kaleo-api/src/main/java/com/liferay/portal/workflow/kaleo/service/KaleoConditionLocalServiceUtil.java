...
public class KaleoConditionLocalServiceUtil {
	...
	public static KaleoConditionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			KaleoConditionLocalServiceUtil::_getService);
	}

	private static KaleoConditionLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			KaleoConditionLocalServiceUtil.class);
		...
		ServiceReference<KaleoConditionLocalService> serviceReference =
			bundleContext.getServiceReference(KaleoConditionLocalService.class);
	...
	private static final DCLSingleton<KaleoConditionLocalService>
