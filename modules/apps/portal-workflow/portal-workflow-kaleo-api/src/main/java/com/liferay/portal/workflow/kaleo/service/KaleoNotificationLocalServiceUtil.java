...
public class KaleoNotificationLocalServiceUtil {
	...
	public static KaleoNotificationLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			KaleoNotificationLocalServiceUtil::_getService);
	}

	private static KaleoNotificationLocalService _getService() {
		...
		ServiceReference<KaleoNotificationLocalService> serviceReference =
	...
	private static final DCLSingleton<KaleoNotificationLocalService>
