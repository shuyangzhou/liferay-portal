...
public class KaleoTransitionLocalServiceUtil {
	...
	public static KaleoTransitionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			KaleoTransitionLocalServiceUtil::_getService);
	}

	private static KaleoTransitionLocalService _getService() {
		...
		ServiceReference<KaleoTransitionLocalService> serviceReference =
	...
	private static final DCLSingleton<KaleoTransitionLocalService>
