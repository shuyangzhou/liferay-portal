...
public class KaleoTaskInstanceTokenTable
	extends Table<KaleoTaskInstanceTokenTable> {
	...
	public final Column<KaleoTaskInstanceTokenTable, String> workflowContext =
		createColumn("workflowContext", String.class, Types.CLOB);
