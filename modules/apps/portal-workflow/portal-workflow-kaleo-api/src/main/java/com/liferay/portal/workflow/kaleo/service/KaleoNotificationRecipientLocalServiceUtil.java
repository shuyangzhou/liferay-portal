...
public class KaleoNotificationRecipientLocalServiceUtil {
	...
	public static KaleoNotificationRecipientLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			KaleoNotificationRecipientLocalServiceUtil::_getService);
	}

	private static KaleoNotificationRecipientLocalService _getService() {
		...
		ServiceReference<KaleoNotificationRecipientLocalService>
	...
	private static final DCLSingleton<KaleoNotificationRecipientLocalService>
