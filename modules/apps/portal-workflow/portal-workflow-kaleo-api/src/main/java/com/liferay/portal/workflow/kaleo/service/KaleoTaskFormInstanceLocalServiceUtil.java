...
public class KaleoTaskFormInstanceLocalServiceUtil {
	...
	public static KaleoTaskFormInstanceLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			KaleoTaskFormInstanceLocalServiceUtil::_getService);
	}

	private static KaleoTaskFormInstanceLocalService _getService() {
		...
		ServiceReference<KaleoTaskFormInstanceLocalService> serviceReference =
	...
	private static final DCLSingleton<KaleoTaskFormInstanceLocalService>
