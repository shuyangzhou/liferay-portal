...
public class KaleoLogLocalServiceUtil {
	...
	public static KaleoLogLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			KaleoLogLocalServiceUtil::_getService);
	}

	private static KaleoLogLocalService _getService() {
		...
		ServiceReference<KaleoLogLocalService> serviceReference =
			bundleContext.getServiceReference(KaleoLogLocalService.class);
	...
	private static final DCLSingleton<KaleoLogLocalService>
