...
public class KaleoDefinitionVersionLocalServiceUtil {
	...
	public static KaleoDefinitionVersionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			KaleoDefinitionVersionLocalServiceUtil::_getService);
	}

	private static KaleoDefinitionVersionLocalService _getService() {
		...
		ServiceReference<KaleoDefinitionVersionLocalService> serviceReference =
	...
	private static final DCLSingleton<KaleoDefinitionVersionLocalService>
