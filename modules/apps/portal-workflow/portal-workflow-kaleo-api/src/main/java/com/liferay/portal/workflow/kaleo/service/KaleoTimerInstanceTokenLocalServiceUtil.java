...
public class KaleoTimerInstanceTokenLocalServiceUtil {
	...
	public static KaleoTimerInstanceTokenLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			KaleoTimerInstanceTokenLocalServiceUtil::_getService);
	}

	private static KaleoTimerInstanceTokenLocalService _getService() {
		...
		ServiceReference<KaleoTimerInstanceTokenLocalService> serviceReference =
	...
	private static final DCLSingleton<KaleoTimerInstanceTokenLocalService>
