 ...
 * @generated
 */
public class KaleoLogTable extends Table<KaleoLogTable> {
	...
	public final Column<KaleoLogTable, String> comment = createColumn(
		"comment_", String.class, Types.CLOB);
	...
	public final Column<KaleoLogTable, String> workflowContext = createColumn(
		"workflowContext", String.class, Types.CLOB);
