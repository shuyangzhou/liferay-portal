...
public class KaleoActionLocalServiceUtil {
	...
	public static KaleoActionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			KaleoActionLocalServiceUtil::_getService);
	}

	private static KaleoActionLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			KaleoActionLocalServiceUtil.class);
		...
		ServiceReference<KaleoActionLocalService> serviceReference =
			bundleContext.getServiceReference(KaleoActionLocalService.class);
	...
	private static final DCLSingleton<KaleoActionLocalService>
