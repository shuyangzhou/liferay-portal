...
public class KaleoTaskAssignmentLocalServiceUtil {
	...
	public static KaleoTaskAssignmentLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			KaleoTaskAssignmentLocalServiceUtil::_getService);
	}

	private static KaleoTaskAssignmentLocalService _getService() {
		...
		ServiceReference<KaleoTaskAssignmentLocalService> serviceReference =
	...
	private static final DCLSingleton<KaleoTaskAssignmentLocalService>
