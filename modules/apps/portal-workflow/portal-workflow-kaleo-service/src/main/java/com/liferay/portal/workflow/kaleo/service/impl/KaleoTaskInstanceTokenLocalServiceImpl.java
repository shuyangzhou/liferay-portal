...
public class KaleoTaskInstanceTokenLocalServiceImpl
	...
	public KaleoTaskInstanceToken addKaleoTaskInstanceToken(
		...
		kaleoTaskInstanceToken = kaleoTaskInstanceTokenPersistence.update(kaleoTaskInstanceToken);
	...
	public KaleoTaskInstanceToken updateDueDate(
		...
		kaleoTaskInstance = kaleoTaskInstanceTokenPersistence.update(kaleoTaskInstance);
