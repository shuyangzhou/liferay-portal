...
public class KaleoLogModelImpl
	...
	public static final long KALEOINSTANCEID_COLUMN_BITMASK = 2048L;

	public static final long KALEOINSTANCETOKENID_COLUMN_BITMASK = 4096L;

	public static final long KALEOTASKINSTANCETOKENID_COLUMN_BITMASK = 8192L;

	public static final long KALEONODENAME_COLUMN_BITMASK = 16384L;

	public static final long TERMINALKALEONODE_COLUMN_BITMASK = 32768L;

	public static final long KALEOACTIONID_COLUMN_BITMASK = 65536L;

	public static final long KALEOACTIONNAME_COLUMN_BITMASK = 131072L;

	public static final long KALEOACTIONDESCRIPTION_COLUMN_BITMASK = 262144L;

	public static final long PREVIOUSKALEONODEID_COLUMN_BITMASK = 524288L;

	public static final long PREVIOUSKALEONODENAME_COLUMN_BITMASK = 1048576L;

	public static final long PREVIOUSASSIGNEECLASSNAME_COLUMN_BITMASK =
		2097152L;

	public static final long PREVIOUSASSIGNEECLASSPK_COLUMN_BITMASK = 4194304L;

	public static final long CURRENTASSIGNEECLASSNAME_COLUMN_BITMASK = 8388608L;

	public static final long CURRENTASSIGNEECLASSPK_COLUMN_BITMASK = 16777216L;

	public static final long TYPE_COLUMN_BITMASK = 33554432L;

	public static final long COMMENT_COLUMN_BITMASK = 67108864L;

	public static final long STARTDATE_COLUMN_BITMASK = 134217728L;

	public static final long ENDDATE_COLUMN_BITMASK = 268435456L;

	public static final long DURATION_COLUMN_BITMASK = 536870912L;

	public static final long WORKFLOWCONTEXT_COLUMN_BITMASK = 1073741824L;
	...
	public static final int KALEOINSTANCEID_COLUMN_INDEX = 11;

	public static final int KALEOINSTANCETOKENID_COLUMN_INDEX = 12;

	public static final int KALEOTASKINSTANCETOKENID_COLUMN_INDEX = 13;

	public static final int KALEONODENAME_COLUMN_INDEX = 14;

	public static final int TERMINALKALEONODE_COLUMN_INDEX = 15;

	public static final int KALEOACTIONID_COLUMN_INDEX = 16;

	public static final int KALEOACTIONNAME_COLUMN_INDEX = 17;

	public static final int KALEOACTIONDESCRIPTION_COLUMN_INDEX = 18;

	public static final int PREVIOUSKALEONODEID_COLUMN_INDEX = 19;

	public static final int PREVIOUSKALEONODENAME_COLUMN_INDEX = 20;

	public static final int PREVIOUSASSIGNEECLASSNAME_COLUMN_INDEX = 21;

	public static final int PREVIOUSASSIGNEECLASSPK_COLUMN_INDEX = 22;

	public static final int CURRENTASSIGNEECLASSNAME_COLUMN_INDEX = 23;

	public static final int CURRENTASSIGNEECLASSPK_COLUMN_INDEX = 24;

	public static final int TYPE_COLUMN_INDEX = 25;

	public static final int COMMENT_COLUMN_INDEX = 26;

	public static final int STARTDATE_COLUMN_INDEX = 27;

	public static final int ENDDATE_COLUMN_INDEX = 28;

	public static final int DURATION_COLUMN_INDEX = 29;

	public static final int WORKFLOWCONTEXT_COLUMN_INDEX = 30;
	...
	public void setKaleoLogId(long kaleoLogId) {
		if ((_columnBitmask & KALEOLOGID_COLUMN_BITMASK) == 0) {
			...
			_originalValues[KALEOLOGID_COLUMN_INDEX] = _kaleoLogId;
		}
	...
	public void setKaleoClassName(String kaleoClassName) {
		if ((_columnBitmask & KALEOCLASSNAME_COLUMN_BITMASK) == 0) {
	...
	public String getOriginalKaleoClassName() {
		if (_originalValues != null) {
			Object originalKaleoClassName =
				_originalValues[KALEOCLASSNAME_COLUMN_INDEX];

			if (originalKaleoClassName != null) {
				return GetterUtil.getString((String)originalKaleoClassName);
			}
		}
	...
	public void setKaleoClassPK(long kaleoClassPK) {
		if ((_columnBitmask & KALEOCLASSPK_COLUMN_BITMASK) == 0) {
	...
	public long getOriginalKaleoClassPK() {
		if (_originalValues != null) {
			Object originalKaleoClassPK =
				_originalValues[KALEOCLASSPK_COLUMN_INDEX];

			if (originalKaleoClassPK != null) {
				return (long)originalKaleoClassPK;
			}
		}
	...
	public void setKaleoDefinitionVersionId(long kaleoDefinitionVersionId) {
		if ((_columnBitmask & KALEODEFINITIONVERSIONID_COLUMN_BITMASK) == 0) {
	...
	public long getOriginalKaleoDefinitionVersionId() {
		if (_originalValues != null) {
			Object originalKaleoDefinitionVersionId =
				_originalValues[KALEODEFINITIONVERSIONID_COLUMN_INDEX];

			if (originalKaleoDefinitionVersionId != null) {
				return (long)originalKaleoDefinitionVersionId;
			}
		}
	...
	public void setKaleoInstanceId(long kaleoInstanceId) {
		if ((_columnBitmask & KALEOINSTANCEID_COLUMN_BITMASK) == 0) {
	...
	public long getOriginalKaleoInstanceId() {
		if (_originalValues != null) {
			Object originalKaleoInstanceId =
				_originalValues[KALEOINSTANCEID_COLUMN_INDEX];

			if (originalKaleoInstanceId != null) {
				return (long)originalKaleoInstanceId;
			}
		}
	...
	public void setKaleoInstanceTokenId(long kaleoInstanceTokenId) {
		if ((_columnBitmask & KALEOINSTANCETOKENID_COLUMN_BITMASK) == 0) {
	...
	public long getOriginalKaleoInstanceTokenId() {
		if (_originalValues != null) {
			Object originalKaleoInstanceTokenId =
				_originalValues[KALEOINSTANCETOKENID_COLUMN_INDEX];

			if (originalKaleoInstanceTokenId != null) {
				return (long)originalKaleoInstanceTokenId;
			}
		}
	...
	public void setKaleoTaskInstanceTokenId(long kaleoTaskInstanceTokenId) {
		if ((_columnBitmask & KALEOTASKINSTANCETOKENID_COLUMN_BITMASK) == 0) {
	...
	public long getOriginalKaleoTaskInstanceTokenId() {
		if (_originalValues != null) {
			Object originalKaleoTaskInstanceTokenId =
				_originalValues[KALEOTASKINSTANCETOKENID_COLUMN_INDEX];

			if (originalKaleoTaskInstanceTokenId != null) {
				return (long)originalKaleoTaskInstanceTokenId;
			}
		}
	...
	public void setKaleoNodeName(String kaleoNodeName) {
		if ((_columnBitmask & KALEONODENAME_COLUMN_BITMASK) == 0) {
			...
			_originalValues[KALEONODENAME_COLUMN_INDEX] = _kaleoNodeName;
		}
	...
	public void setTerminalKaleoNode(boolean terminalKaleoNode) {
		if ((_columnBitmask & TERMINALKALEONODE_COLUMN_BITMASK) == 0) {
			...
			_originalValues[TERMINALKALEONODE_COLUMN_INDEX] =
				_terminalKaleoNode;
		}
	...
	public void setKaleoActionId(long kaleoActionId) {
		if ((_columnBitmask & KALEOACTIONID_COLUMN_BITMASK) == 0) {
			...
			_originalValues[KALEOACTIONID_COLUMN_INDEX] = _kaleoActionId;
		}
	...
	public void setKaleoActionName(String kaleoActionName) {
		if ((_columnBitmask & KALEOACTIONNAME_COLUMN_BITMASK) == 0) {
			...
			_originalValues[KALEOACTIONNAME_COLUMN_INDEX] = _kaleoActionName;
		}
	...
	public void setKaleoActionDescription(String kaleoActionDescription) {
		if ((_columnBitmask & KALEOACTIONDESCRIPTION_COLUMN_BITMASK) == 0) {
			...
			_originalValues[KALEOACTIONDESCRIPTION_COLUMN_INDEX] =
	...
	public void setPreviousKaleoNodeId(long previousKaleoNodeId) {
		if ((_columnBitmask & PREVIOUSKALEONODEID_COLUMN_BITMASK) == 0) {
			...
			_originalValues[PREVIOUSKALEONODEID_COLUMN_INDEX] =
				_previousKaleoNodeId;
		}
	...
	public void setPreviousKaleoNodeName(String previousKaleoNodeName) {
		if ((_columnBitmask & PREVIOUSKALEONODENAME_COLUMN_BITMASK) == 0) {
			...
			_originalValues[PREVIOUSKALEONODENAME_COLUMN_INDEX] =
	...
	public void setPreviousAssigneeClassName(String previousAssigneeClassName) {
		if ((_columnBitmask & PREVIOUSASSIGNEECLASSNAME_COLUMN_BITMASK) == 0) {
			...
			_originalValues[PREVIOUSASSIGNEECLASSNAME_COLUMN_INDEX] =
	...
	public void setPreviousAssigneeClassPK(long previousAssigneeClassPK) {
		if ((_columnBitmask & PREVIOUSASSIGNEECLASSPK_COLUMN_BITMASK) == 0) {
			...
			_originalValues[PREVIOUSASSIGNEECLASSPK_COLUMN_INDEX] =
				_previousAssigneeClassPK;
		}
	...
	public void setCurrentAssigneeClassName(String currentAssigneeClassName) {
		if ((_columnBitmask & CURRENTASSIGNEECLASSNAME_COLUMN_BITMASK) == 0) {
			...
			_originalValues[CURRENTASSIGNEECLASSNAME_COLUMN_INDEX] =
	...
	public void setCurrentAssigneeClassPK(long currentAssigneeClassPK) {
		if ((_columnBitmask & CURRENTASSIGNEECLASSPK_COLUMN_BITMASK) == 0) {
			...
			_originalValues[CURRENTASSIGNEECLASSPK_COLUMN_INDEX] =
				_currentAssigneeClassPK;
		}
	...
	public void setComment(String comment) {
		if ((_columnBitmask & COMMENT_COLUMN_BITMASK) == 0) {
			...
			_originalValues[COMMENT_COLUMN_INDEX] = _comment;
		}
	...
	public void setStartDate(Date startDate) {
		if ((_columnBitmask & STARTDATE_COLUMN_BITMASK) == 0) {
			...
			_originalValues[STARTDATE_COLUMN_INDEX] = _startDate;
		}
	...
	public void setEndDate(Date endDate) {
		if ((_columnBitmask & ENDDATE_COLUMN_BITMASK) == 0) {
			...
			_originalValues[ENDDATE_COLUMN_INDEX] = _endDate;
		}
	...
	public void setDuration(long duration) {
		if ((_columnBitmask & DURATION_COLUMN_BITMASK) == 0) {
			...
			_originalValues[DURATION_COLUMN_INDEX] = _duration;
		}
	...
	public void setWorkflowContext(String workflowContext) {
		if ((_columnBitmask & WORKFLOWCONTEXT_COLUMN_BITMASK) == 0) {
			...
			_originalValues[WORKFLOWCONTEXT_COLUMN_INDEX] = _workflowContext;
		}
