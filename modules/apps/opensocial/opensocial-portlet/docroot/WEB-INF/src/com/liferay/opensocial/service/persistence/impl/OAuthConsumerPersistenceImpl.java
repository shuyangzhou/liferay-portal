...
public class OAuthConsumerPersistenceImpl
	...
	public List<OAuthConsumer> findByGadgetKey(
		...
		return findByGadgetKey(gadgetKey, start, end, orderByComparator);
	}
	...
	public List<OAuthConsumer> findByGadgetKey(
		...
		List<OAuthConsumer> list =
			(List<OAuthConsumer>)FinderCacheUtil.getResult(
	...
	public OAuthConsumer fetchByG_S(
		...
		return fetchByG_S(gadgetKey, serviceName);
	}
