...
public class LayoutUtilityPageEntryLocalServiceUtil {
	...
	public static LayoutUtilityPageEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			LayoutUtilityPageEntryLocalServiceUtil::_getService);
	}

	private static LayoutUtilityPageEntryLocalService _getService() {
		...
		ServiceReference<LayoutUtilityPageEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<LayoutUtilityPageEntryLocalService>
