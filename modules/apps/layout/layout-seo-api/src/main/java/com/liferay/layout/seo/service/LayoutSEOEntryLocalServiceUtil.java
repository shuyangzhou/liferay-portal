...
public class LayoutSEOEntryLocalServiceUtil {
	...
	public static LayoutSEOEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			LayoutSEOEntryLocalServiceUtil::_getService);
	}

	private static LayoutSEOEntryLocalService _getService() {
		...
		ServiceReference<LayoutSEOEntryLocalService> serviceReference =
			bundleContext.getServiceReference(LayoutSEOEntryLocalService.class);
	...
	private static final DCLSingleton<LayoutSEOEntryLocalService>
