...
public class LayoutSEOSiteServiceUtil {
	...
	public static LayoutSEOSiteService getService() {
		return _serviceDCLSingleton.getSingleton(
			LayoutSEOSiteServiceUtil::_getService);
	}

	private static LayoutSEOSiteService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(LayoutSEOSiteServiceUtil.class);
		...
		ServiceReference<LayoutSEOSiteService> serviceReference =
			bundleContext.getServiceReference(LayoutSEOSiteService.class);
	...
	private static final DCLSingleton<LayoutSEOSiteService>
