...
public class LayoutPageTemplateStructureRelTable
	extends Table<LayoutPageTemplateStructureRelTable> {
	...
	public final Column<LayoutPageTemplateStructureRelTable, String> data =
		createColumn("data_", String.class, Types.CLOB);
