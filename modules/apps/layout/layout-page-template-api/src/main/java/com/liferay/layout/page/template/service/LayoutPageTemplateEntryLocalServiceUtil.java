...
public class LayoutPageTemplateEntryLocalServiceUtil {
	...
	public static LayoutPageTemplateEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			LayoutPageTemplateEntryLocalServiceUtil::_getService);
	}

	private static LayoutPageTemplateEntryLocalService _getService() {
		...
		ServiceReference<LayoutPageTemplateEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<LayoutPageTemplateEntryLocalService>
