...
public class LayoutPageTemplateEntryServiceUtil {
	...
	public static LayoutPageTemplateEntryService getService() {
		return _serviceDCLSingleton.getSingleton(
			LayoutPageTemplateEntryServiceUtil::_getService);
	}

	private static LayoutPageTemplateEntryService _getService() {
		...
		ServiceReference<LayoutPageTemplateEntryService> serviceReference =
	...
	private static final DCLSingleton<LayoutPageTemplateEntryService>
