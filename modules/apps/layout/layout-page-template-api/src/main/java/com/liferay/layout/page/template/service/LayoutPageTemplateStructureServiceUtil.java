...
public class LayoutPageTemplateStructureServiceUtil {
	...
	public static LayoutPageTemplateStructureService getService() {
		return _serviceDCLSingleton.getSingleton(
			LayoutPageTemplateStructureServiceUtil::_getService);
	}

	private static LayoutPageTemplateStructureService _getService() {
		...
		ServiceReference<LayoutPageTemplateStructureService> serviceReference =
	...
	private static final DCLSingleton<LayoutPageTemplateStructureService>
