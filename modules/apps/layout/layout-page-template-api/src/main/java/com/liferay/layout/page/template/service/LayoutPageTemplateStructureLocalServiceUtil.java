...
public class LayoutPageTemplateStructureLocalServiceUtil {
	...
	public static LayoutPageTemplateStructureLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			LayoutPageTemplateStructureLocalServiceUtil::_getService);
	}

	private static LayoutPageTemplateStructureLocalService _getService() {
		...
		ServiceReference<LayoutPageTemplateStructureLocalService>
	...
	private static final DCLSingleton<LayoutPageTemplateStructureLocalService>
