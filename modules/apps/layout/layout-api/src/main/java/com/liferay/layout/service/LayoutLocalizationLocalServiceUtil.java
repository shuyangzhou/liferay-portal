...
public class LayoutLocalizationLocalServiceUtil {
	...
	public static LayoutLocalizationLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			LayoutLocalizationLocalServiceUtil::_getService);
	}

	private static LayoutLocalizationLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			LayoutLocalizationLocalServiceUtil.class);
		...
		ServiceReference<LayoutLocalizationLocalService> serviceReference =
	...
	private static final DCLSingleton<LayoutLocalizationLocalService>
