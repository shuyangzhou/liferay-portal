...
public class LayoutClassedModelUsageLocalServiceUtil {
	...
	public static LayoutClassedModelUsageLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			LayoutClassedModelUsageLocalServiceUtil::_getService);
	}

	private static LayoutClassedModelUsageLocalService _getService() {
		...
		ServiceReference<LayoutClassedModelUsageLocalService> serviceReference =
	...
	private static final DCLSingleton<LayoutClassedModelUsageLocalService>
