...
public class LayoutPageTemplateCollectionModelImpl
	...
	public void setLayoutPageTemplateCollectionKey(
		...
		if ((_columnBitmask & LAYOUTPAGETEMPLATECOLLECTIONKEY_COLUMN_BITMASK) ==
				0) {
	...
	public String getOriginalLayoutPageTemplateCollectionKey() {
		if (_originalValues != null) {
			Object originalLayoutPageTemplateCollectionKey =
				_originalValues[LAYOUTPAGETEMPLATECOLLECTIONKEY_COLUMN_INDEX];

			if (originalLayoutPageTemplateCollectionKey != null) {
				return GetterUtil.getString(
					(String)originalLayoutPageTemplateCollectionKey);
			}
		}

		return GetterUtil.getString(_layoutPageTemplateCollectionKey);
	}
