...
public class FragmentCollectionModelImpl
	...
	public void setFragmentCollectionKey(String fragmentCollectionKey) {
		if ((_columnBitmask & FRAGMENTCOLLECTIONKEY_COLUMN_BITMASK) == 0) {
	...
	public String getOriginalFragmentCollectionKey() {
		if (_originalValues != null) {
			Object originalFragmentCollectionKey =
				_originalValues[FRAGMENTCOLLECTIONKEY_COLUMN_INDEX];

			if (originalFragmentCollectionKey != null) {
				return GetterUtil.getString(
					(String)originalFragmentCollectionKey);
			}
		}
