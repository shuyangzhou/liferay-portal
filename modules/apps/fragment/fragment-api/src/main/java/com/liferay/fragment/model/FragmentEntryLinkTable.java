 ...
 * @generated
 */
public class FragmentEntryLinkTable extends Table<FragmentEntryLinkTable> {
	...
	public final Column<FragmentEntryLinkTable, String> css = createColumn(
		"css", String.class, Types.CLOB);
	public final Column<FragmentEntryLinkTable, String> html = createColumn(
		"html", String.class, Types.CLOB);
	public final Column<FragmentEntryLinkTable, String> js = createColumn(
		"js", String.class, Types.CLOB);
	public final Column<FragmentEntryLinkTable, String> configuration =
		createColumn("configuration", String.class, Types.CLOB);
	public final Column<FragmentEntryLinkTable, String> editableValues =
		createColumn("editableValues", String.class, Types.CLOB);
