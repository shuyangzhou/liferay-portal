...
public class FragmentCollectionLocalServiceUtil {
	...
	public static FragmentCollectionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			FragmentCollectionLocalServiceUtil::_getService);
	}

	private static FragmentCollectionLocalService _getService() {
		...
		ServiceReference<FragmentCollectionLocalService> serviceReference =
	...
	private static final DCLSingleton<FragmentCollectionLocalService>
