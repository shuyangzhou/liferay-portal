...
public class FragmentEntryServiceUtil {
	...
	public static FragmentEntryService getService() {
		return _serviceDCLSingleton.getSingleton(
			FragmentEntryServiceUtil::_getService);
	}

	private static FragmentEntryService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(FragmentEntryServiceUtil.class);
		...
		ServiceReference<FragmentEntryService> serviceReference =
			bundleContext.getServiceReference(FragmentEntryService.class);
	...
	private static final DCLSingleton<FragmentEntryService>
