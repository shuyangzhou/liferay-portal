...
public class FragmentCompositionLocalServiceUtil {
	...
	public static FragmentCompositionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			FragmentCompositionLocalServiceUtil::_getService);
	}

	private static FragmentCompositionLocalService _getService() {
		...
		ServiceReference<FragmentCompositionLocalService> serviceReference =
	...
	private static final DCLSingleton<FragmentCompositionLocalService>
