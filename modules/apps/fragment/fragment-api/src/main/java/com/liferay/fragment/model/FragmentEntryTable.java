 ...
 * @generated
 */
public class FragmentEntryTable extends Table<FragmentEntryTable> {
	...
	public final Column<FragmentEntryTable, String> css = createColumn(
		"css", String.class, Types.CLOB);
	public final Column<FragmentEntryTable, String> html = createColumn(
		"html", String.class, Types.CLOB);
	public final Column<FragmentEntryTable, String> js = createColumn(
		"js", String.class, Types.CLOB);
	public final Column<FragmentEntryTable, String> configuration =
