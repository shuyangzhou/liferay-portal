...
public class FragmentEntryLocalServiceUtil {
	...
	public static FragmentEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			FragmentEntryLocalServiceUtil::_getService);
	}

	private static FragmentEntryLocalService _getService() {
		...
		ServiceReference<FragmentEntryLocalService> serviceReference =
			bundleContext.getServiceReference(FragmentEntryLocalService.class);
	...
	private static final DCLSingleton<FragmentEntryLocalService>
