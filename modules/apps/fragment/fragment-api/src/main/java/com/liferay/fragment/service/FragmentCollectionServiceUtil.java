...
public class FragmentCollectionServiceUtil {
	...
	public static FragmentCollectionService getService() {
		return _serviceDCLSingleton.getSingleton(
			FragmentCollectionServiceUtil::_getService);
	}

	private static FragmentCollectionService _getService() {
		...
		ServiceReference<FragmentCollectionService> serviceReference =
			bundleContext.getServiceReference(FragmentCollectionService.class);
	...
	private static final DCLSingleton<FragmentCollectionService>
