...
public class TrashEntryLocalServiceUtil {
	...
	public static TrashEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			TrashEntryLocalServiceUtil::_getService);
	}

	private static TrashEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			TrashEntryLocalServiceUtil.class);
		...
		ServiceReference<TrashEntryLocalService> serviceReference =
			bundleContext.getServiceReference(TrashEntryLocalService.class);
	...
	private static final DCLSingleton<TrashEntryLocalService>
