...
public class TrashVersionLocalServiceUtil {
	...
	public static TrashVersionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			TrashVersionLocalServiceUtil::_getService);
	}

	private static TrashVersionLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			TrashVersionLocalServiceUtil.class);
		...
		ServiceReference<TrashVersionLocalService> serviceReference =
			bundleContext.getServiceReference(TrashVersionLocalService.class);
	...
	private static final DCLSingleton<TrashVersionLocalService>
