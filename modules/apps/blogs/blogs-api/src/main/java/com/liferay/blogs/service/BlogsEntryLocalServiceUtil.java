...
public class BlogsEntryLocalServiceUtil {
	...
	public static BlogsEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			BlogsEntryLocalServiceUtil::_getService);
	}

	private static BlogsEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			BlogsEntryLocalServiceUtil.class);
		...
		ServiceReference<BlogsEntryLocalService> serviceReference =
			bundleContext.getServiceReference(BlogsEntryLocalService.class);
	...
	private static final DCLSingleton<BlogsEntryLocalService>
