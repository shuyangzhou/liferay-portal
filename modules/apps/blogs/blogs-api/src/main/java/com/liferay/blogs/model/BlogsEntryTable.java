...
public class BlogsEntryTable extends Table<BlogsEntryTable> {
	...
	public final Column<BlogsEntryTable, String> content = createColumn(
		"content", String.class, Types.CLOB);
	...
	public final Column<BlogsEntryTable, String> trackbacks = createColumn(
		"trackbacks", String.class, Types.CLOB);
