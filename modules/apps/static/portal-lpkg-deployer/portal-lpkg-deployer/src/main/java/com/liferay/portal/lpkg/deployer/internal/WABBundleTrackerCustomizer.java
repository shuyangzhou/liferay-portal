 ...
 */
public class WABBundleTrackerCustomizer
	implements BundleTrackerCustomizer<Bundle> {

	public WABBundleTrackerCustomizer(BundleContext bundleContext) {
	...
	private Bundle _getWABBundle(Bundle bundle) throws MalformedURLException {
		...
		String wabLocation = LPKGUtil.generateWABLocation(
	...
	private static final Log _log = LogFactoryUtil.getLog(
		WABBundleTrackerCustomizer.class);
