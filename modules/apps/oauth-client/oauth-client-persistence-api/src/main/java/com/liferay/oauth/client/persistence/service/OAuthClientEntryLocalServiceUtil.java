...
public class OAuthClientEntryLocalServiceUtil {
	...
	public static OAuthClientEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			OAuthClientEntryLocalServiceUtil::_getService);
	}

	private static OAuthClientEntryLocalService _getService() {
		...
		ServiceReference<OAuthClientEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<OAuthClientEntryLocalService>
