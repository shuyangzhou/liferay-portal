...
public class OAuthClientASLocalMetadataServiceUtil {
	...
	public static OAuthClientASLocalMetadataService getService() {
		return _serviceDCLSingleton.getSingleton(
			OAuthClientASLocalMetadataServiceUtil::_getService);
	}

	private static OAuthClientASLocalMetadataService _getService() {
		...
		ServiceReference<OAuthClientASLocalMetadataService> serviceReference =
	...
	private static final DCLSingleton<OAuthClientASLocalMetadataService>
