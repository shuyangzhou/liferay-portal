...
public class OAuthClientASLocalMetadataLocalServiceUtil {
	...
	public static OAuthClientASLocalMetadataLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			OAuthClientASLocalMetadataLocalServiceUtil::_getService);
	}

	private static OAuthClientASLocalMetadataLocalService _getService() {
		...
		ServiceReference<OAuthClientASLocalMetadataLocalService>
	...
	private static final DCLSingleton<OAuthClientASLocalMetadataLocalService>
