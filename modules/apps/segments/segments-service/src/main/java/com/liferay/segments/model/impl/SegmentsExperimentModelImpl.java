...
public class SegmentsExperimentModelImpl
	...
	public void setSegmentsExperimentId(long segmentsExperimentId) {
		_setOriginalValue(
			SEGMENTSEXPERIMENTID_COLUMN_INDEX, _segmentsExperimentId);
	...
	public void setSegmentsExperienceId(long segmentsExperienceId) {
		_setOriginalValue(
			SEGMENTSEXPERIENCEID_COLUMN_INDEX, _segmentsExperienceId);
	...
	public void setSegmentsExperimentKey(String segmentsExperimentKey) {
		_setOriginalValue(
			SEGMENTSEXPERIMENTKEY_COLUMN_INDEX, _segmentsExperimentKey);
