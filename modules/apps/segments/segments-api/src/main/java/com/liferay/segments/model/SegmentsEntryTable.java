 ...
 * @generated
 */
public class SegmentsEntryTable extends Table<SegmentsEntryTable> {
	...
	public final Column<SegmentsEntryTable, String> criteria = createColumn(
		"criteria", String.class, Types.CLOB);
