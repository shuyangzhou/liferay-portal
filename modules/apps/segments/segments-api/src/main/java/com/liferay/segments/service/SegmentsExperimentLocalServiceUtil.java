...
public class SegmentsExperimentLocalServiceUtil {
	...
	public static SegmentsExperimentLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SegmentsExperimentLocalServiceUtil::_getService);
	}

	private static SegmentsExperimentLocalService _getService() {
		...
		ServiceReference<SegmentsExperimentLocalService> serviceReference =
	...
	private static final DCLSingleton<SegmentsExperimentLocalService>
