 ...
 * @generated
 */
public class SegmentsExperimentTable extends Table<SegmentsExperimentTable> {
	...
	public final Column<SegmentsExperimentTable, String> typeSettings =
		createColumn("typeSettings", String.class, Types.CLOB);
