...
public class SegmentsEntryRelLocalServiceUtil {
	...
	public static SegmentsEntryRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SegmentsEntryRelLocalServiceUtil::_getService);
	}

	private static SegmentsEntryRelLocalService _getService() {
		...
		ServiceReference<SegmentsEntryRelLocalService> serviceReference =
	...
	private static final DCLSingleton<SegmentsEntryRelLocalService>
