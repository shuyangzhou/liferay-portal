...
public class SegmentsEntryLocalServiceUtil {
	...
	public static SegmentsEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SegmentsEntryLocalServiceUtil::_getService);
	}

	private static SegmentsEntryLocalService _getService() {
		...
		ServiceReference<SegmentsEntryLocalService> serviceReference =
			bundleContext.getServiceReference(SegmentsEntryLocalService.class);
	...
	private static final DCLSingleton<SegmentsEntryLocalService>
