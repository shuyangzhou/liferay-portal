...
public class SegmentsExperimentServiceUtil {
	...
	public static SegmentsExperimentService getService() {
		return _serviceDCLSingleton.getSingleton(
			SegmentsExperimentServiceUtil::_getService);
	}

	private static SegmentsExperimentService _getService() {
		...
		ServiceReference<SegmentsExperimentService> serviceReference =
			bundleContext.getServiceReference(SegmentsExperimentService.class);
	...
	private static final DCLSingleton<SegmentsExperimentService>
