...
public class SegmentsExperimentRelLocalServiceUtil {
	...
	public static SegmentsExperimentRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SegmentsExperimentRelLocalServiceUtil::_getService);
	}

	private static SegmentsExperimentRelLocalService _getService() {
		...
		ServiceReference<SegmentsExperimentRelLocalService> serviceReference =
	...
	private static final DCLSingleton<SegmentsExperimentRelLocalService>
