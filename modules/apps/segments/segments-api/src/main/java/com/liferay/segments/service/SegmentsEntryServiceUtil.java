...
public class SegmentsEntryServiceUtil {
	...
	public static SegmentsEntryService getService() {
		return _serviceDCLSingleton.getSingleton(
			SegmentsEntryServiceUtil::_getService);
	}

	private static SegmentsEntryService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(SegmentsEntryServiceUtil.class);
		...
		ServiceReference<SegmentsEntryService> serviceReference =
			bundleContext.getServiceReference(SegmentsEntryService.class);
	...
	private static final DCLSingleton<SegmentsEntryService>
