...
public class ViewCountEntryCacheModel
	...
	public boolean equals(Object obj) {
		...
		if (viewCountEntryId == viewCountEntryCacheModel.viewCountEntryId) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, viewCountEntryId);
	}
	...
	public ViewCountEntry toEntityModel() {
		...
		viewCountEntryImpl.setViewCountEntryId(viewCountEntryId);
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		viewCountEntryId = objectInput.readLong();
	...
	public void writeExternal(ObjectOutput objectOutput) throws IOException {
		objectOutput.writeLong(viewCountEntryId);
