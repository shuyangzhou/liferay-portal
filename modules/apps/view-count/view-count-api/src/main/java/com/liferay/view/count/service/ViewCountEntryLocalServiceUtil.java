...
public class ViewCountEntryLocalServiceUtil {
	...
	public static long getViewCount(
		...
		return getService().getViewCount(companyId, clazz, classPK);
	}
	...
	public static void incrementViewCount(
		...
		getService().incrementViewCount(companyId, clazz, classPK);
	}

	public static void incrementViewCount(
		long companyId, Class<?> clazz, long classPK, int increment) {

		getService().incrementViewCount(companyId, clazz, classPK, increment);
	}
	...
	public static void removeViewCount(
		...
		getService().removeViewCount(companyId, clazz, classPK);
	}
