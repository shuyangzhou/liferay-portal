...
public class ViewCountEntryLocalServiceUtil {
	...
	public static com.liferay.view.count.model.ViewCountEntry
		createViewCountEntry(long viewCountEntryId) {

		return getService().createViewCountEntry(viewCountEntryId);
	}
	 ...
	 */
	public static com.liferay.view.count.model.ViewCountEntry
			deleteViewCountEntry(long viewCountEntryId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().deleteViewCountEntry(viewCountEntryId);
	}
	...
	public static com.liferay.view.count.model.ViewCountEntry
		fetchViewCountEntry(long viewCountEntryId) {

		return getService().fetchViewCountEntry(viewCountEntryId);
	}
	...
	public static java.util.List<com.liferay.view.count.model.ViewCountEntry>
		...
		return getService().getViewCountEntries(
	...
	public static int getViewCountEntriesCount(
		...
		return getService().getViewCountEntriesCount(companyId, classNameIds);
	}
	...
	public static com.liferay.view.count.model.ViewCountEntry getViewCountEntry(
			long viewCountEntryId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getViewCountEntry(viewCountEntryId);
	}
