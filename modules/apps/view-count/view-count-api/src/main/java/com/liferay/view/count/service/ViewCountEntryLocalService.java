...
public interface ViewCountEntryLocalService
	...
	public ViewCountEntry createViewCountEntry(long viewCountEntryId);
	...
	public ViewCountEntry deleteViewCountEntry(long viewCountEntryId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ViewCountEntry fetchViewCountEntry(long viewCountEntryId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ViewCountEntry getViewCountEntry(long viewCountEntryId)
		throws PortalException;
