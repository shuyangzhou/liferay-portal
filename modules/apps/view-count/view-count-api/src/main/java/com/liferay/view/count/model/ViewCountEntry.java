...
public interface ViewCountEntry extends PersistedModel, ViewCountEntryModel {
	 ...
	 */
	public static final Accessor<ViewCountEntry, Long>
		VIEW_COUNT_ENTRY_ID_ACCESSOR = new Accessor<ViewCountEntry, Long>() {

			@Override
			public Long get(ViewCountEntry viewCountEntry) {
				return viewCountEntry.getViewCountEntryId();
			}
