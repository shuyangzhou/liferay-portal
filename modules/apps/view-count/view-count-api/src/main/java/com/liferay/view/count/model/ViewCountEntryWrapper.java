...
public class ViewCountEntryWrapper
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("viewCountEntryId", getViewCountEntryId());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Long viewCountEntryId = (Long)attributes.get("viewCountEntryId");

		if (viewCountEntryId != null) {
			setViewCountEntryId(viewCountEntryId);
		}
	...
	/**
	 * Returns the view count entry ID of this view count entry.
	 *
	 * @return the view count entry ID of this view count entry
	 */
	@Override
	public long getViewCountEntryId() {
		return model.getViewCountEntryId();
	}
	...
	/**
	 * Sets the view count entry ID of this view count entry.
	 *
	 * @param viewCountEntryId the view count entry ID of this view count entry
	 */
	@Override
	public void setViewCountEntryId(long viewCountEntryId) {
		model.setViewCountEntryId(viewCountEntryId);
	}
