...
public class ViewCountEntryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newViewCountEntry.setCompanyId(RandomTestUtil.nextLong());

		newViewCountEntry.setClassNameId(RandomTestUtil.nextLong());

		newViewCountEntry.setClassPK(RandomTestUtil.nextLong());
		...
		Assert.assertEquals(
			existingViewCountEntry.getViewCountEntryId(),
			newViewCountEntry.getViewCountEntryId());
		Assert.assertEquals(
	...
	protected OrderByComparator<ViewCountEntry> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"ViewCountEntry", "viewCountEntryId", true, "companyId", true,
			"classNameId", true, "classPK", true, "viewCount", true);
	}
	...
	public void testDynamicQueryByPrimaryKeyExisting() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq(
				"viewCountEntryId", newViewCountEntry.getViewCountEntryId()));
	...
	public void testDynamicQueryByPrimaryKeyMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq(
				"viewCountEntryId", RandomTestUtil.nextLong()));
	...
	public void testDynamicQueryByProjectionExisting() throws Exception {
		...
		dynamicQuery.setProjection(
			ProjectionFactoryUtil.property("viewCountEntryId"));

		Object newViewCountEntryId = newViewCountEntry.getViewCountEntryId();

		dynamicQuery.add(
			RestrictionsFactoryUtil.in(
				"viewCountEntryId", new Object[] {newViewCountEntryId}));

		List<Object> result = _persistence.findWithDynamicQuery(dynamicQuery);

		Assert.assertEquals(1, result.size());

		Object existingViewCountEntryId = result.get(0);

		Assert.assertEquals(existingViewCountEntryId, newViewCountEntryId);
	}
	...
	public void testDynamicQueryByProjectionMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.in(
				"viewCountEntryId", new Object[] {RandomTestUtil.nextLong()}));
	...
	public void testResetOriginalValues() throws Exception {
		...
		Assert.assertEquals(
			Long.valueOf(existingViewCountEntry.getCompanyId()),
			ReflectionTestUtil.<Long>invoke(
				existingViewCountEntry, "getOriginalCompanyId",
				new Class<?>[0]));
		Assert.assertEquals(
			Long.valueOf(existingViewCountEntry.getClassNameId()),
			ReflectionTestUtil.<Long>invoke(
				existingViewCountEntry, "getOriginalClassNameId",
				new Class<?>[0]));
		Assert.assertEquals(
			Long.valueOf(existingViewCountEntry.getClassPK()),
			ReflectionTestUtil.<Long>invoke(
				existingViewCountEntry, "getOriginalClassPK", new Class<?>[0]));
	}
	...
	protected ViewCountEntry addViewCountEntry() throws Exception {
		...
		viewCountEntry.setCompanyId(RandomTestUtil.nextLong());

		viewCountEntry.setClassNameId(RandomTestUtil.nextLong());

		viewCountEntry.setClassPK(RandomTestUtil.nextLong());
