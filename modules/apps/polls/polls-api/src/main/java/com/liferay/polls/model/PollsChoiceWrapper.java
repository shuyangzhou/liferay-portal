...
public class PollsChoiceWrapper implements PollsChoice,
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<PollsChoice, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<PollsChoice, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<PollsChoice, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<PollsChoice, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<PollsChoice, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<PollsChoice, Object> attributeBiConsumer = entry.getValue();
	...
	public Map<String, Function<PollsChoice, Object>> getAttributeGetters() {
		return _pollsChoice.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<PollsChoice, Object>> getAttributeSetters() {
		return _pollsChoice.getAttributeSetters();
	}
