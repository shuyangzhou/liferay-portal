...
public class PollsQuestionWrapper implements PollsQuestion,
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<PollsQuestion, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<PollsQuestion, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<PollsQuestion, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<PollsQuestion, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<PollsQuestion, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<PollsQuestion, Object> attributeBiConsumer = entry.getValue();
	...
	@Override
	public Map<String, Function<PollsQuestion, Object>> getAttributeGetters() {
		return _pollsQuestion.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<PollsQuestion, Object>> getAttributeSetters() {
		return _pollsQuestion.getAttributeSetters();
	}
