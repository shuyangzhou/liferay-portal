...
public class PollsChoicePersistenceImpl extends BasePersistenceImpl<PollsChoice>
	...
	public PollsChoice updateImpl(PollsChoice pollsChoice) {
		...
		PollsChoice updatedPollsChoice = null;
		...
		try {
			...
			if (pollsChoice.isNew()) {
				...
				updatedPollsChoice = (PollsChoice)session.merge(pollsChoice);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedPollsChoice == null) {
			...
			cacheUniqueFindersCache(updatedPollsChoice, isNew);
		}
