...
public class PollsVoteModelImpl
	...
	public void setVoteId(long voteId) {
		if ((_columnBitmask & VOTEID_COLUMN_BITMASK) == 0) {
			...
			_originalValues[VOTEID_COLUMN_INDEX] = _voteId;
		}
	...
	public long getOriginalQuestionId() {
		if (_originalValues != null) {
			Object originalQuestionId =
				_originalValues[QUESTIONID_COLUMN_INDEX];

			if (originalQuestionId != null) {
				return (long)originalQuestionId;
			}
		}
	...
	public void setChoiceId(long choiceId) {
		if ((_columnBitmask & CHOICEID_COLUMN_BITMASK) == 0) {
	...
	public long getOriginalChoiceId() {
		if (_originalValues != null) {
			Object originalChoiceId = _originalValues[CHOICEID_COLUMN_INDEX];

			if (originalChoiceId != null) {
				return (long)originalChoiceId;
			}
		}
	...
	public void setVoteDate(Date voteDate) {
		if ((_columnBitmask & VOTEDATE_COLUMN_BITMASK) == 0) {
			...
			_originalValues[VOTEDATE_COLUMN_INDEX] = _voteDate;
		}
