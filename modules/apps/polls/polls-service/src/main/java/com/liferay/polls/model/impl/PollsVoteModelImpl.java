...
public class PollsVoteModelImpl
	...
	public void setVoteId(long voteId) {
		_setOriginalValue(VOTEID_COLUMN_INDEX, _voteId);
	...
	public long getOriginalQuestionId() {
		return _getOriginalValue(QUESTIONID_COLUMN_INDEX, _questionId);
	}
	...
	public void setChoiceId(long choiceId) {
		_setOriginalValue(CHOICEID_COLUMN_INDEX, _choiceId);

		_choiceId = choiceId;
	}

	public long getOriginalChoiceId() {
		return _getOriginalValue(CHOICEID_COLUMN_INDEX, _choiceId);
	}
	...
	public void setVoteDate(Date voteDate) {
		_setOriginalValue(VOTEDATE_COLUMN_INDEX, _voteDate);
