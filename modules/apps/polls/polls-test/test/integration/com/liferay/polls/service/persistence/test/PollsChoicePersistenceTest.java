...
public class PollsChoicePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		Assert.assertTrue(DateUtil.equals(existingPollsChoice.getCreateDate(),
				newPollsChoice.getCreateDate(), DBFactoryUtil.getDB()));
		Assert.assertTrue(DateUtil.equals(
				existingPollsChoice.getModifiedDate(),
				newPollsChoice.getModifiedDate(), DBFactoryUtil.getDB()));
		...
		Assert.assertTrue(DateUtil.equals(
				...
				newPollsChoice.getLastPublishDate(), DBFactoryUtil.getDB()));
	}
