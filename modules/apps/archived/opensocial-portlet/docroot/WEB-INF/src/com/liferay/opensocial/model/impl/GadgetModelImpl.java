...
public class GadgetModelImpl
	...
	public void setGadgetId(long gadgetId) {
		if ((_columnBitmask & GADGETID_COLUMN_BITMASK) == 0) {
			...
			_originalValues[GADGETID_COLUMN_INDEX] = _gadgetId;
		}
	...
	public String getOriginalUrl() {
		if (_originalValues != null) {
			Object originalUrl = _originalValues[URL_COLUMN_INDEX];

			if (originalUrl != null) {
				return GetterUtil.getString((String)originalUrl);
			}
		}
	...
	public void setPortletCategoryNames(String portletCategoryNames) {
		if ((_columnBitmask & PORTLETCATEGORYNAMES_COLUMN_BITMASK) == 0) {
			...
			_originalValues[PORTLETCATEGORYNAMES_COLUMN_INDEX] =
