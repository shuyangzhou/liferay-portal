 ...
 * @generated
 */
public class MessageTable extends Table<MessageTable> {
	...
	public final Column<MessageTable, String> to = createColumn(
		"to_", String.class, Types.CLOB);
	public final Column<MessageTable, String> cc = createColumn(
		"cc", String.class, Types.CLOB);
	public final Column<MessageTable, String> bcc = createColumn(
		"bcc", String.class, Types.CLOB);
	...
	public final Column<MessageTable, String> body = createColumn(
