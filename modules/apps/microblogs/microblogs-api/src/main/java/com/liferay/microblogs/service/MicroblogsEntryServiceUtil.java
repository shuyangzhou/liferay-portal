...
public class MicroblogsEntryServiceUtil {
	...
	public static MicroblogsEntryService getService() {
		return _serviceDCLSingleton.getSingleton(
			MicroblogsEntryServiceUtil::_getService);
	}

	private static MicroblogsEntryService _getService() {
		...
		ServiceReference<MicroblogsEntryService> serviceReference =
			bundleContext.getServiceReference(MicroblogsEntryService.class);
	...
	private static final DCLSingleton<MicroblogsEntryService>
