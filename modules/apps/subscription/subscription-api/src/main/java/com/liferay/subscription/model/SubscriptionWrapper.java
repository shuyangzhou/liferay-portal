...
public class SubscriptionWrapper implements Subscription,
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<Subscription, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<Subscription, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<Subscription, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<Subscription, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<Subscription, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<Subscription, Object> attributeBiConsumer = entry.getValue();
	...
	@Override
	public Map<String, Function<Subscription, Object>> getAttributeGetters() {
		return _subscription.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<Subscription, Object>> getAttributeSetters() {
		return _subscription.getAttributeSetters();
	}
