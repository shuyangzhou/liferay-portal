...
public class ShoppingItemPersistenceImpl extends BasePersistenceImpl<ShoppingItem>
	...
	public ShoppingItem updateImpl(ShoppingItem shoppingItem) {
		...
		ShoppingItem updatedShoppingItem = null;
		...
		try {
			...
			if (shoppingItem.isNew()) {
				...
				updatedShoppingItem = (ShoppingItem)session.merge(shoppingItem);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedShoppingItem == null) {
			...
			cacheUniqueFindersCache(updatedShoppingItem, isNew);
		}
