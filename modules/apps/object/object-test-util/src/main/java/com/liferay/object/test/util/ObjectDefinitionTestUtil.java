...
public class ObjectDefinitionTestUtil {
	...
	public static String getRandomClassName() throws Exception {

		// Draw until the name is free, as
		// ObjectDefinitionLocalServiceImpl._getClassName does, so a generated
		// name does not conflict with one already taken.
