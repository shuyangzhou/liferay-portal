...
public class ObjectRelationshipResourceFactoryImpl
	...
	public ObjectRelationshipResource.Builder create() {
		return new ObjectRelationshipResource.Builder() {
			...
			public ObjectRelationshipResource build() {
				...
				Function<InvocationHandler, ObjectRelationshipResource>
					objectRelationshipResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_objectRelationshipResourceProxyProviderFunction;

				return objectRelationshipResourceProxyProviderFunction.apply(
			...
			@Override
			public ObjectRelationshipResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function
			<InvocationHandler, ObjectRelationshipResource>
				_objectRelationshipResourceProxyProviderFunction =
					_getProxyProviderFunction();
