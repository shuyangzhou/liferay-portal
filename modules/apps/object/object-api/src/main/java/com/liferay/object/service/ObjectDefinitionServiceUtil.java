...
public class ObjectDefinitionServiceUtil {
	...
	public static ObjectDefinitionService getService() {
		return _serviceDCLSingleton.getSingleton(
			ObjectDefinitionServiceUtil::_getService);
	}

	private static ObjectDefinitionService _getService() {
		...
		ServiceReference<ObjectDefinitionService> serviceReference =
			bundleContext.getServiceReference(ObjectDefinitionService.class);
	...
	private static final DCLSingleton<ObjectDefinitionService>
