...
public class ObjectFieldLocalServiceUtil {
	...
	public static ObjectFieldLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ObjectFieldLocalServiceUtil::_getService);
	}

	private static ObjectFieldLocalService _getService() {
		...
		ServiceReference<ObjectFieldLocalService> serviceReference =
			bundleContext.getServiceReference(ObjectFieldLocalService.class);
	...
	private static final DCLSingleton<ObjectFieldLocalService>
