...
public class ObjectViewFilterColumnLocalServiceUtil {
	...
	public static ObjectViewFilterColumnLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ObjectViewFilterColumnLocalServiceUtil::_getService);
	}

	private static ObjectViewFilterColumnLocalService _getService() {
		...
		ServiceReference<ObjectViewFilterColumnLocalService> serviceReference =
	...
	private static final DCLSingleton<ObjectViewFilterColumnLocalService>
