...
public class ObjectStateFlowLocalServiceUtil {
	...
	public static ObjectStateFlowLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ObjectStateFlowLocalServiceUtil::_getService);
	}

	private static ObjectStateFlowLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			ObjectStateFlowLocalServiceUtil.class);
		...
		ServiceReference<ObjectStateFlowLocalService> serviceReference =
	...
	private static final DCLSingleton<ObjectStateFlowLocalService>
