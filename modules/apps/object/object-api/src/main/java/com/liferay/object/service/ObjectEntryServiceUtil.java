...
public class ObjectEntryServiceUtil {
	...
	public static ObjectEntryService getService() {
		return _serviceDCLSingleton.getSingleton(
			ObjectEntryServiceUtil::_getService);
	}

	private static ObjectEntryService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(ObjectEntryServiceUtil.class);
		...
		ServiceReference<ObjectEntryService> serviceReference =
			bundleContext.getServiceReference(ObjectEntryService.class);
	...
	private static final DCLSingleton<ObjectEntryService> _serviceDCLSingleton =
		new DCLSingleton<>();
