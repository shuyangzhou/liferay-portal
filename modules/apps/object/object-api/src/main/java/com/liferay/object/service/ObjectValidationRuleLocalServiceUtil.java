...
public class ObjectValidationRuleLocalServiceUtil {
	...
	public static ObjectValidationRuleLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ObjectValidationRuleLocalServiceUtil::_getService);
	}

	private static ObjectValidationRuleLocalService _getService() {
		...
		ServiceReference<ObjectValidationRuleLocalService> serviceReference =
	...
	private static final DCLSingleton<ObjectValidationRuleLocalService>
