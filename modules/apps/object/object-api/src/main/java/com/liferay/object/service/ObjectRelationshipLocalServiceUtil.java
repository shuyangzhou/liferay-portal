...
public class ObjectRelationshipLocalServiceUtil {
	...
	public static ObjectRelationshipLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ObjectRelationshipLocalServiceUtil::_getService);
	}

	private static ObjectRelationshipLocalService _getService() {
		...
		ServiceReference<ObjectRelationshipLocalService> serviceReference =
	...
	private static final DCLSingleton<ObjectRelationshipLocalService>
