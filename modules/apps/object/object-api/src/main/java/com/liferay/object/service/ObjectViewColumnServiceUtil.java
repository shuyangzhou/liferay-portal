...
public class ObjectViewColumnServiceUtil {
	...
	public static ObjectViewColumnService getService() {
		return _serviceDCLSingleton.getSingleton(
			ObjectViewColumnServiceUtil::_getService);
	}

	private static ObjectViewColumnService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			ObjectViewColumnServiceUtil.class);
		...
		ServiceReference<ObjectViewColumnService> serviceReference =
			bundleContext.getServiceReference(ObjectViewColumnService.class);
	...
	private static final DCLSingleton<ObjectViewColumnService>
