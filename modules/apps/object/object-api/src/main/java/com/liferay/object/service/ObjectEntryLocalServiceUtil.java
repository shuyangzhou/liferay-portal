...
public class ObjectEntryLocalServiceUtil {
	...
	public static ObjectEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ObjectEntryLocalServiceUtil::_getService);
	}

	private static ObjectEntryLocalService _getService() {
		...
		ServiceReference<ObjectEntryLocalService> serviceReference =
			bundleContext.getServiceReference(ObjectEntryLocalService.class);
	...
	private static final DCLSingleton<ObjectEntryLocalService>
