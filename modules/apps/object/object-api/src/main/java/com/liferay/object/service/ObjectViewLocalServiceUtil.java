...
public class ObjectViewLocalServiceUtil {
	...
	public static ObjectViewLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ObjectViewLocalServiceUtil::_getService);
	}

	private static ObjectViewLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			ObjectViewLocalServiceUtil.class);
		...
		ServiceReference<ObjectViewLocalService> serviceReference =
			bundleContext.getServiceReference(ObjectViewLocalService.class);
	...
	private static final DCLSingleton<ObjectViewLocalService>
