...
public class ObjectFieldSettingLocalServiceUtil {
	...
	public static ObjectFieldSettingLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ObjectFieldSettingLocalServiceUtil::_getService);
	}

	private static ObjectFieldSettingLocalService _getService() {
		...
		ServiceReference<ObjectFieldSettingLocalService> serviceReference =
	...
	private static final DCLSingleton<ObjectFieldSettingLocalService>
