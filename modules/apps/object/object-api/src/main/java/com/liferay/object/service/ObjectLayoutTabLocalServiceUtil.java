...
public class ObjectLayoutTabLocalServiceUtil {
	...
	public static ObjectLayoutTabLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ObjectLayoutTabLocalServiceUtil::_getService);
	}

	private static ObjectLayoutTabLocalService _getService() {
		...
		ServiceReference<ObjectLayoutTabLocalService> serviceReference =
	...
	private static final DCLSingleton<ObjectLayoutTabLocalService>
