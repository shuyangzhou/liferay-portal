...
public class ObjectFilterLocalServiceUtil {
	...
	public static ObjectFilterLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ObjectFilterLocalServiceUtil::_getService);
	}

	private static ObjectFilterLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			ObjectFilterLocalServiceUtil.class);
		...
		ServiceReference<ObjectFilterLocalService> serviceReference =
			bundleContext.getServiceReference(ObjectFilterLocalService.class);
	...
	private static final DCLSingleton<ObjectFilterLocalService>
