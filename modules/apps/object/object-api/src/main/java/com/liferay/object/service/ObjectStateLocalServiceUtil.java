...
public class ObjectStateLocalServiceUtil {
	...
	public static ObjectStateLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ObjectStateLocalServiceUtil::_getService);
	}

	private static ObjectStateLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			ObjectStateLocalServiceUtil.class);
		...
		ServiceReference<ObjectStateLocalService> serviceReference =
			bundleContext.getServiceReference(ObjectStateLocalService.class);
	...
	private static final DCLSingleton<ObjectStateLocalService>
