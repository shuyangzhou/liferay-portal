...
create index IX_579C63B0 on BackgroundTask (groupId, taskExecutorClassName[$COLUMN_LENGTH:200$], completed, name[$COLUMN_LENGTH:255$]);
create index IX_98CC0AAB on BackgroundTask (groupId, taskExecutorClassName[$COLUMN_LENGTH:200$], name[$COLUMN_LENGTH:255$]);
