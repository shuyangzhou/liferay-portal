...
public class BackgroundTaskLocalServiceUtil {
	...
	public static BackgroundTaskLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			BackgroundTaskLocalServiceUtil::_getService);
	}

	private static BackgroundTaskLocalService _getService() {
		...
		ServiceReference<BackgroundTaskLocalService> serviceReference =
			bundleContext.getServiceReference(BackgroundTaskLocalService.class);
	...
	private static final DCLSingleton<BackgroundTaskLocalService>
