 ...
 * @generated
 */
public class BackgroundTaskTable extends Table<BackgroundTaskTable> {
	...
	public final Column<BackgroundTaskTable, String> taskContextMap =
		createColumn("taskContextMap", String.class, Types.CLOB);
	...
	public final Column<BackgroundTaskTable, String> statusMessage =
		createColumn("statusMessage", String.class, Types.CLOB);
