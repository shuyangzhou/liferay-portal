...
public class KBFolderModelImpl
	...
	public void setParentKBFolderId(long parentKBFolderId) {
		if ((_columnBitmask & PARENTKBFOLDERID_COLUMN_BITMASK) == 0) {
	...
	public long getOriginalParentKBFolderId() {
		if (_originalValues != null) {
			Object originalParentKBFolderId =
				_originalValues[PARENTKBFOLDERID_COLUMN_INDEX];

			if (originalParentKBFolderId != null) {
				return (long)originalParentKBFolderId;
			}
		}
