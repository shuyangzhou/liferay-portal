...
public class KBArticleModelImpl
	...
	public void setKbArticleId(long kbArticleId) {
		if ((_columnBitmask & KBARTICLEID_COLUMN_BITMASK) == 0) {
			...
			_originalValues[KBARTICLEID_COLUMN_INDEX] = _kbArticleId;
		}
	...
	public void setRootResourcePrimKey(long rootResourcePrimKey) {
		if ((_columnBitmask & ROOTRESOURCEPRIMKEY_COLUMN_BITMASK) == 0) {
			...
			_originalValues[ROOTRESOURCEPRIMKEY_COLUMN_INDEX] =
				_rootResourcePrimKey;
		}
	...
	public void setParentResourceClassNameId(long parentResourceClassNameId) {
		if ((_columnBitmask & PARENTRESOURCECLASSNAMEID_COLUMN_BITMASK) == 0) {
			...
			_originalValues[PARENTRESOURCECLASSNAMEID_COLUMN_INDEX] =
	...
	public void setParentResourcePrimKey(long parentResourcePrimKey) {
		if ((_columnBitmask & PARENTRESOURCEPRIMKEY_COLUMN_BITMASK) == 0) {
	...
	public long getOriginalParentResourcePrimKey() {
		if (_originalValues != null) {
			Object originalParentResourcePrimKey =
				_originalValues[PARENTRESOURCEPRIMKEY_COLUMN_INDEX];

			if (originalParentResourcePrimKey != null) {
				return (long)originalParentResourcePrimKey;
			}
		}
	...
	public void setKbFolderId(long kbFolderId) {
		if ((_columnBitmask & KBFOLDERID_COLUMN_BITMASK) == 0) {
	...
	public long getOriginalKbFolderId() {
		if (_originalValues != null) {
			Object originalKbFolderId =
				_originalValues[KBFOLDERID_COLUMN_INDEX];

			if (originalKbFolderId != null) {
				return (long)originalKbFolderId;
			}
		}
	...
	public void setSections(String sections) {
		if ((_columnBitmask & SECTIONS_COLUMN_BITMASK) == 0) {
	...
	public String getOriginalSections() {
		if (_originalValues != null) {
			Object originalSections = _originalValues[SECTIONS_COLUMN_INDEX];

			if (originalSections != null) {
				return GetterUtil.getString((String)originalSections);
			}
		}
	...
	public void setLatest(boolean latest) {
		if ((_columnBitmask & LATEST_COLUMN_BITMASK) == 0) {
	...
	public boolean getOriginalLatest() {
		if (_originalValues != null) {
			Object originalLatest = _originalValues[LATEST_COLUMN_INDEX];

			if (originalLatest != null) {
				return (boolean)originalLatest;
			}
		}
	...
	public void setMain(boolean main) {
		if ((_columnBitmask & MAIN_COLUMN_BITMASK) == 0) {
	...
	public boolean getOriginalMain() {
		if (_originalValues != null) {
			Object originalMain = _originalValues[MAIN_COLUMN_INDEX];

			if (originalMain != null) {
				return (boolean)originalMain;
			}
		}
	...
	public void setSourceURL(String sourceURL) {
		if ((_columnBitmask & SOURCEURL_COLUMN_BITMASK) == 0) {
