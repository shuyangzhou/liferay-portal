...
page import="com.liferay.knowledge.base.web.internal.permission.AdminPermission" %><%@
page import="com.liferay.knowledge.base.web.internal.permission.DisplayPermission" %><%@
