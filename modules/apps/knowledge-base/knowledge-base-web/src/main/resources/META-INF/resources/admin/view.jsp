				...
				>
					<c:choose>
						<c:when test="<%= kbObject instanceof KBFolder %>">
							...
							rowData.put("actions", StringUtil.merge(kbAdminManagementToolbarDisplayContext.getAvailableActionDropdownItems(kbFolder)));
						...
						<c:otherwise>
							...
							rowData.put("actions", StringUtil.merge(kbAdminManagementToolbarDisplayContext.getAvailableActionDropdownItems(kbArticle)));
