...
public class KBArticleServiceUtil {
	...
	public static KBArticleService getService() {
		return _serviceDCLSingleton.getSingleton(
			KBArticleServiceUtil::_getService);
	}

	private static KBArticleService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(KBArticleServiceUtil.class);
		...
		ServiceReference<KBArticleService> serviceReference =
			bundleContext.getServiceReference(KBArticleService.class);
	...
	private static final DCLSingleton<KBArticleService> _serviceDCLSingleton =
		new DCLSingleton<>();
