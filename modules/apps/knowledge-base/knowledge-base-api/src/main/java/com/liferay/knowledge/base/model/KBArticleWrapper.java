...
public class KBArticleWrapper implements KBArticle, ModelWrapper<KBArticle> {
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<KBArticle, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<KBArticle, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<KBArticle, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<KBArticle, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<KBArticle, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<KBArticle, Object> attributeBiConsumer = entry.getValue();
	...
	public Map<String, Function<KBArticle, Object>> getAttributeGetters() {
		return _kbArticle.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<KBArticle, Object>> getAttributeSetters() {
		return _kbArticle.getAttributeSetters();
	}
