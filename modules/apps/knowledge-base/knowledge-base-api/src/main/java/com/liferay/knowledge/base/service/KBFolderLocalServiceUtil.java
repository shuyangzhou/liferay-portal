...
public class KBFolderLocalServiceUtil {
	...
	public static KBFolderLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			KBFolderLocalServiceUtil::_getService);
	}

	private static KBFolderLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(KBFolderLocalServiceUtil.class);
		...
		ServiceReference<KBFolderLocalService> serviceReference =
			bundleContext.getServiceReference(KBFolderLocalService.class);
	...
	private static final DCLSingleton<KBFolderLocalService>
