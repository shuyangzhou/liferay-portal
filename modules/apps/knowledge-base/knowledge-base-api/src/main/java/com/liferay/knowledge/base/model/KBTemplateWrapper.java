...
public class KBTemplateWrapper implements KBTemplate, ModelWrapper<KBTemplate> {
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<KBTemplate, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<KBTemplate, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<KBTemplate, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<KBTemplate, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<KBTemplate, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<KBTemplate, Object> attributeBiConsumer = entry.getValue();
	...
	@Override
	public Map<String, Function<KBTemplate, Object>> getAttributeGetters() {
		return _kbTemplate.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<KBTemplate, Object>> getAttributeSetters() {
		return _kbTemplate.getAttributeSetters();
	}
