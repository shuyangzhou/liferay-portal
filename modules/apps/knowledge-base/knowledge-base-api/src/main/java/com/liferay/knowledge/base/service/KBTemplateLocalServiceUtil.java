...
public class KBTemplateLocalServiceUtil {
	...
	public static KBTemplateLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			KBTemplateLocalServiceUtil::_getService);
	}

	private static KBTemplateLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			KBTemplateLocalServiceUtil.class);
		...
		ServiceReference<KBTemplateLocalService> serviceReference =
			bundleContext.getServiceReference(KBTemplateLocalService.class);
	...
	private static final DCLSingleton<KBTemplateLocalService>
