...
public class SiteNavigationMenuItemWrapper implements SiteNavigationMenuItem,
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<SiteNavigationMenuItem, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<SiteNavigationMenuItem, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<SiteNavigationMenuItem, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		for (Map.Entry<String, BiConsumer<SiteNavigationMenuItem, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<SiteNavigationMenuItem, Object> attributeBiConsumer = entry.getValue();
	...
	@Override
	public Map<String, Function<SiteNavigationMenuItem, Object>> getAttributeGetters() {
		return _siteNavigationMenuItem.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<SiteNavigationMenuItem, Object>> getAttributeSetters() {
		return _siteNavigationMenuItem.getAttributeSetters();
	}
