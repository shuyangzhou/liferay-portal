...
public class SiteNavigationMenuItemLocalServiceUtil {
	...
	public static SiteNavigationMenuItemLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			SiteNavigationMenuItemLocalServiceUtil::_getService);
	}

	private static SiteNavigationMenuItemLocalService _getService() {
		...
		ServiceReference<SiteNavigationMenuItemLocalService> serviceReference =
	...
	private static final DCLSingleton<SiteNavigationMenuItemLocalService>
