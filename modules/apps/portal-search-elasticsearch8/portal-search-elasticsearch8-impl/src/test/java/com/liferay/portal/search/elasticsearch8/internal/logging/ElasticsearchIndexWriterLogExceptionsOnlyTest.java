...
public class ElasticsearchIndexWriterLogExceptionsOnlyTest
	...
	public void testAddDocuments() {
		try (LogCapture logCapture = LoggerTestUtil.configureLog4JLogger(
			...
			_assertLogCapture(
				logCapture, CoreMatchers.equalTo("Bulk add failed"),
				LoggerTestUtil.ERROR);
		}
	}
	...
	public void testDeleteDocuments() {
		try (LogCapture logCapture = LoggerTestUtil.configureLog4JLogger(
			...
			_assertLogCapture(
				logCapture, CoreMatchers.equalTo("Bulk delete failed"),
				LoggerTestUtil.ERROR);
		}
	}
	...
	public void testDeleteDocumentsBulkExecutor() {
		try (LogCapture logCapture = LoggerTestUtil.configureLog4JLogger(
			...
			_assertLogCapture(
				logCapture,
				CoreMatchers.containsString("no such index [" + uid + "]"),
				LoggerTestUtil.ERROR);
		}
	}
	...
	public void testUpdateDocument() {
		try (LogCapture logCapture = LoggerTestUtil.configureLog4JLogger(
			...
			_assertLogCapture(
				logCapture, CoreMatchers.equalTo("Update failed"),
				LoggerTestUtil.ERROR);
		}
	}
	...
	public void testUpdateDocuments() {
		try (LogCapture logCapture = LoggerTestUtil.configureLog4JLogger(
			...
			_assertLogCapture(
				logCapture, CoreMatchers.equalTo("Bulk update failed"),
				LoggerTestUtil.ERROR);
		}
	}
	...
	private void _assertLogCapture(
		LogCapture logCapture, Matcher<String> messageMatcher,
		String logLevel) {
		...
		Assert.assertThat(logEntry.getMessage(), messageMatcher);
	}
