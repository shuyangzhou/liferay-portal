...
public class CommerceAccountGroupCommerceAccountRelServiceUtil {
	...
	public static CommerceAccountGroupCommerceAccountRelService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceAccountGroupCommerceAccountRelServiceUtil::_getService);
	}

	private static CommerceAccountGroupCommerceAccountRelService _getService() {
		...
		ServiceReference<CommerceAccountGroupCommerceAccountRelService>
	...
	private static final DCLSingleton
		<CommerceAccountGroupCommerceAccountRelService> _serviceDCLSingleton =
			new DCLSingleton<>();
