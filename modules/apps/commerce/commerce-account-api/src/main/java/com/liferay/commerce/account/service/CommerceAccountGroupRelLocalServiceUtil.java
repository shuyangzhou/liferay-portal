...
public class CommerceAccountGroupRelLocalServiceUtil {
	...
	public static CommerceAccountGroupRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceAccountGroupRelLocalServiceUtil::_getService);
	}

	private static CommerceAccountGroupRelLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			CommerceAccountGroupRelLocalServiceUtil.class);
		...
		ServiceReference<CommerceAccountGroupRelLocalService> serviceReference =
	...
	private static final DCLSingleton<CommerceAccountGroupRelLocalService>
