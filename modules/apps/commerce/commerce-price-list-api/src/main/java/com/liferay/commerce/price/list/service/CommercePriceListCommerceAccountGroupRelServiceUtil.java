...
public class CommercePriceListCommerceAccountGroupRelServiceUtil {
	...
	public static CommercePriceListCommerceAccountGroupRelService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommercePriceListCommerceAccountGroupRelServiceUtil::_getService);
	}

	private static CommercePriceListCommerceAccountGroupRelService
		_getService() {
		...
		ServiceReference<CommercePriceListCommerceAccountGroupRelService>
	...
	private static final DCLSingleton
		<CommercePriceListCommerceAccountGroupRelService> _serviceDCLSingleton =
			new DCLSingleton<>();
