...
public class CommercePriceListDiscountRelLocalServiceUtil {
	...
	public static CommercePriceListDiscountRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommercePriceListDiscountRelLocalServiceUtil::_getService);
	}

	private static CommercePriceListDiscountRelLocalService _getService() {
		...
		ServiceReference<CommercePriceListDiscountRelLocalService>
	...
	private static final DCLSingleton<CommercePriceListDiscountRelLocalService>
