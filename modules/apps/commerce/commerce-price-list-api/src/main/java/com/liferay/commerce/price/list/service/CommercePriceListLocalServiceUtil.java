...
public class CommercePriceListLocalServiceUtil {
	...
	public static CommercePriceListLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommercePriceListLocalServiceUtil::_getService);
	}

	private static CommercePriceListLocalService _getService() {
		...
		ServiceReference<CommercePriceListLocalService> serviceReference =
	...
	private static final DCLSingleton<CommercePriceListLocalService>
