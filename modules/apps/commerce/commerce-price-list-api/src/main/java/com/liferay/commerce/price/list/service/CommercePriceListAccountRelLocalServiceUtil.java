...
public class CommercePriceListAccountRelLocalServiceUtil {
	...
	public static CommercePriceListAccountRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommercePriceListAccountRelLocalServiceUtil::_getService);
	}

	private static CommercePriceListAccountRelLocalService _getService() {
		...
		ServiceReference<CommercePriceListAccountRelLocalService>
	...
	private static final DCLSingleton<CommercePriceListAccountRelLocalService>
