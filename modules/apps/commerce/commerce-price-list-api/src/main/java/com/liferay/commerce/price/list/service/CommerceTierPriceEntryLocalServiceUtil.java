...
public class CommerceTierPriceEntryLocalServiceUtil {
	...
	public static CommerceTierPriceEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceTierPriceEntryLocalServiceUtil::_getService);
	}

	private static CommerceTierPriceEntryLocalService _getService() {
		...
		ServiceReference<CommerceTierPriceEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<CommerceTierPriceEntryLocalService>
