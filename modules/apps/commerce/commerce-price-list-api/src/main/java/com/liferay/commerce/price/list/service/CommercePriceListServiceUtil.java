...
public class CommercePriceListServiceUtil {
	...
	public static CommercePriceListService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommercePriceListServiceUtil::_getService);
	}

	private static CommercePriceListService _getService() {
		...
		ServiceReference<CommercePriceListService> serviceReference =
			bundleContext.getServiceReference(CommercePriceListService.class);
	...
	private static final DCLSingleton<CommercePriceListService>
