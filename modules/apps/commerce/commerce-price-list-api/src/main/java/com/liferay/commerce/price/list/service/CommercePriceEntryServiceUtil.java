...
public class CommercePriceEntryServiceUtil {
	...
	public static CommercePriceEntryService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommercePriceEntryServiceUtil::_getService);
	}

	private static CommercePriceEntryService _getService() {
		...
		ServiceReference<CommercePriceEntryService> serviceReference =
			bundleContext.getServiceReference(CommercePriceEntryService.class);
	...
	private static final DCLSingleton<CommercePriceEntryService>
