...
public class CommercePriceListAccountRelServiceUtil {
	...
	public static CommercePriceListAccountRelService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommercePriceListAccountRelServiceUtil::_getService);
	}

	private static CommercePriceListAccountRelService _getService() {
		...
		ServiceReference<CommercePriceListAccountRelService> serviceReference =
	...
	private static final DCLSingleton<CommercePriceListAccountRelService>
