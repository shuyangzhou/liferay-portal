...
public class CommercePriceListOrderTypeRelServiceUtil {
	...
	public static CommercePriceListOrderTypeRelService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommercePriceListOrderTypeRelServiceUtil::_getService);
	}

	private static CommercePriceListOrderTypeRelService _getService() {
		...
		ServiceReference<CommercePriceListOrderTypeRelService>
	...
	private static final DCLSingleton<CommercePriceListOrderTypeRelService>
