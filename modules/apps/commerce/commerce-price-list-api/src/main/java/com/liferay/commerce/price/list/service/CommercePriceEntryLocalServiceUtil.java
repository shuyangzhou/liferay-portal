...
public class CommercePriceEntryLocalServiceUtil {
	...
	public static CommercePriceEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommercePriceEntryLocalServiceUtil::_getService);
	}

	private static CommercePriceEntryLocalService _getService() {
		...
		ServiceReference<CommercePriceEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<CommercePriceEntryLocalService>
