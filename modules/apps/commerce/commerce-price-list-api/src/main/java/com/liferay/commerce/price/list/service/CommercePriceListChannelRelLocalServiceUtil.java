...
public class CommercePriceListChannelRelLocalServiceUtil {
	...
	public static CommercePriceListChannelRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommercePriceListChannelRelLocalServiceUtil::_getService);
	}

	private static CommercePriceListChannelRelLocalService _getService() {
		...
		ServiceReference<CommercePriceListChannelRelLocalService>
	...
	private static final DCLSingleton<CommercePriceListChannelRelLocalService>
