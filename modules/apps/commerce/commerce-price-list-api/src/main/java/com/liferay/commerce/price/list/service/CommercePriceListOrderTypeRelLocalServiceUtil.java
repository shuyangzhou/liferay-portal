...
public class CommercePriceListOrderTypeRelLocalServiceUtil {
	...
	public static CommercePriceListOrderTypeRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommercePriceListOrderTypeRelLocalServiceUtil::_getService);
	}

	private static CommercePriceListOrderTypeRelLocalService _getService() {
		...
		ServiceReference<CommercePriceListOrderTypeRelLocalService>
	...
	private static final DCLSingleton<CommercePriceListOrderTypeRelLocalService>
