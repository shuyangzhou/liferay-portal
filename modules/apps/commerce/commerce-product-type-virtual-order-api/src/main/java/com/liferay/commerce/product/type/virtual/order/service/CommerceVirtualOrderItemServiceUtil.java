...
public class CommerceVirtualOrderItemServiceUtil {
	...
	public static CommerceVirtualOrderItemService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceVirtualOrderItemServiceUtil::_getService);
	}

	private static CommerceVirtualOrderItemService _getService() {
		...
		ServiceReference<CommerceVirtualOrderItemService> serviceReference =
	...
	private static final DCLSingleton<CommerceVirtualOrderItemService>
