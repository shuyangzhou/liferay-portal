...
public class CSDiagramSettingLocalServiceUtil {
	...
	public static CSDiagramSettingLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CSDiagramSettingLocalServiceUtil::_getService);
	}

	private static CSDiagramSettingLocalService _getService() {
		...
		ServiceReference<CSDiagramSettingLocalService> serviceReference =
	...
	private static final DCLSingleton<CSDiagramSettingLocalService>
