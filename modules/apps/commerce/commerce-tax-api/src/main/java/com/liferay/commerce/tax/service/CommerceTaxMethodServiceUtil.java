...
public class CommerceTaxMethodServiceUtil {
	...
	public static CommerceTaxMethodService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceTaxMethodServiceUtil::_getService);
	}

	private static CommerceTaxMethodService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			CommerceTaxMethodServiceUtil.class);
		...
		ServiceReference<CommerceTaxMethodService> serviceReference =
			bundleContext.getServiceReference(CommerceTaxMethodService.class);
	...
	private static final DCLSingleton<CommerceTaxMethodService>
