...
public class CommerceTaxMethodLocalServiceUtil {
	...
	public static CommerceTaxMethodLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceTaxMethodLocalServiceUtil::_getService);
	}

	private static CommerceTaxMethodLocalService _getService() {
		...
		ServiceReference<CommerceTaxMethodLocalService> serviceReference =
	...
	private static final DCLSingleton<CommerceTaxMethodLocalService>
