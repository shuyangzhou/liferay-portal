	...
	public TermOrderTypeResource.Builder create() {
		return new TermOrderTypeResource.Builder() {
			...
			public TermOrderTypeResource build() {
				...
				Function<InvocationHandler, TermOrderTypeResource>
					termOrderTypeResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_termOrderTypeResourceProxyProviderFunction;

				return termOrderTypeResourceProxyProviderFunction.apply(
			...
			@Override
			public TermOrderTypeResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
