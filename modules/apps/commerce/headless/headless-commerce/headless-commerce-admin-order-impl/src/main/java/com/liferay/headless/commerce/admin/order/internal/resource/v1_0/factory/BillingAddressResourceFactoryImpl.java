	...
	public BillingAddressResource.Builder create() {
		return new BillingAddressResource.Builder() {
			...
			public BillingAddressResource build() {
				...
				Function<InvocationHandler, BillingAddressResource>
					billingAddressResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_billingAddressResourceProxyProviderFunction;

				return billingAddressResourceProxyProviderFunction.apply(
			...
			@Override
			public BillingAddressResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
