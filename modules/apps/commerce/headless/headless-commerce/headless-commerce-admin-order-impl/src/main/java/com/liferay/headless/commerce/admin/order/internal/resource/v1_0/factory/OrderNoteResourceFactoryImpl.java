	...
	public OrderNoteResource.Builder create() {
		return new OrderNoteResource.Builder() {
			...
			public OrderNoteResource build() {
				...
				Function<InvocationHandler, OrderNoteResource>
					orderNoteResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_orderNoteResourceProxyProviderFunction;

				return orderNoteResourceProxyProviderFunction.apply(
			...
			@Override
			public OrderNoteResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
