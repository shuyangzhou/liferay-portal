	...
	public OrderRuleResource.Builder create() {
		return new OrderRuleResource.Builder() {
			...
			public OrderRuleResource build() {
				...
				Function<InvocationHandler, OrderRuleResource>
					orderRuleResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_orderRuleResourceProxyProviderFunction;

				return orderRuleResourceProxyProviderFunction.apply(
			...
			@Override
			public OrderRuleResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
