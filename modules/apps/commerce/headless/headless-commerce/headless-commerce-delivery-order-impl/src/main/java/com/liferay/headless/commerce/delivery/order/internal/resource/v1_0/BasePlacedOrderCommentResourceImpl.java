...
public abstract class BasePlacedOrderCommentResourceImpl
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/placed-order-comments/{placedOrderCommentId}")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public PlacedOrderComment getPlacedOrderComment(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("placedOrderCommentId")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/placed-orders/{placedOrderId}/placed-order-comments")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
