	...
	public PriceModifierResource.Builder create() {
		return new PriceModifierResource.Builder() {
			...
			public PriceModifierResource build() {
				...
				Function<InvocationHandler, PriceModifierResource>
					priceModifierResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_priceModifierResourceProxyProviderFunction;

				return priceModifierResourceProxyProviderFunction.apply(
			...
			@Override
			public PriceModifierResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
