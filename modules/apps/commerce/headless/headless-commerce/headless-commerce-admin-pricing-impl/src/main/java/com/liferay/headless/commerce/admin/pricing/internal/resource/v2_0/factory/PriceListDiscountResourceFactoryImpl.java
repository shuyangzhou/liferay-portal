...
public class PriceListDiscountResourceFactoryImpl
	...
	public PriceListDiscountResource.Builder create() {
		return new PriceListDiscountResource.Builder() {
			...
			public PriceListDiscountResource build() {
				...
				Function<InvocationHandler, PriceListDiscountResource>
					priceListDiscountResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_priceListDiscountResourceProxyProviderFunction;

				return priceListDiscountResourceProxyProviderFunction.apply(
			...
			@Override
			public PriceListDiscountResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function
			<InvocationHandler, PriceListDiscountResource>
				_priceListDiscountResourceProxyProviderFunction =
					_getProxyProviderFunction();
