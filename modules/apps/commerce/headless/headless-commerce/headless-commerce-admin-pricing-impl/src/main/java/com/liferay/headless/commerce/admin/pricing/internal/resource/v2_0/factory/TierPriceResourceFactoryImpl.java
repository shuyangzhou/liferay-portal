	...
	public TierPriceResource.Builder create() {
		return new TierPriceResource.Builder() {
			...
			public TierPriceResource build() {
				...
				Function<InvocationHandler, TierPriceResource>
					tierPriceResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_tierPriceResourceProxyProviderFunction;

				return tierPriceResourceProxyProviderFunction.apply(
			...
			@Override
			public TierPriceResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
