 ...
 */
@Component(
	property = "resource.locator.key=/headless-commerce-admin-catalog/v1.0/SkuUnitOfMeasure",
	service = SkuUnitOfMeasureResource.Factory.class
)
@Generated("")
public class SkuUnitOfMeasureResourceFactoryImpl
	implements SkuUnitOfMeasureResource.Factory {

	@Override
	public SkuUnitOfMeasureResource.Builder create() {
		return new SkuUnitOfMeasureResource.Builder() {
			...
			@Override
			public SkuUnitOfMeasureResource.Builder checkPermissions(
			...
			@Override
			public SkuUnitOfMeasureResource.Builder httpServletRequest(
			...
			@Override
			public SkuUnitOfMeasureResource.Builder httpServletResponse(
			...
			@Override
			public SkuUnitOfMeasureResource.Builder preferredLocale(
			...
			@Override
			public SkuUnitOfMeasureResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
			...
			@Override
			public SkuUnitOfMeasureResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, SkuUnitOfMeasureResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			SkuUnitOfMeasureResource.class.getClassLoader(),
			SkuUnitOfMeasureResource.class);

		try {
			Constructor<SkuUnitOfMeasureResource> constructor =
				(Constructor<SkuUnitOfMeasureResource>)
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(skuUnitOfMeasureResource);
