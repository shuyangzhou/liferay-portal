	...
	public AttachmentResource.Builder create() {
		return new AttachmentResource.Builder() {
			...
			public AttachmentResource build() {
				...
				Function<InvocationHandler, AttachmentResource>
					attachmentResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_attachmentResourceProxyProviderFunction;

				return attachmentResourceProxyProviderFunction.apply(
			...
			@Override
			public AttachmentResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
