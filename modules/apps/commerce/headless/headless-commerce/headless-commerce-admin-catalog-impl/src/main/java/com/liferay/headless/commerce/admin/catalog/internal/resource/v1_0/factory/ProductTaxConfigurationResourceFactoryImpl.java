	...
	public ProductTaxConfigurationResource.Builder create() {
		return new ProductTaxConfigurationResource.Builder() {
			...
			public ProductTaxConfigurationResource build() {
				...
				Function<InvocationHandler, ProductTaxConfigurationResource>
					productTaxConfigurationResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_productTaxConfigurationResourceProxyProviderFunction;

				return productTaxConfigurationResourceProxyProviderFunction.
					apply(
			...
			@Override
			public ProductTaxConfigurationResource.Builder uriInfo(
				UriInfo uriInfo) {
