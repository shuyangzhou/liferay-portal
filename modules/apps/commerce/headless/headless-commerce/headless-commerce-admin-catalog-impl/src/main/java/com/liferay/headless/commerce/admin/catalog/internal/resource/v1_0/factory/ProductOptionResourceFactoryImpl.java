	...
	public ProductOptionResource.Builder create() {
		return new ProductOptionResource.Builder() {
			...
			public ProductOptionResource build() {
				...
				Function<InvocationHandler, ProductOptionResource>
					productOptionResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_productOptionResourceProxyProviderFunction;

				return productOptionResourceProxyProviderFunction.apply(
			...
			@Override
			public ProductOptionResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
