	...
	public ProductGroupResource.Builder create() {
		return new ProductGroupResource.Builder() {
			...
			public ProductGroupResource build() {
				...
				Function<InvocationHandler, ProductGroupResource>
					productGroupResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_productGroupResourceProxyProviderFunction;

				return productGroupResourceProxyProviderFunction.apply(
			...
			@Override
			public ProductGroupResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
