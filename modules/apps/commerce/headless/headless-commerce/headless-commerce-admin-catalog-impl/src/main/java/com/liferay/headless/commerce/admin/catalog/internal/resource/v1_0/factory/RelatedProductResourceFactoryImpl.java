...
public class RelatedProductResourceFactoryImpl
	...
	public RelatedProductResource.Builder create() {
		return new RelatedProductResource.Builder() {
			...
			public RelatedProductResource build() {
				...
				Function<InvocationHandler, RelatedProductResource>
					relatedProductResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_relatedProductResourceProxyProviderFunction;

				return relatedProductResourceProxyProviderFunction.apply(
			...
			@Override
			public RelatedProductResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
	...
	private Object _invoke(
		...
		relatedProductResource.setContextHttpServletResponse(
			httpServletResponse);
		relatedProductResource.setContextUriInfo(uriInfo);
