...
public class ReplenishmentItemResourceFactoryImpl
	...
	public ReplenishmentItemResource.Builder create() {
		return new ReplenishmentItemResource.Builder() {
			...
			public ReplenishmentItemResource build() {
				...
				Function<InvocationHandler, ReplenishmentItemResource>
					replenishmentItemResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_replenishmentItemResourceProxyProviderFunction;

				return replenishmentItemResourceProxyProviderFunction.apply(
			...
			@Override
			public ReplenishmentItemResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function
			<InvocationHandler, ReplenishmentItemResource>
				_replenishmentItemResourceProxyProviderFunction =
					_getProxyProviderFunction();
