	...
	public MappedProductResource.Builder create() {
		return new MappedProductResource.Builder() {
			...
			public MappedProductResource build() {
				...
				Function<InvocationHandler, MappedProductResource>
					mappedProductResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_mappedProductResourceProxyProviderFunction;

				return mappedProductResourceProxyProviderFunction.apply(
			...
			@Override
			public MappedProductResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
