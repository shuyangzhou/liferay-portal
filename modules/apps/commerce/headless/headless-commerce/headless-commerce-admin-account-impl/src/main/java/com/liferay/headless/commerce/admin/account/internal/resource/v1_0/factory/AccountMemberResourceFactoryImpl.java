	...
	public AccountMemberResource.Builder create() {
		return new AccountMemberResource.Builder() {
			...
			public AccountMemberResource build() {
				...
				Function<InvocationHandler, AccountMemberResource>
					accountMemberResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_accountMemberResourceProxyProviderFunction;

				return accountMemberResourceProxyProviderFunction.apply(
			...
			@Override
			public AccountMemberResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
