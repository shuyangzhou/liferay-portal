	...
	public AccountChannelEntryResource.Builder create() {
		return new AccountChannelEntryResource.Builder() {
			...
			public AccountChannelEntryResource build() {
				...
				Function<InvocationHandler, AccountChannelEntryResource>
					accountChannelEntryResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_accountChannelEntryResourceProxyProviderFunction;

				return accountChannelEntryResourceProxyProviderFunction.apply(
			...
			@Override
			public AccountChannelEntryResource.Builder uriInfo(
				UriInfo uriInfo) {
