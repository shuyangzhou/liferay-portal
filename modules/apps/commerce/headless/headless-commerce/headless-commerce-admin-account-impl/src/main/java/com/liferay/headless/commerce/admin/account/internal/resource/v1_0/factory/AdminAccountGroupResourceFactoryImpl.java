 ...
 */
@Component(
	property = "resource.locator.key=/headless-commerce-admin-account/v1.0/AdminAccountGroup",
	service = AdminAccountGroupResource.Factory.class
)
@Generated("")
public class AdminAccountGroupResourceFactoryImpl
	implements AdminAccountGroupResource.Factory {

	@Override
	public AdminAccountGroupResource.Builder create() {
		return new AdminAccountGroupResource.Builder() {
			...
			public AdminAccountGroupResource build() {
				...
				Function<InvocationHandler, AdminAccountGroupResource>
					adminAccountGroupResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_adminAccountGroupResourceProxyProviderFunction;

				return adminAccountGroupResourceProxyProviderFunction.apply(
			...
			@Override
			public AdminAccountGroupResource.Builder checkPermissions(
			...
			@Override
			public AdminAccountGroupResource.Builder httpServletRequest(
			...
			@Override
			public AdminAccountGroupResource.Builder httpServletResponse(
			...
			@Override
			public AdminAccountGroupResource.Builder preferredLocale(
			...
			@Override
			public AdminAccountGroupResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
			...
			@Override
			public AdminAccountGroupResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, AdminAccountGroupResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			AdminAccountGroupResource.class.getClassLoader(),
			AdminAccountGroupResource.class);

		try {
			Constructor<AdminAccountGroupResource> constructor =
				(Constructor<AdminAccountGroupResource>)
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(adminAccountGroupResource);
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function
			<InvocationHandler, AdminAccountGroupResource>
				_adminAccountGroupResourceProxyProviderFunction =
					_getProxyProviderFunction();
