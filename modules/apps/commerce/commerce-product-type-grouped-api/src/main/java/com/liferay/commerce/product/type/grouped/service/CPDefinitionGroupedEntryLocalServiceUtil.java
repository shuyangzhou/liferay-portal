...
public class CPDefinitionGroupedEntryLocalServiceUtil {
	...
	public static CPDefinitionGroupedEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPDefinitionGroupedEntryLocalServiceUtil::_getService);
	}

	private static CPDefinitionGroupedEntryLocalService _getService() {
		...
		ServiceReference<CPDefinitionGroupedEntryLocalService>
	...
	private static final DCLSingleton<CPDefinitionGroupedEntryLocalService>
