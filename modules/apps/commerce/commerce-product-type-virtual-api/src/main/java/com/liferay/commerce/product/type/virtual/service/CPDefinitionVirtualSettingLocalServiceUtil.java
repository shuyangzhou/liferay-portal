...
public class CPDefinitionVirtualSettingLocalServiceUtil {
	...
	public static CPDefinitionVirtualSettingLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPDefinitionVirtualSettingLocalServiceUtil::_getService);
	}

	private static CPDefinitionVirtualSettingLocalService _getService() {
		...
		ServiceReference<CPDefinitionVirtualSettingLocalService>
	...
	private static final DCLSingleton<CPDefinitionVirtualSettingLocalService>
