...
public class CommercePaymentMethodGroupRelQualifierServiceUtil {
	...
	public static CommercePaymentMethodGroupRelQualifierService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommercePaymentMethodGroupRelQualifierServiceUtil::_getService);
	}

	private static CommercePaymentMethodGroupRelQualifierService _getService() {
		...
		ServiceReference<CommercePaymentMethodGroupRelQualifierService>
	...
	private static final DCLSingleton
		<CommercePaymentMethodGroupRelQualifierService> _serviceDCLSingleton =
			new DCLSingleton<>();
