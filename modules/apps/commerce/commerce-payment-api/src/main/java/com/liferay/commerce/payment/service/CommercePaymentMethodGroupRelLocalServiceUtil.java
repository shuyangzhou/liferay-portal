...
public class CommercePaymentMethodGroupRelLocalServiceUtil {
	...
	public static CommercePaymentMethodGroupRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommercePaymentMethodGroupRelLocalServiceUtil::_getService);
	}

	private static CommercePaymentMethodGroupRelLocalService _getService() {
		...
		ServiceReference<CommercePaymentMethodGroupRelLocalService>
	...
	private static final DCLSingleton<CommercePaymentMethodGroupRelLocalService>
