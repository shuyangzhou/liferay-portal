...
public class CommercePaymentMethodGroupRelServiceUtil {
	...
	public static CommercePaymentMethodGroupRelService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommercePaymentMethodGroupRelServiceUtil::_getService);
	}

	private static CommercePaymentMethodGroupRelService _getService() {
		...
		ServiceReference<CommercePaymentMethodGroupRelService>
	...
	private static final DCLSingleton<CommercePaymentMethodGroupRelService>
