...
public class CPDefinitionInventoryServiceUtil {
	...
	public static CPDefinitionInventoryService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPDefinitionInventoryServiceUtil::_getService);
	}

	private static CPDefinitionInventoryService _getService() {
		...
		ServiceReference<CPDefinitionInventoryService> serviceReference =
	...
	private static final DCLSingleton<CPDefinitionInventoryService>
