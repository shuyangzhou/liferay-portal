...
public class CommerceAvailabilityEstimateLocalServiceUtil {
	...
	public static CommerceAvailabilityEstimateLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceAvailabilityEstimateLocalServiceUtil::_getService);
	}

	private static CommerceAvailabilityEstimateLocalService _getService() {
		...
		ServiceReference<CommerceAvailabilityEstimateLocalService>
	...
	private static final DCLSingleton<CommerceAvailabilityEstimateLocalService>
