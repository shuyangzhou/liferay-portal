...
public class CommerceShipmentLocalServiceUtil {
	...
	public static CommerceShipmentLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceShipmentLocalServiceUtil::_getService);
	}

	private static CommerceShipmentLocalService _getService() {
		...
		ServiceReference<CommerceShipmentLocalService> serviceReference =
	...
	private static final DCLSingleton<CommerceShipmentLocalService>
