...
public class CommerceSubscriptionEntryLocalServiceUtil {
	...
	public static CommerceSubscriptionEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceSubscriptionEntryLocalServiceUtil::_getService);
	}

	private static CommerceSubscriptionEntryLocalService _getService() {
		...
		ServiceReference<CommerceSubscriptionEntryLocalService>
	...
	private static final DCLSingleton<CommerceSubscriptionEntryLocalService>
