...
public class CommerceOrderItemServiceUtil {
	...
	public static CommerceOrderItemService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceOrderItemServiceUtil::_getService);
	}

	private static CommerceOrderItemService _getService() {
		...
		ServiceReference<CommerceOrderItemService> serviceReference =
			bundleContext.getServiceReference(CommerceOrderItemService.class);
	...
	private static final DCLSingleton<CommerceOrderItemService>
