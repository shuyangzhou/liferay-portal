...
public class CommerceShipmentServiceUtil {
	...
	public static CommerceShipmentService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceShipmentServiceUtil::_getService);
	}

	private static CommerceShipmentService _getService() {
		...
		ServiceReference<CommerceShipmentService> serviceReference =
			bundleContext.getServiceReference(CommerceShipmentService.class);
	...
	private static final DCLSingleton<CommerceShipmentService>
