...
public class CPDefinitionInventoryLocalServiceUtil {
	...
	public static CPDefinitionInventoryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPDefinitionInventoryLocalServiceUtil::_getService);
	}

	private static CPDefinitionInventoryLocalService _getService() {
		...
		ServiceReference<CPDefinitionInventoryLocalService> serviceReference =
	...
	private static final DCLSingleton<CPDefinitionInventoryLocalService>
