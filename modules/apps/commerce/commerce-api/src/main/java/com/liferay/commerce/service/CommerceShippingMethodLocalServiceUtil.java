...
public class CommerceShippingMethodLocalServiceUtil {
	...
	public static CommerceShippingMethodLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceShippingMethodLocalServiceUtil::_getService);
	}

	private static CommerceShippingMethodLocalService _getService() {
		...
		ServiceReference<CommerceShippingMethodLocalService> serviceReference =
	...
	private static final DCLSingleton<CommerceShippingMethodLocalService>
