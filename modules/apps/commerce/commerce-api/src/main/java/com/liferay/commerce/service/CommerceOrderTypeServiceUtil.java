...
public class CommerceOrderTypeServiceUtil {
	...
	public static CommerceOrderTypeService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceOrderTypeServiceUtil::_getService);
	}

	private static CommerceOrderTypeService _getService() {
		...
		ServiceReference<CommerceOrderTypeService> serviceReference =
			bundleContext.getServiceReference(CommerceOrderTypeService.class);
	...
	private static final DCLSingleton<CommerceOrderTypeService>
