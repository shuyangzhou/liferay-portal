...
public class CommerceShippingOptionAccountEntryRelLocalServiceUtil {
	...
	public static CommerceShippingOptionAccountEntryRelLocalService
		...
		return _serviceDCLSingleton.getSingleton(
			CommerceShippingOptionAccountEntryRelLocalServiceUtil::_getService);
	}

	private static CommerceShippingOptionAccountEntryRelLocalService
		_getService() {
		...
		ServiceReference<CommerceShippingOptionAccountEntryRelLocalService>
