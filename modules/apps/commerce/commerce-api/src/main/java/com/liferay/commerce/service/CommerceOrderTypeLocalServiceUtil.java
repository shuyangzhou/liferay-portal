...
public class CommerceOrderTypeLocalServiceUtil {
	...
	public static CommerceOrderTypeLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceOrderTypeLocalServiceUtil::_getService);
	}

	private static CommerceOrderTypeLocalService _getService() {
		...
		ServiceReference<CommerceOrderTypeLocalService> serviceReference =
	...
	private static final DCLSingleton<CommerceOrderTypeLocalService>
