...
public class CPDAvailabilityEstimateLocalServiceUtil {
	...
	public static CPDAvailabilityEstimateLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPDAvailabilityEstimateLocalServiceUtil::_getService);
	}

	private static CPDAvailabilityEstimateLocalService _getService() {
		...
		ServiceReference<CPDAvailabilityEstimateLocalService> serviceReference =
	...
	private static final DCLSingleton<CPDAvailabilityEstimateLocalService>
