...
public class CommerceOrderTypeRelLocalServiceUtil {
	...
	public static CommerceOrderTypeRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceOrderTypeRelLocalServiceUtil::_getService);
	}

	private static CommerceOrderTypeRelLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			CommerceOrderTypeRelLocalServiceUtil.class);
		...
		ServiceReference<CommerceOrderTypeRelLocalService> serviceReference =
	...
	private static final DCLSingleton<CommerceOrderTypeRelLocalService>
