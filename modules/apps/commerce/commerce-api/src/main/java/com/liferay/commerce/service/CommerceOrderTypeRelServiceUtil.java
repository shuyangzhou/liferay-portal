...
public class CommerceOrderTypeRelServiceUtil {
	...
	public static CommerceOrderTypeRelService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceOrderTypeRelServiceUtil::_getService);
	}

	private static CommerceOrderTypeRelService _getService() {
		...
		ServiceReference<CommerceOrderTypeRelService> serviceReference =
	...
	private static final DCLSingleton<CommerceOrderTypeRelService>
