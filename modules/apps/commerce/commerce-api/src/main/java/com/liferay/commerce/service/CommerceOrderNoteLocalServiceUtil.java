...
public class CommerceOrderNoteLocalServiceUtil {
	...
	public static CommerceOrderNoteLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceOrderNoteLocalServiceUtil::_getService);
	}

	private static CommerceOrderNoteLocalService _getService() {
		...
		ServiceReference<CommerceOrderNoteLocalService> serviceReference =
	...
	private static final DCLSingleton<CommerceOrderNoteLocalService>
