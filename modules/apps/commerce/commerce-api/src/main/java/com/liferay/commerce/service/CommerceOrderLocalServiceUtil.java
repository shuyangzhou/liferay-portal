...
public class CommerceOrderLocalServiceUtil {
	...
	public static CommerceOrderLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceOrderLocalServiceUtil::_getService);
	}

	private static CommerceOrderLocalService _getService() {
		...
		ServiceReference<CommerceOrderLocalService> serviceReference =
			bundleContext.getServiceReference(CommerceOrderLocalService.class);
	...
	private static final DCLSingleton<CommerceOrderLocalService>
