...
public class CommerceShipmentItemLocalServiceUtil {
	...
	public static CommerceShipmentItemLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceShipmentItemLocalServiceUtil::_getService);
	}

	private static CommerceShipmentItemLocalService _getService() {
		...
		ServiceReference<CommerceShipmentItemLocalService> serviceReference =
	...
	private static final DCLSingleton<CommerceShipmentItemLocalService>
