...
public class CommerceShipmentItemServiceUtil {
	...
	public static CommerceShipmentItemService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceShipmentItemServiceUtil::_getService);
	}

	private static CommerceShipmentItemService _getService() {
		...
		ServiceReference<CommerceShipmentItemService> serviceReference =
	...
	private static final DCLSingleton<CommerceShipmentItemService>
