...
public class CommerceAvailabilityEstimateServiceUtil {
	...
	public static CommerceAvailabilityEstimateService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceAvailabilityEstimateServiceUtil::_getService);
	}

	private static CommerceAvailabilityEstimateService _getService() {
		...
		ServiceReference<CommerceAvailabilityEstimateService> serviceReference =
	...
	private static final DCLSingleton<CommerceAvailabilityEstimateService>
