...
public class CommerceOrderItemLocalServiceUtil {
	...
	public static CommerceOrderItemLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceOrderItemLocalServiceUtil::_getService);
	}

	private static CommerceOrderItemLocalService _getService() {
		...
		ServiceReference<CommerceOrderItemLocalService> serviceReference =
	...
	private static final DCLSingleton<CommerceOrderItemLocalService>
