...
public class CommerceWishListItemServiceUtil {
	...
	public static CommerceWishListItemService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceWishListItemServiceUtil::_getService);
	}

	private static CommerceWishListItemService _getService() {
		...
		ServiceReference<CommerceWishListItemService> serviceReference =
	...
	private static final DCLSingleton<CommerceWishListItemService>
