...
public class CommerceWishListItemLocalServiceUtil {
	...
	public static CommerceWishListItemLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceWishListItemLocalServiceUtil::_getService);
	}

	private static CommerceWishListItemLocalService _getService() {
		...
		ServiceReference<CommerceWishListItemLocalService> serviceReference =
	...
	private static final DCLSingleton<CommerceWishListItemLocalService>
