...
public class CommerceWishListLocalServiceUtil {
	...
	public static CommerceWishListLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceWishListLocalServiceUtil::_getService);
	}

	private static CommerceWishListLocalService _getService() {
		...
		ServiceReference<CommerceWishListLocalService> serviceReference =
	...
	private static final DCLSingleton<CommerceWishListLocalService>
