...
public class CommerceDiscountRuleLocalServiceUtil {
	...
	public static CommerceDiscountRuleLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceDiscountRuleLocalServiceUtil::_getService);
	}

	private static CommerceDiscountRuleLocalService _getService() {
		...
		ServiceReference<CommerceDiscountRuleLocalService> serviceReference =
	...
	private static final DCLSingleton<CommerceDiscountRuleLocalService>
