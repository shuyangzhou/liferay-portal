...
public class CommerceDiscountRuleServiceUtil {
	...
	public static CommerceDiscountRuleService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceDiscountRuleServiceUtil::_getService);
	}

	private static CommerceDiscountRuleService _getService() {
		...
		ServiceReference<CommerceDiscountRuleService> serviceReference =
	...
	private static final DCLSingleton<CommerceDiscountRuleService>
