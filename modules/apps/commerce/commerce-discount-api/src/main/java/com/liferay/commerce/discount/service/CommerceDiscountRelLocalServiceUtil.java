...
public class CommerceDiscountRelLocalServiceUtil {
	...
	public static CommerceDiscountRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceDiscountRelLocalServiceUtil::_getService);
	}

	private static CommerceDiscountRelLocalService _getService() {
		...
		ServiceReference<CommerceDiscountRelLocalService> serviceReference =
	...
	private static final DCLSingleton<CommerceDiscountRelLocalService>
