...
public class CommerceDiscountUsageEntryLocalServiceUtil {
	...
	public static CommerceDiscountUsageEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceDiscountUsageEntryLocalServiceUtil::_getService);
	}

	private static CommerceDiscountUsageEntryLocalService _getService() {
		...
		ServiceReference<CommerceDiscountUsageEntryLocalService>
	...
	private static final DCLSingleton<CommerceDiscountUsageEntryLocalService>
