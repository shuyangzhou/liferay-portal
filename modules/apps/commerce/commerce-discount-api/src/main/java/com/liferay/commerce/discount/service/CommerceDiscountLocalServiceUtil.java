...
public class CommerceDiscountLocalServiceUtil {
	...
	public static CommerceDiscountLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceDiscountLocalServiceUtil::_getService);
	}

	private static CommerceDiscountLocalService _getService() {
		...
		ServiceReference<CommerceDiscountLocalService> serviceReference =
	...
	private static final DCLSingleton<CommerceDiscountLocalService>
