...
public class CommerceDiscountAccountRelLocalServiceUtil {
	...
	public static CommerceDiscountAccountRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceDiscountAccountRelLocalServiceUtil::_getService);
	}

	private static CommerceDiscountAccountRelLocalService _getService() {
		...
		ServiceReference<CommerceDiscountAccountRelLocalService>
	...
	private static final DCLSingleton<CommerceDiscountAccountRelLocalService>
