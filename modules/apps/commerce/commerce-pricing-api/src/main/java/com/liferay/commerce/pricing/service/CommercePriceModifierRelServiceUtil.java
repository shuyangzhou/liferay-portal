...
public class CommercePriceModifierRelServiceUtil {
	...
	public static CommercePriceModifierRelService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommercePriceModifierRelServiceUtil::_getService);
	}

	private static CommercePriceModifierRelService _getService() {
		...
		ServiceReference<CommercePriceModifierRelService> serviceReference =
	...
	private static final DCLSingleton<CommercePriceModifierRelService>
