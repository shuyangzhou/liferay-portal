...
public class CommercePricingClassLocalServiceUtil {
	...
	public static CommercePricingClassLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommercePricingClassLocalServiceUtil::_getService);
	}

	private static CommercePricingClassLocalService _getService() {
		...
		ServiceReference<CommercePricingClassLocalService> serviceReference =
	...
	private static final DCLSingleton<CommercePricingClassLocalService>
