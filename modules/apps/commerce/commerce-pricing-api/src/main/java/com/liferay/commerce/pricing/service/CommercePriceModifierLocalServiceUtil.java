...
public class CommercePriceModifierLocalServiceUtil {
	...
	public static CommercePriceModifierLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommercePriceModifierLocalServiceUtil::_getService);
	}

	private static CommercePriceModifierLocalService _getService() {
		...
		ServiceReference<CommercePriceModifierLocalService> serviceReference =
	...
	private static final DCLSingleton<CommercePriceModifierLocalService>
