...
public class CommercePricingClassCPDefinitionRelLocalServiceUtil {
	...
	public static CommercePricingClassCPDefinitionRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommercePricingClassCPDefinitionRelLocalServiceUtil::_getService);
	}
	...
	private static CommercePricingClassCPDefinitionRelLocalService
		...
		ServiceReference<CommercePricingClassCPDefinitionRelLocalService>
	...
	private static final DCLSingleton
		<CommercePricingClassCPDefinitionRelLocalService> _serviceDCLSingleton =
			new DCLSingleton<>();
