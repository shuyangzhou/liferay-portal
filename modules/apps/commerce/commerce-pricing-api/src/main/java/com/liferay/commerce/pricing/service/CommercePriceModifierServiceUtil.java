...
public class CommercePriceModifierServiceUtil {
	...
	public static CommercePriceModifierService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommercePriceModifierServiceUtil::_getService);
	}

	private static CommercePriceModifierService _getService() {
		...
		ServiceReference<CommercePriceModifierService> serviceReference =
	...
	private static final DCLSingleton<CommercePriceModifierService>
