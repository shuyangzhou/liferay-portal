...
public class CommercePricingClassServiceUtil {
	...
	public static CommercePricingClassService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommercePricingClassServiceUtil::_getService);
	}

	private static CommercePricingClassService _getService() {
		...
		ServiceReference<CommercePricingClassService> serviceReference =
	...
	private static final DCLSingleton<CommercePricingClassService>
