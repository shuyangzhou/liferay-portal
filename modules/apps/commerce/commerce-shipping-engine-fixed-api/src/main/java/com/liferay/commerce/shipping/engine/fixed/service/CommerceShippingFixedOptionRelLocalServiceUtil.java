...
public class CommerceShippingFixedOptionRelLocalServiceUtil {
	...
	public static CommerceShippingFixedOptionRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceShippingFixedOptionRelLocalServiceUtil::_getService);
	}

	private static CommerceShippingFixedOptionRelLocalService _getService() {
		...
		ServiceReference<CommerceShippingFixedOptionRelLocalService>
	...
	private static final DCLSingleton
		<CommerceShippingFixedOptionRelLocalService> _serviceDCLSingleton =
			new DCLSingleton<>();
