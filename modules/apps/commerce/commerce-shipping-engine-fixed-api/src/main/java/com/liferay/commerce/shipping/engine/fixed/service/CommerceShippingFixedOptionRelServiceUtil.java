...
public class CommerceShippingFixedOptionRelServiceUtil {
	...
	public static CommerceShippingFixedOptionRelService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceShippingFixedOptionRelServiceUtil::_getService);
	}

	private static CommerceShippingFixedOptionRelService _getService() {
		...
		ServiceReference<CommerceShippingFixedOptionRelService>
	...
	private static final DCLSingleton<CommerceShippingFixedOptionRelService>
