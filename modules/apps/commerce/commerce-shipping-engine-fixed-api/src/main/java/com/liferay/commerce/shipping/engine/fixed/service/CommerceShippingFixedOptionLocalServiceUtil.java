...
public class CommerceShippingFixedOptionLocalServiceUtil {
	...
	public static CommerceShippingFixedOptionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceShippingFixedOptionLocalServiceUtil::_getService);
	}

	private static CommerceShippingFixedOptionLocalService _getService() {
		...
		ServiceReference<CommerceShippingFixedOptionLocalService>
	...
	private static final DCLSingleton<CommerceShippingFixedOptionLocalService>
