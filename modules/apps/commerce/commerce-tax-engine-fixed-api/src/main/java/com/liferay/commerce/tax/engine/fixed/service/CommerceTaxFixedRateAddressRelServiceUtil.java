...
public class CommerceTaxFixedRateAddressRelServiceUtil {
	...
	public static CommerceTaxFixedRateAddressRelService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceTaxFixedRateAddressRelServiceUtil::_getService);
	}

	private static CommerceTaxFixedRateAddressRelService _getService() {
		...
		ServiceReference<CommerceTaxFixedRateAddressRelService>
	...
	private static final DCLSingleton<CommerceTaxFixedRateAddressRelService>
