...
public class CommerceTaxFixedRateLocalServiceUtil {
	...
	public static CommerceTaxFixedRateLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceTaxFixedRateLocalServiceUtil::_getService);
	}

	private static CommerceTaxFixedRateLocalService _getService() {
		...
		ServiceReference<CommerceTaxFixedRateLocalService> serviceReference =
	...
	private static final DCLSingleton<CommerceTaxFixedRateLocalService>
