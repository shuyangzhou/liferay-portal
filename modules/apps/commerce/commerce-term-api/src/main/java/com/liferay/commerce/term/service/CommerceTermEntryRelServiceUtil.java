...
public class CommerceTermEntryRelServiceUtil {
	...
	public static CommerceTermEntryRelService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceTermEntryRelServiceUtil::_getService);
	}

	private static CommerceTermEntryRelService _getService() {
		...
		ServiceReference<CommerceTermEntryRelService> serviceReference =
	...
	private static final DCLSingleton<CommerceTermEntryRelService>
