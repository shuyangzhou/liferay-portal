...
public class CommerceTermEntryLocalServiceUtil {
	...
	public static CommerceTermEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceTermEntryLocalServiceUtil::_getService);
	}

	private static CommerceTermEntryLocalService _getService() {
		...
		ServiceReference<CommerceTermEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<CommerceTermEntryLocalService>
