...
public class COREntryRelLocalServiceUtil {
	...
	public static COREntryRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			COREntryRelLocalServiceUtil::_getService);
	}

	private static COREntryRelLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			COREntryRelLocalServiceUtil.class);
		...
		ServiceReference<COREntryRelLocalService> serviceReference =
			bundleContext.getServiceReference(COREntryRelLocalService.class);
	...
	private static final DCLSingleton<COREntryRelLocalService>
