...
public class COREntryLocalServiceUtil {
	...
	public static COREntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			COREntryLocalServiceUtil::_getService);
	}

	private static COREntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(COREntryLocalServiceUtil.class);
		...
		ServiceReference<COREntryLocalService> serviceReference =
			bundleContext.getServiceReference(COREntryLocalService.class);
	...
	private static final DCLSingleton<COREntryLocalService>
