...
public class CommerceCurrencyLocalServiceUtil {
	...
	public static CommerceCurrencyLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceCurrencyLocalServiceUtil::_getService);
	}

	private static CommerceCurrencyLocalService _getService() {
		...
		ServiceReference<CommerceCurrencyLocalService> serviceReference =
	...
	private static final DCLSingleton<CommerceCurrencyLocalService>
