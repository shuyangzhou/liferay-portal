...
public class CommerceNotificationAttachmentLocalServiceUtil {
	...
	public static CommerceNotificationAttachmentLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceNotificationAttachmentLocalServiceUtil::_getService);
	}

	private static CommerceNotificationAttachmentLocalService _getService() {
		...
		ServiceReference<CommerceNotificationAttachmentLocalService>
	...
	private static final DCLSingleton
		<CommerceNotificationAttachmentLocalService> _serviceDCLSingleton =
			new DCLSingleton<>();
