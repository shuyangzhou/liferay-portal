...
public class CommerceNotificationQueueEntryServiceUtil {
	...
	public static CommerceNotificationQueueEntryService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceNotificationQueueEntryServiceUtil::_getService);
	}

	private static CommerceNotificationQueueEntryService _getService() {
		...
		ServiceReference<CommerceNotificationQueueEntryService>
	...
	private static final DCLSingleton<CommerceNotificationQueueEntryService>
