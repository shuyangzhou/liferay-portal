...
public class CommerceNotificationTemplateServiceUtil {
	...
	public static CommerceNotificationTemplateService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceNotificationTemplateServiceUtil::_getService);
	}

	private static CommerceNotificationTemplateService _getService() {
		...
		ServiceReference<CommerceNotificationTemplateService> serviceReference =
	...
	private static final DCLSingleton<CommerceNotificationTemplateService>
