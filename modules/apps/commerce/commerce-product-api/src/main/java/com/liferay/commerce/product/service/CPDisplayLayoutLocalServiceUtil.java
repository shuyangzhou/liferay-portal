...
public class CPDisplayLayoutLocalServiceUtil {
	...
	public static CPDisplayLayoutLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPDisplayLayoutLocalServiceUtil::_getService);
	}

	private static CPDisplayLayoutLocalService _getService() {
		...
		ServiceReference<CPDisplayLayoutLocalService> serviceReference =
	...
	private static final DCLSingleton<CPDisplayLayoutLocalService>
