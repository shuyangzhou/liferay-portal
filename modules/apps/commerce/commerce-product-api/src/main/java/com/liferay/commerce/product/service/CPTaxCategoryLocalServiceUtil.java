...
public class CPTaxCategoryLocalServiceUtil {
	...
	public static CPTaxCategoryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPTaxCategoryLocalServiceUtil::_getService);
	}

	private static CPTaxCategoryLocalService _getService() {
		...
		ServiceReference<CPTaxCategoryLocalService> serviceReference =
			bundleContext.getServiceReference(CPTaxCategoryLocalService.class);
	...
	private static final DCLSingleton<CPTaxCategoryLocalService>
