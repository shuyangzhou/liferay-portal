...
public class CommerceCatalogLocalServiceUtil {
	...
	public static CommerceCatalogLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceCatalogLocalServiceUtil::_getService);
	}

	private static CommerceCatalogLocalService _getService() {
		...
		ServiceReference<CommerceCatalogLocalService> serviceReference =
	...
	private static final DCLSingleton<CommerceCatalogLocalService>
