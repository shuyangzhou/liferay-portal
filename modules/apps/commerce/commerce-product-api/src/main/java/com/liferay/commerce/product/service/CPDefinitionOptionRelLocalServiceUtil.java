...
public class CPDefinitionOptionRelLocalServiceUtil {
	...
	public static CPDefinitionOptionRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPDefinitionOptionRelLocalServiceUtil::_getService);
	}

	private static CPDefinitionOptionRelLocalService _getService() {
		...
		ServiceReference<CPDefinitionOptionRelLocalService> serviceReference =
	...
	private static final DCLSingleton<CPDefinitionOptionRelLocalService>
