...
public class CPDefinitionLinkServiceUtil {
	...
	public static CPDefinitionLinkService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPDefinitionLinkServiceUtil::_getService);
	}

	private static CPDefinitionLinkService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			CPDefinitionLinkServiceUtil.class);
		...
		ServiceReference<CPDefinitionLinkService> serviceReference =
			bundleContext.getServiceReference(CPDefinitionLinkService.class);
	...
	private static final DCLSingleton<CPDefinitionLinkService>
