...
public class CPOptionServiceUtil {
	...
	public static CPOptionService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPOptionServiceUtil::_getService);
	}

	private static CPOptionService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(CPOptionServiceUtil.class);
		...
		ServiceReference<CPOptionService> serviceReference =
			bundleContext.getServiceReference(CPOptionService.class);
	...
	private static final DCLSingleton<CPOptionService> _serviceDCLSingleton =
		new DCLSingleton<>();
