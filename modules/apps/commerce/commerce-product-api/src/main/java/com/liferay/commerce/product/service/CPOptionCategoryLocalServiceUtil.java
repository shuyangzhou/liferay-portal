...
public class CPOptionCategoryLocalServiceUtil {
	...
	public static CPOptionCategoryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPOptionCategoryLocalServiceUtil::_getService);
	}

	private static CPOptionCategoryLocalService _getService() {
		...
		ServiceReference<CPOptionCategoryLocalService> serviceReference =
	...
	private static final DCLSingleton<CPOptionCategoryLocalService>
