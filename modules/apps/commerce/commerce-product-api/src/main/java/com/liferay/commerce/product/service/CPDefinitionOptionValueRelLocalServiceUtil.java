...
public class CPDefinitionOptionValueRelLocalServiceUtil {
	...
	public static CPDefinitionOptionValueRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPDefinitionOptionValueRelLocalServiceUtil::_getService);
	}

	private static CPDefinitionOptionValueRelLocalService _getService() {
		...
		ServiceReference<CPDefinitionOptionValueRelLocalService>
	...
	private static final DCLSingleton<CPDefinitionOptionValueRelLocalService>
