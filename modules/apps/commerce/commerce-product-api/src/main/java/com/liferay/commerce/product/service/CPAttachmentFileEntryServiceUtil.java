...
public class CPAttachmentFileEntryServiceUtil {
	...
	public static CPAttachmentFileEntryService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPAttachmentFileEntryServiceUtil::_getService);
	}

	private static CPAttachmentFileEntryService _getService() {
		...
		ServiceReference<CPAttachmentFileEntryService> serviceReference =
	...
	private static final DCLSingleton<CPAttachmentFileEntryService>
