...
public class CommerceChannelRelServiceUtil {
	...
	public static CommerceChannelRelService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceChannelRelServiceUtil::_getService);
	}

	private static CommerceChannelRelService _getService() {
		...
		ServiceReference<CommerceChannelRelService> serviceReference =
			bundleContext.getServiceReference(CommerceChannelRelService.class);
	...
	private static final DCLSingleton<CommerceChannelRelService>
