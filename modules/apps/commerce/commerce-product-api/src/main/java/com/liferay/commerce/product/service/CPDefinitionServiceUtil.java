...
public class CPDefinitionServiceUtil {
	...
	public static CPDefinitionService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPDefinitionServiceUtil::_getService);
	}

	private static CPDefinitionService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(CPDefinitionServiceUtil.class);
		...
		ServiceReference<CPDefinitionService> serviceReference =
			bundleContext.getServiceReference(CPDefinitionService.class);
	...
	private static final DCLSingleton<CPDefinitionService>
