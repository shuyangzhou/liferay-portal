...
public class CPMeasurementUnitLocalServiceUtil {
	...
	public static CPMeasurementUnitLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPMeasurementUnitLocalServiceUtil::_getService);
	}

	private static CPMeasurementUnitLocalService _getService() {
		...
		ServiceReference<CPMeasurementUnitLocalService> serviceReference =
	...
	private static final DCLSingleton<CPMeasurementUnitLocalService>
