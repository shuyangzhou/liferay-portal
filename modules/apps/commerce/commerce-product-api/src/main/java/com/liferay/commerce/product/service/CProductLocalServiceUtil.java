...
public class CProductLocalServiceUtil {
	...
	public static CProductLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CProductLocalServiceUtil::_getService);
	}

	private static CProductLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(CProductLocalServiceUtil.class);
		...
		ServiceReference<CProductLocalService> serviceReference =
			bundleContext.getServiceReference(CProductLocalService.class);
	...
	private static final DCLSingleton<CProductLocalService>
