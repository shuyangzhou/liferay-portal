...
public class CPOptionValueLocalServiceUtil {
	...
	public static CPOptionValueLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPOptionValueLocalServiceUtil::_getService);
	}

	private static CPOptionValueLocalService _getService() {
		...
		ServiceReference<CPOptionValueLocalService> serviceReference =
			bundleContext.getServiceReference(CPOptionValueLocalService.class);
	...
	private static final DCLSingleton<CPOptionValueLocalService>
