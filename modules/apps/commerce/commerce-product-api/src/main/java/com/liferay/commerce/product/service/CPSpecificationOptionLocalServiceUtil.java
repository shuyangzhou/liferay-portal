...
public class CPSpecificationOptionLocalServiceUtil {
	...
	public static CPSpecificationOptionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPSpecificationOptionLocalServiceUtil::_getService);
	}

	private static CPSpecificationOptionLocalService _getService() {
		...
		ServiceReference<CPSpecificationOptionLocalService> serviceReference =
	...
	private static final DCLSingleton<CPSpecificationOptionLocalService>
