...
public class CPTaxCategoryServiceUtil {
	...
	public static CPTaxCategoryService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPTaxCategoryServiceUtil::_getService);
	}

	private static CPTaxCategoryService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(CPTaxCategoryServiceUtil.class);
		...
		ServiceReference<CPTaxCategoryService> serviceReference =
			bundleContext.getServiceReference(CPTaxCategoryService.class);
	...
	private static final DCLSingleton<CPTaxCategoryService>
