...
public class CPDefinitionOptionValueRelServiceUtil {
	...
	public static CPDefinitionOptionValueRelService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPDefinitionOptionValueRelServiceUtil::_getService);
	}

	private static CPDefinitionOptionValueRelService _getService() {
		...
		ServiceReference<CPDefinitionOptionValueRelService> serviceReference =
	...
	private static final DCLSingleton<CPDefinitionOptionValueRelService>
