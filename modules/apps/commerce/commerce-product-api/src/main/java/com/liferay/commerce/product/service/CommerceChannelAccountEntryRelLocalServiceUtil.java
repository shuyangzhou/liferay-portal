...
public class CommerceChannelAccountEntryRelLocalServiceUtil {
	...
	public static CommerceChannelAccountEntryRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceChannelAccountEntryRelLocalServiceUtil::_getService);
	}

	private static CommerceChannelAccountEntryRelLocalService _getService() {
		...
		ServiceReference<CommerceChannelAccountEntryRelLocalService>
	...
	private static final DCLSingleton
		<CommerceChannelAccountEntryRelLocalService> _serviceDCLSingleton =
			new DCLSingleton<>();
