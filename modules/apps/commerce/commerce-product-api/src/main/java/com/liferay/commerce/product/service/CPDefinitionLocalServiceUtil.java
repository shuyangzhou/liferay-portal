...
public class CPDefinitionLocalServiceUtil {
	...
	public static CPDefinitionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPDefinitionLocalServiceUtil::_getService);
	}

	private static CPDefinitionLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			CPDefinitionLocalServiceUtil.class);
		...
		ServiceReference<CPDefinitionLocalService> serviceReference =
			bundleContext.getServiceReference(CPDefinitionLocalService.class);
	...
	private static final DCLSingleton<CPDefinitionLocalService>
