...
public class CPInstanceServiceUtil {
	...
	public static CPInstanceService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPInstanceServiceUtil::_getService);
	}

	private static CPInstanceService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(CPInstanceServiceUtil.class);
		...
		ServiceReference<CPInstanceService> serviceReference =
			bundleContext.getServiceReference(CPInstanceService.class);
	...
	private static final DCLSingleton<CPInstanceService> _serviceDCLSingleton =
		new DCLSingleton<>();
