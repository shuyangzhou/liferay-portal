...
public class CPOptionLocalServiceUtil {
	...
	public static CPOptionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPOptionLocalServiceUtil::_getService);
	}

	private static CPOptionLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(CPOptionLocalServiceUtil.class);
		...
		ServiceReference<CPOptionLocalService> serviceReference =
			bundleContext.getServiceReference(CPOptionLocalService.class);
	...
	private static final DCLSingleton<CPOptionLocalService>
