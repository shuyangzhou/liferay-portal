...
public class CPInstanceOptionValueRelLocalServiceUtil {
	...
	public static CPInstanceOptionValueRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPInstanceOptionValueRelLocalServiceUtil::_getService);
	}

	private static CPInstanceOptionValueRelLocalService _getService() {
		...
		ServiceReference<CPInstanceOptionValueRelLocalService>
	...
	private static final DCLSingleton<CPInstanceOptionValueRelLocalService>
