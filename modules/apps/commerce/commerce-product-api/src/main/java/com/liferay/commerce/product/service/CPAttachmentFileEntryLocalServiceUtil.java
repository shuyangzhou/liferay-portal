...
public class CPAttachmentFileEntryLocalServiceUtil {
	...
	public static CPAttachmentFileEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CPAttachmentFileEntryLocalServiceUtil::_getService);
	}

	private static CPAttachmentFileEntryLocalService _getService() {
		...
		ServiceReference<CPAttachmentFileEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<CPAttachmentFileEntryLocalService>
