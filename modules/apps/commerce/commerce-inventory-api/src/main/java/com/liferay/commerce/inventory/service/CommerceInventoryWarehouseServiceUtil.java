...
public class CommerceInventoryWarehouseServiceUtil {
	...
	public static CommerceInventoryWarehouseService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceInventoryWarehouseServiceUtil::_getService);
	}

	private static CommerceInventoryWarehouseService _getService() {
		...
		ServiceReference<CommerceInventoryWarehouseService> serviceReference =
	...
	private static final DCLSingleton<CommerceInventoryWarehouseService>
