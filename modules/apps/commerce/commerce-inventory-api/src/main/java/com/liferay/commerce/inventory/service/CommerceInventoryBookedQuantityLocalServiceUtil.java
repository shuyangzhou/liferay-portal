...
public class CommerceInventoryBookedQuantityLocalServiceUtil {
	...
	public static CommerceInventoryBookedQuantityLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceInventoryBookedQuantityLocalServiceUtil::_getService);
	}

	private static CommerceInventoryBookedQuantityLocalService _getService() {
		...
		ServiceReference<CommerceInventoryBookedQuantityLocalService>
	...
	private static final DCLSingleton
		<CommerceInventoryBookedQuantityLocalService> _serviceDCLSingleton =
			new DCLSingleton<>();
