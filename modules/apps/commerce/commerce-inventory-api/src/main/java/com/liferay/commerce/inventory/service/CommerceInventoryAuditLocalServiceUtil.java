...
public class CommerceInventoryAuditLocalServiceUtil {
	...
	public static CommerceInventoryAuditLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CommerceInventoryAuditLocalServiceUtil::_getService);
	}

	private static CommerceInventoryAuditLocalService _getService() {
		...
		ServiceReference<CommerceInventoryAuditLocalService> serviceReference =
	...
	private static final DCLSingleton<CommerceInventoryAuditLocalService>
