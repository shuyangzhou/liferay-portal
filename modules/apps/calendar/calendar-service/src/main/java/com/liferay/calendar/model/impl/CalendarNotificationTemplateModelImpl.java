...
public class CalendarNotificationTemplateModelImpl
	...
	public void setCalendarNotificationTemplateId(
		...
		if ((_columnBitmask & CALENDARNOTIFICATIONTEMPLATEID_COLUMN_BITMASK) ==
				0) {
			...
			_originalValues[CALENDARNOTIFICATIONTEMPLATEID_COLUMN_INDEX] =
	...
	public String getOriginalNotificationType() {
		if (_originalValues != null) {
			...
			if (originalNotificationType != null) {
				return GetterUtil.getString((String)originalNotificationType);
			}
		}
	...
	public void setNotificationTypeSettings(String notificationTypeSettings) {
		if ((_columnBitmask & NOTIFICATIONTYPESETTINGS_COLUMN_BITMASK) == 0) {
			...
			_originalValues[NOTIFICATIONTYPESETTINGS_COLUMN_INDEX] =
	...
	public void setNotificationTemplateType(String notificationTemplateType) {
		if ((_columnBitmask & NOTIFICATIONTEMPLATETYPE_COLUMN_BITMASK) == 0) {
	...
	public String getOriginalNotificationTemplateType() {
		if (_originalValues != null) {
			Object originalNotificationTemplateType =
				_originalValues[NOTIFICATIONTEMPLATETYPE_COLUMN_INDEX];

			if (originalNotificationTemplateType != null) {
				return GetterUtil.getString(
					(String)originalNotificationTemplateType);
			}
		}
