...
public class CalendarLocalServiceUtil {
	...
	public static CalendarLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CalendarLocalServiceUtil::_getService);
	}

	private static CalendarLocalService _getService() {
		...
		ServiceReference<CalendarLocalService> serviceReference =
			bundleContext.getServiceReference(CalendarLocalService.class);
	...
	private static final DCLSingleton<CalendarLocalService>
