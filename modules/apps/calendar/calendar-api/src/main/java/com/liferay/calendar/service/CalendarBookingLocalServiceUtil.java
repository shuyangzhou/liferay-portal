...
public class CalendarBookingLocalServiceUtil {
	...
	public static CalendarBookingLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CalendarBookingLocalServiceUtil::_getService);
	}

	private static CalendarBookingLocalService _getService() {
		...
		ServiceReference<CalendarBookingLocalService> serviceReference =
	...
	private static final DCLSingleton<CalendarBookingLocalService>
