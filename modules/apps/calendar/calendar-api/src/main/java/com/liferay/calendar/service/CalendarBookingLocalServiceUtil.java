...
public class CalendarBookingLocalServiceUtil {
	...
	public static com.liferay.calendar.model.CalendarBooking
		fetchCalendarBooking(long calendarId, java.lang.String vEventUid) {

		return getService().fetchCalendarBooking(calendarId, vEventUid);
	}

	public static com.liferay.calendar.model.CalendarBooking
		fetchCalendarBooking(java.lang.String uuid, long groupId) {
	...
	public static int searchCount(
		...
		long[] calendarResourceIds, long parentCalendarBookingId,
		java.lang.String title, java.lang.String description,
		java.lang.String location, long startTime, long endTime, int[] statuses,
		boolean andOperator) {
	...
	private static volatile CalendarBookingLocalService
