...
public class CalendarNotificationTemplateLocalServiceUtil {
	...
	public static CalendarNotificationTemplateLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			CalendarNotificationTemplateLocalServiceUtil::_getService);
	}

	private static CalendarNotificationTemplateLocalService _getService() {
		...
		ServiceReference<CalendarNotificationTemplateLocalService>
	...
	private static final DCLSingleton<CalendarNotificationTemplateLocalService>
