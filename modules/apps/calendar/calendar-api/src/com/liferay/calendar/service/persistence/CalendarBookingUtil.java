...
public class CalendarBookingUtil {
	...
	*/
	public static List<CalendarBooking> findByCalendarResourceId(
		...
		return getPersistence()
				   .findByCalendarResourceId(calendarResourceId,
			retrieveFromCache);
	}
	...
	*/
	public static List<CalendarBooking> findByC_S(long calendarId, int status,
		boolean retrieveFromCache) {
		return getPersistence().findByC_S(calendarId, status, retrieveFromCache);
	}
	...
	*/
	public static List<CalendarBooking> findByC_S(long calendarId, int status,
		int start, int end, boolean retrieveFromCache) {
		return getPersistence()
				   .findByC_S(calendarId, status, start, end, retrieveFromCache);
	}
	...
	*/
	public static List<CalendarBooking> findByC_S(long calendarId,
		...
		return getPersistence()
				   .findByC_S(calendarId, statuses, retrieveFromCache);
	}
	...
	*/
	public static List<CalendarBooking> findByP_S(
		long parentCalendarBookingId, int status, boolean retrieveFromCache) {
		return getPersistence()
				   .findByP_S(parentCalendarBookingId, status, retrieveFromCache);
	}
