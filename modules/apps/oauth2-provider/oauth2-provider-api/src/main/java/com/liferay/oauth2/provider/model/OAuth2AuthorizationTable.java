...
public class OAuth2AuthorizationTable extends Table<OAuth2AuthorizationTable> {
	...
	public final Column<OAuth2AuthorizationTable, String> accessTokenContent =
		createColumn("accessTokenContent", String.class, Types.CLOB);
	...
	public final Column<OAuth2AuthorizationTable, String> refreshTokenContent =
		createColumn("refreshTokenContent", String.class, Types.CLOB);
	public final Column<OAuth2AuthorizationTable, Long>
