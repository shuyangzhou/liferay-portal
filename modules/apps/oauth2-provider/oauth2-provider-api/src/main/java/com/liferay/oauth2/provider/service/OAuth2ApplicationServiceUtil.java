...
public class OAuth2ApplicationServiceUtil {
	...
	public static OAuth2ApplicationService getService() {
		return _serviceDCLSingleton.getSingleton(
			OAuth2ApplicationServiceUtil::_getService);
	}

	private static OAuth2ApplicationService _getService() {
		...
		ServiceReference<OAuth2ApplicationService> serviceReference =
			bundleContext.getServiceReference(OAuth2ApplicationService.class);
	...
	private static final DCLSingleton<OAuth2ApplicationService>
