...
public class OAuth2AuthorizationLocalServiceUtil {
	...
	public static OAuth2AuthorizationLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			OAuth2AuthorizationLocalServiceUtil::_getService);
	}

	private static OAuth2AuthorizationLocalService _getService() {
	...
	private static final DCLSingleton<OAuth2AuthorizationLocalService>
