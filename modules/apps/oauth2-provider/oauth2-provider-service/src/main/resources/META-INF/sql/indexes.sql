...
create index IX_EFE93C04 on OAuth2Authorization (oAuth2ApplicationId, userId, rememberDeviceContent[$COLUMN_LENGTH:75$]);

create index IX_88938BF on OAuth2ScopeGrant (oA2AScopeAliasesId, companyId, applicationName[$COLUMN_LENGTH:255$], bundleSymbolicName[$COLUMN_LENGTH:255$], scope[$COLUMN_LENGTH:240$]);