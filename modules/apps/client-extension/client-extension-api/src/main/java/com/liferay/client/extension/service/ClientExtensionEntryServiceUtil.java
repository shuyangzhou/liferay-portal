...
public class ClientExtensionEntryServiceUtil {
	...
	public static ClientExtensionEntryService getService() {
		return _serviceDCLSingleton.getSingleton(
			ClientExtensionEntryServiceUtil::_getService);
	}

	private static ClientExtensionEntryService _getService() {
		...
		ServiceReference<ClientExtensionEntryService> serviceReference =
	...
	private static final DCLSingleton<ClientExtensionEntryService>
