...
public class ClientExtensionEntryLocalServiceUtil {
	...
	public static ClientExtensionEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ClientExtensionEntryLocalServiceUtil::_getService);
	}

	private static ClientExtensionEntryLocalService _getService() {
		...
		ServiceReference<ClientExtensionEntryLocalService> serviceReference =
	...
	private static final DCLSingleton<ClientExtensionEntryLocalService>
