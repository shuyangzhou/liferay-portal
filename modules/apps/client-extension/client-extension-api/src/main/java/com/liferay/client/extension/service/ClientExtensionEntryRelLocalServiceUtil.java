...
public class ClientExtensionEntryRelLocalServiceUtil {
	...
	public static ClientExtensionEntryRelLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			ClientExtensionEntryRelLocalServiceUtil::_getService);
	}

	private static ClientExtensionEntryRelLocalService _getService() {
		...
		ServiceReference<ClientExtensionEntryRelLocalService> serviceReference =
	...
	private static final DCLSingleton<ClientExtensionEntryRelLocalService>
