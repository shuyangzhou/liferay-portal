...
public class UpgradeFileUploadsConfiguration extends UpgradeProcess {
	...
	protected void upgradeFileUploadsConfiguration() throws Exception {
		_prefsPropsToConfigurationUpgradeHelper.mapConfigurations(
			...
			(userFileUploadsConfiguration, configurationMappingCollector) -> {
				configurationMappingCollector.mapConfiguration(
					_OLD_KEY_USERS_IMAGE_CHECK_TOKEN, "imageCheckToken",
					userFileUploadsConfiguration.imageCheckToken());
				configurationMappingCollector.mapConfiguration(
					_OLD_KEY_USERS_IMAGE_MAX_HEIGHT, "imageMaxHeight",
					userFileUploadsConfiguration.imageMaxHeight());
				configurationMappingCollector.mapConfiguration(
					_OLD_KEY_USERS_IMAGE_MAX_SIZE, "imageMaxSize",
					userFileUploadsConfiguration.imageMaxSize());
				configurationMappingCollector.mapConfiguration(
					_OLD_KEY_USERS_IMAGE_MAX_WIDTH, "imageMaxWidth",
					userFileUploadsConfiguration.imageMaxWidth());
			});
	}
