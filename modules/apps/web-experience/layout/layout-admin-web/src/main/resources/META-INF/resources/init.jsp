...
page import="com.liferay.layout.admin.web.internal.permission.LayoutPageTemplateCollectionPermission" %><%@
page import="com.liferay.layout.admin.web.internal.permission.LayoutPageTemplateEntryPermission" %><%@
