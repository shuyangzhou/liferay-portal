 ...
 */
public class SiteNavigationMenuPermissionCheckerFactory {

	public static ModelResourcePermission<SiteNavigationMenu> create(
		...
		return ModelResourcePermissionChecker.create(
			...
			siteNavigationMenuLocalService::getSiteNavigationMenu,
