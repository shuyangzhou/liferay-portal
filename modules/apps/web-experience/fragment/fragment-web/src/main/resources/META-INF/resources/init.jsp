...
page import="com.liferay.fragment.web.internal.permission.FragmentCollectionPermission" %><%@
page import="com.liferay.fragment.web.internal.permission.FragmentEntryPermission" %><%@
