...
public class SuggestionResourceFactoryImpl
	...
	public SuggestionResource.Builder create() {
		return new SuggestionResource.Builder() {
			...
			public SuggestionResource build() {
				...
				Function<InvocationHandler, SuggestionResource>
					suggestionResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_suggestionResourceProxyProviderFunction;

				return suggestionResourceProxyProviderFunction.apply(
			...
			@Override
			public SuggestionResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
	...
	private static Function<InvocationHandler, SuggestionResource>
		...
		try {
			Constructor<SuggestionResource> constructor =
				(Constructor<SuggestionResource>)proxyClass.getConstructor(
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function<InvocationHandler, SuggestionResource>
			_suggestionResourceProxyProviderFunction =
				_getProxyProviderFunction();
