...
public class FVSEntryLocalServiceUtil {
	...
	public static FVSEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			FVSEntryLocalServiceUtil::_getService);
	}

	private static FVSEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(FVSEntryLocalServiceUtil.class);
		...
		ServiceReference<FVSEntryLocalService> serviceReference =
			bundleContext.getServiceReference(FVSEntryLocalService.class);
	...
	private static final DCLSingleton<FVSEntryLocalService>
