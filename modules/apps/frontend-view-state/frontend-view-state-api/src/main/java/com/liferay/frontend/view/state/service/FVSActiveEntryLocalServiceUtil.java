...
public class FVSActiveEntryLocalServiceUtil {
	...
	public static FVSActiveEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			FVSActiveEntryLocalServiceUtil::_getService);
	}

	private static FVSActiveEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			FVSActiveEntryLocalServiceUtil.class);
		...
		ServiceReference<FVSActiveEntryLocalService> serviceReference =
			bundleContext.getServiceReference(FVSActiveEntryLocalService.class);
	...
	private static final DCLSingleton<FVSActiveEntryLocalService>
