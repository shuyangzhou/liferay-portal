...
public class SAPEntryServiceUtil {
	...
	public static SAPEntryService getService() {
		return _serviceDCLSingleton.getSingleton(
			SAPEntryServiceUtil::_getService);
	}

	private static SAPEntryService _getService() {
		...
		ServiceReference<SAPEntryService> serviceReference =
			bundleContext.getServiceReference(SAPEntryService.class);
	...
	private static final DCLSingleton<SAPEntryService> _serviceDCLSingleton =
		new DCLSingleton<>();
