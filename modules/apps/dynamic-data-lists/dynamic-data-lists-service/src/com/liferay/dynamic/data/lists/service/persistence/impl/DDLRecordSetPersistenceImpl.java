...
public class DDLRecordSetPersistenceImpl extends BasePersistenceImpl<DDLRecordSet>
	...
	public DDLRecordSet updateImpl(DDLRecordSet ddlRecordSet) {
		...
		DDLRecordSet updatedDDLRecordSet = null;
		...
		try {
			...
			if (ddlRecordSet.isNew()) {
				...
				updatedDDLRecordSet = (DDLRecordSet)session.merge(ddlRecordSet);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedDDLRecordSet == null) {
			...
			cacheUniqueFindersCache(updatedDDLRecordSet, isNew);
		}
