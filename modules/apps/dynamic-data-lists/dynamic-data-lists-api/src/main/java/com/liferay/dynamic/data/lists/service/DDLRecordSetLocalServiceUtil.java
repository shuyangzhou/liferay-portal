...
public class DDLRecordSetLocalServiceUtil {
	...
	public static DDLRecordSetLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDLRecordSetLocalServiceUtil::_getService);
	}

	private static DDLRecordSetLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			DDLRecordSetLocalServiceUtil.class);
		...
		ServiceReference<DDLRecordSetLocalService> serviceReference =
			bundleContext.getServiceReference(DDLRecordSetLocalService.class);
	...
	private static final DCLSingleton<DDLRecordSetLocalService>
