...
public class DDLRecordServiceUtil {
	...
	public static DDLRecordService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDLRecordServiceUtil::_getService);
	}

	private static DDLRecordService _getService() {
		...
		ServiceReference<DDLRecordService> serviceReference =
			bundleContext.getServiceReference(DDLRecordService.class);
	...
	private static final DCLSingleton<DDLRecordService> _serviceDCLSingleton =
		new DCLSingleton<>();
