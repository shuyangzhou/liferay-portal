...
public class DDLRecordVersionServiceUtil {
	...
	public static DDLRecordVersionService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDLRecordVersionServiceUtil::_getService);
	}

	private static DDLRecordVersionService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			DDLRecordVersionServiceUtil.class);
		...
		ServiceReference<DDLRecordVersionService> serviceReference =
			bundleContext.getServiceReference(DDLRecordVersionService.class);
	...
	private static final DCLSingleton<DDLRecordVersionService>
