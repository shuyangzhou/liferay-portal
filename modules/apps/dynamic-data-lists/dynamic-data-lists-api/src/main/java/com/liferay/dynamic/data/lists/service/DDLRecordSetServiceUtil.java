...
public class DDLRecordSetServiceUtil {
	...
	public static DDLRecordSetService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDLRecordSetServiceUtil::_getService);
	}

	private static DDLRecordSetService _getService() {
		...
		ServiceReference<DDLRecordSetService> serviceReference =
			bundleContext.getServiceReference(DDLRecordSetService.class);
	...
	private static final DCLSingleton<DDLRecordSetService>
