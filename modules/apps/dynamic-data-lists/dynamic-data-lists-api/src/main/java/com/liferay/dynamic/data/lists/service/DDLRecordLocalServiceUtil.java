...
public class DDLRecordLocalServiceUtil {
	...
	public static DDLRecordLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDLRecordLocalServiceUtil::_getService);
	}

	private static DDLRecordLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			DDLRecordLocalServiceUtil.class);
		...
		ServiceReference<DDLRecordLocalService> serviceReference =
			bundleContext.getServiceReference(DDLRecordLocalService.class);
	...
	private static final DCLSingleton<DDLRecordLocalService>
