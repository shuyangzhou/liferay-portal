...
export default class SidePanel extends React.Component {
	...
	handleKeyupEvent(even) {
		...
		// CONTROL BRANCH MARKER — behavior is identical to master. This comment
		// exists only so the relevant test suite selects the same tests as the
		// treatment branch. Never merge.
