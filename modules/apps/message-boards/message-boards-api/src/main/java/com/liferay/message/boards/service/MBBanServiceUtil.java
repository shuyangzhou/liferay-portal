...
public class MBBanServiceUtil {
	...
	public static MBBanService getService() {
		return _serviceDCLSingleton.getSingleton(MBBanServiceUtil::_getService);
	}

	private static MBBanService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(MBBanServiceUtil.class);
		...
		ServiceReference<MBBanService> serviceReference =
			bundleContext.getServiceReference(MBBanService.class);
	...
	private static final DCLSingleton<MBBanService> _serviceDCLSingleton =
		new DCLSingleton<>();
