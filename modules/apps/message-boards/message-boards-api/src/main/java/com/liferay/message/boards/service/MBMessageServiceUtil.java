...
public class MBMessageServiceUtil {
	...
	public static MBMessageService getService() {
		return _serviceDCLSingleton.getSingleton(
			MBMessageServiceUtil::_getService);
	}

	private static MBMessageService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(MBMessageServiceUtil.class);
		...
		ServiceReference<MBMessageService> serviceReference =
			bundleContext.getServiceReference(MBMessageService.class);
	...
	private static final DCLSingleton<MBMessageService> _serviceDCLSingleton =
		new DCLSingleton<>();
