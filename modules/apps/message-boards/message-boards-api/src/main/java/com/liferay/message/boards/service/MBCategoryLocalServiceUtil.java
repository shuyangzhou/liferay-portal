...
public class MBCategoryLocalServiceUtil {
	...
	public static MBCategoryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			MBCategoryLocalServiceUtil::_getService);
	}

	private static MBCategoryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			MBCategoryLocalServiceUtil.class);
		...
		ServiceReference<MBCategoryLocalService> serviceReference =
			bundleContext.getServiceReference(MBCategoryLocalService.class);
	...
	private static final DCLSingleton<MBCategoryLocalService>
