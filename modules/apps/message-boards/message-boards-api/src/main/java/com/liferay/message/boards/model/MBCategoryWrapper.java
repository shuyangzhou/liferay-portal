...
public class MBCategoryWrapper implements MBCategory, ModelWrapper<MBCategory> {
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<MBCategory, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<MBCategory, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<MBCategory, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<MBCategory, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<MBCategory, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<MBCategory, Object> attributeBiConsumer = entry.getValue();
	...
	public Map<String, Function<MBCategory, Object>> getAttributeGetters() {
		return _mbCategory.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<MBCategory, Object>> getAttributeSetters() {
		return _mbCategory.getAttributeSetters();
	}
