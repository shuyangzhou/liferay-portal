...
public class MBThreadLocalServiceUtil {
	...
	public static MBThreadLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			MBThreadLocalServiceUtil::_getService);
	}

	private static MBThreadLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(MBThreadLocalServiceUtil.class);
		...
		ServiceReference<MBThreadLocalService> serviceReference =
			bundleContext.getServiceReference(MBThreadLocalService.class);
	...
	private static final DCLSingleton<MBThreadLocalService>
