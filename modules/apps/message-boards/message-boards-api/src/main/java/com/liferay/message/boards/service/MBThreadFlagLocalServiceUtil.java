...
public class MBThreadFlagLocalServiceUtil {
	...
	public static MBThreadFlagLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			MBThreadFlagLocalServiceUtil::_getService);
	}

	private static MBThreadFlagLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			MBThreadFlagLocalServiceUtil.class);
		...
		ServiceReference<MBThreadFlagLocalService> serviceReference =
			bundleContext.getServiceReference(MBThreadFlagLocalService.class);
	...
	private static final DCLSingleton<MBThreadFlagLocalService>
