...
public class MBThreadServiceUtil {
	...
	public static MBThreadService getService() {
		return _serviceDCLSingleton.getSingleton(
			MBThreadServiceUtil::_getService);
	}

	private static MBThreadService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(MBThreadServiceUtil.class);
		...
		ServiceReference<MBThreadService> serviceReference =
			bundleContext.getServiceReference(MBThreadService.class);
	...
	private static final DCLSingleton<MBThreadService> _serviceDCLSingleton =
		new DCLSingleton<>();
