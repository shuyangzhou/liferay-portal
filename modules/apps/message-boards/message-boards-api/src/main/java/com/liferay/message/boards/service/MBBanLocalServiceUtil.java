...
public class MBBanLocalServiceUtil {
	...
	public static MBBanLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			MBBanLocalServiceUtil::_getService);
	}

	private static MBBanLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(MBBanLocalServiceUtil.class);
		...
		ServiceReference<MBBanLocalService> serviceReference =
			bundleContext.getServiceReference(MBBanLocalService.class);
	...
	private static final DCLSingleton<MBBanLocalService> _serviceDCLSingleton =
		new DCLSingleton<>();
