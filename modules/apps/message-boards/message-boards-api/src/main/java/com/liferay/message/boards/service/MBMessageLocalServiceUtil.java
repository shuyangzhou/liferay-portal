...
public class MBMessageLocalServiceUtil {
	...
	public static MBMessageLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			MBMessageLocalServiceUtil::_getService);
	}

	private static MBMessageLocalService _getService() {
		...
		ServiceReference<MBMessageLocalService> serviceReference =
			bundleContext.getServiceReference(MBMessageLocalService.class);
	...
	private static final DCLSingleton<MBMessageLocalService>
