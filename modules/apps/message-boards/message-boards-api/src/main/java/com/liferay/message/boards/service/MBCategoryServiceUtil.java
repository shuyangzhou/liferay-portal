...
public class MBCategoryServiceUtil {
	...
	public static MBCategoryService getService() {
		return _serviceDCLSingleton.getSingleton(
			MBCategoryServiceUtil::_getService);
	}

	private static MBCategoryService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(MBCategoryServiceUtil.class);
		...
		ServiceReference<MBCategoryService> serviceReference =
			bundleContext.getServiceReference(MBCategoryService.class);
	...
	private static final DCLSingleton<MBCategoryService> _serviceDCLSingleton =
		new DCLSingleton<>();
