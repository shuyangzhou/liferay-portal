...
public class MBDiscussionWrapper implements MBDiscussion,
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<MBDiscussion, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<MBDiscussion, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<MBDiscussion, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<MBDiscussion, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<MBDiscussion, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<MBDiscussion, Object> attributeBiConsumer = entry.getValue();
	...
	public Map<String, Function<MBDiscussion, Object>> getAttributeGetters() {
		return _mbDiscussion.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<MBDiscussion, Object>> getAttributeSetters() {
		return _mbDiscussion.getAttributeSetters();
	}
