			...
			>
				...
				<c:choose>
					<c:when test="<%= curCategory != null %>">
						...
						rowData.put("actions", StringUtil.merge(mbEntriesManagementToolbarDisplayContext.getAvailableActionDropdownItems(curCategory)));
					...
					<c:otherwise>
						...
						rowData.put("actions", StringUtil.merge(mbEntriesManagementToolbarDisplayContext.getAvailableActionDropdownItems(message)));
