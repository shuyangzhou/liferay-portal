...
public class MBBanModelImpl extends BaseModelImpl<MBBan> implements MBBanModel {
	...
	public static final long BANID_COLUMN_BITMASK = 2L;
	...
	public static final long BANUSERID_COLUMN_BITMASK = 256L;
	...
	public void setBanId(long banId) {
		if ((_columnBitmask & BANID_COLUMN_BITMASK) == 0) {
			...
			_originalValues[BANID_COLUMN_INDEX] = _banId;
		}
	...
	public void setBanUserId(long banUserId) {
		if ((_columnBitmask & BANUSERID_COLUMN_BITMASK) == 0) {
	...
	public long getOriginalBanUserId() {
		if (_originalValues != null) {
			Object originalBanUserId = _originalValues[BANUSERID_COLUMN_INDEX];

			if (originalBanUserId != null) {
				return (long)originalBanUserId;
			}
		}
