...
public class DDMStructureServiceUtil {
	...
	public static DDMStructureService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDMStructureServiceUtil::_getService);
	}

	private static DDMStructureService _getService() {
		...
		ServiceReference<DDMStructureService> serviceReference =
			bundleContext.getServiceReference(DDMStructureService.class);
	...
	private static final DCLSingleton<DDMStructureService>
