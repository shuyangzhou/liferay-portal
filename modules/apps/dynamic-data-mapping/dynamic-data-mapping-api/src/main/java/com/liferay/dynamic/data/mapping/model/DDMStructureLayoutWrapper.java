...
public class DDMStructureLayoutWrapper implements DDMStructureLayout,
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<DDMStructureLayout, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<DDMStructureLayout, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<DDMStructureLayout, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<DDMStructureLayout, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<DDMStructureLayout, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<DDMStructureLayout, Object> attributeBiConsumer = entry.getValue();
	...
	public Map<String, Function<DDMStructureLayout, Object>> getAttributeGetters() {
		return _ddmStructureLayout.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<DDMStructureLayout, Object>> getAttributeSetters() {
		return _ddmStructureLayout.getAttributeSetters();
	}
