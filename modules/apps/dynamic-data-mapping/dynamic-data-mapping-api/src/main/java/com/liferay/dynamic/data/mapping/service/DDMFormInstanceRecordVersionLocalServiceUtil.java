...
public class DDMFormInstanceRecordVersionLocalServiceUtil {
	...
	public static DDMFormInstanceRecordVersionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDMFormInstanceRecordVersionLocalServiceUtil::_getService);
	}

	private static DDMFormInstanceRecordVersionLocalService _getService() {
		...
		ServiceReference<DDMFormInstanceRecordVersionLocalService>
	...
	private static final DCLSingleton<DDMFormInstanceRecordVersionLocalService>
