...
public class DDMTemplateVersionLocalServiceUtil {
	...
	public static DDMTemplateVersionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDMTemplateVersionLocalServiceUtil::_getService);
	}

	private static DDMTemplateVersionLocalService _getService() {
		...
		ServiceReference<DDMTemplateVersionLocalService> serviceReference =
	...
	private static final DCLSingleton<DDMTemplateVersionLocalService>
