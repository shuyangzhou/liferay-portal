...
public class DDMTemplateLocalServiceUtil {
	...
	public static DDMTemplateLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDMTemplateLocalServiceUtil::_getService);
	}

	private static DDMTemplateLocalService _getService() {
		...
		ServiceReference<DDMTemplateLocalService> serviceReference =
			bundleContext.getServiceReference(DDMTemplateLocalService.class);
	...
	private static final DCLSingleton<DDMTemplateLocalService>
