...
public class DDMFormInstanceLocalServiceUtil {
	...
	public static DDMFormInstanceLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDMFormInstanceLocalServiceUtil::_getService);
	}

	private static DDMFormInstanceLocalService _getService() {
		...
		ServiceReference<DDMFormInstanceLocalService> serviceReference =
	...
	private static final DCLSingleton<DDMFormInstanceLocalService>
