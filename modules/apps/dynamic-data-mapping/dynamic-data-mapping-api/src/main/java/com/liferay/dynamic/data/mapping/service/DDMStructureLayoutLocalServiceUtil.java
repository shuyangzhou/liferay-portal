...
public class DDMStructureLayoutLocalServiceUtil {
	...
	public static DDMStructureLayoutLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDMStructureLayoutLocalServiceUtil::_getService);
	}

	private static DDMStructureLayoutLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			DDMStructureLayoutLocalServiceUtil.class);
		...
		ServiceReference<DDMStructureLayoutLocalService> serviceReference =
	...
	private static final DCLSingleton<DDMStructureLayoutLocalService>
