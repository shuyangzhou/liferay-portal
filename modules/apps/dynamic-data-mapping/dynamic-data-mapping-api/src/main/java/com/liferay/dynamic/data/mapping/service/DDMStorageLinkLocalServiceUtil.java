...
public class DDMStorageLinkLocalServiceUtil {
	...
	public static DDMStorageLinkLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDMStorageLinkLocalServiceUtil::_getService);
	}

	private static DDMStorageLinkLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			DDMStorageLinkLocalServiceUtil.class);
		...
		ServiceReference<DDMStorageLinkLocalService> serviceReference =
			bundleContext.getServiceReference(DDMStorageLinkLocalService.class);
	...
	private static final DCLSingleton<DDMStorageLinkLocalService>
