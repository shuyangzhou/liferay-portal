...
public class DDMContentLocalServiceUtil {
	...
	public static DDMContentLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDMContentLocalServiceUtil::_getService);
	}

	private static DDMContentLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			DDMContentLocalServiceUtil.class);
		...
		ServiceReference<DDMContentLocalService> serviceReference =
			bundleContext.getServiceReference(DDMContentLocalService.class);
	...
	private static final DCLSingleton<DDMContentLocalService>
