...
public class DDMFormInstanceRecordVersionServiceUtil {
	...
	public static DDMFormInstanceRecordVersionService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDMFormInstanceRecordVersionServiceUtil::_getService);
	}

	private static DDMFormInstanceRecordVersionService _getService() {
		...
		ServiceReference<DDMFormInstanceRecordVersionService> serviceReference =
	...
	private static final DCLSingleton<DDMFormInstanceRecordVersionService>
