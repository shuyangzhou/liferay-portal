...
public class DDMTemplateServiceUtil {
	...
	public static DDMTemplateService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDMTemplateServiceUtil::_getService);
	}

	private static DDMTemplateService _getService() {
		...
		ServiceReference<DDMTemplateService> serviceReference =
			bundleContext.getServiceReference(DDMTemplateService.class);
	...
	private static final DCLSingleton<DDMTemplateService> _serviceDCLSingleton =
		new DCLSingleton<>();
