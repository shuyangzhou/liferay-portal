...
public class DDMStructureVersionServiceUtil {
	...
	public static DDMStructureVersionService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDMStructureVersionServiceUtil::_getService);
	}

	private static DDMStructureVersionService _getService() {
		...
		ServiceReference<DDMStructureVersionService> serviceReference =
			bundleContext.getServiceReference(DDMStructureVersionService.class);
	...
	private static final DCLSingleton<DDMStructureVersionService>
