 ...
 * @generated
 */
public class DDMStructureLayoutTable extends Table<DDMStructureLayoutTable> {
	...
	public final Column<DDMStructureLayoutTable, String> name = createColumn(
		"name", String.class, Types.CLOB);
	public final Column<DDMStructureLayoutTable, String> description =
		createColumn("description", String.class, Types.CLOB);
	public final Column<DDMStructureLayoutTable, String> definition =
		createColumn("definition", String.class, Types.CLOB);
