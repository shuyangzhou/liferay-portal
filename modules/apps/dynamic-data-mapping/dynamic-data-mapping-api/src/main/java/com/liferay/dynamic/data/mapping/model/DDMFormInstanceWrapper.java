...
public class DDMFormInstanceWrapper implements DDMFormInstance,
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<DDMFormInstance, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<DDMFormInstance, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<DDMFormInstance, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<DDMFormInstance, Object>> attributeSetters = getAttributeSetters();

		for (Map.Entry<String, BiConsumer<DDMFormInstance, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<DDMFormInstance, Object> attributeBiConsumer = entry.getValue();
	...
	@Override
	public Map<String, Function<DDMFormInstance, Object>> getAttributeGetters() {
		return _ddmFormInstance.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<DDMFormInstance, Object>> getAttributeSetters() {
		return _ddmFormInstance.getAttributeSetters();
	}
