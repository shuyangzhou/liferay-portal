...
public class DDMFormInstanceRecordLocalServiceUtil {
	...
	public static DDMFormInstanceRecordLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDMFormInstanceRecordLocalServiceUtil::_getService);
	}

	private static DDMFormInstanceRecordLocalService _getService() {
		...
		ServiceReference<DDMFormInstanceRecordLocalService> serviceReference =
	...
	private static final DCLSingleton<DDMFormInstanceRecordLocalService>
