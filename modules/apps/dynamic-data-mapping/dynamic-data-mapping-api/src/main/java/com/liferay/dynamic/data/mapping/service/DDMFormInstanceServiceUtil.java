...
public class DDMFormInstanceServiceUtil {
	...
	public static DDMFormInstanceService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDMFormInstanceServiceUtil::_getService);
	}

	private static DDMFormInstanceService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			DDMFormInstanceServiceUtil.class);
		...
		ServiceReference<DDMFormInstanceService> serviceReference =
			bundleContext.getServiceReference(DDMFormInstanceService.class);
	...
	private static final DCLSingleton<DDMFormInstanceService>
