...
public class DDMDataProviderInstanceTable
	extends Table<DDMDataProviderInstanceTable> {
	...
	public final Column<DDMDataProviderInstanceTable, String> description =
		createColumn("description", String.class, Types.CLOB);
	public final Column<DDMDataProviderInstanceTable, String> definition =
