...
public class DDMDataProviderInstanceLocalServiceUtil {
	...
	public static DDMDataProviderInstanceLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDMDataProviderInstanceLocalServiceUtil::_getService);
	}

	private static DDMDataProviderInstanceLocalService _getService() {
		...
		ServiceReference<DDMDataProviderInstanceLocalService> serviceReference =
	...
	private static final DCLSingleton<DDMDataProviderInstanceLocalService>
