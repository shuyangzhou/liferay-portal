...
public class DDMTemplateLinkUtil {
	 ...
	 */
	public static List<DDMTemplateLink> findByCTCollectionId(
		long ctCollectionId) {
	 ...
	 */
	public static DDMTemplateLink findByCTCollectionId_First(
			long ctCollectionId,
			OrderByComparator<DDMTemplateLink> orderByComparator)
	 ...
	 */
	public static DDMTemplateLink fetchByCTCollectionId_First(
		long ctCollectionId,
		OrderByComparator<DDMTemplateLink> orderByComparator) {
	 ...
	 * @throws NoSuchTemplateLinkException if a matching ddm template link could not be found
	 */
	public static DDMTemplateLink findByCTCollectionId_Last(
			long ctCollectionId,
			OrderByComparator<DDMTemplateLink> orderByComparator)
		throws com.liferay.dynamic.data.mapping.exception.
			NoSuchTemplateLinkException {
	 ...
	 */
	public static DDMTemplateLink fetchByCTCollectionId_Last(
		long ctCollectionId,
		OrderByComparator<DDMTemplateLink> orderByComparator) {
	 ...
	 */
	public static DDMTemplateLink[] findByCTCollectionId_PrevAndNext(
		...
		return getPersistence().findByCTCollectionId_PrevAndNext(
			templateLinkId, ctCollectionId, orderByComparator);
	}
