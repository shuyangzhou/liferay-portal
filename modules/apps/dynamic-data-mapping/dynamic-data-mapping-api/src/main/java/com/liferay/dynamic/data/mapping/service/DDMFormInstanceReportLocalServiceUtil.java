...
public class DDMFormInstanceReportLocalServiceUtil {
	...
	public static DDMFormInstanceReportLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDMFormInstanceReportLocalServiceUtil::_getService);
	}

	private static DDMFormInstanceReportLocalService _getService() {
		...
		ServiceReference<DDMFormInstanceReportLocalService> serviceReference =
	...
	private static final DCLSingleton<DDMFormInstanceReportLocalService>
