...
public class DDMFormInstanceVersionLocalServiceUtil {
	...
	public static DDMFormInstanceVersionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDMFormInstanceVersionLocalServiceUtil::_getService);
	}

	private static DDMFormInstanceVersionLocalService _getService() {
		...
		ServiceReference<DDMFormInstanceVersionLocalService> serviceReference =
	...
	private static final DCLSingleton<DDMFormInstanceVersionLocalService>
