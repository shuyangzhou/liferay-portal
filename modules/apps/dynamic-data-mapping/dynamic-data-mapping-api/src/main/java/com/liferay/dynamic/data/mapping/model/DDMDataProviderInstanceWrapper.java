...
public class DDMDataProviderInstanceWrapper implements DDMDataProviderInstance,
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<DDMDataProviderInstance, Object>> attributeGetters = getAttributeGetters();

		for (Map.Entry<String, Function<DDMDataProviderInstance, Object>> entry : attributeGetters.entrySet()) {
			String attributeName = entry.getKey();
			Function<DDMDataProviderInstance, Object> attributeFunction = entry.getValue();
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		for (Map.Entry<String, BiConsumer<DDMDataProviderInstance, Object>> entry : attributeSetters.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<DDMDataProviderInstance, Object> attributeBiConsumer = entry.getValue();
	...
	@Override
	public Map<String, Function<DDMDataProviderInstance, Object>> getAttributeGetters() {
		return _ddmDataProviderInstance.getAttributeGetters();
	}

	@Override
	public Map<String, BiConsumer<DDMDataProviderInstance, Object>> getAttributeSetters() {
		return _ddmDataProviderInstance.getAttributeSetters();
	}
