 ...
 * @generated
 */
public class DDMStructureTable extends Table<DDMStructureTable> {
	...
	public final Column<DDMStructureTable, String> description = createColumn(
		"description", String.class, Types.CLOB);
	public final Column<DDMStructureTable, String> definition = createColumn(
		"definition", String.class, Types.CLOB);
