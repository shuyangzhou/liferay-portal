...
public class DDMStructureVersionLocalServiceUtil {
	...
	public static DDMStructureVersionLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDMStructureVersionLocalServiceUtil::_getService);
	}

	private static DDMStructureVersionLocalService _getService() {
		...
		ServiceReference<DDMStructureVersionLocalService> serviceReference =
	...
	private static final DCLSingleton<DDMStructureVersionLocalService>
