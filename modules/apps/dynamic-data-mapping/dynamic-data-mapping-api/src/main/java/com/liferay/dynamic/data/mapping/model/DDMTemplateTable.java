 ...
 * @generated
 */
public class DDMTemplateTable extends Table<DDMTemplateTable> {
	...
	public final Column<DDMTemplateTable, String> name = createColumn(
		"name", String.class, Types.CLOB);
	public final Column<DDMTemplateTable, String> description = createColumn(
	...
	public final Column<DDMTemplateTable, String> script = createColumn(
