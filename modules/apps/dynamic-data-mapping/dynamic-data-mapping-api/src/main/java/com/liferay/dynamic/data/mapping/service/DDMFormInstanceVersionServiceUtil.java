...
public class DDMFormInstanceVersionServiceUtil {
	...
	public static DDMFormInstanceVersionService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDMFormInstanceVersionServiceUtil::_getService);
	}

	private static DDMFormInstanceVersionService _getService() {
		...
		ServiceReference<DDMFormInstanceVersionService> serviceReference =
	...
	private static final DCLSingleton<DDMFormInstanceVersionService>
