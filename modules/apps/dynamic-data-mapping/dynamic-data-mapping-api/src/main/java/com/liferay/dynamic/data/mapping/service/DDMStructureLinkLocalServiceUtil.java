...
public class DDMStructureLinkLocalServiceUtil {
	...
	public static DDMStructureLinkLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			DDMStructureLinkLocalServiceUtil::_getService);
	}

	private static DDMStructureLinkLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(
			DDMStructureLinkLocalServiceUtil.class);
		...
		ServiceReference<DDMStructureLinkLocalService> serviceReference =
	...
	private static final DCLSingleton<DDMStructureLinkLocalService>
