...
public class DDMTemplateVersionTable extends Table<DDMTemplateVersionTable> {
	...
	public final Column<DDMTemplateVersionTable, String> name = createColumn(
		"name", String.class, Types.CLOB);
	public final Column<DDMTemplateVersionTable, String> description =
	...
	public final Column<DDMTemplateVersionTable, String> script = createColumn(
		"script", String.class, Types.CLOB);
