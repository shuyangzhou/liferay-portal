...
public class DDMFormInstanceRecordVersionModelImpl
	...
	public void setFormInstanceRecordVersionId(
		...
		if ((_columnBitmask & FORMINSTANCERECORDVERSIONID_COLUMN_BITMASK) ==
				0) {
			...
			_originalValues[FORMINSTANCERECORDVERSIONID_COLUMN_INDEX] =
	...
	public long getOriginalFormInstanceRecordId() {
		if (_originalValues != null) {
			Object originalFormInstanceRecordId =
				_originalValues[FORMINSTANCERECORDID_COLUMN_INDEX];

			if (originalFormInstanceRecordId != null) {
				return (long)originalFormInstanceRecordId;
			}
		}
