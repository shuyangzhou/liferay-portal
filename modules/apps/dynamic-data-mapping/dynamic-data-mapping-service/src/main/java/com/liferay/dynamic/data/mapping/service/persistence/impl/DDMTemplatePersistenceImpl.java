...
public class DDMTemplatePersistenceImpl
	...
	static {
		...
		strictCTModeAttributeNames.add("versionUserId");
		strictCTModeAttributeNames.add("versionUserName");
		...
		strictCTModeAttributeNames.add("resourceClassNameId");
		strictCTModeAttributeNames.add("templateKey");
		strictCTModeAttributeNames.add("version");
		strictCTModeAttributeNames.add("name");
		strictCTModeAttributeNames.add("description");
		strictCTModeAttributeNames.add("type_");
		strictCTModeAttributeNames.add("mode_");
		strictCTModeAttributeNames.add("language");
		strictCTModeAttributeNames.add("script");
		strictCTModeAttributeNames.add("cacheable");
		strictCTModeAttributeNames.add("smallImage");
		strictCTModeAttributeNames.add("smallImageId");
		strictCTModeAttributeNames.add("smallImageURL");
		...
		_ctModeAttributeNames.put(
			CTMode.PK, Collections.singleton("templateId"));
