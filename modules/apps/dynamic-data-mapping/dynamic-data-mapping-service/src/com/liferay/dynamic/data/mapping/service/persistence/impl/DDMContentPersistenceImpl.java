...
public class DDMContentPersistenceImpl extends BasePersistenceImpl<DDMContent>
	...
	public DDMContent updateImpl(DDMContent ddmContent) {
		...
		DDMContent updatedDDMContent = null;
		...
		try {
			...
			if (ddmContent.isNew()) {
				...
				updatedDDMContent = (DDMContent)session.merge(ddmContent);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedDDMContent == null) {
			...
			cacheUniqueFindersCache(updatedDDMContent, isNew);
		}
