...
public class DDMTemplatePersistenceImpl extends BasePersistenceImpl<DDMTemplate>
	...
	public DDMTemplate updateImpl(DDMTemplate ddmTemplate) {
		...
		DDMTemplate updatedDDMTemplate = null;
		...
		try {
			...
			if (ddmTemplate.isNew()) {
				...
				updatedDDMTemplate = (DDMTemplate)session.merge(ddmTemplate);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedDDMTemplate == null) {
			...
			cacheUniqueFindersCache(updatedDDMTemplate, isNew);
		}
