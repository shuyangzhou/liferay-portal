...
public class DDMStructurePersistenceImpl extends BasePersistenceImpl<DDMStructure>
	...
	public DDMStructure updateImpl(DDMStructure ddmStructure) {
		...
		DDMStructure updatedDDMStructure = null;
		...
		try {
			...
			if (ddmStructure.isNew()) {
				...
				updatedDDMStructure = (DDMStructure)session.merge(ddmStructure);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (updatedDDMStructure == null) {
			...
			cacheUniqueFindersCache(updatedDDMStructure, isNew);
		}
