...
public class ProjectTemplatesTest {
	...
	public void testBuildTemplateSoyPortlet() throws Exception {
		...
		_testContains(
			...
			"public class FooSoyPortletRegister implements SoyPortletRegister" +
				" {");
		_testContains(
			gradleProjectDir,
	...
	public void testBuildTemplateSoyPortletCustomClass() throws Exception {
		...
		_testContains(
			gradleProjectDir,
			"src/main/java/foo/portlet/MySoyPortletPortletRegister.java",
			"public class MySoyPortletPortletRegister implements " +
				"SoyPortletRegister {");
	}
