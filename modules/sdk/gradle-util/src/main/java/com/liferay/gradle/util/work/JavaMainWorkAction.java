 ...
 * @author Peter Shin
 */
public abstract class JavaMainWorkAction
	implements WorkAction<JavaMainWorkParameters> {

	@Override
	public void execute() {
		Class<?> mainClass = null;

		JavaMainWorkParameters javaMainWorkParameters = getParameters();

		Property<String> classNameProperty =
			javaMainWorkParameters.getClassName();

		try {
			mainClass = Class.forName(classNameProperty.get());
		}
