...
public class ConcurrentMapperHashMapTest {
	...
	public void testCompute() {
		...
		Assert.assertSame(
			_testValue,
			_concurrentMap.compute(_testKey, (key, value) -> _testValue));
		...
		Assert.assertSame(
			...
			_concurrentMap.compute(
				_testKey, (key, value) -> _testValueAnother));
	...
	public void testComputeIfAbsent() {
		...
		Assert.assertSame(
			_testValue,
			_concurrentMap.computeIfAbsent(_testKey, key -> _testValue));
		...
		Assert.assertSame(
			_testValue,
			_concurrentMap.computeIfAbsent(_testKey, key -> _testValueAnother));
	...
	public void testValues() {
		...
		Assert.assertTrue(valuesString, values.contains(_testValue));
