...
TOS_HOME="/Applications/TOSDI-7.1.1/studio/"

COMPONENT_NAME="com.liferay.talend"
COMPONENT_GROUP_ID_TO_PATH="com/liferay/"
COMPONENT_VERSION="0.1.0-SNAPSHOT"

MAVEN_LOCAL_HOME="/Volumes/ext/Users/ivicac/.m2/repository/"
...
cp -rf "$_LOCAL_M2_COMPONENT_PATH""$COMPONENT_NAME"".definition" "$_TOS_M2_COMPONENT_PATH"
cp -rf "$_LOCAL_M2_COMPONENT_PATH""$COMPONENT_NAME"".runtime" "$_TOS_M2_COMPONENT_PATH"
