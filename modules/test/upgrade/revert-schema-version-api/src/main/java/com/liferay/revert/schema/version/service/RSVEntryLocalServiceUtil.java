...
public class RSVEntryLocalServiceUtil {
	...
	public static RSVEntryLocalService getService() {
		return _serviceDCLSingleton.getSingleton(
			RSVEntryLocalServiceUtil::_getService);
	}

	private static RSVEntryLocalService _getService() {
		Bundle bundle = FrameworkUtil.getBundle(RSVEntryLocalServiceUtil.class);
		...
		ServiceReference<RSVEntryLocalService> serviceReference =
			bundleContext.getServiceReference(RSVEntryLocalService.class);
	...
	private static final DCLSingleton<RSVEntryLocalService>
