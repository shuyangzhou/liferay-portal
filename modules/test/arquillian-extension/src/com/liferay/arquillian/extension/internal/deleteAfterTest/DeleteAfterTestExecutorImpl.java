...
package com.liferay.arquillian.extension.internal.deleteAfterTest;
...
public class DeleteAfterTestExecutorImpl implements DeleteAfterTestExecutor {
	...
	public void deleteFieldsAfterTest(Object instance, Method method)
		throws Exception {
		...
		while (testClass != null) {
			for (Field field : testClass.getDeclaredFields()) {
				DeleteAfterTest deleteAfterTestRun = field.getAnnotation(
					DeleteAfterTest.class);
