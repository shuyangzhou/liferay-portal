...
package com.liferay.service.builder.demo.service.persistence.impl;
...
import com.liferay.service.builder.demo.exception.NoSuchBigDecimalEntryException;
import com.liferay.service.builder.demo.model.BigDecimalEntry;
import com.liferay.service.builder.demo.model.impl.BigDecimalEntryImpl;
import com.liferay.service.builder.demo.model.impl.BigDecimalEntryModelImpl;
import com.liferay.service.builder.demo.service.persistence.BigDecimalEntryPersistence;
 ...
 * @see com.liferay.service.builder.demo.service.persistence.BigDecimalEntryUtil
 * @generated
 */
@ProviderType
public class BigDecimalEntryPersistenceImpl extends BasePersistenceImpl<BigDecimalEntry>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_LESSTHANBIGDECIMALVALUE =
		new FinderPath(BigDecimalEntryModelImpl.ENTITY_CACHE_ENABLED,
			BigDecimalEntryModelImpl.FINDER_CACHE_ENABLED,
			BigDecimalEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByLessThanBigDecimalValue",
			new String[] {
				BigDecimal.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_LESSTHANBIGDECIMALVALUE =
		new FinderPath(BigDecimalEntryModelImpl.ENTITY_CACHE_ENABLED,
			BigDecimalEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"countByLessThanBigDecimalValue",
			new String[] { BigDecimal.class.getName() });
	 ...
	 */
	@Override
	public List<BigDecimalEntry> findByLessThanBigDecimalValue(
		BigDecimal bigDecimalValue) {
		return findByLessThanBigDecimalValue(bigDecimalValue,
	...
	public List<BigDecimalEntry> findByLessThanBigDecimalValue(
		BigDecimal bigDecimalValue, int start, int end) {
		return findByLessThanBigDecimalValue(bigDecimalValue, start, end, null);
	}
	...
	public List<BigDecimalEntry> findByLessThanBigDecimalValue(
		BigDecimal bigDecimalValue, int start, int end,
		OrderByComparator<BigDecimalEntry> orderByComparator) {
		return findByLessThanBigDecimalValue(bigDecimalValue, start, end,
			orderByComparator, true);
	}
	...
	public List<BigDecimalEntry> findByLessThanBigDecimalValue(
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_LESSTHANBIGDECIMALVALUE;
		...
		if (list == null) {
			...
			if (bigDecimalValue == null) {
				query.append(_FINDER_COLUMN_LESSTHANBIGDECIMALVALUE_BIGDECIMALVALUE_1);
			}
			else {
				bindBigDecimalValue = true;

				query.append(_FINDER_COLUMN_LESSTHANBIGDECIMALVALUE_BIGDECIMALVALUE_2);
			}
	 ...
	 */
	@Override
	public BigDecimalEntry findByLessThanBigDecimalValue_First(
		BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator)
		throws NoSuchBigDecimalEntryException {
		BigDecimalEntry bigDecimalEntry = fetchByLessThanBigDecimalValue_First(bigDecimalValue,
				orderByComparator);
	 ...
	 */
	@Override
	public BigDecimalEntry fetchByLessThanBigDecimalValue_First(
		BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator) {
		List<BigDecimalEntry> list = findByLessThanBigDecimalValue(bigDecimalValue,
	 ...
	 */
	@Override
	public BigDecimalEntry findByLessThanBigDecimalValue_Last(
		BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator)
		throws NoSuchBigDecimalEntryException {
		BigDecimalEntry bigDecimalEntry = fetchByLessThanBigDecimalValue_Last(bigDecimalValue,
				orderByComparator);
	 ...
	 */
	@Override
	public BigDecimalEntry fetchByLessThanBigDecimalValue_Last(
		BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator) {
		int count = countByLessThanBigDecimalValue(bigDecimalValue);
	 ...
	 */
	@Override
	public BigDecimalEntry[] findByLessThanBigDecimalValue_PrevAndNext(
		long bigDecimalEntryId, BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator)
		throws NoSuchBigDecimalEntryException {
		BigDecimalEntry bigDecimalEntry = findByPrimaryKey(bigDecimalEntryId);
		...
		try {
			...
			array[0] = getByLessThanBigDecimalValue_PrevAndNext(session,
					bigDecimalEntry, bigDecimalValue, orderByComparator, true);

			array[1] = bigDecimalEntry;

			array[2] = getByLessThanBigDecimalValue_PrevAndNext(session,
					bigDecimalEntry, bigDecimalValue, orderByComparator, false);
	...
	protected BigDecimalEntry getByLessThanBigDecimalValue_PrevAndNext(
		Session session, BigDecimalEntry bigDecimalEntry,
		BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByLessThanBigDecimalValue(BigDecimal bigDecimalValue) {
		for (BigDecimalEntry bigDecimalEntry : findByLessThanBigDecimalValue(
				bigDecimalValue, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(bigDecimalEntry);
		}
	}
	 ...
	 */
	@Override
	public int countByLessThanBigDecimalValue(BigDecimal bigDecimalValue) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_LESSTHANBIGDECIMALVALUE;
	...
	private static final String _FINDER_COLUMN_LESSTHANBIGDECIMALVALUE_BIGDECIMALVALUE_1 =
		"bigDecimalEntry.bigDecimalValue IS NULL";
	private static final String _FINDER_COLUMN_LESSTHANBIGDECIMALVALUE_BIGDECIMALVALUE_2 =
		"bigDecimalEntry.bigDecimalValue < ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GREATERTHANBIGDECIMALVALUE =
		new FinderPath(BigDecimalEntryModelImpl.ENTITY_CACHE_ENABLED,
			BigDecimalEntryModelImpl.FINDER_CACHE_ENABLED,
			BigDecimalEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByGreaterThanBigDecimalValue",
			new String[] {
				BigDecimal.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_GREATERTHANBIGDECIMALVALUE =
		new FinderPath(BigDecimalEntryModelImpl.ENTITY_CACHE_ENABLED,
			BigDecimalEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"countByGreaterThanBigDecimalValue",
			new String[] { BigDecimal.class.getName() });
	 ...
	 */
	@Override
	public List<BigDecimalEntry> findByGreaterThanBigDecimalValue(
		BigDecimal bigDecimalValue) {
		return findByGreaterThanBigDecimalValue(bigDecimalValue,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<BigDecimalEntry> findByGreaterThanBigDecimalValue(
		BigDecimal bigDecimalValue, int start, int end) {
		return findByGreaterThanBigDecimalValue(bigDecimalValue, start, end,
			null);
	}
	...
	public List<BigDecimalEntry> findByGreaterThanBigDecimalValue(
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_GREATERTHANBIGDECIMALVALUE;
		finderArgs = new Object[] { bigDecimalValue, start, end, orderByComparator };
		...
		if (list == null) {
			...
			if (bigDecimalValue == null) {
				query.append(_FINDER_COLUMN_GREATERTHANBIGDECIMALVALUE_BIGDECIMALVALUE_1);
			}
			else {
				bindBigDecimalValue = true;

				query.append(_FINDER_COLUMN_GREATERTHANBIGDECIMALVALUE_BIGDECIMALVALUE_2);
			}
	 ...
	 */
	@Override
	public BigDecimalEntry findByGreaterThanBigDecimalValue_First(
		BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator)
		throws NoSuchBigDecimalEntryException {
		BigDecimalEntry bigDecimalEntry = fetchByGreaterThanBigDecimalValue_First(bigDecimalValue,
				orderByComparator);
	 ...
	 */
	@Override
	public BigDecimalEntry fetchByGreaterThanBigDecimalValue_First(
		BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator) {
		List<BigDecimalEntry> list = findByGreaterThanBigDecimalValue(bigDecimalValue,
				0, 1, orderByComparator);
	 ...
	 */
	@Override
	public BigDecimalEntry findByGreaterThanBigDecimalValue_Last(
		BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator)
		throws NoSuchBigDecimalEntryException {
		BigDecimalEntry bigDecimalEntry = fetchByGreaterThanBigDecimalValue_Last(bigDecimalValue,
				orderByComparator);
	 ...
	 */
	@Override
	public BigDecimalEntry fetchByGreaterThanBigDecimalValue_Last(
		BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator) {
		int count = countByGreaterThanBigDecimalValue(bigDecimalValue);
	 ...
	 */
	@Override
	public BigDecimalEntry[] findByGreaterThanBigDecimalValue_PrevAndNext(
		long bigDecimalEntryId, BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator)
		throws NoSuchBigDecimalEntryException {
		BigDecimalEntry bigDecimalEntry = findByPrimaryKey(bigDecimalEntryId);
		...
		try {
			...
			array[0] = getByGreaterThanBigDecimalValue_PrevAndNext(session,
					bigDecimalEntry, bigDecimalValue, orderByComparator, true);

			array[1] = bigDecimalEntry;

			array[2] = getByGreaterThanBigDecimalValue_PrevAndNext(session,
					bigDecimalEntry, bigDecimalValue, orderByComparator, false);
	...
	protected BigDecimalEntry getByGreaterThanBigDecimalValue_PrevAndNext(
		Session session, BigDecimalEntry bigDecimalEntry,
		BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByGreaterThanBigDecimalValue(BigDecimal bigDecimalValue) {
		for (BigDecimalEntry bigDecimalEntry : findByGreaterThanBigDecimalValue(
				bigDecimalValue, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(bigDecimalEntry);
		}
	}
	 ...
	 */
	@Override
	public int countByGreaterThanBigDecimalValue(BigDecimal bigDecimalValue) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_GREATERTHANBIGDECIMALVALUE;
	...
	private static final String _FINDER_COLUMN_GREATERTHANBIGDECIMALVALUE_BIGDECIMALVALUE_1 =
		"bigDecimalEntry.bigDecimalValue IS NULL";
	private static final String _FINDER_COLUMN_GREATERTHANBIGDECIMALVALUE_BIGDECIMALVALUE_2 =
		"bigDecimalEntry.bigDecimalValue > ?";
