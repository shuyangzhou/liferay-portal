...
public class HtmlTopTagTest {
	...
	public void testDataSennaTrackAttributeAddedLPS_77775()
		...
		_testDataSennaTrackAttributeAdded(
			"<script type=\"text/javascript\" src=\"http://liferay.com/javascript-file.js\"></script>",
			"permanent");
		_testDataSennaTrackAttributeAdded(
			"<link rel=\"stylesheet\" type=\"text/css\" src=\"http://liferay.com/css-file.css\">",
			"temporary");
		_testDataSennaTrackAttributeAdded(
			"<style type=\"text/css\">.example { background-color: red; }</style>",
			"temporary");
		_testDataSennaTrackAttributeAdded(
			"<script type=\"text/javascript\" src=\"http://liferay.com/javascript-file.js\" data-senna-track=\"temporary\"></script>",
			"temporary");
		_testDataSennaTrackAttributeAdded(
			"<link rel=\"stylesheet\" type=\"text/css\" src=\"http://liferay.com/css-file.css\" data-senna-track=\"permanent\">",
			"permanent");
		_testDataSennaTrackAttributeAdded(
			"<style type=\"text/css\" data-senna-track=\"permanent\">.example { background-color: red; }</style>",
			"permanent");
		_testDataSennaTrackAttributeAdded(
	...
	private static void _testDataSennaTrackAttributeAdded(
		...
		if (expectedDataSennaTrackValue != null) {
			...
			int countOfDataSennaTrackAttrs =
				StringUtil.count(htmlTopTagOutputString,
					dataSennaTrackAttributeName);
