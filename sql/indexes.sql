...
create index IX_459BE01B on AnnouncementsEntry (classNameId, classPK, companyId, alert);
...
create index IX_4539A99C on AnnouncementsFlag (entryId, userId, value);
...
create index IX_F67BECAD on AssetCategory (parentCategoryId, groupId);
...
create index IX_C7F39FCA on AssetCategory (vocabularyId, groupId, name[$COLUMN_LENGTH:255$]);
create index IX_D61ABE08 on AssetCategory (vocabularyId, name[$COLUMN_LENGTH:255$]);
create index IX_87603842 on AssetCategory (vocabularyId, parentCategoryId, groupId);
create unique index IX_DC516B1D on AssetCategory (vocabularyId, parentCategoryId, name[$COLUMN_LENGTH:255$], ctCollectionId);
...
create index IX_D63322F9 on AssetTag (name[$COLUMN_LENGTH:75$], groupId);
...
create unique index IX_B38C8F6F on Country (companyId, ctCollectionId, a2[$COLUMN_LENGTH:75$]);
create unique index IX_8136F130 on Country (companyId, ctCollectionId, a3[$COLUMN_LENGTH:75$]);
create unique index IX_2E567809 on Country (companyId, ctCollectionId, name[$COLUMN_LENGTH:75$]);
create unique index IX_53078AD8 on Country (companyId, ctCollectionId, number_[$COLUMN_LENGTH:75$]);
...
create index IX_25F5CAB9 on DLFileEntry (custom2ImageId, custom1ImageId, largeImageId, smallImageId);
...
create unique index IX_A256938C on DLFileEntry (folderId, groupId, ctCollectionId, fileName[$COLUMN_LENGTH:255$]);
create unique index IX_F7878970 on DLFileEntry (folderId, groupId, ctCollectionId, name[$COLUMN_LENGTH:255$]);
create unique index IX_EAAB273 on DLFileEntry (folderId, groupId, ctCollectionId, title[$COLUMN_LENGTH:255$]);
create index IX_29D0AF28 on DLFileEntry (folderId, groupId, fileEntryTypeId);
create index IX_D20C434D on DLFileEntry (folderId, groupId, userId);
create index IX_8F6C75D0 on DLFileEntry (folderId, name[$COLUMN_LENGTH:255$]);
create index IX_1B352F4A on DLFileEntry (folderId, repositoryId);
...
create unique index IX_B9210CAD on DLFileEntryMetadata (fileVersionId, DDMStructureId, ctCollectionId);
create index IX_D49AB5D1 on DLFileEntryMetadata (uuid_[$COLUMN_LENGTH:75$]);

create unique index IX_B6F21286 on DLFileEntryType (groupId, ctCollectionId, dataDefinitionId);
create unique index IX_402227BD on DLFileEntryType (groupId, ctCollectionId, fileEntryTypeKey[$COLUMN_LENGTH:75$]);
...
create index IX_8571953E on DLFileShortcut (status, companyId);
create index IX_17EE3098 on DLFileShortcut (status, groupId, folderId, active_);
...
create index IX_9BE769ED on DLFileVersion (groupId, folderId, version[$COLUMN_LENGTH:75$], title[$COLUMN_LENGTH:255$]);
create index IX_FFB3395C on DLFileVersion (mimeType[$COLUMN_LENGTH:75$]);
create index IX_A0A283F4 on DLFileVersion (status, companyId);
create index IX_D47BB14D on DLFileVersion (status, fileEntryId);
create index IX_DFD809D3 on DLFileVersion (status, groupId, folderId);
...
create unique index IX_C7E346D2 on DLFolder (parentFolderId, groupId, name[$COLUMN_LENGTH:255$], ctCollectionId);
create index IX_CE360BF6 on DLFolder (parentFolderId, groupId, status, hidden_);
create index IX_C88430AB on DLFolder (parentFolderId, groupId, status, mountPoint, hidden_);
create index IX_51556082 on DLFolder (parentFolderId, name[$COLUMN_LENGTH:255$]);
create index IX_6747B2BC on DLFolder (parentFolderId, repositoryId);
create index IX_6F63F140 on DLFolder (repositoryId, mountPoint);
create index IX_E79BE432 on DLFolder (status, companyId);
...
create unique index IX_488E0C53 on ExpandoRow (classPK, tableId, ctCollectionId);

create unique index IX_87D370E2 on ExpandoTable (companyId, classNameId, name[$COLUMN_LENGTH:75$], ctCollectionId);

create index IX_B29FEF17 on ExpandoValue (classPK, classNameId);
create unique index IX_E6D98E43 on ExpandoValue (rowId_, columnId, ctCollectionId);
create unique index IX_D8C72C45 on ExpandoValue (tableId, classPK, columnId, ctCollectionId);
create index IX_B71E92D5 on ExpandoValue (tableId, rowId_);

create index IX_1827A2E5 on ExportImportConfiguration (companyId);
create index IX_47CC6234 on ExportImportConfiguration (groupId, status, type_);

create index IX_7B590A7A on Group_ (active_, type_);
create index IX_8257E37B on Group_ (classNameId, classPK);
create index IX_DDC91A87 on Group_ (companyId, active_);
create unique index IX_504CABF5 on Group_ (companyId, classNameId, ctCollectionId, classPK);
...
create unique index IX_9A7D6AD0 on Group_ (companyId, ctCollectionId, friendlyURL[$COLUMN_LENGTH:255$]);
create unique index IX_BE219CF4 on Group_ (companyId, ctCollectionId, groupKey[$COLUMN_LENGTH:150$]);
create index IX_5D75499E on Group_ (companyId, parentGroupId);
create index IX_B91488EC on Group_ (companyId, site, active_);
create index IX_D4BFF38B on Group_ (companyId, site, parentGroupId, inheritContent);
...
create unique index IX_B556968F on Layout (groupId, privateLayout, ctCollectionId, friendlyURL[$COLUMN_LENGTH:255$]);
create unique index IX_CF5120DA on Layout (groupId, privateLayout, ctCollectionId, layoutId);
...
create index IX_881EABCB on Layout (layoutPrototypeUuid[$COLUMN_LENGTH:75$], companyId);
...
create index IX_A705FF94 on LayoutBranch (plid, layoutSetBranchId, master);
create unique index IX_FD57097D on LayoutBranch (plid, layoutSetBranchId, name[$COLUMN_LENGTH:75$]);

create index IX_EAB317C8 on LayoutFriendlyURL (companyId);
create unique index IX_E73BB186 on LayoutFriendlyURL (friendlyURL[$COLUMN_LENGTH:255$], languageId[$COLUMN_LENGTH:75$], ctCollectionId, groupId, privateLayout);
...
create index IX_9EC9F954 on LayoutRevision (layoutSetBranchId, status, head);
create index IX_43E8286A on LayoutRevision (plid, head);
create index IX_38C5DF14 on LayoutRevision (plid, layoutSetBranchId, head, layoutBranchId);
create index IX_13984800 on LayoutRevision (plid, layoutSetBranchId, layoutBranchId);
...
create index IX_BC1F2123 on LayoutSet (layoutSetPrototypeUuid[$COLUMN_LENGTH:75$], companyId);
create unique index IX_3F2A9AEF on LayoutSet (privateLayout, groupId, ctCollectionId);
...
create index IX_D834B361 on Organization_ (companyId, name[$COLUMN_LENGTH:100$], parentOrganizationId);
...
create unique index IX_A6DD0ECF on PortalPreferenceValue (portalPreferencesId, namespace[$COLUMN_LENGTH:255$], key_[$COLUMN_LENGTH:255$], index_);
create index IX_9FF9CC4E on PortalPreferenceValue (portalPreferencesId, namespace[$COLUMN_LENGTH:255$], key_[$COLUMN_LENGTH:255$], smallValue[$COLUMN_LENGTH:255$]);

create index IX_D1F795F1 on PortalPreferences (ownerType, ownerId);

create unique index IX_12B5E51D on Portlet (companyId, portletId[$COLUMN_LENGTH:200$]);

create index IX_D699243F on PortletItem (groupId, classNameId, portletId[$COLUMN_LENGTH:200$], name[$COLUMN_LENGTH:75$]);

create unique index IX_AD38E28D on PortletPreferenceValue (name[$COLUMN_LENGTH:255$], portletPreferencesId, index_, ctCollectionId);
create index IX_8E75AB8C on PortletPreferenceValue (name[$COLUMN_LENGTH:255$], portletPreferencesId, smallValue[$COLUMN_LENGTH:255$]);
create index IX_2B7D5A63 on PortletPreferenceValue (name[$COLUMN_LENGTH:255$], smallValue[$COLUMN_LENGTH:255$], companyId);

create index IX_60C49142 on PortletPreferences (ownerId, ownerType, portletId[$COLUMN_LENGTH:200$], companyId);
create unique index IX_CB778855 on PortletPreferences (ownerId, ownerType, portletId[$COLUMN_LENGTH:200$], plid, ctCollectionId);

create index IX_A1A8CB8B on RatingsEntry (classNameId, classPK, score);
create unique index IX_B938D06F on RatingsEntry (classNameId, classPK, userId, ctCollectionId);
...
create unique index IX_A9FF4B2C on ResourcePermission (companyId, scope, name[$COLUMN_LENGTH:255$], primKey[$COLUMN_LENGTH:255$], roleId, ctCollectionId);
create index IX_49AEC6F3 on ResourcePermission (companyId, scope, name[$COLUMN_LENGTH:255$], roleId, primKeyId, viewActionId);
...
create unique index IX_C0F6BCAC on Role_ (companyId, ctCollectionId, classNameId, classPK);
create unique index IX_4CC99816 on Role_ (companyId, ctCollectionId, name[$COLUMN_LENGTH:75$]);
create index IX_F436EC8E on Role_ (name[$COLUMN_LENGTH:75$]);
create index IX_CBE204 on Role_ (subtype[$COLUMN_LENGTH:75$], type_);
...
create unique index IX_24810327 on SocialActivity (classNameId, classPK, groupId, userId, type_, receiverUserId, ctCollectionId, createDate);
create index IX_1F00C374 on SocialActivity (classNameId, classPK, mirrorActivityId);
...
create unique index IX_8F6B63C5 on SocialActivityCounter (classNameId, classPK, groupId, ownerType, name[$COLUMN_LENGTH:75$], ctCollectionId, endPeriod);
create unique index IX_D520F00C on SocialActivityCounter (classNameId, classPK, groupId, ownerType, name[$COLUMN_LENGTH:75$], ctCollectionId, startPeriod);

create unique index IX_4A636E75 on SocialActivityLimit (classNameId, classPK, userId, groupId, activityType, activityCounterName[$COLUMN_LENGTH:75$], ctCollectionId);

create index IX_9E13F2DE on SocialActivitySet (groupId);
create index IX_4460FA14 on SocialActivitySet (type_, classNameId, classPK);
create index IX_62AC101A on SocialActivitySet (type_, classNameId, userId, classPK);
create index IX_9BE30DDF on SocialActivitySet (type_, classNameId, userId, groupId);

create index IX_D984AABA on SocialActivitySetting (groupId, activityType, classNameId, name[$COLUMN_LENGTH:75$]);

create index IX_61171E99 on SocialRelation (companyId);
create index IX_95135D1C on SocialRelation (type_, companyId);
create unique index IX_D97ACDA3 on SocialRelation (userId2, type_, userId1, ctCollectionId);
create index IX_B5C9C690 on SocialRelation (userId2, userId1);
create index IX_F0CA24A5 on SocialRelation (uuid_[$COLUMN_LENGTH:75$]);

create unique index IX_EF4BB505 on SocialRequest (classNameId, classPK, receiverUserId, type_, userId, ctCollectionId);
create index IX_A90FE5A0 on SocialRequest (companyId);
create index IX_D3425487 on SocialRequest (status, classNameId, classPK, receiverUserId, type_);
create index IX_CC86A444 on SocialRequest (status, classNameId, classPK, type_, userId);
create index IX_D9380CB7 on SocialRequest (status, receiverUserId);
...
create index IX_8BACD0AA on Ticket (classNameId, classPK, type_, companyId);
...
create unique index IX_B384D815 on UserGroupGroupRole (userGroupId, roleId, groupId, ctCollectionId);

create unique index IX_F8059243 on UserGroupRole (userId, roleId, groupId, ctCollectionId);
...
create unique index IX_D1C44A6E on UserIdMapper (type_[$COLUMN_LENGTH:75$], userId);
...
create index IX_C4EFBD45 on UserNotificationEvent (userId, deliveryType, archived, actionRequired);
create index IX_4BF3A7AD on UserNotificationEvent (userId, deliveryType, archived, delivered, actionRequired);
create index IX_7AFE83D7 on UserNotificationEvent (userId, deliveryType, archived, delivered, type_[$COLUMN_LENGTH:200$]);
create index IX_8FB65EC1 on UserNotificationEvent (userId, deliveryType, delivered, type_[$COLUMN_LENGTH:200$]);
...
create unique index IX_6C9F41D8 on User_ (companyId, ctCollectionId, emailAddress[$COLUMN_LENGTH:254$]);
create unique index IX_EEC1E477 on User_ (companyId, ctCollectionId, screenName[$COLUMN_LENGTH:75$]);
...
create index IX_FD06BAAD on User_ (companyId, status, type_);
...
create index IX_EECA5FDA on VirtualHost (layoutSetId, companyId, defaultVirtualHost);
...
create index IX_705B40EE on WorkflowDefinitionLink (companyId, groupId, classPK, classNameId, typePK);
