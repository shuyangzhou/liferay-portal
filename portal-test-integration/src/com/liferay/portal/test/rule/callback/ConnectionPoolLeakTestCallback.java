...
public class ConnectionPoolLeakTestCallback
	...
	public void afterMethod(
		...
		for (ServiceReference<ConnectionPoolMetrics> serviceReference :
			...
			int initialActiveConnectionsCount =
				_methodConnectionPoolActiveMap.get(
					connectionPoolMetrics.getConnectionPoolName());
			...
			int initialIdleConnectionsCount = _methodConnectionPoolIdleMap.get(
				connectionPoolMetrics.getConnectionPoolName());
	...
	public Collection<ServiceReference<ConnectionPoolMetrics>> beforeClass(
		...
		for (ServiceReference<ConnectionPoolMetrics> serviceReference :
			...
			_connectionPoolActiveMap.put(
				connectionPoolMetrics.getConnectionPoolName(),
				connectionPoolMetrics.getNumActive());

			_connectionPoolIdleMap.put(
				connectionPoolMetrics.getConnectionPoolName(),
				connectionPoolMetrics.getNumIdle());
	...
	public Collection<ServiceReference<ConnectionPoolMetrics>> beforeMethod(
		...
		for (ServiceReference<ConnectionPoolMetrics> serviceReference :
			...
			_methodConnectionPoolActiveMap.put(
				connectionPoolMetrics.getConnectionPoolName(),
				connectionPoolMetrics.getNumActive());

			_methodConnectionPoolIdleMap.put(
				connectionPoolMetrics.getConnectionPoolName(),
				connectionPoolMetrics.getNumIdle());
	...
	private final Map<String, Integer> _connectionPoolActiveMap =
		new HashMap<>();
	private final Map<String, Integer> _connectionPoolIdleMap = new HashMap<>();
	private final Map<String, Integer> _methodConnectionPoolActiveMap =
		new HashMap<>();
	private final Map<String, Integer> _methodConnectionPoolIdleMap =
		new HashMap<>();
