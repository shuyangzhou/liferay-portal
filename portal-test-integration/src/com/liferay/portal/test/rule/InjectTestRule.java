 ...
 */
public class InjectTestRule extends BaseTestRule<InjectTestBag, InjectTestBag> {

	public static final InjectTestRule INSTANCE = new InjectTestRule(
		InjectTestCallback.INSTANCE);

	private InjectTestRule(
		TestCallback<InjectTestBag, InjectTestBag> testCallback) {
