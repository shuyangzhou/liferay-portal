...
create table BlogsEntry (
	...
	trackbacks clob,
	coverImageCaption varchar(4000),
	coverImageFileEntryId bigint,
	coverImageURL varchar(4000),
	smallImage smallint,
...
create table DDMTemplateLink (
	templateLinkId bigint not null primary key,
	classNameId bigint,
	classPK bigint,
	templateId bigint
);
...
insert into Release_ (releaseId, createDate, modifiedDate, servletContextName, buildNumber, verified) values (1, current timestamp, current timestamp, 'portal', 7000, 0);
